...
func (o Evaluationsettingsassignee) MarshalJSON() ([]byte, error) {
...
func (o *Evaluationsettingsassignee) UnmarshalJSON(b []byte) error {
	var EvaluationsettingsassigneeMap map[string]interface{}
	err := json.Unmarshal(b, &EvaluationsettingsassigneeMap)
	if err != nil {
		return err
	}
