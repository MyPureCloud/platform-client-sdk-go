...
func (o *Outbounddomain) SetField(field string, fieldValue interface{}) {
...
func (o *Outbounddomain) UnmarshalJSON(b []byte) error {
	...
	if DmarcVerificationResult, ok := OutbounddomainMap["dmarcVerificationResult"].(map[string]interface{}); ok {
