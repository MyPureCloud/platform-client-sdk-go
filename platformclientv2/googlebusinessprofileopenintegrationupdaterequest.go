...
func (o *Googlebusinessprofileopenintegrationupdaterequest) SetField(field string, fieldValue interface{}) {
...
func (o Googlebusinessprofileopenintegrationupdaterequest) MarshalJSON() ([]byte, error) {
...
func (o *Googlebusinessprofileopenintegrationupdaterequest) UnmarshalJSON(b []byte) error {
	var GooglebusinessprofileopenintegrationupdaterequestMap map[string]interface{}
	err := json.Unmarshal(b, &GooglebusinessprofileopenintegrationupdaterequestMap)
	if err != nil {
		return err
	}
	
	if Id, ok := GooglebusinessprofileopenintegrationupdaterequestMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Name, ok := GooglebusinessprofileopenintegrationupdaterequestMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if SupportedContent, ok := GooglebusinessprofileopenintegrationupdaterequestMap["supportedContent"].(map[string]interface{}); ok {
		SupportedContentString, _ := json.Marshal(SupportedContent)
		json.Unmarshal(SupportedContentString, &o.SupportedContent)
	}
	
	if MessagingSetting, ok := GooglebusinessprofileopenintegrationupdaterequestMap["messagingSetting"].(map[string]interface{}); ok {
		MessagingSettingString, _ := json.Marshal(MessagingSetting)
		json.Unmarshal(MessagingSettingString, &o.MessagingSetting)
	}
	
	if Token, ok := GooglebusinessprofileopenintegrationupdaterequestMap["token"].(map[string]interface{}); ok {
		TokenString, _ := json.Marshal(Token)
		json.Unmarshal(TokenString, &o.Token)
	}
	
	if Account, ok := GooglebusinessprofileopenintegrationupdaterequestMap["account"].(map[string]interface{}); ok {
		AccountString, _ := json.Marshal(Account)
		json.Unmarshal(AccountString, &o.Account)
	}
	
	if SelfUri, ok := GooglebusinessprofileopenintegrationupdaterequestMap["selfUri"].(string); ok {
		o.SelfUri = &SelfUri
	}
