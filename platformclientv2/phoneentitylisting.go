...
func (o *Phoneentitylisting) SetField(field string, fieldValue interface{}) {
...
func (o *Phoneentitylisting) UnmarshalJSON(b []byte) error {
	...
	if TotalNumberOfEntities, ok := PhoneentitylistingMap["totalNumberOfEntities"].(float64); ok {
