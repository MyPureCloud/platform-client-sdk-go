...
func (o *Identityresolutionautomergeconfig) SetField(field string, fieldValue interface{}) {
...
func (o Identityresolutionautomergeconfig) MarshalJSON() ([]byte, error) {
...
func (o *Identityresolutionautomergeconfig) UnmarshalJSON(b []byte) error {
	var IdentityresolutionautomergeconfigMap map[string]interface{}
	err := json.Unmarshal(b, &IdentityresolutionautomergeconfigMap)
	if err != nil {
		return err
	}
