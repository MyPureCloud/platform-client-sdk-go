...
func (o *Dnclistdownloadreadyexporturi) SetField(field string, fieldValue interface{}) {
...
func (o *Dnclistdownloadreadyexporturi) UnmarshalJSON(b []byte) error {
	...
	if GetAdditionalProperties, ok := DnclistdownloadreadyexporturiMap["getAdditionalProperties"].(map[string]interface{}); ok {
