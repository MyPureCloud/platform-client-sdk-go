...
func (o *Historicalimportstatuslisting) SetField(field string, fieldValue interface{}) {
...
func (o *Historicalimportstatuslisting) UnmarshalJSON(b []byte) error {
	...
	if DownloadUrl, ok := HistoricalimportstatuslistingMap["downloadUrl"].(string); ok {
