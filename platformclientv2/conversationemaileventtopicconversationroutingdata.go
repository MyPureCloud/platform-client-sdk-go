...
type Conversationemaileventtopicconversationroutingdata struct { 
	...
	SkillExpressionId *Conversationemaileventtopicurireference `json:"skillExpressionId,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Conversationemaileventtopicconversationroutingdata) SetField(field string, fieldValue interface{}) {
...
func (o *Conversationemaileventtopicconversationroutingdata) UnmarshalJSON(b []byte) error {
	...
	if SkillExpressionId, ok := ConversationemaileventtopicconversationroutingdataMap["skillExpressionId"].(map[string]interface{}); ok {
