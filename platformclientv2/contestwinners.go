...
func (o *Contestwinners) SetField(field string, fieldValue interface{}) {
...
func (o Contestwinners) MarshalJSON() ([]byte, error) {
...
func (o *Contestwinners) UnmarshalJSON(b []byte) error {
	var ContestwinnersMap map[string]interface{}
	err := json.Unmarshal(b, &ContestwinnersMap)
	if err != nil {
		return err
	}
