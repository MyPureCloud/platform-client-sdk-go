...
func (a SearchApi) GetTelephonyProvidersEdgesSitesSearch(q64 string, expand []string) (*Sitessearchresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	...
	if &q64 == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'q64' when calling SearchApi->GetTelephonyProvidersEdgesSitesSearch")
	}
...
// PostConversationsCustomattributesSearch invokes POST /api/v2/conversations/customattributes/search
//
// Search resources.
func (a SearchApi) PostConversationsCustomattributesSearch(body Conversationcustomattributessearchrequest) (*Jsonsearchresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/customattributes/search"
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling SearchApi->PostConversationsCustomattributesSearch")
	}
...
func (a SearchApi) PostConversationsParticipantsAttributesSearch(body Conversationparticipantsearchrequest) (*Jsoncursorsearchresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling SearchApi->PostConversationsParticipantsAttributesSearch")
	}
...
// PostDocumentationAllSearch invokes POST /api/v2/documentation/all/search
//
...
func (a SearchApi) PostDocumentationAllSearch(body Documentationv2searchrequest) (*Jsonnodesearchresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/documentation/all/search"
	defaultReturn := new(Jsonnodesearchresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling SearchApi->PostDocumentationAllSearch")
	}
...
func (a SearchApi) PostTeamsSearch(body Teamsearchrequest) (*Teamssearchresponse, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling SearchApi->PostTeamsSearch")
	}
...
//
// Search sites
func (a SearchApi) PostTelephonyProvidersEdgesSitesSearch(body Sitesearchrequest) (*Sitessearchresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/telephony/providers/edges/sites/search"
	defaultReturn := new(Sitessearchresponse)
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling SearchApi->PostTelephonyProvidersEdgesSitesSearch")
	}
...
func (a SearchApi) PostUsersSearchConversationTarget(body Usersearchrequest) (*Userssearchresponse, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling SearchApi->PostUsersSearchConversationTarget")
	}
...
func (a SearchApi) PostUsersSearchQueuemembersManage(body Usersearchrequest) (*Userssearchresponse, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling SearchApi->PostUsersSearchQueuemembersManage")
	}
...
func (a SearchApi) PostUsersSearchTeamsAssign(body Usersearchrequest) (*Userssearchresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling SearchApi->PostUsersSearchTeamsAssign")
	}
