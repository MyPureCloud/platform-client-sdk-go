...
func (o *Staffinggroupresponse) SetField(field string, fieldValue interface{}) {
...
func (o Staffinggroupresponse) MarshalJSON() ([]byte, error) {
...
func (o *Staffinggroupresponse) UnmarshalJSON(b []byte) error {
	var StaffinggroupresponseMap map[string]interface{}
	err := json.Unmarshal(b, &StaffinggroupresponseMap)
	if err != nil {
		return err
	}
	
	if Id, ok := StaffinggroupresponseMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Name, ok := StaffinggroupresponseMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if Users, ok := StaffinggroupresponseMap["users"].([]interface{}); ok {
	...
	if SelfUri, ok := StaffinggroupresponseMap["selfUri"].(string); ok {
		o.SelfUri = &SelfUri
	}
