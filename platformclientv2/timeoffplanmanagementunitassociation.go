...
func (o *Timeoffplanmanagementunitassociation) SetField(field string, fieldValue interface{}) {
...
func (o Timeoffplanmanagementunitassociation) MarshalJSON() ([]byte, error) {
...
func (o *Timeoffplanmanagementunitassociation) UnmarshalJSON(b []byte) error {
	var TimeoffplanmanagementunitassociationMap map[string]interface{}
	err := json.Unmarshal(b, &TimeoffplanmanagementunitassociationMap)
	if err != nil {
		return err
	}
	
	if ManagementUnit, ok := TimeoffplanmanagementunitassociationMap["managementUnit"].(map[string]interface{}); ok {
		ManagementUnitString, _ := json.Marshal(ManagementUnit)
		json.Unmarshal(ManagementUnitString, &o.ManagementUnit)
	}
	
	if StaffingGroups, ok := TimeoffplanmanagementunitassociationMap["staffingGroups"].([]interface{}); ok {
