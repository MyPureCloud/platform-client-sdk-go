...
func (o *Roomupdaterequest) SetField(field string, fieldValue interface{}) {
...
func (o Roomupdaterequest) MarshalJSON() ([]byte, error) {
...
func (o *Roomupdaterequest) UnmarshalJSON(b []byte) error {
	var RoomupdaterequestMap map[string]interface{}
	err := json.Unmarshal(b, &RoomupdaterequestMap)
	if err != nil {
		return err
	}
	
	if Description, ok := RoomupdaterequestMap["description"].(string); ok {
