...
func (o *Gamificationscorecardchangetopicpunctualityevent) SetField(field string, fieldValue interface{}) {
...
func (o *Gamificationscorecardchangetopicpunctualityevent) UnmarshalJSON(b []byte) error {
	...
	if ActivityCodeId, ok := GamificationscorecardchangetopicpunctualityeventMap["activityCodeId"].(string); ok {
