...
// GetGamificationInsightsManagers invokes GET /api/v2/gamification/insights/managers
//
// Query managers in a profile during a period of time
func (a GamificationApi) GetGamificationInsightsManagers(filterType string, filterId string, granularity string, startWorkday time.Time, pageSize int, pageNumber int) (*Insightsagents, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/gamification/insights/managers"
	...
	if &filterType == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'filterType' when calling GamificationApi->GetGamificationInsightsManagers")
	}
	// verify the required parameter 'filterId' is set
	if &filterId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'filterId' when calling GamificationApi->GetGamificationInsightsManagers")
	}
	// verify the required parameter 'granularity' is set
	if &granularity == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'granularity' when calling GamificationApi->GetGamificationInsightsManagers")
	}
	// verify the required parameter 'startWorkday' is set
	if &startWorkday == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'startWorkday' when calling GamificationApi->GetGamificationInsightsManagers")
	}
