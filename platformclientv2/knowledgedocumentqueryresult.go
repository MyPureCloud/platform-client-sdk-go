...
type Knowledgedocumentqueryresult struct { 
	...
	Variations *[]Knowledgedocumentqueryvariation `json:"variations,omitempty"`
...
func (o *Knowledgedocumentqueryresult) SetField(field string, fieldValue interface{}) {
...
func (o Knowledgedocumentqueryresult) MarshalJSON() ([]byte, error) {
...
func (o *Knowledgedocumentqueryresult) UnmarshalJSON(b []byte) error {
	var KnowledgedocumentqueryresultMap map[string]interface{}
	err := json.Unmarshal(b, &KnowledgedocumentqueryresultMap)
	if err != nil {
		return err
	}
	
	if Id, ok := KnowledgedocumentqueryresultMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Title, ok := KnowledgedocumentqueryresultMap["title"].(string); ok {
		o.Title = &Title
	}
    
	if Visible, ok := KnowledgedocumentqueryresultMap["visible"].(bool); ok {
		o.Visible = &Visible
	}
    
	if Alternatives, ok := KnowledgedocumentqueryresultMap["alternatives"].([]interface{}); ok {
		AlternativesString, _ := json.Marshal(Alternatives)
		json.Unmarshal(AlternativesString, &o.Alternatives)
	}
	
	if State, ok := KnowledgedocumentqueryresultMap["state"].(string); ok {
		o.State = &State
	}
    
	if dateCreatedString, ok := KnowledgedocumentqueryresultMap["dateCreated"].(string); ok {
		DateCreated, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateCreatedString)
		o.DateCreated = &DateCreated
	}
	
	if dateModifiedString, ok := KnowledgedocumentqueryresultMap["dateModified"].(string); ok {
		DateModified, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateModifiedString)
		o.DateModified = &DateModified
	}
	
	if dateImportedString, ok := KnowledgedocumentqueryresultMap["dateImported"].(string); ok {
		DateImported, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateImportedString)
		o.DateImported = &DateImported
	}
	
	if LastPublishedVersionNumber, ok := KnowledgedocumentqueryresultMap["lastPublishedVersionNumber"].(float64); ok {
		LastPublishedVersionNumberInt := int(LastPublishedVersionNumber)
		o.LastPublishedVersionNumber = &LastPublishedVersionNumberInt
	}
	
	if datePublishedString, ok := KnowledgedocumentqueryresultMap["datePublished"].(string); ok {
		DatePublished, _ := time.Parse("2006-01-02T15:04:05.999999Z", datePublishedString)
		o.DatePublished = &DatePublished
	}
	
	if CreatedBy, ok := KnowledgedocumentqueryresultMap["createdBy"].(map[string]interface{}); ok {
		CreatedByString, _ := json.Marshal(CreatedBy)
		json.Unmarshal(CreatedByString, &o.CreatedBy)
	}
	
	if ModifiedBy, ok := KnowledgedocumentqueryresultMap["modifiedBy"].(map[string]interface{}); ok {
		ModifiedByString, _ := json.Marshal(ModifiedBy)
		json.Unmarshal(ModifiedByString, &o.ModifiedBy)
	}
	
	if DocumentVersion, ok := KnowledgedocumentqueryresultMap["documentVersion"].(map[string]interface{}); ok {
		DocumentVersionString, _ := json.Marshal(DocumentVersion)
		json.Unmarshal(DocumentVersionString, &o.DocumentVersion)
	}
	
	if Category, ok := KnowledgedocumentqueryresultMap["category"].(map[string]interface{}); ok {
		CategoryString, _ := json.Marshal(Category)
		json.Unmarshal(CategoryString, &o.Category)
	}
	
	if Labels, ok := KnowledgedocumentqueryresultMap["labels"].([]interface{}); ok {
		LabelsString, _ := json.Marshal(Labels)
		json.Unmarshal(LabelsString, &o.Labels)
	}
	
	if KnowledgeBase, ok := KnowledgedocumentqueryresultMap["knowledgeBase"].(map[string]interface{}); ok {
		KnowledgeBaseString, _ := json.Marshal(KnowledgeBase)
		json.Unmarshal(KnowledgeBaseString, &o.KnowledgeBase)
	}
	
	if ExternalId, ok := KnowledgedocumentqueryresultMap["externalId"].(string); ok {
		o.ExternalId = &ExternalId
	}
    
	if ExternalUrl, ok := KnowledgedocumentqueryresultMap["externalUrl"].(string); ok {
		o.ExternalUrl = &ExternalUrl
	}
    
	if Source, ok := KnowledgedocumentqueryresultMap["source"].(map[string]interface{}); ok {
		SourceString, _ := json.Marshal(Source)
		json.Unmarshal(SourceString, &o.Source)
	}
	
	if Readonly, ok := KnowledgedocumentqueryresultMap["readonly"].(bool); ok {
		o.Readonly = &Readonly
	}
    
	if Variations, ok := KnowledgedocumentqueryresultMap["variations"].([]interface{}); ok {
		VariationsString, _ := json.Marshal(Variations)
		json.Unmarshal(VariationsString, &o.Variations)
	}
	
	if SelfUri, ok := KnowledgedocumentqueryresultMap["selfUri"].(string); ok {
		o.SelfUri = &SelfUri
	}
