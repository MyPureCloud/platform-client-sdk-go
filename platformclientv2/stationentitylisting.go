...
func (o *Stationentitylisting) SetField(field string, fieldValue interface{}) {
...
func (o *Stationentitylisting) UnmarshalJSON(b []byte) error {
	...
	if TotalNumberOfEntities, ok := StationentitylistingMap["totalNumberOfEntities"].(float64); ok {
