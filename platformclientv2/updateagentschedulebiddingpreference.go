...
func (o *Updateagentschedulebiddingpreference) SetField(field string, fieldValue interface{}) {
...
func (o Updateagentschedulebiddingpreference) MarshalJSON() ([]byte, error) {
...
func (o *Updateagentschedulebiddingpreference) UnmarshalJSON(b []byte) error {
	var UpdateagentschedulebiddingpreferenceMap map[string]interface{}
	err := json.Unmarshal(b, &UpdateagentschedulebiddingpreferenceMap)
	if err != nil {
		return err
	}
	
	if Submitted, ok := UpdateagentschedulebiddingpreferenceMap["submitted"].(bool); ok {
		o.Submitted = &Submitted
	}
    
	if AgentScheduleBidPreferences, ok := UpdateagentschedulebiddingpreferenceMap["agentScheduleBidPreferences"].([]interface{}); ok {
