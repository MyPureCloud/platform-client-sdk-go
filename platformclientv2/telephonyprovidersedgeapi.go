...
// DeleteTelephonyProvidersEdgesAlertablepresences invokes DELETE /api/v2/telephony/providers/edges/alertablepresences
//
// Deletes alertable presences overrides.
func (a TelephonyProvidersEdgeApi) DeleteTelephonyProvidersEdgesAlertablepresences() (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/telephony/providers/edges/alertablepresences"
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
// GetTelephonyProvidersEdgesAlertablepresences invokes GET /api/v2/telephony/providers/edges/alertablepresences
//
...
func (a TelephonyProvidersEdgeApi) GetTelephonyProvidersEdgesAlertablepresences(varType string) (*Alertablepresences, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/telephony/providers/edges/alertablepresences"
	defaultReturn := new(Alertablepresences)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Alertablepresences
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
// GetTelephonyProvidersEdgesExtensionpoolsDivisionviews invokes GET /api/v2/telephony/providers/edges/extensionpools/divisionviews
//
...
func (a TelephonyProvidersEdgeApi) GetTelephonyProvidersEdgesExtensionpoolsDivisionviews(pageNumber int, pageSize int, sortBy string, sortOrder string, id []string, name string, divisionId []string) (*Extensionpooldivisionviewentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/telephony/providers/edges/extensionpools/divisionviews"
	defaultReturn := new(Extensionpooldivisionviewentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Extensionpooldivisionviewentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Extensionpooldivisionviewentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetTelephonyProvidersEdgesMediastatisticsConversation invokes GET /api/v2/telephony/providers/edges/mediastatistics/conversations/{conversationId}
//
// Get media endpoint statistics events.
//
// Preview: GetTelephonyProvidersEdgesMediastatisticsConversation is a preview method and is subject to both breaking and non-breaking changes at any time without notice
func (a TelephonyProvidersEdgeApi) GetTelephonyProvidersEdgesMediastatisticsConversation(conversationId string) (*Mediastatisticslisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/telephony/providers/edges/mediastatistics/conversations/{conversationId}"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	defaultReturn := new(Mediastatisticslisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling TelephonyProvidersEdgeApi->GetTelephonyProvidersEdgesMediastatisticsConversation")
	}
	...
	var successPayload *Mediastatisticslisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Mediastatisticslisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetTelephonyProvidersEdgesMediastatisticsConversationCommunication invokes GET /api/v2/telephony/providers/edges/mediastatistics/conversations/{conversationId}/communications/{communicationId}
//
// Get media endpoint statistics event.
//
// Preview: GetTelephonyProvidersEdgesMediastatisticsConversationCommunication is a preview method and is subject to both breaking and non-breaking changes at any time without notice
func (a TelephonyProvidersEdgeApi) GetTelephonyProvidersEdgesMediastatisticsConversationCommunication(conversationId string, communicationId string) (*Mediastatistics, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/telephony/providers/edges/mediastatistics/conversations/{conversationId}/communications/{communicationId}"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling TelephonyProvidersEdgeApi->GetTelephonyProvidersEdgesMediastatisticsConversationCommunication")
	}
	// verify the required parameter 'communicationId' is set
	if &communicationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'communicationId' when calling TelephonyProvidersEdgeApi->GetTelephonyProvidersEdgesMediastatisticsConversationCommunication")
	}
...
// GetTelephonyProvidersEdgesSiteSiteconnections invokes GET /api/v2/telephony/providers/edges/sites/{siteId}/siteconnections
//
// Get site connections for a site.
func (a TelephonyProvidersEdgeApi) GetTelephonyProvidersEdgesSiteSiteconnections(siteId string) (*Siteconnections, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/telephony/providers/edges/sites/{siteId}/siteconnections"
	path = strings.Replace(path, "{siteId}", url.PathEscape(fmt.Sprintf("%v", siteId)), -1)
	defaultReturn := new(Siteconnections)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &siteId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'siteId' when calling TelephonyProvidersEdgeApi->GetTelephonyProvidersEdgesSiteSiteconnections")
	}
	...
	var successPayload *Siteconnections
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
// GetTelephonyProvidersEdgesSitesSearch invokes GET /api/v2/telephony/providers/edges/sites/search
//
// Search sites using the q64 value returned from a previous search
func (a TelephonyProvidersEdgeApi) GetTelephonyProvidersEdgesSitesSearch(q64 string, expand []string) (*Sitessearchresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/telephony/providers/edges/sites/search"
	defaultReturn := new(Sitessearchresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &q64 == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'q64' when calling TelephonyProvidersEdgeApi->GetTelephonyProvidersEdgesSitesSearch")
	}
	...
	var successPayload *Sitessearchresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
// GetTelephonyProvidersEdgesTrunkbasesettingsSiteSiteId invokes GET /api/v2/telephony/providers/edges/trunkbasesettings/site/{siteId}
//
// Get Trunk Base Settings listing for site
//
// Managed properties will not be returned unless the user is assigned the internal:trunk:edit permission.
func (a TelephonyProvidersEdgeApi) GetTelephonyProvidersEdgesTrunkbasesettingsSiteSiteId(siteId string, pageNumber int, pageSize int, sortBy string, sortOrder string) (*Trunkbaseentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/telephony/providers/edges/trunkbasesettings/site/{siteId}"
	path = strings.Replace(path, "{siteId}", url.PathEscape(fmt.Sprintf("%v", siteId)), -1)
	defaultReturn := new(Trunkbaseentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	...
	if &siteId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'siteId' when calling TelephonyProvidersEdgeApi->GetTelephonyProvidersEdgesTrunkbasesettingsSiteSiteId")
	}
...
// PatchTelephonyProvidersEdgesSiteSiteconnections invokes PATCH /api/v2/telephony/providers/edges/sites/{siteId}/siteconnections
//
// Disable site connections for a site.
func (a TelephonyProvidersEdgeApi) PatchTelephonyProvidersEdgesSiteSiteconnections(siteId string, body Disablesiteconnectionsrequest) (*Siteconnections, *APIResponse, error) {
	...
	if &siteId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'siteId' when calling TelephonyProvidersEdgeApi->PatchTelephonyProvidersEdgesSiteSiteconnections")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling TelephonyProvidersEdgeApi->PatchTelephonyProvidersEdgesSiteSiteconnections")
	}
...
// PostTelephonyProvidersEdgeOfflineconfiguration invokes POST /api/v2/telephony/providers/edges/{edgeId}/offlineconfiguration
//
// Create a file that can be used to configure a hardware Edge's settings.
func (a TelephonyProvidersEdgeApi) PostTelephonyProvidersEdgeOfflineconfiguration(edgeId string, body Edgeofflineconfiguration) (*Edgeofflineconfigurationresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/telephony/providers/edges/{edgeId}/offlineconfiguration"
	path = strings.Replace(path, "{edgeId}", url.PathEscape(fmt.Sprintf("%v", edgeId)), -1)
	defaultReturn := new(Edgeofflineconfigurationresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &edgeId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'edgeId' when calling TelephonyProvidersEdgeApi->PostTelephonyProvidersEdgeOfflineconfiguration")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling TelephonyProvidersEdgeApi->PostTelephonyProvidersEdgeOfflineconfiguration")
	}
	...
	var successPayload *Edgeofflineconfigurationresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Edgeofflineconfigurationresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostTelephonyProvidersEdgesSitesSearch invokes POST /api/v2/telephony/providers/edges/sites/search
//
// Search sites
func (a TelephonyProvidersEdgeApi) PostTelephonyProvidersEdgesSitesSearch(body Sitesearchrequest) (*Sitessearchresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/telephony/providers/edges/sites/search"
	defaultReturn := new(Sitessearchresponse)
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling TelephonyProvidersEdgeApi->PostTelephonyProvidersEdgesSitesSearch")
	}
...
// PostTelephonyProvidersEdgesTrunkbasesettingsSearch invokes POST /api/v2/telephony/providers/edges/trunkbasesettings/search
//
// Search Trunk Base Settings
//
// Managed properties will not be returned unless the user is assigned the internal:trunk:edit permission.
func (a TelephonyProvidersEdgeApi) PostTelephonyProvidersEdgesTrunkbasesettingsSearch(body Telephonysearchrequest) (*Trunkbasessearchresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/telephony/providers/edges/trunkbasesettings/search"
	defaultReturn := new(Trunkbasessearchresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling TelephonyProvidersEdgeApi->PostTelephonyProvidersEdgesTrunkbasesettingsSearch")
	}
	...
	var successPayload *Trunkbasessearchresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Trunkbasessearchresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostTelephonyProvidersEdgesTrunksSearch invokes POST /api/v2/telephony/providers/edges/trunks/search
//
// Search for trunks
func (a TelephonyProvidersEdgeApi) PostTelephonyProvidersEdgesTrunksSearch(body Telephonysearchrequest) (*Trunkinstancesearchresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/telephony/providers/edges/trunks/search"
	defaultReturn := new(Trunkinstancesearchresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling TelephonyProvidersEdgeApi->PostTelephonyProvidersEdgesTrunksSearch")
	}
	...
	var successPayload *Trunkinstancesearchresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Trunkinstancesearchresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PutTelephonyProvidersEdgesAlertablepresences invokes PUT /api/v2/telephony/providers/edges/alertablepresences
//
// Creates or updates alertable presences overrides.
func (a TelephonyProvidersEdgeApi) PutTelephonyProvidersEdgesAlertablepresences(body Alertablepresences) (*APIResponse, error) {
	var httpMethod = "PUT"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/telephony/providers/edges/alertablepresences"
	if true == false {
	...
	if &body == nil {
		// false
		return nil, errors.New("Missing required parameter 'body' when calling TelephonyProvidersEdgeApi->PutTelephonyProvidersEdgesAlertablepresences")
	}
...
// PutTelephonyProvidersEdgesSiteSiteconnections invokes PUT /api/v2/telephony/providers/edges/sites/{siteId}/siteconnections
//
// Update site connections for a site.
func (a TelephonyProvidersEdgeApi) PutTelephonyProvidersEdgesSiteSiteconnections(siteId string, body Siteconnections) (*Siteconnections, *APIResponse, error) {
	var httpMethod = "PUT"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/telephony/providers/edges/sites/{siteId}/siteconnections"
	path = strings.Replace(path, "{siteId}", url.PathEscape(fmt.Sprintf("%v", siteId)), -1)
	...
	if &siteId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'siteId' when calling TelephonyProvidersEdgeApi->PutTelephonyProvidersEdgesSiteSiteconnections")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling TelephonyProvidersEdgeApi->PutTelephonyProvidersEdgesSiteSiteconnections")
	}
