...
type Conversationcallbackeventtopicqueuemediasettings struct { 
...
func (o *Conversationcallbackeventtopicqueuemediasettings) SetField(field string, fieldValue interface{}) {
...
func (o Conversationcallbackeventtopicqueuemediasettings) MarshalJSON() ([]byte, error) {
	...
	type Alias Conversationcallbackeventtopicqueuemediasettings
...
func (o *Conversationcallbackeventtopicqueuemediasettings) UnmarshalJSON(b []byte) error {
	var ConversationcallbackeventtopicqueuemediasettingsMap map[string]interface{}
	err := json.Unmarshal(b, &ConversationcallbackeventtopicqueuemediasettingsMap)
	if err != nil {
		return err
	}
	
	if AlertingTimeoutSeconds, ok := ConversationcallbackeventtopicqueuemediasettingsMap["alertingTimeoutSeconds"].(float64); ok {
		AlertingTimeoutSecondsInt := int(AlertingTimeoutSeconds)
		o.AlertingTimeoutSeconds = &AlertingTimeoutSecondsInt
	}
	
	if AutoAnswerAlertToneSeconds, ok := ConversationcallbackeventtopicqueuemediasettingsMap["autoAnswerAlertToneSeconds"].(float64); ok {
	...
	if ManualAnswerAlertToneSeconds, ok := ConversationcallbackeventtopicqueuemediasettingsMap["manualAnswerAlertToneSeconds"].(float64); ok {
	...
	if EnableAutoAnswer, ok := ConversationcallbackeventtopicqueuemediasettingsMap["enableAutoAnswer"].(bool); ok {
...
func (o *Conversationcallbackeventtopicqueuemediasettings) String() string {
	j, _ := json.Marshal(o)
