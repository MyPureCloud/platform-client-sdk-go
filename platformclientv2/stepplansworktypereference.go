...
func (o *Stepplansworktypereference) SetField(field string, fieldValue interface{}) {
...
func (o Stepplansworktypereference) MarshalJSON() ([]byte, error) {
...
func (o *Stepplansworktypereference) UnmarshalJSON(b []byte) error {
	var StepplansworktypereferenceMap map[string]interface{}
	err := json.Unmarshal(b, &StepplansworktypereferenceMap)
	if err != nil {
		return err
	}
