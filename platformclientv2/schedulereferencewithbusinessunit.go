...
func (o *Schedulereferencewithbusinessunit) SetField(field string, fieldValue interface{}) {
...
func (o Schedulereferencewithbusinessunit) MarshalJSON() ([]byte, error) {
...
func (o *Schedulereferencewithbusinessunit) UnmarshalJSON(b []byte) error {
	var SchedulereferencewithbusinessunitMap map[string]interface{}
	err := json.Unmarshal(b, &SchedulereferencewithbusinessunitMap)
	if err != nil {
		return err
	}
	
	if Id, ok := SchedulereferencewithbusinessunitMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if weekDateString, ok := SchedulereferencewithbusinessunitMap["weekDate"].(string); ok {
		WeekDate, _ := time.Parse("2006-01-02", weekDateString)
		o.WeekDate = &WeekDate
	}
	
	if BusinessUnit, ok := SchedulereferencewithbusinessunitMap["businessUnit"].(map[string]interface{}); ok {
		BusinessUnitString, _ := json.Marshal(BusinessUnit)
		json.Unmarshal(BusinessUnitString, &o.BusinessUnit)
	}
	
	if SelfUri, ok := SchedulereferencewithbusinessunitMap["selfUri"].(string); ok {
		o.SelfUri = &SelfUri
	}
