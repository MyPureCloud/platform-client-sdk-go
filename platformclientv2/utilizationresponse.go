...
func (o *Utilizationresponse) SetField(field string, fieldValue interface{}) {
...
func (o *Utilizationresponse) UnmarshalJSON(b []byte) error {
	var UtilizationresponseMap map[string]interface{}
	err := json.Unmarshal(b, &UtilizationresponseMap)
	if err != nil {
		return err
	}
