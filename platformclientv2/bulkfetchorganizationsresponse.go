...
type Bulkfetchorganizationsresponse struct { 
	...
	Results *[]Bulkresponseresultexternalorganizationentitybulkentityerrorentity `json:"results,omitempty"`
...
func (o *Bulkfetchorganizationsresponse) SetField(field string, fieldValue interface{}) {
