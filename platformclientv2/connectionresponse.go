...
func (o *Connectionresponse) SetField(field string, fieldValue interface{}) {
...
func (o *Connectionresponse) UnmarshalJSON(b []byte) error {
	var ConnectionresponseMap map[string]interface{}
	err := json.Unmarshal(b, &ConnectionresponseMap)
	if err != nil {
		return err
	}
	
	if Id, ok := ConnectionresponseMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Name, ok := ConnectionresponseMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if VarType, ok := ConnectionresponseMap["type"].(string); ok {
		o.VarType = &VarType
	}
    
	if Integration, ok := ConnectionresponseMap["integration"].(map[string]interface{}); ok {
		IntegrationString, _ := json.Marshal(Integration)
		json.Unmarshal(IntegrationString, &o.Integration)
	}
	
	if AuthenticationProperties, ok := ConnectionresponseMap["authenticationProperties"].(map[string]interface{}); ok {
	...
	if CreatedBy, ok := ConnectionresponseMap["createdBy"].(map[string]interface{}); ok {
		CreatedByString, _ := json.Marshal(CreatedBy)
		json.Unmarshal(CreatedByString, &o.CreatedBy)
	}
	
	if ModifiedBy, ok := ConnectionresponseMap["modifiedBy"].(map[string]interface{}); ok {
		ModifiedByString, _ := json.Marshal(ModifiedBy)
		json.Unmarshal(ModifiedByString, &o.ModifiedBy)
	}
	
	if dateCreatedString, ok := ConnectionresponseMap["dateCreated"].(string); ok {
		DateCreated, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateCreatedString)
		o.DateCreated = &DateCreated
	}
	
	if dateModifiedString, ok := ConnectionresponseMap["dateModified"].(string); ok {
		DateModified, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateModifiedString)
		o.DateModified = &DateModified
	}
	
	if Status, ok := ConnectionresponseMap["status"].(string); ok {
		o.Status = &Status
	}
