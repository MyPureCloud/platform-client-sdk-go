...
// Conversationeventtopicqueuemediasettings - Represents the queue setting for this media.
type Conversationeventtopicqueuemediasettings struct { 
...
func (o *Conversationeventtopicqueuemediasettings) SetField(field string, fieldValue interface{}) {
...
func (o Conversationeventtopicqueuemediasettings) MarshalJSON() ([]byte, error) {
	...
	type Alias Conversationeventtopicqueuemediasettings
...
func (o *Conversationeventtopicqueuemediasettings) UnmarshalJSON(b []byte) error {
	var ConversationeventtopicqueuemediasettingsMap map[string]interface{}
	err := json.Unmarshal(b, &ConversationeventtopicqueuemediasettingsMap)
	if err != nil {
		return err
	}
	
	if AlertingTimeoutSeconds, ok := ConversationeventtopicqueuemediasettingsMap["alertingTimeoutSeconds"].(float64); ok {
		AlertingTimeoutSecondsInt := int(AlertingTimeoutSeconds)
		o.AlertingTimeoutSeconds = &AlertingTimeoutSecondsInt
	}
	
	if AutoAnswerAlertToneSeconds, ok := ConversationeventtopicqueuemediasettingsMap["autoAnswerAlertToneSeconds"].(float64); ok {
	...
	if ManualAnswerAlertToneSeconds, ok := ConversationeventtopicqueuemediasettingsMap["manualAnswerAlertToneSeconds"].(float64); ok {
	...
	if EnableAutoAnswer, ok := ConversationeventtopicqueuemediasettingsMap["enableAutoAnswer"].(bool); ok {
...
func (o *Conversationeventtopicqueuemediasettings) String() string {
	j, _ := json.Marshal(o)
