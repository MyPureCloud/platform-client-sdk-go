...
func (o *Transcriptionenginesrequest) SetField(field string, fieldValue interface{}) {
...
func (o Transcriptionenginesrequest) MarshalJSON() ([]byte, error) {
...
func (o *Transcriptionenginesrequest) UnmarshalJSON(b []byte) error {
	var TranscriptionenginesrequestMap map[string]interface{}
	err := json.Unmarshal(b, &TranscriptionenginesrequestMap)
	if err != nil {
		return err
	}
	
	if TranscriptionEngines, ok := TranscriptionenginesrequestMap["transcriptionEngines"].([]interface{}); ok {
