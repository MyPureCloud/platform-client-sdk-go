...
func (o *Queueconversationsocialexpressioneventtopiccallback) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationsocialexpressioneventtopiccallback) UnmarshalJSON(b []byte) error {
	...
	if QueueMediaSettings, ok := QueueconversationsocialexpressioneventtopiccallbackMap["queueMediaSettings"].(map[string]interface{}); ok {
