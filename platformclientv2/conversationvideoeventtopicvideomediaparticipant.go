...
func (o *Conversationvideoeventtopicvideomediaparticipant) SetField(field string, fieldValue interface{}) {
...
func (o *Conversationvideoeventtopicvideomediaparticipant) UnmarshalJSON(b []byte) error {
	...
	if InitialState, ok := ConversationvideoeventtopicvideomediaparticipantMap["initialState"].(string); ok {
	...
	if ExternalContactInitialDivisionId, ok := ConversationvideoeventtopicvideomediaparticipantMap["externalContactInitialDivisionId"].(string); ok {
	...
	if resumeTimeString, ok := ConversationvideoeventtopicvideomediaparticipantMap["resumeTime"].(string); ok {
		ResumeTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", resumeTimeString)
		o.ResumeTime = &ResumeTime
	}
	
	if parkTimeString, ok := ConversationvideoeventtopicvideomediaparticipantMap["parkTime"].(string); ok {
