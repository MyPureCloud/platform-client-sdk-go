...
func (o *Agentqueuetimerequest) SetField(field string, fieldValue interface{}) {
...
func (o Agentqueuetimerequest) MarshalJSON() ([]byte, error) {
...
func (o *Agentqueuetimerequest) UnmarshalJSON(b []byte) error {
	var AgentqueuetimerequestMap map[string]interface{}
	err := json.Unmarshal(b, &AgentqueuetimerequestMap)
	if err != nil {
		return err
	}
	
	if AgentId, ok := AgentqueuetimerequestMap["agentId"].(string); ok {
		o.AgentId = &AgentId
	}
    
	if StartOffsetMinutes, ok := AgentqueuetimerequestMap["startOffsetMinutes"].([]interface{}); ok {
		StartOffsetMinutesString, _ := json.Marshal(StartOffsetMinutes)
		json.Unmarshal(StartOffsetMinutesString, &o.StartOffsetMinutes)
	}
