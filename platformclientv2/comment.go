...
func (o *Comment) SetField(field string, fieldValue interface{}) {
...
func (o *Comment) UnmarshalJSON(b []byte) error {
	...
	err := json.Unmarshal(b, &CommentMap)
	if err != nil {
		return err
	}
	...
	if ModifiedBy, ok := CommentMap["modifiedBy"].(map[string]interface{}); ok {
		ModifiedByString, _ := json.Marshal(ModifiedBy)
		json.Unmarshal(ModifiedByString, &o.ModifiedBy)
	}
	
	if dateCreatedString, ok := CommentMap["dateCreated"].(string); ok {
		DateCreated, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateCreatedString)
		o.DateCreated = &DateCreated
	}
	
	if dateModifiedString, ok := CommentMap["dateModified"].(string); ok {
		DateModified, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateModifiedString)
		o.DateModified = &DateModified
	}
	
	if SelfUri, ok := CommentMap["selfUri"].(string); ok {
		o.SelfUri = &SelfUri
	}
