...
func (o *Queueconversationvideoeventtopicchat) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationvideoeventtopicchat) UnmarshalJSON(b []byte) error {
	...
	if QueueMediaSettings, ok := QueueconversationvideoeventtopicchatMap["queueMediaSettings"].(map[string]interface{}); ok {
