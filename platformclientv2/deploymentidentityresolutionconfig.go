...
func (o *Deploymentidentityresolutionconfig) SetField(field string, fieldValue interface{}) {
...
func (o Deploymentidentityresolutionconfig) MarshalJSON() ([]byte, error) {
...
func (o *Deploymentidentityresolutionconfig) UnmarshalJSON(b []byte) error {
	var DeploymentidentityresolutionconfigMap map[string]interface{}
	err := json.Unmarshal(b, &DeploymentidentityresolutionconfigMap)
	if err != nil {
		return err
	}
	
	if Id, ok := DeploymentidentityresolutionconfigMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Division, ok := DeploymentidentityresolutionconfigMap["division"].(map[string]interface{}); ok {
		DivisionString, _ := json.Marshal(Division)
		json.Unmarshal(DivisionString, &o.Division)
	}
	
	if ResolveIdentities, ok := DeploymentidentityresolutionconfigMap["resolveIdentities"].(bool); ok {
