...
func (o *Conversationeventtopicchat) SetField(field string, fieldValue interface{}) {
...
func (o *Conversationeventtopicchat) UnmarshalJSON(b []byte) error {
	...
	if InitialState, ok := ConversationeventtopicchatMap["initialState"].(string); ok {
	...
	if QueueMediaSettings, ok := ConversationeventtopicchatMap["queueMediaSettings"].(map[string]interface{}); ok {
