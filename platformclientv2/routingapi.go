...
// DeleteRoutingDirectroutingbackupSettingsMe invokes DELETE /api/v2/routing/directroutingbackup/settings/me
//
// Delete the user's Direct Routing Backup settings and revert to the Direct Routing Queue default.
func (a RoutingApi) DeleteRoutingDirectroutingbackupSettingsMe() (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/directroutingbackup/settings/me"
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
// DeleteRoutingEmailOutboundDomain invokes DELETE /api/v2/routing/email/outbound/domains/{domainId}
//
// Delete an outbound domain
func (a RoutingApi) DeleteRoutingEmailOutboundDomain(domainId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	...
	if &domainId == nil {
		// false
		return nil, errors.New("Missing required parameter 'domainId' when calling RoutingApi->DeleteRoutingEmailOutboundDomain")
	}
...
// DeleteRoutingEmailSettingEmailSettingId invokes DELETE /api/v2/routing/email/setting/{emailSettingId}
//
// Delete an email setting. Removes the email setting and its associated settings
func (a RoutingApi) DeleteRoutingEmailSettingEmailSettingId(emailSettingId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/email/setting/{emailSettingId}"
	path = strings.Replace(path, "{emailSettingId}", url.PathEscape(fmt.Sprintf("%v", emailSettingId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}

	// verify the required parameter 'emailSettingId' is set
	if &emailSettingId == nil {
		// false
		return nil, errors.New("Missing required parameter 'emailSettingId' when calling RoutingApi->DeleteRoutingEmailSettingEmailSettingId")
	}
...
func (a RoutingApi) DeleteRoutingLanguage(languageId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	...
	if &languageId == nil {
		// false
		return nil, errors.New("Missing required parameter 'languageId' when calling RoutingApi->DeleteRoutingLanguage")
	}
...
func (a RoutingApi) DeleteRoutingPredictorsKeyperformanceindicator(kpiId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/predictors/keyperformanceindicators/{kpiId}"
	path = strings.Replace(path, "{kpiId}", url.PathEscape(fmt.Sprintf("%v", kpiId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &kpiId == nil {
		// false
		return nil, errors.New("Missing required parameter 'kpiId' when calling RoutingApi->DeleteRoutingPredictorsKeyperformanceindicator")
	}
...
// DeleteRoutingSkillexpression invokes DELETE /api/v2/routing/skillexpressions/{expressionId}
//
// Archive a skill expression to remove it from the set of active expressions
func (a RoutingApi) DeleteRoutingSkillexpression(expressionId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/skillexpressions/{expressionId}"
	path = strings.Replace(path, "{expressionId}", url.PathEscape(fmt.Sprintf("%v", expressionId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &expressionId == nil {
		// false
		return nil, errors.New("Missing required parameter 'expressionId' when calling RoutingApi->DeleteRoutingSkillexpression")
	}
...
// DeleteRoutingSkillexpressions invokes DELETE /api/v2/routing/skillexpressions
//
// Archive a set of skill expressions to remove them from the set of active expressions
func (a RoutingApi) DeleteRoutingSkillexpressions(id []string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/skillexpressions"
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
// DeleteRoutingSkillgroup invokes DELETE /api/v2/routing/skillgroups/{skillGroupId}
//
// Remove skill group definition
func (a RoutingApi) DeleteRoutingSkillgroup(skillGroupId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	...
	if &skillGroupId == nil {
		// false
		return nil, errors.New("Missing required parameter 'skillGroupId' when calling RoutingApi->DeleteRoutingSkillgroup")
	}
...
// DeleteRoutingUserDirectroutingbackupSettings invokes DELETE /api/v2/routing/users/{userId}/directroutingbackup/settings
//
// Delete the user's Direct Routing Backup settings and revert to the Direct Routing Queue default.
func (a RoutingApi) DeleteRoutingUserDirectroutingbackupSettings(userId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/users/{userId}/directroutingbackup/settings"
	...
	if &userId == nil {
		// false
		return nil, errors.New("Missing required parameter 'userId' when calling RoutingApi->DeleteRoutingUserDirectroutingbackupSettings")
	}
...
func (a RoutingApi) DeleteRoutingUtilizationLabel(labelId string, forceDelete bool) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/utilization/labels/{labelId}"
	...
	if &labelId == nil {
		// false
		return nil, errors.New("Missing required parameter 'labelId' when calling RoutingApi->DeleteRoutingUtilizationLabel")
	}
...
func (a RoutingApi) GetRoutingAssessment(assessmentId string) (*Benefitassessment, *APIResponse, error) {
	...
	var successPayload *Benefitassessment
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
func (a RoutingApi) GetRoutingAssessments(before string, after string, limit string, pageSize string, queueId []string) (*Assessmentlisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/assessments"
	defaultReturn := new(Assessmentlisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Assessmentlisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
func (a RoutingApi) GetRoutingAssessmentsJob(jobId string) (*Benefitassessmentjob, *APIResponse, error) {
	...
	var successPayload *Benefitassessmentjob
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Benefitassessmentjob" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a RoutingApi) GetRoutingAssessmentsJobs(divisionId []string) (*Assessmentjoblisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/assessments/jobs"
	defaultReturn := new(Assessmentjoblisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Assessmentjoblisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Assessmentjoblisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a RoutingApi) GetRoutingAvailablemediatypes() (*Availablemediatypeentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/availablemediatypes"
	defaultReturn := new(Availablemediatypeentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Availablemediatypeentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Availablemediatypeentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetRoutingDirectroutingbackupSettingsMe invokes GET /api/v2/routing/directroutingbackup/settings/me
//
// Get the user's Direct Routing Backup settings.
func (a RoutingApi) GetRoutingDirectroutingbackupSettingsMe() (*Agentdirectroutingbackupsettings, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/directroutingbackup/settings/me"
	defaultReturn := new(Agentdirectroutingbackupsettings)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Agentdirectroutingbackupsettings
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Agentdirectroutingbackupsettings" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a RoutingApi) GetRoutingEmailDomains(pageSize int, pageNumber int, excludeStatus bool, filter string, expand string) (*Inbounddomainentitylisting, *APIResponse, error) {
	...
	if err != nil {
		...
		if "Inbounddomainentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a RoutingApi) GetRoutingEmailOutboundDomain(domainId string, expand string) (*Outbounddomain, *APIResponse, error) {
	...
	if &domainId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'domainId' when calling RoutingApi->GetRoutingEmailOutboundDomain")
	}
...
// GetRoutingEmailOutboundDomainActivation invokes GET /api/v2/routing/email/outbound/domains/{domainId}/activation
//
// Get activation status (cname + dkim) of an outbound domain
func (a RoutingApi) GetRoutingEmailOutboundDomainActivation(domainId string) (*Emailoutbounddomainresult, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	...
	if &domainId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'domainId' when calling RoutingApi->GetRoutingEmailOutboundDomainActivation")
	}
	...
	var successPayload *Emailoutbounddomainresult
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Emailoutbounddomainresult" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a RoutingApi) GetRoutingEmailOutboundDomains(pageSize int, pageNumber int, filter string, expand string) (*Outbounddomainentitylisting, *APIResponse, error) {
	...
	defaultReturn := new(Outbounddomainentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Outbounddomainentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Outbounddomainentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetRoutingEmailSetting invokes GET /api/v2/routing/email/setting
//
// Get a paged list of email routing settings.
func (a RoutingApi) GetRoutingEmailSetting(pageSize int, pageNumber int) (*Emailsettingentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/email/setting"
	defaultReturn := new(Emailsettingentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Emailsettingentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Emailsettingentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetRoutingEmailSettingEmailSettingId invokes GET /api/v2/routing/email/setting/{emailSettingId}
//
// Get email setting. Returns the specified email setting that defines settings for email
func (a RoutingApi) GetRoutingEmailSettingEmailSettingId(emailSettingId string) (*Emailsetting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/email/setting/{emailSettingId}"
	path = strings.Replace(path, "{emailSettingId}", url.PathEscape(fmt.Sprintf("%v", emailSettingId)), -1)
	defaultReturn := new(Emailsetting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &emailSettingId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'emailSettingId' when calling RoutingApi->GetRoutingEmailSettingEmailSettingId")
	}
	...
	var successPayload *Emailsetting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
func (a RoutingApi) GetRoutingLanguage(languageId string) (*Language, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/languages/{languageId}"
	path = strings.Replace(path, "{languageId}", url.PathEscape(fmt.Sprintf("%v", languageId)), -1)
	...
	if &languageId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'languageId' when calling RoutingApi->GetRoutingLanguage")
	}
...
func (a RoutingApi) GetRoutingPredictors(before string, after string, limit string, pageSize string, queueId []string, kpiId string, state string) (*Predictorlisting, *APIResponse, error) {
	...
	defaultReturn := new(Predictorlisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Predictorlisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
func (a RoutingApi) GetRoutingPredictorsKeyperformanceindicator(kpiId string, expand []string) (*Keyperformanceindicator, *APIResponse, error) {
	...
	if &kpiId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'kpiId' when calling RoutingApi->GetRoutingPredictorsKeyperformanceindicator")
	}
...
func (a RoutingApi) GetRoutingPredictorsKeyperformanceindicatortypes() ([]Keyperformanceindicatortype, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/predictors/keyperformanceindicatortypes"
	defaultReturn := make([]Keyperformanceindicatortype, 0)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload []Keyperformanceindicatortype
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "[]Keyperformanceindicatortype" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a RoutingApi) GetRoutingQueueAssistant(queueId string, expand []string, languageVariation string, fallbackToPrimaryAssistant bool) (*Assistantqueue, *APIResponse, error) {
	...
	if &queueId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'queueId' when calling RoutingApi->GetRoutingQueueAssistant")
	}
...
func (a RoutingApi) GetRoutingQueueComparisonperiod(queueId string, comparisonPeriodId string) (*Comparisonperiod, *APIResponse, error) {
	...
	var successPayload *Comparisonperiod
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
func (a RoutingApi) GetRoutingQueueComparisonperiods(queueId string) (*Comparisonperiodlisting, *APIResponse, error) {
	...
	var successPayload *Comparisonperiodlisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Comparisonperiodlisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a RoutingApi) GetRoutingQueueEstimatedwaittime(queueId string, conversationId string) (*Estimatedwaittimepredictions, *APIResponse, error) {
	...
	if err != nil {
		...
		if "Estimatedwaittimepredictions" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a RoutingApi) GetRoutingQueueMembers(queueId string, pageNumber int, pageSize int, sortOrder string, expand []string, name string, profileSkills []string, skills []string, languages []string, routingStatus []string, presence []string, memberBy string, joined bool) (*Queuememberentitylisting, *APIResponse, error) {
	...
	queryParams["profileSkills"] = a.Configuration.APIClient.ParameterToString(profileSkills, "multi")
	
	queryParams["skills"] = a.Configuration.APIClient.ParameterToString(skills, "multi")
	
	queryParams["languages"] = a.Configuration.APIClient.ParameterToString(languages, "multi")
...
func (a RoutingApi) GetRoutingSettingsContactcenter() (*Contactcentersettings, *APIResponse, error) {
	...
	if err != nil {
		...
		if "Contactcentersettings" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetRoutingSkillexpression invokes GET /api/v2/routing/skillexpressions/{expressionId}
//
// Get a skill expression by ID
func (a RoutingApi) GetRoutingSkillexpression(expressionId string, includeArchived bool, format string) (*Skillexpression, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/skillexpressions/{expressionId}"
	path = strings.Replace(path, "{expressionId}", url.PathEscape(fmt.Sprintf("%v", expressionId)), -1)
	defaultReturn := new(Skillexpression)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &expressionId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'expressionId' when calling RoutingApi->GetRoutingSkillexpression")
	}
	...
	queryParams["includeArchived"] = a.Configuration.APIClient.ParameterToString(includeArchived, "")
	
	queryParams["format"] = a.Configuration.APIClient.ParameterToString(format, "")
	...
	var successPayload *Skillexpression
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
// GetRoutingSkillexpressions invokes GET /api/v2/routing/skillexpressions
//
// Get skill expressions
func (a RoutingApi) GetRoutingSkillexpressions(format string, includeArchived bool, id []string) (*Skillexpressionentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/skillexpressions"
	defaultReturn := new(Skillexpressionentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Skillexpressionentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Skillexpressionentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetRoutingSkillexpressionsQueueQueueId invokes GET /api/v2/routing/skillexpressions/queue/{queueId}
//
// Get skill expressions associated with a queue
func (a RoutingApi) GetRoutingSkillexpressionsQueueQueueId(queueId string, format string, includeArchived bool) (*Skillexpressionentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/skillexpressions/queue/{queueId}"
	path = strings.Replace(path, "{queueId}", url.PathEscape(fmt.Sprintf("%v", queueId)), -1)
	defaultReturn := new(Skillexpressionentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	...
	if &queueId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'queueId' when calling RoutingApi->GetRoutingSkillexpressionsQueueQueueId")
	}
...
// GetRoutingSkillgroup invokes GET /api/v2/routing/skillgroups/{skillGroupId}
//
// Get skill group
func (a RoutingApi) GetRoutingSkillgroup(skillGroupId string) (*Skillgroup, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/skillgroups/{skillGroupId}"
	path = strings.Replace(path, "{skillGroupId}", url.PathEscape(fmt.Sprintf("%v", skillGroupId)), -1)
	...
	if &skillGroupId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'skillGroupId' when calling RoutingApi->GetRoutingSkillgroup")
	}
...
// GetRoutingSkillgroupMembers invokes GET /api/v2/routing/skillgroups/{skillGroupId}/members
//
// Get skill group members
func (a RoutingApi) GetRoutingSkillgroupMembers(skillGroupId string, pageSize int, after string, before string, expand string) (*Skillgroupmemberentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	...
	if &skillGroupId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'skillGroupId' when calling RoutingApi->GetRoutingSkillgroupMembers")
	}
	...
	var successPayload *Skillgroupmemberentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Skillgroupmemberentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetRoutingSkillgroupMembersDivisions invokes GET /api/v2/routing/skillgroups/{skillGroupId}/members/divisions
//
// Get list of member divisions for this skill group.
func (a RoutingApi) GetRoutingSkillgroupMembersDivisions(skillGroupId string, expand string) (*Skillgroupmemberdivisionlist, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	...
	if &skillGroupId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'skillGroupId' when calling RoutingApi->GetRoutingSkillgroupMembersDivisions")
	}
	...
	var successPayload *Skillgroupmemberdivisionlist
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Skillgroupmemberdivisionlist" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetRoutingSkillgroups invokes GET /api/v2/routing/skillgroups
//
// Get skill group listing
func (a RoutingApi) GetRoutingSkillgroups(pageSize int, name string, after string, before string) (*Skillgroupentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/skillgroups"
	defaultReturn := new(Skillgroupentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Skillgroupentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Skillgroupentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a RoutingApi) GetRoutingSmsAddresses(pageSize int, pageNumber int) (*Smsaddressentitylisting, *APIResponse, error) {
	...
	if err != nil {
		...
		if "Smsaddressentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a RoutingApi) GetRoutingSmsAvailablephonenumbers(countryCode string, phoneNumberType string, region string, city string, areaCode string, pattern string, addressRequirement string) (*Smsavailablephonenumberentitylisting, *APIResponse, error) {
	...
	queryParams["countryCode"] = a.Configuration.APIClient.ParameterToString(countryCode, "")
	
	queryParams["region"] = a.Configuration.APIClient.ParameterToString(region, "")
	
	queryParams["city"] = a.Configuration.APIClient.ParameterToString(city, "")
	
	queryParams["areaCode"] = a.Configuration.APIClient.ParameterToString(areaCode, "")
...
func (a RoutingApi) GetRoutingSmsPhonenumbers(phoneNumber string, phoneNumberType []string, phoneNumberStatus []string, countryCode []string, pageSize int, pageNumber int, sortBy string, sortOrder string, language string, integrationId string, supportedContentId string, expand []string) (*Smsphonenumberentitylisting, *APIResponse, error) {
	...
	if err != nil {
		...
		if "Smsphonenumberentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetRoutingUserDirectroutingbackupSettings invokes GET /api/v2/routing/users/{userId}/directroutingbackup/settings
//
// Get the user's Direct Routing Backup settings.
func (a RoutingApi) GetRoutingUserDirectroutingbackupSettings(userId string) (*Agentdirectroutingbackupsettings, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/users/{userId}/directroutingbackup/settings"
	path = strings.Replace(path, "{userId}", url.PathEscape(fmt.Sprintf("%v", userId)), -1)
	...
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling RoutingApi->GetRoutingUserDirectroutingbackupSettings")
	}
...
func (a RoutingApi) GetRoutingUserUtilization(userId string) (*Agentmaxutilizationresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/users/{userId}/utilization"
	path = strings.Replace(path, "{userId}", url.PathEscape(fmt.Sprintf("%v", userId)), -1)
...
func (a RoutingApi) GetRoutingUtilization() (*Utilizationresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/utilization"
	defaultReturn := new(Utilizationresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Utilizationresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
func (a RoutingApi) GetRoutingUtilizationLabel(labelId string) (*Utilizationlabel, *APIResponse, error) {
	...
	path := a.Configuration.BasePath + "/api/v2/routing/utilization/labels/{labelId}"
	path = strings.Replace(path, "{labelId}", url.PathEscape(fmt.Sprintf("%v", labelId)), -1)
	defaultReturn := new(Utilizationlabel)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &labelId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'labelId' when calling RoutingApi->GetRoutingUtilizationLabel")
	}
	...
	var successPayload *Utilizationlabel
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
func (a RoutingApi) GetRoutingUtilizationLabelAgents(labelId string) ([]interface{}, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/utilization/labels/{labelId}/agents"
	path = strings.Replace(path, "{labelId}", url.PathEscape(fmt.Sprintf("%v", labelId)), -1)
	...
	if &labelId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'labelId' when calling RoutingApi->GetRoutingUtilizationLabelAgents")
	}
...
func (a RoutingApi) GetRoutingUtilizationLabels(pageSize int, pageNumber int, sortOrder string, name string) (*Utilizationlabelentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/utilization/labels"
	defaultReturn := new(Utilizationlabelentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Utilizationlabelentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Utilizationlabelentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a RoutingApi) GetRoutingWrapupcodes(pageSize int, pageNumber int, sortBy string, sortOrder string, name string, id []string, divisionId []string) (*Wrapupcodeentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
...
func (a RoutingApi) GetUserSkillgroups(userId string, pageSize int, after string, before string) (*Userskillgroupentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	...
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling RoutingApi->GetUserSkillgroups")
	}
...
// PatchRoutingEmailSettingEmailSettingId invokes PATCH /api/v2/routing/email/setting/{emailSettingId}
//
// Update an email setting. Modifies the settings for email setting
func (a RoutingApi) PatchRoutingEmailSettingEmailSettingId(emailSettingId string, body Emailsetting) (*Emailsetting, *APIResponse, error) {
	var httpMethod = "PATCH"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/email/setting/{emailSettingId}"
	path = strings.Replace(path, "{emailSettingId}", url.PathEscape(fmt.Sprintf("%v", emailSettingId)), -1)
	...
	if &emailSettingId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'emailSettingId' when calling RoutingApi->PatchRoutingEmailSettingEmailSettingId")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling RoutingApi->PatchRoutingEmailSettingEmailSettingId")
	}
...
func (a RoutingApi) PatchRoutingPredictorsKeyperformanceindicator(kpiId string, body Updatekpirequest) (*Keyperformanceindicator, *APIResponse, error) {
	...
	if &kpiId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'kpiId' when calling RoutingApi->PatchRoutingPredictorsKeyperformanceindicator")
	}
...
func (a RoutingApi) PatchRoutingQueueMembers(queueId string, body []Queuemember) (*Queuememberentitylisting, *APIResponse, error) {
	...
	if &body == nil {
		// true
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling RoutingApi->PatchRoutingQueueMembers")
	}
...
// PatchRoutingSkill invokes PATCH /api/v2/routing/skills/{skillId}
//
// Update Routing Skill Division
func (a RoutingApi) PatchRoutingSkill(skillId string, body Updateskilldivisionrequest) (*Routingskill, *APIResponse, error) {
	var httpMethod = "PATCH"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/skills/{skillId}"
	path = strings.Replace(path, "{skillId}", url.PathEscape(fmt.Sprintf("%v", skillId)), -1)
	...
	if &skillId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'skillId' when calling RoutingApi->PatchRoutingSkill")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling RoutingApi->PatchRoutingSkill")
	}
...
func (a RoutingApi) PatchRoutingSkillgroup(skillGroupId string, body Skillgroup) (*Skillgroup, *APIResponse, error) {
	var httpMethod = "PATCH"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/skillgroups/{skillGroupId}"
	path = strings.Replace(path, "{skillGroupId}", url.PathEscape(fmt.Sprintf("%v", skillGroupId)), -1)
	...
	if &skillGroupId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'skillGroupId' when calling RoutingApi->PatchRoutingSkillgroup")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling RoutingApi->PatchRoutingSkillgroup")
	}
...
func (a RoutingApi) PatchRoutingSmsPhonenumber(phoneNumberId string, body Smsphonenumberpatchrequest) (*Smsphonenumber, *APIResponse, error) {
	...
	if &phoneNumberId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'phoneNumberId' when calling RoutingApi->PatchRoutingSmsPhonenumber")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling RoutingApi->PatchRoutingSmsPhonenumber")
	}
...
func (a RoutingApi) PostAnalyticsRoutingActivityQuery(body Routingactivityquery, pageSize int, pageNumber int) (*Routingactivityresponse, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling RoutingApi->PostAnalyticsRoutingActivityQuery")
	}
...
func (a RoutingApi) PostRoutingEmailOutboundDomains(body Outbounddomaincreaterequest) (*Emailoutbounddomainresult, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling RoutingApi->PostRoutingEmailOutboundDomains")
	}
...
func (a RoutingApi) PostRoutingEmailOutboundDomainsSimulated(body Outbounddomaincreaterequest) (*Emailoutbounddomainresult, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling RoutingApi->PostRoutingEmailOutboundDomainsSimulated")
	}
...
// PostRoutingEmailSetting invokes POST /api/v2/routing/email/setting
//
// Create a new email setting. Used to define various settings, that can then be associated with email domains
func (a RoutingApi) PostRoutingEmailSetting(body Emailsetting) (*Emailsetting, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/email/setting"
	defaultReturn := new(Emailsetting)
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling RoutingApi->PostRoutingEmailSetting")
	}
...
func (a RoutingApi) PostRoutingPredictorsKeyperformanceindicators(body Createkpirequest) (*Keyperformanceindicator, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling RoutingApi->PostRoutingPredictorsKeyperformanceindicators")
	}
...
// PostRoutingSkillexpressionsValidate invokes POST /api/v2/routing/skillexpressions/validate
//
// Validate and normalize a skill expression
func (a RoutingApi) PostRoutingSkillexpressionsValidate(body Skillexpressiondata) (*Skillexpressionvalidationresult, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/skillexpressions/validate"
	defaultReturn := new(Skillexpressionvalidationresult)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling RoutingApi->PostRoutingSkillexpressionsValidate")
	}
	...
	var successPayload *Skillexpressionvalidationresult
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Skillexpressionvalidationresult" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostRoutingSkillgroupMembersDivisions invokes POST /api/v2/routing/skillgroups/{skillGroupId}/members/divisions
//
// Add or remove member divisions for this skill group.
func (a RoutingApi) PostRoutingSkillgroupMembersDivisions(skillGroupId string, body Skillgroupmemberdivisions) (*APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/skillgroups/{skillGroupId}/members/divisions"
	path = strings.Replace(path, "{skillGroupId}", url.PathEscape(fmt.Sprintf("%v", skillGroupId)), -1)
	...
	if &skillGroupId == nil {
		// false
		return nil, errors.New("Missing required parameter 'skillGroupId' when calling RoutingApi->PostRoutingSkillgroupMembersDivisions")
	}
...
func (a RoutingApi) PostRoutingSkillgroups(body Skillgroupwithmemberdivisions) (*Skillgroupwithmemberdivisions, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling RoutingApi->PostRoutingSkillgroups")
	}
...
// PostRoutingSmsPhonenumbersAlphanumeric invokes POST /api/v2/routing/sms/phonenumbers/alphanumeric
//
// Provision an alphanumeric number for SMS
//
// Preview: PostRoutingSmsPhonenumbersAlphanumeric is a preview method and is subject to both breaking and non-breaking changes at any time without notice
func (a RoutingApi) PostRoutingSmsPhonenumbersAlphanumeric(body Smsalphanumericprovision) (*Smsphonenumber, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/sms/phonenumbers/alphanumeric"
	defaultReturn := new(Smsphonenumber)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling RoutingApi->PostRoutingSmsPhonenumbersAlphanumeric")
	}
...
func (a RoutingApi) PostRoutingSmsPhonenumbersImport(body Smsphonenumberimport) (*Smsphonenumber, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/sms/phonenumbers/import"
	defaultReturn := new(Smsphonenumber)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling RoutingApi->PostRoutingSmsPhonenumbersImport")
	}
...
func (a RoutingApi) PostRoutingUtilizationLabels(body Createutilizationlabelrequest) (*Utilizationlabel, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling RoutingApi->PostRoutingUtilizationLabels")
	}
...
// PutRoutingDirectroutingbackupSettingsMe invokes PUT /api/v2/routing/directroutingbackup/settings/me
//
// Update the user's Direct Routing Backup settings.
func (a RoutingApi) PutRoutingDirectroutingbackupSettingsMe(body Agentdirectroutingbackupsettings) (*Agentdirectroutingbackupsettings, *APIResponse, error) {
	var httpMethod = "PUT"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/directroutingbackup/settings/me"
	defaultReturn := new(Agentdirectroutingbackupsettings)
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling RoutingApi->PutRoutingDirectroutingbackupSettingsMe")
	}
...
func (a RoutingApi) PutRoutingEmailOutboundDomainActivation(domainId string) (*Emailoutbounddomainresult, *APIResponse, error) {
	var httpMethod = "PUT"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/email/outbound/domains/{domainId}/activation"
	path = strings.Replace(path, "{domainId}", url.PathEscape(fmt.Sprintf("%v", domainId)), -1)
	...
	if &domainId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'domainId' when calling RoutingApi->PutRoutingEmailOutboundDomainActivation")
	}
...
// PutRoutingUserDirectroutingbackupSettings invokes PUT /api/v2/routing/users/{userId}/directroutingbackup/settings
//
// Update the user's Direct Routing Backup settings.
func (a RoutingApi) PutRoutingUserDirectroutingbackupSettings(userId string, body Agentdirectroutingbackupsettings) (*Agentdirectroutingbackupsettings, *APIResponse, error) {
	var httpMethod = "PUT"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/users/{userId}/directroutingbackup/settings"
	path = strings.Replace(path, "{userId}", url.PathEscape(fmt.Sprintf("%v", userId)), -1)
	...
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling RoutingApi->PutRoutingUserDirectroutingbackupSettings")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling RoutingApi->PutRoutingUserDirectroutingbackupSettings")
	}
...
func (a RoutingApi) PutRoutingUtilizationLabel(labelId string, body Updateutilizationlabelrequest) (*Utilizationlabel, *APIResponse, error) {
	...
	if &labelId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'labelId' when calling RoutingApi->PutRoutingUtilizationLabel")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling RoutingApi->PutRoutingUtilizationLabel")
	}
