...
func (o *Queueconversationcalleventtopicwrapup) SetField(field string, fieldValue interface{}) {
...
func (o Queueconversationcalleventtopicwrapup) MarshalJSON() ([]byte, error) {
	...
	type Alias Queueconversationcalleventtopicwrapup
...
func (o *Queueconversationcalleventtopicwrapup) UnmarshalJSON(b []byte) error {
	var QueueconversationcalleventtopicwrapupMap map[string]interface{}
	err := json.Unmarshal(b, &QueueconversationcalleventtopicwrapupMap)
	if err != nil {
		return err
	}
	
	if Code, ok := QueueconversationcalleventtopicwrapupMap["code"].(string); ok {
		o.Code = &Code
	}
    
	if Notes, ok := QueueconversationcalleventtopicwrapupMap["notes"].(string); ok {
		o.Notes = &Notes
	}
    
	if Tags, ok := QueueconversationcalleventtopicwrapupMap["tags"].([]interface{}); ok {
		TagsString, _ := json.Marshal(Tags)
		json.Unmarshal(TagsString, &o.Tags)
	}
	
	if DurationSeconds, ok := QueueconversationcalleventtopicwrapupMap["durationSeconds"].(float64); ok {
...
func (o *Queueconversationcalleventtopicwrapup) String() string {
	j, _ := json.Marshal(o)
