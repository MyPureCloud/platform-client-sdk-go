...
func (o *Shifttradeexternalactivityrule) SetField(field string, fieldValue interface{}) {
...
func (o Shifttradeexternalactivityrule) MarshalJSON() ([]byte, error) {
...
func (o *Shifttradeexternalactivityrule) UnmarshalJSON(b []byte) error {
	var ShifttradeexternalactivityruleMap map[string]interface{}
	err := json.Unmarshal(b, &ShifttradeexternalactivityruleMap)
	if err != nil {
		return err
	}
	
	if ExternalActivityType, ok := ShifttradeexternalactivityruleMap["externalActivityType"].(string); ok {
		o.ExternalActivityType = &ExternalActivityType
	}
    
	if Action, ok := ShifttradeexternalactivityruleMap["action"].(string); ok {
		o.Action = &Action
	}
    
	if ActivityCodeIdReplacement, ok := ShifttradeexternalactivityruleMap["activityCodeIdReplacement"].(string); ok {
