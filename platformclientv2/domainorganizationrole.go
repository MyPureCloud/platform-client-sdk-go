...
func (o *Domainorganizationrole) SetField(field string, fieldValue interface{}) {
...
func (o *Domainorganizationrole) UnmarshalJSON(b []byte) error {
	...
	if BaseLicense, ok := DomainorganizationroleMap["baseLicense"].(string); ok {
		o.BaseLicense = &BaseLicense
	}
    
	if AddonLicenses, ok := DomainorganizationroleMap["addonLicenses"].([]interface{}); ok {
		AddonLicensesString, _ := json.Marshal(AddonLicenses)
		json.Unmarshal(AddonLicensesString, &o.AddonLicenses)
	}
	
	if dateLicenseLastUpdatedString, ok := DomainorganizationroleMap["dateLicenseLastUpdated"].(string); ok {
