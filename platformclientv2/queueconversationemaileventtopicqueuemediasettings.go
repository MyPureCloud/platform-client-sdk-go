...
type Queueconversationemaileventtopicqueuemediasettings struct { 
...
func (o *Queueconversationemaileventtopicqueuemediasettings) SetField(field string, fieldValue interface{}) {
...
func (o Queueconversationemaileventtopicqueuemediasettings) MarshalJSON() ([]byte, error) {
	...
	type Alias Queueconversationemaileventtopicqueuemediasettings
...
func (o *Queueconversationemaileventtopicqueuemediasettings) UnmarshalJSON(b []byte) error {
	var QueueconversationemaileventtopicqueuemediasettingsMap map[string]interface{}
	err := json.Unmarshal(b, &QueueconversationemaileventtopicqueuemediasettingsMap)
	if err != nil {
		return err
	}
	
	if AlertingTimeoutSeconds, ok := QueueconversationemaileventtopicqueuemediasettingsMap["alertingTimeoutSeconds"].(float64); ok {
		AlertingTimeoutSecondsInt := int(AlertingTimeoutSeconds)
		o.AlertingTimeoutSeconds = &AlertingTimeoutSecondsInt
	}
	
	if AutoAnswerAlertToneSeconds, ok := QueueconversationemaileventtopicqueuemediasettingsMap["autoAnswerAlertToneSeconds"].(float64); ok {
	...
	if ManualAnswerAlertToneSeconds, ok := QueueconversationemaileventtopicqueuemediasettingsMap["manualAnswerAlertToneSeconds"].(float64); ok {
	...
	if EnableAutoAnswer, ok := QueueconversationemaileventtopicqueuemediasettingsMap["enableAutoAnswer"].(bool); ok {
...
func (o *Queueconversationemaileventtopicqueuemediasettings) String() string {
	j, _ := json.Marshal(o)
