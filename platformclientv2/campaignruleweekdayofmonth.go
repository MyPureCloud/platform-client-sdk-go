...
func (o Campaignruleweekdayofmonth) MarshalJSON() ([]byte, error) {
...
func (o *Campaignruleweekdayofmonth) UnmarshalJSON(b []byte) error {
	var CampaignruleweekdayofmonthMap map[string]interface{}
