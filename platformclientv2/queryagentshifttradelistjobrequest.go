...
func (o *Queryagentshifttradelistjobrequest) SetField(field string, fieldValue interface{}) {
...
func (o Queryagentshifttradelistjobrequest) MarshalJSON() ([]byte, error) {
...
func (o *Queryagentshifttradelistjobrequest) UnmarshalJSON(b []byte) error {
	var QueryagentshifttradelistjobrequestMap map[string]interface{}
	err := json.Unmarshal(b, &QueryagentshifttradelistjobrequestMap)
	if err != nil {
		return err
	}
	
	if WeekDates, ok := QueryagentshifttradelistjobrequestMap["weekDates"].([]interface{}); ok {
