...
type Dependencycount struct { 
	...
	// EstimatedCount - Number of dependents.
	EstimatedCount *int `json:"estimatedCount,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Dependencycount) SetField(field string, fieldValue interface{}) {
...
func (o Dependencycount) MarshalJSON() ([]byte, error) {
...
func (o *Dependencycount) UnmarshalJSON(b []byte) error {
	var DependencycountMap map[string]interface{}
	err := json.Unmarshal(b, &DependencycountMap)
	if err != nil {
		return err
	}
	
	if EstimatedCount, ok := DependencycountMap["estimatedCount"].(float64); ok {
