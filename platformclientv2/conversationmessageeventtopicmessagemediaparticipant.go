...
func (o *Conversationmessageeventtopicmessagemediaparticipant) UnmarshalJSON(b []byte) error {
	...
	if ExternalContactInitialDivisionId, ok := ConversationmessageeventtopicmessagemediaparticipantMap["externalContactInitialDivisionId"].(string); ok {
	...
	if resumeTimeString, ok := ConversationmessageeventtopicmessagemediaparticipantMap["resumeTime"].(string); ok {
		ResumeTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", resumeTimeString)
		o.ResumeTime = &ResumeTime
	}
	
	if parkTimeString, ok := ConversationmessageeventtopicmessagemediaparticipantMap["parkTime"].(string); ok {
