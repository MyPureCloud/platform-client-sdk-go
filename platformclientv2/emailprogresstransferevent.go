...
func (o *Emailprogresstransferevent) SetField(field string, fieldValue interface{}) {
...
func (o Emailprogresstransferevent) MarshalJSON() ([]byte, error) {
...
func (o *Emailprogresstransferevent) UnmarshalJSON(b []byte) error {
	var EmailprogresstransfereventMap map[string]interface{}
	err := json.Unmarshal(b, &EmailprogresstransfereventMap)
	if err != nil {
		return err
	}
	
	if EventId, ok := EmailprogresstransfereventMap["eventId"].(string); ok {
		o.EventId = &EventId
	}
    
	if eventDateTimeString, ok := EmailprogresstransfereventMap["eventDateTime"].(string); ok {
		EventDateTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", eventDateTimeString)
		o.EventDateTime = &EventDateTime
	}
	
	if ConversationId, ok := EmailprogresstransfereventMap["conversationId"].(string); ok {
		o.ConversationId = &ConversationId
	}
    
	if CommandId, ok := EmailprogresstransfereventMap["commandId"].(string); ok {
		o.CommandId = &CommandId
	}
    
	if ObjectCommunicationId, ok := EmailprogresstransfereventMap["objectCommunicationId"].(string); ok {
		o.ObjectCommunicationId = &ObjectCommunicationId
	}
    
	if DestinationCommunicationId, ok := EmailprogresstransfereventMap["destinationCommunicationId"].(string); ok {
