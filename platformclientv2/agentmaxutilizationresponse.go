...
func (o *Agentmaxutilizationresponse) SetField(field string, fieldValue interface{}) {
...
func (o Agentmaxutilizationresponse) MarshalJSON() ([]byte, error) {
...
func (o *Agentmaxutilizationresponse) UnmarshalJSON(b []byte) error {
	var AgentmaxutilizationresponseMap map[string]interface{}
	err := json.Unmarshal(b, &AgentmaxutilizationresponseMap)
	if err != nil {
		return err
	}
