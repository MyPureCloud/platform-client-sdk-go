...
func (o *Agentschedulebidschedulesetresponse) SetField(field string, fieldValue interface{}) {
...
func (o Agentschedulebidschedulesetresponse) MarshalJSON() ([]byte, error) {
...
func (o *Agentschedulebidschedulesetresponse) UnmarshalJSON(b []byte) error {
	var AgentschedulebidschedulesetresponseMap map[string]interface{}
	err := json.Unmarshal(b, &AgentschedulebidschedulesetresponseMap)
	if err != nil {
		return err
	}
	
	if DownloadUrl, ok := AgentschedulebidschedulesetresponseMap["downloadUrl"].(string); ok {
		o.DownloadUrl = &DownloadUrl
	}
    
	if DownloadTemplate, ok := AgentschedulebidschedulesetresponseMap["downloadTemplate"].(map[string]interface{}); ok {
