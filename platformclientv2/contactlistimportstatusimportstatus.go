...
func (o *Contactlistimportstatusimportstatus) UnmarshalJSON(b []byte) error {
	...
	if TargetContactListIds, ok := ContactlistimportstatusimportstatusMap["targetContactListIds"].([]interface{}); ok {
	...
	if ListNamePrefix, ok := ContactlistimportstatusimportstatusMap["listNamePrefix"].(string); ok {
	...
	if GetAdditionalProperties, ok := ContactlistimportstatusimportstatusMap["getAdditionalProperties"].(map[string]interface{}); ok {
