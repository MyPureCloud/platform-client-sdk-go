...
func (o *Twitterdataingestionruleresponse) SetField(field string, fieldValue interface{}) {
...
func (o Twitterdataingestionruleresponse) MarshalJSON() ([]byte, error) {
...
func (o *Twitterdataingestionruleresponse) UnmarshalJSON(b []byte) error {
	var TwitterdataingestionruleresponseMap map[string]interface{}
	err := json.Unmarshal(b, &TwitterdataingestionruleresponseMap)
	if err != nil {
		return err
	}
	
	if Id, ok := TwitterdataingestionruleresponseMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Name, ok := TwitterdataingestionruleresponseMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if Description, ok := TwitterdataingestionruleresponseMap["description"].(string); ok {
	...
	if dateModifiedString, ok := TwitterdataingestionruleresponseMap["dateModified"].(string); ok {
	...
	if IngestionRuleInfo, ok := TwitterdataingestionruleresponseMap["ingestionRuleInfo"].(map[string]interface{}); ok {
