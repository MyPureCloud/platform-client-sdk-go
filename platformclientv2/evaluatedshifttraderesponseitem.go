...
func (o *Evaluatedshifttraderesponseitem) SetField(field string, fieldValue interface{}) {
...
func (o Evaluatedshifttraderesponseitem) MarshalJSON() ([]byte, error) {
...
func (o *Evaluatedshifttraderesponseitem) UnmarshalJSON(b []byte) error {
	var EvaluatedshifttraderesponseitemMap map[string]interface{}
	err := json.Unmarshal(b, &EvaluatedshifttraderesponseitemMap)
	if err != nil {
		return err
	}
	
	if Trade, ok := EvaluatedshifttraderesponseitemMap["trade"].(map[string]interface{}); ok {
		TradeString, _ := json.Marshal(Trade)
		json.Unmarshal(TradeString, &o.Trade)
	}
	
	if MatchReview, ok := EvaluatedshifttraderesponseitemMap["matchReview"].(map[string]interface{}); ok {
