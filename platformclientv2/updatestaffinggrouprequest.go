...
func (o *Updatestaffinggrouprequest) SetField(field string, fieldValue interface{}) {
...
func (o Updatestaffinggrouprequest) MarshalJSON() ([]byte, error) {
...
func (o *Updatestaffinggrouprequest) UnmarshalJSON(b []byte) error {
	var UpdatestaffinggrouprequestMap map[string]interface{}
	err := json.Unmarshal(b, &UpdatestaffinggrouprequestMap)
	if err != nil {
		return err
	}
	
	if Name, ok := UpdatestaffinggrouprequestMap["name"].(string); ok {
		o.Name = &Name
	}
