...
func (o *Workitem) SetField(field string, fieldValue interface{}) {
...
func (o Workitem) MarshalJSON() ([]byte, error) {
...
func (o *Workitem) UnmarshalJSON(b []byte) error {
	var WorkitemMap map[string]interface{}
	err := json.Unmarshal(b, &WorkitemMap)
	if err != nil {
		return err
	}
	
	if Id, ok := WorkitemMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Name, ok := WorkitemMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if Division, ok := WorkitemMap["division"].(map[string]interface{}); ok {
		DivisionString, _ := json.Marshal(Division)
		json.Unmarshal(DivisionString, &o.Division)
	}
	
	if VarType, ok := WorkitemMap["type"].(map[string]interface{}); ok {
		VarTypeString, _ := json.Marshal(VarType)
		json.Unmarshal(VarTypeString, &o.VarType)
	}
	
	if Description, ok := WorkitemMap["description"].(string); ok {
	...
	if dateCreatedString, ok := WorkitemMap["dateCreated"].(string); ok {
		DateCreated, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateCreatedString)
		o.DateCreated = &DateCreated
	}
	
	if dateModifiedString, ok := WorkitemMap["dateModified"].(string); ok {
		DateModified, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateModifiedString)
		o.DateModified = &DateModified
	}
	
	if dateDueString, ok := WorkitemMap["dateDue"].(string); ok {
		DateDue, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateDueString)
		o.DateDue = &DateDue
	}
	
	if dateExpiresString, ok := WorkitemMap["dateExpires"].(string); ok {
		DateExpires, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateExpiresString)
		o.DateExpires = &DateExpires
	}
	
	if DurationSeconds, ok := WorkitemMap["durationSeconds"].(float64); ok {
		DurationSecondsInt := int(DurationSeconds)
		o.DurationSeconds = &DurationSecondsInt
	}
	
	if Ttl, ok := WorkitemMap["ttl"].(float64); ok {
		TtlInt := int(Ttl)
		o.Ttl = &TtlInt
	}
	
	if Status, ok := WorkitemMap["status"].(map[string]interface{}); ok {
		StatusString, _ := json.Marshal(Status)
		json.Unmarshal(StatusString, &o.Status)
	}
	
	if StatusCategory, ok := WorkitemMap["statusCategory"].(string); ok {
		o.StatusCategory = &StatusCategory
	}
    
	if dateStatusChangedString, ok := WorkitemMap["dateStatusChanged"].(string); ok {
		DateStatusChanged, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateStatusChangedString)
		o.DateStatusChanged = &DateStatusChanged
	}
	
	if dateClosedString, ok := WorkitemMap["dateClosed"].(string); ok {
		DateClosed, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateClosedString)
		o.DateClosed = &DateClosed
	}
	
	if Workbin, ok := WorkitemMap["workbin"].(map[string]interface{}); ok {
		WorkbinString, _ := json.Marshal(Workbin)
		json.Unmarshal(WorkbinString, &o.Workbin)
	}
	
	if Reporter, ok := WorkitemMap["reporter"].(map[string]interface{}); ok {
		ReporterString, _ := json.Marshal(Reporter)
		json.Unmarshal(ReporterString, &o.Reporter)
	}
	
	if Assignee, ok := WorkitemMap["assignee"].(map[string]interface{}); ok {
		AssigneeString, _ := json.Marshal(Assignee)
		json.Unmarshal(AssigneeString, &o.Assignee)
	}
	
	if ExternalContact, ok := WorkitemMap["externalContact"].(map[string]interface{}); ok {
		ExternalContactString, _ := json.Marshal(ExternalContact)
		json.Unmarshal(ExternalContactString, &o.ExternalContact)
	}
	
	if ExternalTag, ok := WorkitemMap["externalTag"].(string); ok {
		o.ExternalTag = &ExternalTag
	}
    
	if ModifiedBy, ok := WorkitemMap["modifiedBy"].(map[string]interface{}); ok {
		ModifiedByString, _ := json.Marshal(ModifiedBy)
		json.Unmarshal(ModifiedByString, &o.ModifiedBy)
	}
	
	if Queue, ok := WorkitemMap["queue"].(map[string]interface{}); ok {
		QueueString, _ := json.Marshal(Queue)
		json.Unmarshal(QueueString, &o.Queue)
	}
	
	if AssignmentState, ok := WorkitemMap["assignmentState"].(string); ok {
		o.AssignmentState = &AssignmentState
	}
    
	if dateAssignmentStateChangedString, ok := WorkitemMap["dateAssignmentStateChanged"].(string); ok {
