...
func (o *Queueconversationeventtopicvideo) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationeventtopicvideo) UnmarshalJSON(b []byte) error {
	...
	if PeerCount, ok := QueueconversationeventtopicvideoMap["peerCount"].(float64); ok {
	...
	if QueueMediaSettings, ok := QueueconversationeventtopicvideoMap["queueMediaSettings"].(map[string]interface{}); ok {
