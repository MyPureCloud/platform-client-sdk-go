...
func (o *Conversationscreenshareeventtopicscreensharemediaparticipant) SetField(field string, fieldValue interface{}) {
...
func (o *Conversationscreenshareeventtopicscreensharemediaparticipant) UnmarshalJSON(b []byte) error {
	...
	if ExternalContactInitialDivisionId, ok := ConversationscreenshareeventtopicscreensharemediaparticipantMap["externalContactInitialDivisionId"].(string); ok {
	...
	if resumeTimeString, ok := ConversationscreenshareeventtopicscreensharemediaparticipantMap["resumeTime"].(string); ok {
		ResumeTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", resumeTimeString)
		o.ResumeTime = &ResumeTime
	}
	
	if parkTimeString, ok := ConversationscreenshareeventtopicscreensharemediaparticipantMap["parkTime"].(string); ok {
