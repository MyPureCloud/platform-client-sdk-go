...
func (o *Agentadherencescheduledactivity) SetField(field string, fieldValue interface{}) {
...
func (o Agentadherencescheduledactivity) MarshalJSON() ([]byte, error) {
...
func (o *Agentadherencescheduledactivity) UnmarshalJSON(b []byte) error {
	var AgentadherencescheduledactivityMap map[string]interface{}
	err := json.Unmarshal(b, &AgentadherencescheduledactivityMap)
	if err != nil {
		return err
	}
	
	if ActivityCodeId, ok := AgentadherencescheduledactivityMap["activityCodeId"].(string); ok {
		o.ActivityCodeId = &ActivityCodeId
	}
    
	if StartOffsetSeconds, ok := AgentadherencescheduledactivityMap["startOffsetSeconds"].(float64); ok {
		StartOffsetSecondsInt := int(StartOffsetSeconds)
		o.StartOffsetSeconds = &StartOffsetSecondsInt
	}
	
	if EndOffsetSeconds, ok := AgentadherencescheduledactivityMap["endOffsetSeconds"].(float64); ok {
