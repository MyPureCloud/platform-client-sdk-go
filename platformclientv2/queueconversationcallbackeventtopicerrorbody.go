...
type Queueconversationcallbackeventtopicerrorbody struct { 
	...
	// Limit
	Limit *Queueconversationcallbackeventtopiclimit `json:"limit,omitempty"`
}
...
func (o *Queueconversationcallbackeventtopicerrorbody) UnmarshalJSON(b []byte) error {
	...
	if Limit, ok := QueueconversationcallbackeventtopicerrorbodyMap["limit"].(map[string]interface{}); ok {
