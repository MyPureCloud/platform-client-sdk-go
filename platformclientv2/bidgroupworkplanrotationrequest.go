...
func (o *Bidgroupworkplanrotationrequest) SetField(field string, fieldValue interface{}) {
...
func (o Bidgroupworkplanrotationrequest) MarshalJSON() ([]byte, error) {
...
func (o *Bidgroupworkplanrotationrequest) UnmarshalJSON(b []byte) error {
	var BidgroupworkplanrotationrequestMap map[string]interface{}
	err := json.Unmarshal(b, &BidgroupworkplanrotationrequestMap)
	if err != nil {
		return err
	}
	
	if WorkPlanRotationId, ok := BidgroupworkplanrotationrequestMap["workPlanRotationId"].(string); ok {
		o.WorkPlanRotationId = &WorkPlanRotationId
	}
    
	if AgentCount, ok := BidgroupworkplanrotationrequestMap["agentCount"].(float64); ok {
