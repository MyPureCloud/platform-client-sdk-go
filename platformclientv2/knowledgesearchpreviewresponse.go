...
func (o *Knowledgesearchpreviewresponse) SetField(field string, fieldValue interface{}) {
...
func (o Knowledgesearchpreviewresponse) MarshalJSON() ([]byte, error) {
...
func (o *Knowledgesearchpreviewresponse) UnmarshalJSON(b []byte) error {
	var KnowledgesearchpreviewresponseMap map[string]interface{}
	err := json.Unmarshal(b, &KnowledgesearchpreviewresponseMap)
	if err != nil {
		return err
	}
	
	if Query, ok := KnowledgesearchpreviewresponseMap["query"].(string); ok {
		o.Query = &Query
	}
    
	if SearchId, ok := KnowledgesearchpreviewresponseMap["searchId"].(string); ok {
		o.SearchId = &SearchId
	}
    
	if SessionId, ok := KnowledgesearchpreviewresponseMap["sessionId"].(string); ok {
