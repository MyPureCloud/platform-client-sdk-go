...
func (o *Buschedulenotificationssettingsrequest) SetField(field string, fieldValue interface{}) {
...
func (o Buschedulenotificationssettingsrequest) MarshalJSON() ([]byte, error) {
...
func (o *Buschedulenotificationssettingsrequest) UnmarshalJSON(b []byte) error {
	var BuschedulenotificationssettingsrequestMap map[string]interface{}
	err := json.Unmarshal(b, &BuschedulenotificationssettingsrequestMap)
	if err != nil {
		return err
	}
	
	if EarlyReminderMinutes, ok := BuschedulenotificationssettingsrequestMap["earlyReminderMinutes"].(float64); ok {
		EarlyReminderMinutesInt := int(EarlyReminderMinutes)
		o.EarlyReminderMinutes = &EarlyReminderMinutesInt
	}
	
	if ActivityCategorySettings, ok := BuschedulenotificationssettingsrequestMap["activityCategorySettings"].([]interface{}); ok {
