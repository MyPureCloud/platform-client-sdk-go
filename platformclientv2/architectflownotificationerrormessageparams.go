...
func (o *Architectflownotificationerrormessageparams) SetField(field string, fieldValue interface{}) {
...
func (o *Architectflownotificationerrormessageparams) UnmarshalJSON(b []byte) error {
	...
	if GetAdditionalProperties, ok := ArchitectflownotificationerrormessageparamsMap["getAdditionalProperties"].(map[string]interface{}); ok {
