...
func (o *Knowledgegenerationsetting) SetField(field string, fieldValue interface{}) {
...
func (o Knowledgegenerationsetting) MarshalJSON() ([]byte, error) {
...
func (o *Knowledgegenerationsetting) UnmarshalJSON(b []byte) error {
	var KnowledgegenerationsettingMap map[string]interface{}
	err := json.Unmarshal(b, &KnowledgegenerationsettingMap)
	if err != nil {
		return err
	}
	
	if AnswerGeneration, ok := KnowledgegenerationsettingMap["answerGeneration"].(bool); ok {
		o.AnswerGeneration = &AnswerGeneration
	}
    
	if GenerationLanguage, ok := KnowledgegenerationsettingMap["generationLanguage"].(string); ok {
