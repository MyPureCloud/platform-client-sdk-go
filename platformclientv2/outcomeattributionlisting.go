...
type Outcomeattributionlisting struct { 
	...
	// Entities
	Entities *[]Outcomeattributionrequest `json:"entities,omitempty"`
...
func (o *Outcomeattributionlisting) SetField(field string, fieldValue interface{}) {
...
func (o Outcomeattributionlisting) MarshalJSON() ([]byte, error) {
...
func (o *Outcomeattributionlisting) UnmarshalJSON(b []byte) error {
	var OutcomeattributionlistingMap map[string]interface{}
	err := json.Unmarshal(b, &OutcomeattributionlistingMap)
	if err != nil {
		return err
	}
	
	if Entities, ok := OutcomeattributionlistingMap["entities"].([]interface{}); ok {
		EntitiesString, _ := json.Marshal(Entities)
		json.Unmarshal(EntitiesString, &o.Entities)
	}
	
	if PercentFailedThreshold, ok := OutcomeattributionlistingMap["percentFailedThreshold"].(float64); ok {
