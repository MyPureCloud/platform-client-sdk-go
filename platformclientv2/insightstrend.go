...
func (o *Insightstrend) SetField(field string, fieldValue interface{}) {
...
func (o Insightstrend) MarshalJSON() ([]byte, error) {
...
func (o *Insightstrend) UnmarshalJSON(b []byte) error {
	var InsightstrendMap map[string]interface{}
	err := json.Unmarshal(b, &InsightstrendMap)
	if err != nil {
		return err
	}
	
	if PerformanceProfile, ok := InsightstrendMap["performanceProfile"].(map[string]interface{}); ok {
		PerformanceProfileString, _ := json.Marshal(PerformanceProfile)
		json.Unmarshal(PerformanceProfileString, &o.PerformanceProfile)
	}
	
	if Division, ok := InsightstrendMap["division"].(map[string]interface{}); ok {
		DivisionString, _ := json.Marshal(Division)
		json.Unmarshal(DivisionString, &o.Division)
	}
	
	if Granularity, ok := InsightstrendMap["granularity"].(string); ok {
		o.Granularity = &Granularity
	}
    
	if ComparativePeriod, ok := InsightstrendMap["comparativePeriod"].(map[string]interface{}); ok {
		ComparativePeriodString, _ := json.Marshal(ComparativePeriod)
		json.Unmarshal(ComparativePeriodString, &o.ComparativePeriod)
	}
	
	if PrimaryPeriod, ok := InsightstrendMap["primaryPeriod"].(map[string]interface{}); ok {
		PrimaryPeriodString, _ := json.Marshal(PrimaryPeriod)
		json.Unmarshal(PrimaryPeriodString, &o.PrimaryPeriod)
	}
	
	if Entities, ok := InsightstrendMap["entities"].([]interface{}); ok {
		EntitiesString, _ := json.Marshal(Entities)
		json.Unmarshal(EntitiesString, &o.Entities)
	}
	
	if Total, ok := InsightstrendMap["total"].(map[string]interface{}); ok {
