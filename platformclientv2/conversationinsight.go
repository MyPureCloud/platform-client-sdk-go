...
func (o *Conversationinsight) SetField(field string, fieldValue interface{}) {
...
func (o *Conversationinsight) UnmarshalJSON(b []byte) error {
	var ConversationinsightMap map[string]interface{}
	err := json.Unmarshal(b, &ConversationinsightMap)
	if err != nil {
		return err
	}
	
	if VarType, ok := ConversationinsightMap["type"].(string); ok {
		o.VarType = &VarType
	}
    
	if Title, ok := ConversationinsightMap["title"].(string); ok {
		o.Title = &Title
	}
