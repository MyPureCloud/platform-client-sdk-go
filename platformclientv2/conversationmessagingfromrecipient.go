...
type Conversationmessagingfromrecipient struct { 
	...
	// ExternalContactDivisionId - The division identifier of the external contact.
	ExternalContactDivisionId *string `json:"externalContactDivisionId,omitempty"`
...
func (o *Conversationmessagingfromrecipient) SetField(field string, fieldValue interface{}) {
...
func (o Conversationmessagingfromrecipient) MarshalJSON() ([]byte, error) {
	...
	return json.Marshal(&struct { 
		...
		ExternalContactDivisionId: o.ExternalContactDivisionId,
...
func (o *Conversationmessagingfromrecipient) UnmarshalJSON(b []byte) error {
	...
	if ExternalContactId, ok := ConversationmessagingfromrecipientMap["externalContactId"].(string); ok {
		o.ExternalContactId = &ExternalContactId
	}
    
	if ExternalContactDivisionId, ok := ConversationmessagingfromrecipientMap["externalContactDivisionId"].(string); ok {
		o.ExternalContactDivisionId = &ExternalContactDivisionId
	}
