...
func (o *Wfmentitymetadata) SetField(field string, fieldValue interface{}) {
...
func (o Wfmentitymetadata) MarshalJSON() ([]byte, error) {
...
func (o *Wfmentitymetadata) UnmarshalJSON(b []byte) error {
	var WfmentitymetadataMap map[string]interface{}
	err := json.Unmarshal(b, &WfmentitymetadataMap)
	if err != nil {
		return err
	}
	
	if ModifiedBy, ok := WfmentitymetadataMap["modifiedBy"].(map[string]interface{}); ok {
		ModifiedByString, _ := json.Marshal(ModifiedBy)
		json.Unmarshal(ModifiedByString, &o.ModifiedBy)
	}
	
	if dateModifiedString, ok := WfmentitymetadataMap["dateModified"].(string); ok {
		DateModified, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateModifiedString)
		o.DateModified = &DateModified
	}
	
	if CreatedBy, ok := WfmentitymetadataMap["createdBy"].(map[string]interface{}); ok {
		CreatedByString, _ := json.Marshal(CreatedBy)
		json.Unmarshal(CreatedByString, &o.CreatedBy)
	}
	
	if dateCreatedString, ok := WfmentitymetadataMap["dateCreated"].(string); ok {
