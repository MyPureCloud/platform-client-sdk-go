...
func (o *V3startmanualsyncrequest) SetField(field string, fieldValue interface{}) {
...
func (o V3startmanualsyncrequest) MarshalJSON() ([]byte, error) {
...
func (o *V3startmanualsyncrequest) UnmarshalJSON(b []byte) error {
	var V3startmanualsyncrequestMap map[string]interface{}
	err := json.Unmarshal(b, &V3startmanualsyncrequestMap)
	if err != nil {
		return err
	}
	
	if VarType, ok := V3startmanualsyncrequestMap["type"].(string); ok {
		o.VarType = &VarType
	}
