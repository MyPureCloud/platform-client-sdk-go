...
func (o *Evaluationformresponse) SetField(field string, fieldValue interface{}) {
...
func (o *Evaluationformresponse) UnmarshalJSON(b []byte) error {
	...
	if Division, ok := EvaluationformresponseMap["division"].(map[string]interface{}); ok {
	...
	if EvaluationSettings, ok := EvaluationformresponseMap["evaluationSettings"].(map[string]interface{}); ok {
	...
	if LatestVersionFormName, ok := EvaluationformresponseMap["latestVersionFormName"].(string); ok {
