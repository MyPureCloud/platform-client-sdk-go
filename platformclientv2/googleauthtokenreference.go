...
func (o *Googleauthtokenreference) SetField(field string, fieldValue interface{}) {
...
func (o Googleauthtokenreference) MarshalJSON() ([]byte, error) {
...
func (o *Googleauthtokenreference) UnmarshalJSON(b []byte) error {
	var GoogleauthtokenreferenceMap map[string]interface{}
	err := json.Unmarshal(b, &GoogleauthtokenreferenceMap)
	if err != nil {
		return err
	}
	
	if Id, ok := GoogleauthtokenreferenceMap["id"].(string); ok {
		o.Id = &Id
	}
