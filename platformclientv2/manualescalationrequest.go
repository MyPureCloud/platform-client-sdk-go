...
func (o *Manualescalationrequest) SetField(field string, fieldValue interface{}) {
...
func (o Manualescalationrequest) MarshalJSON() ([]byte, error) {
...
func (o *Manualescalationrequest) UnmarshalJSON(b []byte) error {
	var ManualescalationrequestMap map[string]interface{}
	err := json.Unmarshal(b, &ManualescalationrequestMap)
	if err != nil {
		return err
	}
	
	if SocialMediaNormalizedMessageId, ok := ManualescalationrequestMap["socialMediaNormalizedMessageId"].(string); ok {
		o.SocialMediaNormalizedMessageId = &SocialMediaNormalizedMessageId
	}
    
	if EscalationTarget, ok := ManualescalationrequestMap["escalationTarget"].(map[string]interface{}); ok {
