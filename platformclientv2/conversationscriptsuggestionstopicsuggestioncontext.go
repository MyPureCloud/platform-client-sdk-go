...
func (o *Conversationscriptsuggestionstopicsuggestioncontext) UnmarshalJSON(b []byte) error {
	...
	if Language, ok := ConversationscriptsuggestionstopicsuggestioncontextMap["language"].(string); ok {
		o.Language = &Language
	}
    
	if QueryReformulationContext, ok := ConversationscriptsuggestionstopicsuggestioncontextMap["queryReformulationContext"].(map[string]interface{}); ok {
