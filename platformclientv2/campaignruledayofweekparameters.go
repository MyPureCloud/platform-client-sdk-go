...
func (o Campaignruledayofweekparameters) MarshalJSON() ([]byte, error) {
...
func (o *Campaignruledayofweekparameters) UnmarshalJSON(b []byte) error {
	var CampaignruledayofweekparametersMap map[string]interface{}
