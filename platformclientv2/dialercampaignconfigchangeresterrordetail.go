...
func (o *Dialercampaignconfigchangeresterrordetail) SetField(field string, fieldValue interface{}) {
...
func (o *Dialercampaignconfigchangeresterrordetail) UnmarshalJSON(b []byte) error {
	...
	if GetAdditionalProperties, ok := DialercampaignconfigchangeresterrordetailMap["getAdditionalProperties"].(map[string]interface{}); ok {
