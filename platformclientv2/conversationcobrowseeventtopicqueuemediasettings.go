...
type Conversationcobrowseeventtopicqueuemediasettings struct { 
...
func (o *Conversationcobrowseeventtopicqueuemediasettings) SetField(field string, fieldValue interface{}) {
...
func (o Conversationcobrowseeventtopicqueuemediasettings) MarshalJSON() ([]byte, error) {
	...
	type Alias Conversationcobrowseeventtopicqueuemediasettings
...
func (o *Conversationcobrowseeventtopicqueuemediasettings) UnmarshalJSON(b []byte) error {
	var ConversationcobrowseeventtopicqueuemediasettingsMap map[string]interface{}
	err := json.Unmarshal(b, &ConversationcobrowseeventtopicqueuemediasettingsMap)
	if err != nil {
		return err
	}
	
	if AlertingTimeoutSeconds, ok := ConversationcobrowseeventtopicqueuemediasettingsMap["alertingTimeoutSeconds"].(float64); ok {
		AlertingTimeoutSecondsInt := int(AlertingTimeoutSeconds)
		o.AlertingTimeoutSeconds = &AlertingTimeoutSecondsInt
	}
	
	if AutoAnswerAlertToneSeconds, ok := ConversationcobrowseeventtopicqueuemediasettingsMap["autoAnswerAlertToneSeconds"].(float64); ok {
	...
	if ManualAnswerAlertToneSeconds, ok := ConversationcobrowseeventtopicqueuemediasettingsMap["manualAnswerAlertToneSeconds"].(float64); ok {
	...
	if EnableAutoAnswer, ok := ConversationcobrowseeventtopicqueuemediasettingsMap["enableAutoAnswer"].(bool); ok {
...
func (o *Conversationcobrowseeventtopicqueuemediasettings) String() string {
	j, _ := json.Marshal(o)
