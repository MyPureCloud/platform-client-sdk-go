...
func (o *Intakesettingsupdate) SetField(field string, fieldValue interface{}) {
...
func (o Intakesettingsupdate) MarshalJSON() ([]byte, error) {
...
func (o *Intakesettingsupdate) UnmarshalJSON(b []byte) error {
	var IntakesettingsupdateMap map[string]interface{}
	err := json.Unmarshal(b, &IntakesettingsupdateMap)
	if err != nil {
		return err
	}
	
	if IntakeSettings, ok := IntakesettingsupdateMap["intakeSettings"].([]interface{}); ok {
