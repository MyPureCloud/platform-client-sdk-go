...
func (o *Queueconversationsocialexpressioneventtopicdisconnectreason) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationsocialexpressioneventtopicdisconnectreason) UnmarshalJSON(b []byte) error {
	...
	if Reason, ok := QueueconversationsocialexpressioneventtopicdisconnectreasonMap["reason"].(string); ok {
		o.Reason = &Reason
	}
