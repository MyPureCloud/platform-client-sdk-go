...
func (o *Dialercontactlistconfigchangeemailcolumn) SetField(field string, fieldValue interface{}) {
...
func (o *Dialercontactlistconfigchangeemailcolumn) UnmarshalJSON(b []byte) error {
	...
	if GetAdditionalProperties, ok := DialercontactlistconfigchangeemailcolumnMap["getAdditionalProperties"].(map[string]interface{}); ok {
