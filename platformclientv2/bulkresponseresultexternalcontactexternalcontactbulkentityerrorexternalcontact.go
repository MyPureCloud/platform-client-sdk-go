...
func (o *Bulkresponseresultexternalcontactexternalcontactbulkentityerrorexternalcontact) SetField(field string, fieldValue interface{}) {
...
func (o Bulkresponseresultexternalcontactexternalcontactbulkentityerrorexternalcontact) MarshalJSON() ([]byte, error) {
...
func (o *Bulkresponseresultexternalcontactexternalcontactbulkentityerrorexternalcontact) UnmarshalJSON(b []byte) error {
	var BulkresponseresultexternalcontactexternalcontactbulkentityerrorexternalcontactMap map[string]interface{}
	err := json.Unmarshal(b, &BulkresponseresultexternalcontactexternalcontactbulkentityerrorexternalcontactMap)
	if err != nil {
		return err
	}
	
	if Id, ok := BulkresponseresultexternalcontactexternalcontactbulkentityerrorexternalcontactMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Success, ok := BulkresponseresultexternalcontactexternalcontactbulkentityerrorexternalcontactMap["success"].(bool); ok {
		o.Success = &Success
	}
    
	if Entity, ok := BulkresponseresultexternalcontactexternalcontactbulkentityerrorexternalcontactMap["entity"].(map[string]interface{}); ok {
