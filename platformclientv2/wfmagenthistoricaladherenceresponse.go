...
type Wfmagenthistoricaladherenceresponse struct { 
	...
	Job *Wfmagenthistoricaladherencejobreference `json:"job,omitempty"`
	...
	Result *Wfmagenthistoricaladherenceresult `json:"result,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Wfmagenthistoricaladherenceresponse) SetField(field string, fieldValue interface{}) {
...
func (o Wfmagenthistoricaladherenceresponse) MarshalJSON() ([]byte, error) {
...
func (o *Wfmagenthistoricaladherenceresponse) UnmarshalJSON(b []byte) error {
	var WfmagenthistoricaladherenceresponseMap map[string]interface{}
	err := json.Unmarshal(b, &WfmagenthistoricaladherenceresponseMap)
	if err != nil {
		return err
	}
	
	if Job, ok := WfmagenthistoricaladherenceresponseMap["job"].(map[string]interface{}); ok {
		JobString, _ := json.Marshal(Job)
		json.Unmarshal(JobString, &o.Job)
	}
	
	if DownloadUrls, ok := WfmagenthistoricaladherenceresponseMap["downloadUrls"].([]interface{}); ok {
		DownloadUrlsString, _ := json.Marshal(DownloadUrls)
		json.Unmarshal(DownloadUrlsString, &o.DownloadUrls)
	}
	
	if Result, ok := WfmagenthistoricaladherenceresponseMap["result"].(map[string]interface{}); ok {
