...
func (a VoicemailApi) DeleteVoicemailMessages() (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/voicemail/messages"
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
func (a VoicemailApi) GetVoicemailMailbox() (*Voicemailmailboxinfo, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/voicemail/mailbox"
	defaultReturn := new(Voicemailmailboxinfo)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
func (a VoicemailApi) GetVoicemailMeMailbox() (*Voicemailmailboxinfo, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/voicemail/me/mailbox"
	defaultReturn := new(Voicemailmailboxinfo)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
func (a VoicemailApi) GetVoicemailMePolicy() (*Voicemailuserpolicy, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/voicemail/me/policy"
...
func (a VoicemailApi) GetVoicemailPolicy() (*Voicemailorganizationpolicy, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/voicemail/policy"
	defaultReturn := new(Voicemailorganizationpolicy)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
// GetVoicemailUserMailbox invokes GET /api/v2/voicemail/users/{userId}/mailbox
//
// Get a user's mailbox information
func (a VoicemailApi) GetVoicemailUserMailbox(userId string) (*Voicemailmailboxinfo, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/voicemail/users/{userId}/mailbox"
	...
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling VoicemailApi->GetVoicemailUserMailbox")
	}
...
// GetVoicemailUserMessages invokes GET /api/v2/voicemail/users/{userId}/messages
//
// List voicemail messages
func (a VoicemailApi) GetVoicemailUserMessages(userId string, pageSize int, pageNumber int) (*Voicemailmessageentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/voicemail/users/{userId}/messages"
	path = strings.Replace(path, "{userId}", url.PathEscape(fmt.Sprintf("%v", userId)), -1)
	defaultReturn := new(Voicemailmessageentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	...
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling VoicemailApi->GetVoicemailUserMessages")
	}
