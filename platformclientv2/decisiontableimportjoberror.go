...
func (o *Decisiontableimportjoberror) SetField(field string, fieldValue interface{}) {
...
func (o Decisiontableimportjoberror) MarshalJSON() ([]byte, error) {
...
func (o *Decisiontableimportjoberror) UnmarshalJSON(b []byte) error {
	var DecisiontableimportjoberrorMap map[string]interface{}
	err := json.Unmarshal(b, &DecisiontableimportjoberrorMap)
	if err != nil {
		return err
	}
	
	if ErrorCode, ok := DecisiontableimportjoberrorMap["errorCode"].(string); ok {
		o.ErrorCode = &ErrorCode
	}
    
	if ErrorMessage, ok := DecisiontableimportjoberrorMap["errorMessage"].(string); ok {
		o.ErrorMessage = &ErrorMessage
	}
    
	if MessageWithParams, ok := DecisiontableimportjoberrorMap["messageWithParams"].(string); ok {
		o.MessageWithParams = &MessageWithParams
	}
    
	if MessageParams, ok := DecisiontableimportjoberrorMap["messageParams"].(map[string]interface{}); ok {
		MessageParamsString, _ := json.Marshal(MessageParams)
		json.Unmarshal(MessageParamsString, &o.MessageParams)
	}
	
	if ValidationErrors, ok := DecisiontableimportjoberrorMap["validationErrors"].([]interface{}); ok {
