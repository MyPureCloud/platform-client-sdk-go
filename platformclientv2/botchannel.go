...
func (o *Botchannel) SetField(field string, fieldValue interface{}) {
...
func (o Botchannel) MarshalJSON() ([]byte, error) {
...
func (o *Botchannel) UnmarshalJSON(b []byte) error {
	var BotchannelMap map[string]interface{}
	err := json.Unmarshal(b, &BotchannelMap)
	if err != nil {
		return err
	}
	
	if Name, ok := BotchannelMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if InputModes, ok := BotchannelMap["inputModes"].([]interface{}); ok {
		InputModesString, _ := json.Marshal(InputModes)
		json.Unmarshal(InputModesString, &o.InputModes)
	}
	
	if OutputModes, ok := BotchannelMap["outputModes"].([]interface{}); ok {
		OutputModesString, _ := json.Marshal(OutputModes)
		json.Unmarshal(OutputModesString, &o.OutputModes)
	}
	
	if UserAgent, ok := BotchannelMap["userAgent"].(map[string]interface{}); ok {
