...
func (o *Createtimeoffplanbusinessunitassociation) SetField(field string, fieldValue interface{}) {
...
func (o Createtimeoffplanbusinessunitassociation) MarshalJSON() ([]byte, error) {
...
func (o *Createtimeoffplanbusinessunitassociation) UnmarshalJSON(b []byte) error {
	var CreatetimeoffplanbusinessunitassociationMap map[string]interface{}
	err := json.Unmarshal(b, &CreatetimeoffplanbusinessunitassociationMap)
	if err != nil {
		return err
	}
	
	if ManagementUnitIds, ok := CreatetimeoffplanbusinessunitassociationMap["managementUnitIds"].([]interface{}); ok {
		ManagementUnitIdsString, _ := json.Marshal(ManagementUnitIds)
		json.Unmarshal(ManagementUnitIdsString, &o.ManagementUnitIds)
	}
	
	if StaffingGroupIds, ok := CreatetimeoffplanbusinessunitassociationMap["staffingGroupIds"].([]interface{}); ok {
