...
func (o *Learningmodulepreviewupdaterequestcurrentstep) SetField(field string, fieldValue interface{}) {
...
func (o Learningmodulepreviewupdaterequestcurrentstep) MarshalJSON() ([]byte, error) {
...
func (o *Learningmodulepreviewupdaterequestcurrentstep) UnmarshalJSON(b []byte) error {
	var LearningmodulepreviewupdaterequestcurrentstepMap map[string]interface{}
	err := json.Unmarshal(b, &LearningmodulepreviewupdaterequestcurrentstepMap)
	if err != nil {
		return err
	}
	
	if Id, ok := LearningmodulepreviewupdaterequestcurrentstepMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if CompletionPercentage, ok := LearningmodulepreviewupdaterequestcurrentstepMap["completionPercentage"].(float64); ok {
		CompletionPercentageFloat32 := float32(CompletionPercentage)
		o.CompletionPercentage = &CompletionPercentageFloat32
	}
	
	if ShareableContentObject, ok := LearningmodulepreviewupdaterequestcurrentstepMap["shareableContentObject"].(map[string]interface{}); ok {
