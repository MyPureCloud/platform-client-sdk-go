...
func (o *Internalmessagedetails) SetField(field string, fieldValue interface{}) {
...
func (o Internalmessagedetails) MarshalJSON() ([]byte, error) {
...
func (o *Internalmessagedetails) UnmarshalJSON(b []byte) error {
	var InternalmessagedetailsMap map[string]interface{}
	err := json.Unmarshal(b, &InternalmessagedetailsMap)
	if err != nil {
		return err
	}
	
	if MessageId, ok := InternalmessagedetailsMap["messageId"].(string); ok {
		o.MessageId = &MessageId
	}
    
	if messageTimeString, ok := InternalmessagedetailsMap["messageTime"].(string); ok {
