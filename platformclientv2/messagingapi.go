...
// DeleteMessagingSetting invokes DELETE /api/v2/messaging/settings/{messageSettingId}
//
// Delete a messaging setting
//
// Deprecated: DeleteMessagingSetting is deprecated
func (a MessagingApi) DeleteMessagingSetting(messageSettingId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/messaging/settings/{messageSettingId}"
	...
	if &messageSettingId == nil {
		// false
		return nil, errors.New("Missing required parameter 'messageSettingId' when calling MessagingApi->DeleteMessagingSetting")
	}
...
// DeleteMessagingSettingsDefault invokes DELETE /api/v2/messaging/settings/default
//
...
//
// Deprecated: DeleteMessagingSettingsDefault is deprecated
func (a MessagingApi) DeleteMessagingSettingsDefault() (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/messaging/settings/default"
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
// GetMessagingSetting invokes GET /api/v2/messaging/settings/{messageSettingId}
//
// Get a messaging setting
//
// Deprecated: GetMessagingSetting is deprecated
func (a MessagingApi) GetMessagingSetting(messageSettingId string) (*Messagingsetting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/messaging/settings/{messageSettingId}"
	path = strings.Replace(path, "{messageSettingId}", url.PathEscape(fmt.Sprintf("%v", messageSettingId)), -1)
	...
	if &messageSettingId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'messageSettingId' when calling MessagingApi->GetMessagingSetting")
	}
...
// GetMessagingSettings invokes GET /api/v2/messaging/settings
//
// Get a list of messaging settings
//
// Deprecated: GetMessagingSettings is deprecated
func (a MessagingApi) GetMessagingSettings(pageSize int, pageNumber int) (*Messagingconfiglisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/messaging/settings"
...
// GetMessagingSettingsDefault invokes GET /api/v2/messaging/settings/default
//
// Get the organization's default settings that will be used as the default when creating an integration.
//
// When an integration is created a settings ID may be assigned to it. If the settings ID is not supplied, the default settings will be applied to it.
//
// Deprecated: GetMessagingSettingsDefault is deprecated
func (a MessagingApi) GetMessagingSettingsDefault() (*Messagingsetting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/messaging/settings/default"
	defaultReturn := new(Messagingsetting)
...
// PatchMessagingSetting invokes PATCH /api/v2/messaging/settings/{messageSettingId}
//
// Update a messaging setting
//
// Deprecated: PatchMessagingSetting is deprecated
func (a MessagingApi) PatchMessagingSetting(messageSettingId string, body Messagingsettingrequest) (*Messagingsetting, *APIResponse, error) {
	...
	if &messageSettingId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'messageSettingId' when calling MessagingApi->PatchMessagingSetting")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling MessagingApi->PatchMessagingSetting")
	}
...
// PostMessagingSettings invokes POST /api/v2/messaging/settings
//
// Create a messaging setting
//
// Deprecated: PostMessagingSettings is deprecated
func (a MessagingApi) PostMessagingSettings(body Messagingsettingrequest) (*Messagingsetting, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/messaging/settings"
	defaultReturn := new(Messagingsetting)
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling MessagingApi->PostMessagingSettings")
	}
...
// PutMessagingSettingsDefault invokes PUT /api/v2/messaging/settings/default
//
// Set the organization's default settings that may be applied to an integration when it is created.
//
// When an integration is created a settings ID may be assigned to it. If the settings ID is not supplied, the default settings will be applied to it.
//
// Deprecated: PutMessagingSettingsDefault is deprecated
func (a MessagingApi) PutMessagingSettingsDefault(body Messagingsettingdefaultrequest) (*Messagingsetting, *APIResponse, error) {
	var httpMethod = "PUT"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/messaging/settings/default"
	defaultReturn := new(Messagingsetting)
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling MessagingApi->PutMessagingSettingsDefault")
	}
