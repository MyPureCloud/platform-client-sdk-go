...
// Queueconversationsocialexpressioneventtopicqueuemediasettings - Represents the queue setting for this media.
type Queueconversationsocialexpressioneventtopicqueuemediasettings struct { 
...
func (o *Queueconversationsocialexpressioneventtopicqueuemediasettings) SetField(field string, fieldValue interface{}) {
...
func (o Queueconversationsocialexpressioneventtopicqueuemediasettings) MarshalJSON() ([]byte, error) {
	...
	type Alias Queueconversationsocialexpressioneventtopicqueuemediasettings
...
func (o *Queueconversationsocialexpressioneventtopicqueuemediasettings) UnmarshalJSON(b []byte) error {
	var QueueconversationsocialexpressioneventtopicqueuemediasettingsMap map[string]interface{}
	err := json.Unmarshal(b, &QueueconversationsocialexpressioneventtopicqueuemediasettingsMap)
	if err != nil {
		return err
	}
	
	if AlertingTimeoutSeconds, ok := QueueconversationsocialexpressioneventtopicqueuemediasettingsMap["alertingTimeoutSeconds"].(float64); ok {
		AlertingTimeoutSecondsInt := int(AlertingTimeoutSeconds)
		o.AlertingTimeoutSeconds = &AlertingTimeoutSecondsInt
	}
	
	if AutoAnswerAlertToneSeconds, ok := QueueconversationsocialexpressioneventtopicqueuemediasettingsMap["autoAnswerAlertToneSeconds"].(float64); ok {
	...
	if ManualAnswerAlertToneSeconds, ok := QueueconversationsocialexpressioneventtopicqueuemediasettingsMap["manualAnswerAlertToneSeconds"].(float64); ok {
	...
	if EnableAutoAnswer, ok := QueueconversationsocialexpressioneventtopicqueuemediasettingsMap["enableAutoAnswer"].(bool); ok {
...
func (o *Queueconversationsocialexpressioneventtopicqueuemediasettings) String() string {
	j, _ := json.Marshal(o)
