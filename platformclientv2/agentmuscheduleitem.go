...
type Agentmuscheduleitem struct { 
	...
	Shifts *[]Agentmuscheduleshift `json:"shifts,omitempty"`
...
func (o *Agentmuscheduleitem) SetField(field string, fieldValue interface{}) {
...
func (o Agentmuscheduleitem) MarshalJSON() ([]byte, error) {
...
func (o *Agentmuscheduleitem) UnmarshalJSON(b []byte) error {
	var AgentmuscheduleitemMap map[string]interface{}
	err := json.Unmarshal(b, &AgentmuscheduleitemMap)
	if err != nil {
		return err
	}
	
	if Agent, ok := AgentmuscheduleitemMap["agent"].(map[string]interface{}); ok {
		AgentString, _ := json.Marshal(Agent)
		json.Unmarshal(AgentString, &o.Agent)
	}
	
	if Shifts, ok := AgentmuscheduleitemMap["shifts"].([]interface{}); ok {
		ShiftsString, _ := json.Marshal(Shifts)
		json.Unmarshal(ShiftsString, &o.Shifts)
	}
	
	if FullDayTimeOffMarkerDates, ok := AgentmuscheduleitemMap["fullDayTimeOffMarkerDates"].([]interface{}); ok {
