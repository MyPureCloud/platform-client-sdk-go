...
type Campaignschedule struct { 
	...
	Campaign *Divisioneddomainentityref `json:"campaign,omitempty"`
...
func (o *Campaignschedule) SetField(field string, fieldValue interface{}) {
...
func (o *Campaignschedule) UnmarshalJSON(b []byte) error {
	...
	if Recurrences, ok := CampaignscheduleMap["recurrences"].([]interface{}); ok {
