...
func (o *Journeyviewlisting) SetField(field string, fieldValue interface{}) {
...
func (o Journeyviewlisting) MarshalJSON() ([]byte, error) {
...
func (o *Journeyviewlisting) UnmarshalJSON(b []byte) error {
	var JourneyviewlistingMap map[string]interface{}
	err := json.Unmarshal(b, &JourneyviewlistingMap)
	if err != nil {
		return err
	}
