...
func (o *Buschedulersettingsrequest) SetField(field string, fieldValue interface{}) {
...
func (o Buschedulersettingsrequest) MarshalJSON() ([]byte, error) {
...
func (o *Buschedulersettingsrequest) UnmarshalJSON(b []byte) error {
	var BuschedulersettingsrequestMap map[string]interface{}
	err := json.Unmarshal(b, &BuschedulersettingsrequestMap)
	if err != nil {
		return err
	}
	
	if ConsistentServiceLevelSmoothing, ok := BuschedulersettingsrequestMap["consistentServiceLevelSmoothing"].(bool); ok {
		o.ConsistentServiceLevelSmoothing = &ConsistentServiceLevelSmoothing
	}
    
	if Metadata, ok := BuschedulersettingsrequestMap["metadata"].(map[string]interface{}); ok {
