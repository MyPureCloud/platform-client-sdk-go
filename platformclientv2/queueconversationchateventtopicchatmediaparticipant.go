...
func (o *Queueconversationchateventtopicchatmediaparticipant) UnmarshalJSON(b []byte) error {
	...
	if ExternalContactInitialDivisionId, ok := QueueconversationchateventtopicchatmediaparticipantMap["externalContactInitialDivisionId"].(string); ok {
	...
	if parkTimeString, ok := QueueconversationchateventtopicchatmediaparticipantMap["parkTime"].(string); ok {
