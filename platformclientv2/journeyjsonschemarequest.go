...
func (o *Journeyjsonschemarequest) SetField(field string, fieldValue interface{}) {
...
func (o Journeyjsonschemarequest) MarshalJSON() ([]byte, error) {
...
func (o *Journeyjsonschemarequest) UnmarshalJSON(b []byte) error {
	var JourneyjsonschemarequestMap map[string]interface{}
	err := json.Unmarshal(b, &JourneyjsonschemarequestMap)
	if err != nil {
		return err
	}
	
	if Schema, ok := JourneyjsonschemarequestMap["$schema"].(string); ok {
		o.Schema = &Schema
	}
    
	if Title, ok := JourneyjsonschemarequestMap["title"].(string); ok {
		o.Title = &Title
	}
    
	if Description, ok := JourneyjsonschemarequestMap["description"].(string); ok {
		o.Description = &Description
	}
    
	if Required, ok := JourneyjsonschemarequestMap["required"].([]interface{}); ok {
		RequiredString, _ := json.Marshal(Required)
		json.Unmarshal(RequiredString, &o.Required)
	}
	
	if Properties, ok := JourneyjsonschemarequestMap["properties"].(map[string]interface{}); ok {
