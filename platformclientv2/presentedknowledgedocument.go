...
func (o *Presentedknowledgedocument) SetField(field string, fieldValue interface{}) {
...
func (o Presentedknowledgedocument) MarshalJSON() ([]byte, error) {
...
func (o *Presentedknowledgedocument) UnmarshalJSON(b []byte) error {
	var PresentedknowledgedocumentMap map[string]interface{}
	err := json.Unmarshal(b, &PresentedknowledgedocumentMap)
	if err != nil {
		return err
	}
	
	if DocumentId, ok := PresentedknowledgedocumentMap["documentId"].(string); ok {
		o.DocumentId = &DocumentId
	}
    
	if DocumentVariationId, ok := PresentedknowledgedocumentMap["documentVariationId"].(string); ok {
		o.DocumentVariationId = &DocumentVariationId
	}
    
	if DocumentVersionId, ok := PresentedknowledgedocumentMap["documentVersionId"].(string); ok {
		o.DocumentVersionId = &DocumentVersionId
	}
    
	if SurfacingMethod, ok := PresentedknowledgedocumentMap["surfacingMethod"].(string); ok {
