...
func (o *Domains) SetField(field string, fieldValue interface{}) {
...
func (o Domains) MarshalJSON() ([]byte, error) {
...
func (o *Domains) UnmarshalJSON(b []byte) error {
	...
	if AuthorizedDomains, ok := DomainsMap["authorizedDomains"].(map[string]interface{}); ok {
		AuthorizedDomainsString, _ := json.Marshal(AuthorizedDomains)
