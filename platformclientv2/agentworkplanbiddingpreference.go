...
func (o *Agentworkplanbiddingpreference) SetField(field string, fieldValue interface{}) {
...
func (o Agentworkplanbiddingpreference) MarshalJSON() ([]byte, error) {
...
func (o *Agentworkplanbiddingpreference) UnmarshalJSON(b []byte) error {
	var AgentworkplanbiddingpreferenceMap map[string]interface{}
	err := json.Unmarshal(b, &AgentworkplanbiddingpreferenceMap)
	if err != nil {
		return err
	}
	
	if WorkPlan, ok := AgentworkplanbiddingpreferenceMap["workPlan"].(map[string]interface{}); ok {
		WorkPlanString, _ := json.Marshal(WorkPlan)
		json.Unmarshal(WorkPlanString, &o.WorkPlan)
	}
	
	if Priority, ok := AgentworkplanbiddingpreferenceMap["priority"].(float64); ok {
