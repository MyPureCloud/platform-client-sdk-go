...
type Agentmuqueryresponse struct { 
	...
	Result *Agentmuscheduleresult `json:"result,omitempty"`
...
func (o *Agentmuqueryresponse) SetField(field string, fieldValue interface{}) {
...
func (o Agentmuqueryresponse) MarshalJSON() ([]byte, error) {
...
func (o *Agentmuqueryresponse) UnmarshalJSON(b []byte) error {
	var AgentmuqueryresponseMap map[string]interface{}
	err := json.Unmarshal(b, &AgentmuqueryresponseMap)
	if err != nil {
		return err
	}
	
	if Status, ok := AgentmuqueryresponseMap["status"].(string); ok {
		o.Status = &Status
	}
    
	if OperationId, ok := AgentmuqueryresponseMap["operationId"].(string); ok {
		o.OperationId = &OperationId
	}
    
	if Result, ok := AgentmuqueryresponseMap["result"].(map[string]interface{}); ok {
		ResultString, _ := json.Marshal(Result)
		json.Unmarshal(ResultString, &o.Result)
	}
	
	if DownloadUrl, ok := AgentmuqueryresponseMap["downloadUrl"].(string); ok {
		o.DownloadUrl = &DownloadUrl
	}
    
	if VarError, ok := AgentmuqueryresponseMap["error"].(map[string]interface{}); ok {
