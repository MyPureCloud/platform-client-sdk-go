...
type Bulkorganizationsenrichresponse struct { 
	...
	Results *[]Bulkresponseresultexternalorganizationexternalorganizationenrichrequestbulkentityerrorexternalorganizationenrichrequest `json:"results,omitempty"`
...
func (o *Bulkorganizationsenrichresponse) SetField(field string, fieldValue interface{}) {
...
func (o Bulkorganizationsenrichresponse) MarshalJSON() ([]byte, error) {
...
func (o *Bulkorganizationsenrichresponse) UnmarshalJSON(b []byte) error {
	var BulkorganizationsenrichresponseMap map[string]interface{}
	err := json.Unmarshal(b, &BulkorganizationsenrichresponseMap)
	if err != nil {
		return err
	}
	
	if Results, ok := BulkorganizationsenrichresponseMap["results"].([]interface{}); ok {
		ResultsString, _ := json.Marshal(Results)
		json.Unmarshal(ResultsString, &o.Results)
	}
	
	if ErrorCount, ok := BulkorganizationsenrichresponseMap["errorCount"].(float64); ok {
		ErrorCountInt := int(ErrorCount)
		o.ErrorCount = &ErrorCountInt
	}
	
	if ErrorIndexes, ok := BulkorganizationsenrichresponseMap["errorIndexes"].([]interface{}); ok {
