...
func (o *Querytimeofflimitvaluesforgranularityrequest) SetField(field string, fieldValue interface{}) {
...
func (o Querytimeofflimitvaluesforgranularityrequest) MarshalJSON() ([]byte, error) {
...
func (o *Querytimeofflimitvaluesforgranularityrequest) UnmarshalJSON(b []byte) error {
	var QuerytimeofflimitvaluesforgranularityrequestMap map[string]interface{}
	err := json.Unmarshal(b, &QuerytimeofflimitvaluesforgranularityrequestMap)
	if err != nil {
		return err
	}
	
	if DateRanges, ok := QuerytimeofflimitvaluesforgranularityrequestMap["dateRanges"].([]interface{}); ok {
