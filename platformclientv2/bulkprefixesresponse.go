...
type Bulkprefixesresponse struct { 
	...
	Results *[]Bulkresponseresultprefixprefixbulkentityerrorprefix `json:"results,omitempty"`
...
func (o *Bulkprefixesresponse) SetField(field string, fieldValue interface{}) {
...
func (o Bulkprefixesresponse) MarshalJSON() ([]byte, error) {
...
func (o *Bulkprefixesresponse) UnmarshalJSON(b []byte) error {
	var BulkprefixesresponseMap map[string]interface{}
	err := json.Unmarshal(b, &BulkprefixesresponseMap)
	if err != nil {
		return err
	}
	
	if Results, ok := BulkprefixesresponseMap["results"].([]interface{}); ok {
		ResultsString, _ := json.Marshal(Results)
		json.Unmarshal(ResultsString, &o.Results)
	}
	
	if ErrorCount, ok := BulkprefixesresponseMap["errorCount"].(float64); ok {
		ErrorCountInt := int(ErrorCount)
		o.ErrorCount = &ErrorCountInt
	}
	
	if ErrorIndexes, ok := BulkprefixesresponseMap["errorIndexes"].([]interface{}); ok {
