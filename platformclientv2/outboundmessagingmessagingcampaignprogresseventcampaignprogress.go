...
func (o *Outboundmessagingmessagingcampaignprogresseventcampaignprogress) UnmarshalJSON(b []byte) error {
	...
	if NumberOfContactsSkipped, ok := OutboundmessagingmessagingcampaignprogresseventcampaignprogressMap["numberOfContactsSkipped"].(map[string]interface{}); ok {
	...
	if GetAdditionalProperties, ok := OutboundmessagingmessagingcampaignprogresseventcampaignprogressMap["getAdditionalProperties"].(map[string]interface{}); ok {
