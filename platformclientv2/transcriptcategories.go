...
func (o *Transcriptcategories) SetField(field string, fieldValue interface{}) {
...
func (o Transcriptcategories) MarshalJSON() ([]byte, error) {
...
func (o *Transcriptcategories) UnmarshalJSON(b []byte) error {
	var TranscriptcategoriesMap map[string]interface{}
	err := json.Unmarshal(b, &TranscriptcategoriesMap)
	if err != nil {
		return err
	}
	
	if Includes, ok := TranscriptcategoriesMap["includes"].([]interface{}); ok {
		IncludesString, _ := json.Marshal(Includes)
		json.Unmarshal(IncludesString, &o.Includes)
	}
	
	if Excludes, ok := TranscriptcategoriesMap["excludes"].([]interface{}); ok {
