...
type Workitemsqueueeventsnotificationworkitem struct { 
	...
	// PropertyChanges
	PropertyChanges *[]Workitemsqueueeventsnotificationpropertychange `json:"propertyChanges,omitempty"`
	...
	// Sessions
	Sessions *[]Workitemsqueueeventsnotificationsession `json:"sessions,omitempty"`
...
func (o *Workitemsqueueeventsnotificationworkitem) UnmarshalJSON(b []byte) error {
	...
	if PropertyChanges, ok := WorkitemsqueueeventsnotificationworkitemMap["propertyChanges"].([]interface{}); ok {
	...
	if Sessions, ok := WorkitemsqueueeventsnotificationworkitemMap["sessions"].([]interface{}); ok {
		SessionsString, _ := json.Marshal(Sessions)
		json.Unmarshal(SessionsString, &o.Sessions)
	}
	
	if SkillIds, ok := WorkitemsqueueeventsnotificationworkitemMap["skillIds"].([]interface{}); ok {
		SkillIdsString, _ := json.Marshal(SkillIds)
		json.Unmarshal(SkillIdsString, &o.SkillIds)
	}
	
	if ScriptId, ok := WorkitemsqueueeventsnotificationworkitemMap["scriptId"].(string); ok {
		o.ScriptId = &ScriptId
	}
    
	if WorkbinName, ok := WorkitemsqueueeventsnotificationworkitemMap["workbinName"].(string); ok {
		o.WorkbinName = &WorkbinName
	}
    
	if TypeName, ok := WorkitemsqueueeventsnotificationworkitemMap["typeName"].(string); ok {
		o.TypeName = &TypeName
	}
    
	if PreferredAgentIds, ok := WorkitemsqueueeventsnotificationworkitemMap["preferredAgentIds"].([]interface{}); ok {
		PreferredAgentIdsString, _ := json.Marshal(PreferredAgentIds)
		json.Unmarshal(PreferredAgentIdsString, &o.PreferredAgentIds)
	}
	
	if DivisionId, ok := WorkitemsqueueeventsnotificationworkitemMap["divisionId"].(string); ok {
		o.DivisionId = &DivisionId
	}
    
	if ScoredAgents, ok := WorkitemsqueueeventsnotificationworkitemMap["scoredAgents"].([]interface{}); ok {
