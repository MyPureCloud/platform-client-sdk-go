...
func (o Campaignrulecampaignwaittimesettings) MarshalJSON() ([]byte, error) {
...
func (o *Campaignrulecampaignwaittimesettings) UnmarshalJSON(b []byte) error {
	var CampaignrulecampaignwaittimesettingsMap map[string]interface{}
	err := json.Unmarshal(b, &CampaignrulecampaignwaittimesettingsMap)
	if err != nil {
		return err
	}
