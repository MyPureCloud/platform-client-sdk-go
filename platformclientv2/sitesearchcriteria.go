...
type Sitesearchcriteria struct { 
	...
	Group *[]Sitesearchcriteria `json:"group,omitempty"`
...
func (o *Sitesearchcriteria) SetField(field string, fieldValue interface{}) {
...
func (o Sitesearchcriteria) MarshalJSON() ([]byte, error) {
...
func (o *Sitesearchcriteria) UnmarshalJSON(b []byte) error {
	var SitesearchcriteriaMap map[string]interface{}
	err := json.Unmarshal(b, &SitesearchcriteriaMap)
	if err != nil {
		return err
	}
	
	if EndValue, ok := SitesearchcriteriaMap["endValue"].(string); ok {
		o.EndValue = &EndValue
	}
    
	if Values, ok := SitesearchcriteriaMap["values"].([]interface{}); ok {
		ValuesString, _ := json.Marshal(Values)
		json.Unmarshal(ValuesString, &o.Values)
	}
	
	if StartValue, ok := SitesearchcriteriaMap["startValue"].(string); ok {
		o.StartValue = &StartValue
	}
    
	if Value, ok := SitesearchcriteriaMap["value"].(string); ok {
		o.Value = &Value
	}
    
	if Operator, ok := SitesearchcriteriaMap["operator"].(string); ok {
		o.Operator = &Operator
	}
    
	if Group, ok := SitesearchcriteriaMap["group"].([]interface{}); ok {
		GroupString, _ := json.Marshal(Group)
		json.Unmarshal(GroupString, &o.Group)
	}
	
	if DateFormat, ok := SitesearchcriteriaMap["dateFormat"].(string); ok {
		o.DateFormat = &DateFormat
	}
    
	if VarType, ok := SitesearchcriteriaMap["type"].(string); ok {
		o.VarType = &VarType
	}
    
	if Fields, ok := SitesearchcriteriaMap["fields"].([]interface{}); ok {
