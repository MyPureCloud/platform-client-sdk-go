...
func (o *Dashboardconfigurationbulkrequest) SetField(field string, fieldValue interface{}) {
...
func (o Dashboardconfigurationbulkrequest) MarshalJSON() ([]byte, error) {
...
func (o *Dashboardconfigurationbulkrequest) UnmarshalJSON(b []byte) error {
	var DashboardconfigurationbulkrequestMap map[string]interface{}
	err := json.Unmarshal(b, &DashboardconfigurationbulkrequestMap)
	if err != nil {
		return err
	}
	
	if DashboardConfigurationIds, ok := DashboardconfigurationbulkrequestMap["dashboardConfigurationIds"].([]interface{}); ok {
