...
func (o *Admintimeoffrequestpatch) UnmarshalJSON(b []byte) error {
	...
	if FullDayEarliestStartOffsetMinutes, ok := AdmintimeoffrequestpatchMap["fullDayEarliestStartOffsetMinutes"].(map[string]interface{}); ok {
	...
	if FullDayLatestEndOffsetMinutes, ok := AdmintimeoffrequestpatchMap["fullDayLatestEndOffsetMinutes"].(map[string]interface{}); ok {
