...
func (o *Queueconversationeventtopiccallback) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationeventtopiccallback) UnmarshalJSON(b []byte) error {
	...
	if InitialState, ok := QueueconversationeventtopiccallbackMap["initialState"].(string); ok {
