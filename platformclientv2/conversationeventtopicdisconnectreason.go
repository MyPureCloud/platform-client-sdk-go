...
func (o *Conversationeventtopicdisconnectreason) SetField(field string, fieldValue interface{}) {
...
func (o *Conversationeventtopicdisconnectreason) UnmarshalJSON(b []byte) error {
	...
	if Reason, ok := ConversationeventtopicdisconnectreasonMap["reason"].(string); ok {
		o.Reason = &Reason
	}
