...
func (o *Dialercampaignconfigchangephonecolumn) SetField(field string, fieldValue interface{}) {
...
func (o *Dialercampaignconfigchangephonecolumn) UnmarshalJSON(b []byte) error {
	...
	if GetAdditionalProperties, ok := DialercampaignconfigchangephonecolumnMap["getAdditionalProperties"].(map[string]interface{}); ok {
