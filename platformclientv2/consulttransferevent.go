...
func (o *Consulttransferevent) SetField(field string, fieldValue interface{}) {
...
func (o Consulttransferevent) MarshalJSON() ([]byte, error) {
...
func (o *Consulttransferevent) UnmarshalJSON(b []byte) error {
	var ConsulttransfereventMap map[string]interface{}
	err := json.Unmarshal(b, &ConsulttransfereventMap)
	if err != nil {
		return err
	}
	
	if EventId, ok := ConsulttransfereventMap["eventId"].(string); ok {
		o.EventId = &EventId
	}
    
	if eventDateTimeString, ok := ConsulttransfereventMap["eventDateTime"].(string); ok {
		EventDateTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", eventDateTimeString)
		o.EventDateTime = &EventDateTime
	}
	
	if ConversationId, ok := ConsulttransfereventMap["conversationId"].(string); ok {
		o.ConversationId = &ConversationId
	}
    
	if InitiatingCommunicationId, ok := ConsulttransfereventMap["initiatingCommunicationId"].(string); ok {
		o.InitiatingCommunicationId = &InitiatingCommunicationId
	}
    
	if DestinationCommunicationId, ok := ConsulttransfereventMap["destinationCommunicationId"].(string); ok {
		o.DestinationCommunicationId = &DestinationCommunicationId
	}
    
	if ObjectCommunicationId, ok := ConsulttransfereventMap["objectCommunicationId"].(string); ok {
