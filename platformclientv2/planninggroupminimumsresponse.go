...
func (o *Planninggroupminimumsresponse) SetField(field string, fieldValue interface{}) {
...
func (o Planninggroupminimumsresponse) MarshalJSON() ([]byte, error) {
...
func (o *Planninggroupminimumsresponse) UnmarshalJSON(b []byte) error {
	var PlanninggroupminimumsresponseMap map[string]interface{}
	err := json.Unmarshal(b, &PlanninggroupminimumsresponseMap)
	if err != nil {
		return err
	}
	
	if PlanningGroup, ok := PlanninggroupminimumsresponseMap["planningGroup"].(map[string]interface{}); ok {
		PlanningGroupString, _ := json.Marshal(PlanningGroup)
		json.Unmarshal(PlanningGroupString, &o.PlanningGroup)
	}
	
	if DayOfWeekMinimums, ok := PlanninggroupminimumsresponseMap["dayOfWeekMinimums"].([]interface{}); ok {
