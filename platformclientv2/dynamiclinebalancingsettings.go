...
func (o *Dynamiclinebalancingsettings) SetField(field string, fieldValue interface{}) {
...
func (o Dynamiclinebalancingsettings) MarshalJSON() ([]byte, error) {
...
func (o *Dynamiclinebalancingsettings) UnmarshalJSON(b []byte) error {
	var DynamiclinebalancingsettingsMap map[string]interface{}
	err := json.Unmarshal(b, &DynamiclinebalancingsettingsMap)
	if err != nil {
		return err
	}
	
	if Enabled, ok := DynamiclinebalancingsettingsMap["enabled"].(bool); ok {
		o.Enabled = &Enabled
	}
    
	if RelativeWeight, ok := DynamiclinebalancingsettingsMap["relativeWeight"].(float64); ok {
