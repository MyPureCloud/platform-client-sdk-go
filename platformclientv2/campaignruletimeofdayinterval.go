...
func (o Campaignruletimeofdayinterval) MarshalJSON() ([]byte, error) {
...
func (o *Campaignruletimeofdayinterval) UnmarshalJSON(b []byte) error {
	var CampaignruletimeofdayintervalMap map[string]interface{}
	err := json.Unmarshal(b, &CampaignruletimeofdayintervalMap)
	if err != nil {
		return err
	}
