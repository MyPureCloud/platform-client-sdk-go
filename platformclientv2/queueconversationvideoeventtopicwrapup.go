...
func (o *Queueconversationvideoeventtopicwrapup) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationvideoeventtopicwrapup) UnmarshalJSON(b []byte) error {
	...
	if AdditionalProperties, ok := QueueconversationvideoeventtopicwrapupMap["additionalProperties"].(map[string]interface{}); ok {
