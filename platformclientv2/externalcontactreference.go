...
func (o *Externalcontactreference) SetField(field string, fieldValue interface{}) {
...
func (o Externalcontactreference) MarshalJSON() ([]byte, error) {
...
func (o *Externalcontactreference) UnmarshalJSON(b []byte) error {
	var ExternalcontactreferenceMap map[string]interface{}
	err := json.Unmarshal(b, &ExternalcontactreferenceMap)
	if err != nil {
		return err
	}
