...
func (o *Queryshifttradelistjobrequest) SetField(field string, fieldValue interface{}) {
...
func (o Queryshifttradelistjobrequest) MarshalJSON() ([]byte, error) {
...
func (o *Queryshifttradelistjobrequest) UnmarshalJSON(b []byte) error {
	var QueryshifttradelistjobrequestMap map[string]interface{}
	err := json.Unmarshal(b, &QueryshifttradelistjobrequestMap)
	if err != nil {
		return err
	}
	
	if ManagementUnitIds, ok := QueryshifttradelistjobrequestMap["managementUnitIds"].([]interface{}); ok {
		ManagementUnitIdsString, _ := json.Marshal(ManagementUnitIds)
		json.Unmarshal(ManagementUnitIdsString, &o.ManagementUnitIds)
	}
	
	if WeekDates, ok := QueryshifttradelistjobrequestMap["weekDates"].([]interface{}); ok {
		WeekDatesString, _ := json.Marshal(WeekDates)
		json.Unmarshal(WeekDatesString, &o.WeekDates)
	}
	
	if UserIds, ok := QueryshifttradelistjobrequestMap["userIds"].([]interface{}); ok {
