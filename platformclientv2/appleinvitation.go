...
func (o Appleinvitation) MarshalJSON() ([]byte, error) {
...
func (o *Appleinvitation) UnmarshalJSON(b []byte) error {
	var AppleinvitationMap map[string]interface{}
	err := json.Unmarshal(b, &AppleinvitationMap)
	if err != nil {
		return err
	}
