...
func (o *Knowledgesuggestionconfig) SetField(field string, fieldValue interface{}) {
...
func (o Knowledgesuggestionconfig) MarshalJSON() ([]byte, error) {
...
func (o *Knowledgesuggestionconfig) UnmarshalJSON(b []byte) error {
	var KnowledgesuggestionconfigMap map[string]interface{}
	err := json.Unmarshal(b, &KnowledgesuggestionconfigMap)
	if err != nil {
		return err
	}
	
	if VendorName, ok := KnowledgesuggestionconfigMap["vendorName"].(string); ok {
		o.VendorName = &VendorName
	}
    
	if KnowledgeBase, ok := KnowledgesuggestionconfigMap["knowledgeBase"].(map[string]interface{}); ok {
		KnowledgeBaseString, _ := json.Marshal(KnowledgeBase)
		json.Unmarshal(KnowledgeBaseString, &o.KnowledgeBase)
	}
	
	if KnowledgeBases, ok := KnowledgesuggestionconfigMap["knowledgeBases"].([]interface{}); ok {
		KnowledgeBasesString, _ := json.Marshal(KnowledgeBases)
