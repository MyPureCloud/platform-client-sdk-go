...
func (o *Daily) SetField(field string, fieldValue interface{}) {
...
func (o Daily) MarshalJSON() ([]byte, error) {
...
func (o *Daily) UnmarshalJSON(b []byte) error {
	var DailyMap map[string]interface{}
	err := json.Unmarshal(b, &DailyMap)
	if err != nil {
		return err
	}
	
	if DownloadUrl, ok := DailyMap["downloadUrl"].(string); ok {
		o.DownloadUrl = &DownloadUrl
	}
    
	if DownloadResult, ok := DailyMap["downloadResult"].([]interface{}); ok {
