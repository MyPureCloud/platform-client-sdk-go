...
func (o *Recordingtemplatecard) SetField(field string, fieldValue interface{}) {
...
func (o Recordingtemplatecard) MarshalJSON() ([]byte, error) {
...
func (o *Recordingtemplatecard) UnmarshalJSON(b []byte) error {
	var RecordingtemplatecardMap map[string]interface{}
	err := json.Unmarshal(b, &RecordingtemplatecardMap)
	if err != nil {
		return err
	}
	
	if Header, ok := RecordingtemplatecardMap["header"].(map[string]interface{}); ok {
		HeaderString, _ := json.Marshal(Header)
		json.Unmarshal(HeaderString, &o.Header)
	}
	
	if Body, ok := RecordingtemplatecardMap["body"].(map[string]interface{}); ok {
		BodyString, _ := json.Marshal(Body)
		json.Unmarshal(BodyString, &o.Body)
	}
	
	if Buttons, ok := RecordingtemplatecardMap["buttons"].([]interface{}); ok {
