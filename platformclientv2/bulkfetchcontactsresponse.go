...
type Bulkfetchcontactsresponse struct { 
	...
	Results *[]Bulkresponseresultexternalcontactentitybulkentityerrorentity `json:"results,omitempty"`
...
func (o *Bulkfetchcontactsresponse) SetField(field string, fieldValue interface{}) {
