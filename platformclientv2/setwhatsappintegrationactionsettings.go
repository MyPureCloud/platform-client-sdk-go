...
func (o Setwhatsappintegrationactionsettings) MarshalJSON() ([]byte, error) {
...
func (o *Setwhatsappintegrationactionsettings) UnmarshalJSON(b []byte) error {
	var SetwhatsappintegrationactionsettingsMap map[string]interface{}
	err := json.Unmarshal(b, &SetwhatsappintegrationactionsettingsMap)
	if err != nil {
		return err
	}
