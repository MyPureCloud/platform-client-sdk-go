...
type Queueconversationcalleventtopiccallmediaparticipant struct { 
	...
	// QueueMediaSettings
	QueueMediaSettings *Queueconversationcalleventtopicqueuemediasettings `json:"queueMediaSettings,omitempty"`
	...
	// RecordersState
	RecordersState *Queueconversationcalleventtopicrecordersstate `json:"recordersState,omitempty"`
...
func (o *Queueconversationcalleventtopiccallmediaparticipant) UnmarshalJSON(b []byte) error {
	...
	if ExternalContactInitialDivisionId, ok := QueueconversationcalleventtopiccallmediaparticipantMap["externalContactInitialDivisionId"].(string); ok {
	...
	if resumeTimeString, ok := QueueconversationcalleventtopiccallmediaparticipantMap["resumeTime"].(string); ok {
		ResumeTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", resumeTimeString)
		o.ResumeTime = &ResumeTime
	}
	
	if parkTimeString, ok := QueueconversationcalleventtopiccallmediaparticipantMap["parkTime"].(string); ok {
	...
	if QueueMediaSettings, ok := QueueconversationcalleventtopiccallmediaparticipantMap["queueMediaSettings"].(map[string]interface{}); ok {
	...
	if RecordersState, ok := QueueconversationcalleventtopiccallmediaparticipantMap["recordersState"].(map[string]interface{}); ok {
		RecordersStateString, _ := json.Marshal(RecordersState)
		json.Unmarshal(RecordersStateString, &o.RecordersState)
	}
	
	if Disposition, ok := QueueconversationcalleventtopiccallmediaparticipantMap["disposition"].(map[string]interface{}); ok {
	...
	if PublicIpAddress, ok := QueueconversationcalleventtopiccallmediaparticipantMap["publicIpAddress"].(string); ok {
