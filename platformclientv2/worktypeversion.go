...
type Worktypeversion struct { 
	...
	DefaultLanguage *Workitemlanguagereference `json:"defaultLanguage,omitempty"`
	...
	DefaultSkills *[]Workitemroutingskillreference `json:"defaultSkills,omitempty"`
...
func (o *Worktypeversion) SetField(field string, fieldValue interface{}) {
...
func (o Worktypeversion) MarshalJSON() ([]byte, error) {
...
func (o *Worktypeversion) UnmarshalJSON(b []byte) error {
	var WorktypeversionMap map[string]interface{}
	err := json.Unmarshal(b, &WorktypeversionMap)
	if err != nil {
		return err
	}
	
	if Id, ok := WorktypeversionMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Name, ok := WorktypeversionMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if Division, ok := WorktypeversionMap["division"].(map[string]interface{}); ok {
		DivisionString, _ := json.Marshal(Division)
		json.Unmarshal(DivisionString, &o.Division)
	}
	
	if Description, ok := WorktypeversionMap["description"].(string); ok {
		o.Description = &Description
	}
    
	if dateCreatedString, ok := WorktypeversionMap["dateCreated"].(string); ok {
		DateCreated, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateCreatedString)
		o.DateCreated = &DateCreated
	}
	
	if dateModifiedString, ok := WorktypeversionMap["dateModified"].(string); ok {
		DateModified, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateModifiedString)
		o.DateModified = &DateModified
	}
	
	if DefaultWorkbin, ok := WorktypeversionMap["defaultWorkbin"].(map[string]interface{}); ok {
		DefaultWorkbinString, _ := json.Marshal(DefaultWorkbin)
		json.Unmarshal(DefaultWorkbinString, &o.DefaultWorkbin)
	}
	
	if DefaultStatus, ok := WorktypeversionMap["defaultStatus"].(map[string]interface{}); ok {
		DefaultStatusString, _ := json.Marshal(DefaultStatus)
		json.Unmarshal(DefaultStatusString, &o.DefaultStatus)
	}
	
	if Statuses, ok := WorktypeversionMap["statuses"].([]interface{}); ok {
		StatusesString, _ := json.Marshal(Statuses)
		json.Unmarshal(StatusesString, &o.Statuses)
	}
	
	if DefaultDurationSeconds, ok := WorktypeversionMap["defaultDurationSeconds"].(float64); ok {
		DefaultDurationSecondsInt := int(DefaultDurationSeconds)
		o.DefaultDurationSeconds = &DefaultDurationSecondsInt
	}
	
	if DefaultExpirationSeconds, ok := WorktypeversionMap["defaultExpirationSeconds"].(float64); ok {
		DefaultExpirationSecondsInt := int(DefaultExpirationSeconds)
		o.DefaultExpirationSeconds = &DefaultExpirationSecondsInt
	}
	
	if DefaultDueDurationSeconds, ok := WorktypeversionMap["defaultDueDurationSeconds"].(float64); ok {
		DefaultDueDurationSecondsInt := int(DefaultDueDurationSeconds)
		o.DefaultDueDurationSeconds = &DefaultDueDurationSecondsInt
	}
	
	if DefaultPriority, ok := WorktypeversionMap["defaultPriority"].(float64); ok {
		DefaultPriorityInt := int(DefaultPriority)
		o.DefaultPriority = &DefaultPriorityInt
	}
	
	if DefaultLanguage, ok := WorktypeversionMap["defaultLanguage"].(map[string]interface{}); ok {
		DefaultLanguageString, _ := json.Marshal(DefaultLanguage)
		json.Unmarshal(DefaultLanguageString, &o.DefaultLanguage)
	}
	
	if DefaultTtlSeconds, ok := WorktypeversionMap["defaultTtlSeconds"].(float64); ok {
		DefaultTtlSecondsInt := int(DefaultTtlSeconds)
		o.DefaultTtlSeconds = &DefaultTtlSecondsInt
	}
	
	if ModifiedBy, ok := WorktypeversionMap["modifiedBy"].(map[string]interface{}); ok {
		ModifiedByString, _ := json.Marshal(ModifiedBy)
		json.Unmarshal(ModifiedByString, &o.ModifiedBy)
	}
	
	if DefaultQueue, ok := WorktypeversionMap["defaultQueue"].(map[string]interface{}); ok {
		DefaultQueueString, _ := json.Marshal(DefaultQueue)
		json.Unmarshal(DefaultQueueString, &o.DefaultQueue)
	}
	
	if DefaultSkills, ok := WorktypeversionMap["defaultSkills"].([]interface{}); ok {
		DefaultSkillsString, _ := json.Marshal(DefaultSkills)
		json.Unmarshal(DefaultSkillsString, &o.DefaultSkills)
	}
	
	if AssignmentEnabled, ok := WorktypeversionMap["assignmentEnabled"].(bool); ok {
	...
	if SelfUri, ok := WorktypeversionMap["selfUri"].(string); ok {
		o.SelfUri = &SelfUri
	}
