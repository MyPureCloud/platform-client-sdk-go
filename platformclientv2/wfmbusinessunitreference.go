...
func (o *Wfmbusinessunitreference) SetField(field string, fieldValue interface{}) {
...
func (o *Wfmbusinessunitreference) UnmarshalJSON(b []byte) error {
	var WfmbusinessunitreferenceMap map[string]interface{}
	err := json.Unmarshal(b, &WfmbusinessunitreferenceMap)
	if err != nil {
		return err
	}
	
	if Id, ok := WfmbusinessunitreferenceMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if SelfUri, ok := WfmbusinessunitreferenceMap["selfUri"].(string); ok {
		o.SelfUri = &SelfUri
	}
