...
func (o *Dataextractionfileschema) SetField(field string, fieldValue interface{}) {
...
func (o Dataextractionfileschema) MarshalJSON() ([]byte, error) {
...
func (o *Dataextractionfileschema) UnmarshalJSON(b []byte) error {
	var DataextractionfileschemaMap map[string]interface{}
	err := json.Unmarshal(b, &DataextractionfileschemaMap)
	if err != nil {
		return err
	}
	
	if Id, ok := DataextractionfileschemaMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if DataSchema, ok := DataextractionfileschemaMap["dataSchema"].(string); ok {
		o.DataSchema = &DataSchema
	}
    
	if dateCreatedString, ok := DataextractionfileschemaMap["dateCreated"].(string); ok {
		DateCreated, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateCreatedString)
		o.DateCreated = &DateCreated
	}
	
	if dateExpiresString, ok := DataextractionfileschemaMap["dateExpires"].(string); ok {
