...
type Emergencygroupdivisionviewentitylisting struct { 
	...
	// Entities
	Entities *[]Emergencygroupdivisionview `json:"entities,omitempty"`
...
func (o *Emergencygroupdivisionviewentitylisting) SetField(field string, fieldValue interface{}) {
...
func (o Emergencygroupdivisionviewentitylisting) MarshalJSON() ([]byte, error) {
...
func (o *Emergencygroupdivisionviewentitylisting) UnmarshalJSON(b []byte) error {
	var EmergencygroupdivisionviewentitylistingMap map[string]interface{}
	err := json.Unmarshal(b, &EmergencygroupdivisionviewentitylistingMap)
	if err != nil {
		return err
	}
	
	if Entities, ok := EmergencygroupdivisionviewentitylistingMap["entities"].([]interface{}); ok {
		EntitiesString, _ := json.Marshal(Entities)
		json.Unmarshal(EntitiesString, &o.Entities)
	}
	
	if PageSize, ok := EmergencygroupdivisionviewentitylistingMap["pageSize"].(float64); ok {
		PageSizeInt := int(PageSize)
		o.PageSize = &PageSizeInt
	}
	
	if PageNumber, ok := EmergencygroupdivisionviewentitylistingMap["pageNumber"].(float64); ok {
		PageNumberInt := int(PageNumber)
		o.PageNumber = &PageNumberInt
	}
	
	if Total, ok := EmergencygroupdivisionviewentitylistingMap["total"].(float64); ok {
		TotalInt := int(Total)
		o.Total = &TotalInt
	}
	
	if TotalNumberOfEntities, ok := EmergencygroupdivisionviewentitylistingMap["totalNumberOfEntities"].(float64); ok {
