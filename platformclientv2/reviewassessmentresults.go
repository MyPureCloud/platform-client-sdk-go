...
func (o Reviewassessmentresults) MarshalJSON() ([]byte, error) {
...
func (o *Reviewassessmentresults) UnmarshalJSON(b []byte) error {
	var ReviewassessmentresultsMap map[string]interface{}
	err := json.Unmarshal(b, &ReviewassessmentresultsMap)
	if err != nil {
		return err
	}
