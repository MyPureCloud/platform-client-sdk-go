...
type Snapshotmetadata struct { 
	...
	DownloadResult *Snapshotmetadataresult `json:"downloadResult,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Snapshotmetadata) SetField(field string, fieldValue interface{}) {
...
func (o *Snapshotmetadata) UnmarshalJSON(b []byte) error {
	var SnapshotmetadataMap map[string]interface{}
	err := json.Unmarshal(b, &SnapshotmetadataMap)
	if err != nil {
		return err
	}
	
	if DownloadUrl, ok := SnapshotmetadataMap["downloadUrl"].(string); ok {
		o.DownloadUrl = &DownloadUrl
	}
    
	if DownloadResult, ok := SnapshotmetadataMap["downloadResult"].(map[string]interface{}); ok {
