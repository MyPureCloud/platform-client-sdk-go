...
func (o *Campaigndiagnosticcampaignhealthstate) SetField(field string, fieldValue interface{}) {
...
func (o Campaigndiagnosticcampaignhealthstate) MarshalJSON() ([]byte, error) {
...
func (o *Campaigndiagnosticcampaignhealthstate) UnmarshalJSON(b []byte) error {
	var CampaigndiagnosticcampaignhealthstateMap map[string]interface{}
	err := json.Unmarshal(b, &CampaigndiagnosticcampaignhealthstateMap)
	if err != nil {
		return err
	}
	
	if State, ok := CampaigndiagnosticcampaignhealthstateMap["state"].(string); ok {
		o.State = &State
	}
    
	if dateStartString, ok := CampaigndiagnosticcampaignhealthstateMap["dateStart"].(string); ok {
		DateStart, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateStartString)
		o.DateStart = &DateStart
	}
	
	if dateEndString, ok := CampaigndiagnosticcampaignhealthstateMap["dateEnd"].(string); ok {
