...
func (o *Appleinvitationnotificationparameters) SetField(field string, fieldValue interface{}) {
...
func (o Appleinvitationnotificationparameters) MarshalJSON() ([]byte, error) {
...
func (o *Appleinvitationnotificationparameters) UnmarshalJSON(b []byte) error {
	var AppleinvitationnotificationparametersMap map[string]interface{}
	err := json.Unmarshal(b, &AppleinvitationnotificationparametersMap)
	if err != nil {
		return err
	}
	
	if ReferenceId, ok := AppleinvitationnotificationparametersMap["referenceId"].(string); ok {
