...
func (a QualityApi) DeleteAnalyticsEvaluationsAggregatesJob(jobId string) (*APIResponse, error) {
	...
	if &jobId == nil {
		// false
		return nil, errors.New("Missing required parameter 'jobId' when calling QualityApi->DeleteAnalyticsEvaluationsAggregatesJob")
	}
...
func (a QualityApi) DeleteAnalyticsSurveysAggregatesJob(jobId string) (*APIResponse, error) {
	...
	if &jobId == nil {
		// false
		return nil, errors.New("Missing required parameter 'jobId' when calling QualityApi->DeleteAnalyticsSurveysAggregatesJob")
	}
...
// DeleteQualityProgramAgentscoringrule invokes DELETE /api/v2/quality/programs/{programId}/agentscoringrules/{ruleId}
//
// Delete an Agent Scoring Rule
func (a QualityApi) DeleteQualityProgramAgentscoringrule(programId string, ruleId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/quality/programs/{programId}/agentscoringrules/{ruleId}"
	...
	if &programId == nil {
		// false
		return nil, errors.New("Missing required parameter 'programId' when calling QualityApi->DeleteQualityProgramAgentscoringrule")
	}
	// verify the required parameter 'ruleId' is set
	if &ruleId == nil {
		// false
		return nil, errors.New("Missing required parameter 'ruleId' when calling QualityApi->DeleteQualityProgramAgentscoringrule")
	}
...
func (a QualityApi) GetAnalyticsEvaluationsAggregatesJob(jobId string) (*Asyncquerystatus, *APIResponse, error) {
	...
	if &jobId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'jobId' when calling QualityApi->GetAnalyticsEvaluationsAggregatesJob")
	}
...
func (a QualityApi) GetAnalyticsEvaluationsAggregatesJobResults(jobId string, cursor string) (*Evaluationasyncaggregatequeryresponse, *APIResponse, error) {
	...
	if &jobId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'jobId' when calling QualityApi->GetAnalyticsEvaluationsAggregatesJobResults")
	}
...
func (a QualityApi) GetAnalyticsSurveysAggregatesJob(jobId string) (*Asyncquerystatus, *APIResponse, error) {
	...
	if &jobId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'jobId' when calling QualityApi->GetAnalyticsSurveysAggregatesJob")
	}
...
func (a QualityApi) GetAnalyticsSurveysAggregatesJobResults(jobId string, cursor string) (*Surveyasyncaggregatequeryresponse, *APIResponse, error) {
	...
	if &jobId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'jobId' when calling QualityApi->GetAnalyticsSurveysAggregatesJobResults")
	}
...
func (a QualityApi) GetQualityAgentsActivity(pageSize int, pageNumber int, sortBy string, expand []string, nextPage string, previousPage string, startTime time.Time, endTime time.Time, agentUserId []string, evaluatorUserId string, name string, group string, agentTeamId string, formContextId string, userState string) (*Agentactivityentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	...
	queryParams["agentTeamId"] = a.Configuration.APIClient.ParameterToString(agentTeamId, "")
	
	queryParams["formContextId"] = a.Configuration.APIClient.ParameterToString(formContextId, "")
	
	queryParams["userState"] = a.Configuration.APIClient.ParameterToString(userState, "")
...
func (a QualityApi) GetQualityConversationsAuditsQueryTransactionId(transactionId string) (*Qualityauditqueryexecutionstatusresponse, *APIResponse, error) {
	...
	var successPayload *Qualityauditqueryexecutionstatusresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
func (a QualityApi) GetQualityConversationsAuditsQueryTransactionIdResults(transactionId string, cursor string, pageSize int, expand []string) (*Qualityauditqueryexecutionresultsresponse, *APIResponse, error) {
	...
	var successPayload *Qualityauditqueryexecutionresultsresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
func (a QualityApi) GetQualityEvaluationsQuery(pageSize int, pageNumber int, expand []string, previousPage string, conversationId string, agentUserId string, agentTeamId string, evaluatorUserId string, assigneeUserId string, queueId string, startTime string, endTime string, formContextId string, evaluationState []string, isReleased bool, agentHasRead bool, expandAnswerTotalScores bool, maximum int, sortOrder string, includeDeletedUsers bool) (*Evaluationentitylisting, *APIResponse, error) {
	...
	queryParams["includeDeletedUsers"] = a.Configuration.APIClient.ParameterToString(includeDeletedUsers, "")
...
func (a QualityApi) GetQualityFormVersions(formId string, pageSize int, pageNumber int, sortOrder string) (*Evaluationformresponseentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
...
// GetQualityFormsEvaluationsBulk invokes GET /api/v2/quality/forms/evaluations/bulk
//
// Retrieve a list of evaluation forms by their ids
func (a QualityApi) GetQualityFormsEvaluationsBulk(id []string, includeLatestVersionFormName bool) (*Evaluationformresponseentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/quality/forms/evaluations/bulk"
	defaultReturn := new(Evaluationformresponseentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &id == nil {
		// true
		return defaultReturn, nil, errors.New("Missing required parameter 'id' when calling QualityApi->GetQualityFormsEvaluationsBulk")
	}
	...
	queryParams["includeLatestVersionFormName"] = a.Configuration.APIClient.ParameterToString(includeLatestVersionFormName, "")
...
func (a QualityApi) GetQualityFormsEvaluationsBulkContexts(contextId []string) ([]Evaluationformresponse, *APIResponse, error) {
	...
	if &contextId == nil {
		// true
		return defaultReturn, nil, errors.New("Missing required parameter 'contextId' when calling QualityApi->GetQualityFormsEvaluationsBulkContexts")
	}
...
// GetQualityProgramAgentscoringrule invokes GET /api/v2/quality/programs/{programId}/agentscoringrules/{ruleId}
//
// Get an Agent Scoring Rule
func (a QualityApi) GetQualityProgramAgentscoringrule(programId string, ruleId string) (*Agentscoringrule, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/quality/programs/{programId}/agentscoringrules/{ruleId}"
	path = strings.Replace(path, "{programId}", url.PathEscape(fmt.Sprintf("%v", programId)), -1)
	path = strings.Replace(path, "{ruleId}", url.PathEscape(fmt.Sprintf("%v", ruleId)), -1)
	defaultReturn := new(Agentscoringrule)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &programId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'programId' when calling QualityApi->GetQualityProgramAgentscoringrule")
	}
	// verify the required parameter 'ruleId' is set
	if &ruleId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'ruleId' when calling QualityApi->GetQualityProgramAgentscoringrule")
	}
	...
	var successPayload *Agentscoringrule
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
// GetQualityProgramAgentscoringrules invokes GET /api/v2/quality/programs/{programId}/agentscoringrules
//
// Get Agent Scoring Rules for a program
func (a QualityApi) GetQualityProgramAgentscoringrules(programId string) (*Agentscoringruleentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/quality/programs/{programId}/agentscoringrules"
	path = strings.Replace(path, "{programId}", url.PathEscape(fmt.Sprintf("%v", programId)), -1)
	defaultReturn := new(Agentscoringruleentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &programId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'programId' when calling QualityApi->GetQualityProgramAgentscoringrules")
	}
	...
	var successPayload *Agentscoringruleentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Agentscoringruleentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetQualityPublishedformsEvaluationsDivisionview invokes GET /api/v2/quality/publishedforms/evaluations/divisionviews/{evaluationFormId}
//
// Get the most recent published version of an evaluation form across any division.
func (a QualityApi) GetQualityPublishedformsEvaluationsDivisionview(evaluationFormId string) (*Evaluationformdivisionview, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/quality/publishedforms/evaluations/divisionviews/{evaluationFormId}"
	path = strings.Replace(path, "{evaluationFormId}", url.PathEscape(fmt.Sprintf("%v", evaluationFormId)), -1)
	defaultReturn := new(Evaluationformdivisionview)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}

	// verify the required parameter 'evaluationFormId' is set
	if &evaluationFormId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'evaluationFormId' when calling QualityApi->GetQualityPublishedformsEvaluationsDivisionview")
	}
	...
	var successPayload *Evaluationformdivisionview
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Evaluationformdivisionview" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetQualityPublishedformsEvaluationsDivisionviews invokes GET /api/v2/quality/publishedforms/evaluations/divisionviews
//
// Get the published evaluation forms across any division.
func (a QualityApi) GetQualityPublishedformsEvaluationsDivisionviews(id []string, pageSize int, pageNumber int, name string, divisionId string) (*Evaluationformdivisionviewlisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/quality/publishedforms/evaluations/divisionviews"
	defaultReturn := new(Evaluationformdivisionviewlisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &id == nil {
		// true
		return defaultReturn, nil, errors.New("Missing required parameter 'id' when calling QualityApi->GetQualityPublishedformsEvaluationsDivisionviews")
	}
	...
	var successPayload *Evaluationformdivisionviewlisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Evaluationformdivisionviewlisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetQualityPublishedformsSurveysDivisionview invokes GET /api/v2/quality/publishedforms/surveys/divisionviews/{surveyFormId}
//
// Get the most recent published version of an enabled survey form across any division.
func (a QualityApi) GetQualityPublishedformsSurveysDivisionview(surveyFormId string) (*Surveyformdivisionview, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/quality/publishedforms/surveys/divisionviews/{surveyFormId}"
	path = strings.Replace(path, "{surveyFormId}", url.PathEscape(fmt.Sprintf("%v", surveyFormId)), -1)
	defaultReturn := new(Surveyformdivisionview)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &surveyFormId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'surveyFormId' when calling QualityApi->GetQualityPublishedformsSurveysDivisionview")
	}
	...
	var successPayload *Surveyformdivisionview
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Surveyformdivisionview" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetQualityPublishedformsSurveysDivisionviews invokes GET /api/v2/quality/publishedforms/surveys/divisionviews
//
// Get the published and enabled survey forms across any division.
func (a QualityApi) GetQualityPublishedformsSurveysDivisionviews(id []string, pageSize int, pageNumber int, name string, divisionId string) (*Surveyformdivisionviewlisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/quality/publishedforms/surveys/divisionviews"
	defaultReturn := new(Surveyformdivisionviewlisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &id == nil {
		// true
		return defaultReturn, nil, errors.New("Missing required parameter 'id' when calling QualityApi->GetQualityPublishedformsSurveysDivisionviews")
	}
	...
	var successPayload *Surveyformdivisionviewlisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Surveyformdivisionviewlisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a QualityApi) PostAnalyticsEvaluationsAggregatesJobs(body Evaluationasyncaggregationquery) (*Asyncqueryresponse, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling QualityApi->PostAnalyticsEvaluationsAggregatesJobs")
	}
...
func (a QualityApi) PostAnalyticsSurveysAggregatesJobs(body Surveyasyncaggregationquery) (*Asyncqueryresponse, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling QualityApi->PostAnalyticsSurveysAggregatesJobs")
	}
...
func (a QualityApi) PostQualityConversationsAuditsQuery(body Qmauditqueryrequest) (*Qualityauditqueryexecutionstatusresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/quality/conversations/audits/query"
	defaultReturn := new(Qualityauditqueryexecutionstatusresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
func (a QualityApi) PostQualityEvaluationsAggregatesQueryMe(body Evaluationaggregationqueryme) (*Evaluationaggregatequeryresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/quality/evaluations/aggregates/query/me"
	defaultReturn := new(Evaluationaggregatequeryresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
// PostQualityEvaluationsSearch invokes POST /api/v2/quality/evaluations/search
//
...
func (a QualityApi) PostQualityEvaluationsSearch(body Evaluationsearchrequestdto) (*Evaluationsearchresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/quality/evaluations/search"
	defaultReturn := new(Evaluationsearchresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling QualityApi->PostQualityEvaluationsSearch")
	}
	...
	var successPayload *Evaluationsearchresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Evaluationsearchresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostQualityProgramAgentscoringrules invokes POST /api/v2/quality/programs/{programId}/agentscoringrules
//
...
func (a QualityApi) PostQualityProgramAgentscoringrules(programId string, body Agentscoringrule) (*Agentscoringrule, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/quality/programs/{programId}/agentscoringrules"
	path = strings.Replace(path, "{programId}", url.PathEscape(fmt.Sprintf("%v", programId)), -1)
	...
	if &programId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'programId' when calling QualityApi->PostQualityProgramAgentscoringrules")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling QualityApi->PostQualityProgramAgentscoringrules")
	}
...
func (a QualityApi) PostQualitySurveys(body Createsurveyrequest) (*Createsurveyresponse, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling QualityApi->PostQualitySurveys")
	}
...
// PutQualityProgramAgentscoringrule invokes PUT /api/v2/quality/programs/{programId}/agentscoringrules/{ruleId}
//
// Update an Agent Scoring Rule
func (a QualityApi) PutQualityProgramAgentscoringrule(programId string, ruleId string, body Agentscoringrule) (*Agentscoringrule, *APIResponse, error) {
	var httpMethod = "PUT"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/quality/programs/{programId}/agentscoringrules/{ruleId}"
	path = strings.Replace(path, "{programId}", url.PathEscape(fmt.Sprintf("%v", programId)), -1)
	...
	if &programId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'programId' when calling QualityApi->PutQualityProgramAgentscoringrule")
	}
	// verify the required parameter 'ruleId' is set
	if &ruleId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'ruleId' when calling QualityApi->PutQualityProgramAgentscoringrule")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling QualityApi->PutQualityProgramAgentscoringrule")
	}
