...
func (o *Queueconversationemaileventtopicemailmediaparticipant) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationemaileventtopicemailmediaparticipant) UnmarshalJSON(b []byte) error {
	...
	if ExternalContactInitialDivisionId, ok := QueueconversationemaileventtopicemailmediaparticipantMap["externalContactInitialDivisionId"].(string); ok {
	...
	if resumeTimeString, ok := QueueconversationemaileventtopicemailmediaparticipantMap["resumeTime"].(string); ok {
		ResumeTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", resumeTimeString)
		o.ResumeTime = &ResumeTime
	}
	
	if parkTimeString, ok := QueueconversationemaileventtopicemailmediaparticipantMap["parkTime"].(string); ok {
