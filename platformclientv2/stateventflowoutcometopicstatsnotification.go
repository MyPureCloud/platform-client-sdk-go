...
type Stateventflowoutcometopicstatsnotification struct { 
	...
	// Data
	Data *[]Stateventflowoutcometopicintervalmetrics `json:"data,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Stateventflowoutcometopicstatsnotification) SetField(field string, fieldValue interface{}) {
