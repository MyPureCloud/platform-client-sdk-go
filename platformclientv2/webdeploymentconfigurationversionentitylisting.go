...
func (o *Webdeploymentconfigurationversionentitylisting) SetField(field string, fieldValue interface{}) {
...
func (o *Webdeploymentconfigurationversionentitylisting) UnmarshalJSON(b []byte) error {
	...
	if NextUri, ok := WebdeploymentconfigurationversionentitylistingMap["nextUri"].(string); ok {
		o.NextUri = &NextUri
	}
	...
	if PreviousUri, ok := WebdeploymentconfigurationversionentitylistingMap["previousUri"].(string); ok {
