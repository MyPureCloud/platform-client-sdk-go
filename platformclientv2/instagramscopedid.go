...
func (o *Instagramscopedid) SetField(field string, fieldValue interface{}) {
...
func (o Instagramscopedid) MarshalJSON() ([]byte, error) {
...
func (o *Instagramscopedid) UnmarshalJSON(b []byte) error {
	var InstagramscopedidMap map[string]interface{}
	err := json.Unmarshal(b, &InstagramscopedidMap)
	if err != nil {
		return err
	}
	
	if ScopedId, ok := InstagramscopedidMap["scopedId"].(string); ok {
		o.ScopedId = &ScopedId
	}
