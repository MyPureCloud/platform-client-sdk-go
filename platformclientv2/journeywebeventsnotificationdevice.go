...
func (o *Journeywebeventsnotificationdevice) SetField(field string, fieldValue interface{}) {
...
func (o *Journeywebeventsnotificationdevice) UnmarshalJSON(b []byte) error {
	...
	if ScreenDensity, ok := JourneywebeventsnotificationdeviceMap["screenDensity"].(float64); ok {
	...
	if Manufacturer, ok := JourneywebeventsnotificationdeviceMap["manufacturer"].(string); ok {
