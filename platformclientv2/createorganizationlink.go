...
func (o *Createorganizationlink) SetField(field string, fieldValue interface{}) {
...
func (o Createorganizationlink) MarshalJSON() ([]byte, error) {
...
func (o *Createorganizationlink) UnmarshalJSON(b []byte) error {
	var CreateorganizationlinkMap map[string]interface{}
	err := json.Unmarshal(b, &CreateorganizationlinkMap)
	if err != nil {
		return err
	}
	
	if TargetOrganizationId, ok := CreateorganizationlinkMap["targetOrganizationId"].(string); ok {
		o.TargetOrganizationId = &TargetOrganizationId
	}
    
	if TargetRegion, ok := CreateorganizationlinkMap["targetRegion"].(string); ok {
