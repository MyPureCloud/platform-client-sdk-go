...
func (a InfrastructureAsCodeApi) GetInfrastructureascodeJobs(maxResults int, includeErrors bool, sortBy string, sortOrder string) (*Infrastructureascodejob, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
