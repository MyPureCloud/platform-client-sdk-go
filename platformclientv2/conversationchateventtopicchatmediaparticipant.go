...
type Conversationchateventtopicchatmediaparticipant struct { 
	...
	// QueueMediaSettings
	QueueMediaSettings *Conversationchateventtopicqueuemediasettings `json:"queueMediaSettings,omitempty"`
...
func (o *Conversationchateventtopicchatmediaparticipant) SetField(field string, fieldValue interface{}) {
...
func (o *Conversationchateventtopicchatmediaparticipant) UnmarshalJSON(b []byte) error {
	...
	if InitialState, ok := ConversationchateventtopicchatmediaparticipantMap["initialState"].(string); ok {
	...
	if ExternalContactInitialDivisionId, ok := ConversationchateventtopicchatmediaparticipantMap["externalContactInitialDivisionId"].(string); ok {
	...
	if resumeTimeString, ok := ConversationchateventtopicchatmediaparticipantMap["resumeTime"].(string); ok {
		ResumeTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", resumeTimeString)
		o.ResumeTime = &ResumeTime
	}
	
	if parkTimeString, ok := ConversationchateventtopicchatmediaparticipantMap["parkTime"].(string); ok {
	...
	if QueueMediaSettings, ok := ConversationchateventtopicchatmediaparticipantMap["queueMediaSettings"].(map[string]interface{}); ok {
