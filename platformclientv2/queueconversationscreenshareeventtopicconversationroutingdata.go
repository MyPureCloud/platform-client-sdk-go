...
type Queueconversationscreenshareeventtopicconversationroutingdata struct { 
	...
	SkillExpressionId *Queueconversationscreenshareeventtopicurireference `json:"skillExpressionId,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Queueconversationscreenshareeventtopicconversationroutingdata) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationscreenshareeventtopicconversationroutingdata) UnmarshalJSON(b []byte) error {
	...
	if SkillExpressionId, ok := QueueconversationscreenshareeventtopicconversationroutingdataMap["skillExpressionId"].(map[string]interface{}); ok {
