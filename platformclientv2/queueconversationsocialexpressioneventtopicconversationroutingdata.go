...
type Queueconversationsocialexpressioneventtopicconversationroutingdata struct { 
	...
	SkillExpressionId *Queueconversationsocialexpressioneventtopicurireference `json:"skillExpressionId,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Queueconversationsocialexpressioneventtopicconversationroutingdata) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationsocialexpressioneventtopicconversationroutingdata) UnmarshalJSON(b []byte) error {
	...
	if SkillExpressionId, ok := QueueconversationsocialexpressioneventtopicconversationroutingdataMap["skillExpressionId"].(map[string]interface{}); ok {
