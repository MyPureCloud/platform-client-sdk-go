...
type Internalmessagemediaparticipant struct { 
	...
	InternalMessageId *string `json:"internalMessageId,omitempty"`
	...
	SourceUser *Addressableentityref `json:"sourceUser,omitempty"`
...
func (o *Internalmessagemediaparticipant) SetField(field string, fieldValue interface{}) {
...
func (o Internalmessagemediaparticipant) MarshalJSON() ([]byte, error) {
	...
	return json.Marshal(&struct { 
		...
		InternalMessageId: o.InternalMessageId,
...
func (o *Internalmessagemediaparticipant) UnmarshalJSON(b []byte) error {
	var InternalmessagemediaparticipantMap map[string]interface{}
	err := json.Unmarshal(b, &InternalmessagemediaparticipantMap)
	if err != nil {
		return err
	}
	
	if Id, ok := InternalmessagemediaparticipantMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Name, ok := InternalmessagemediaparticipantMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if Address, ok := InternalmessagemediaparticipantMap["address"].(string); ok {
		o.Address = &Address
	}
    
	if startTimeString, ok := InternalmessagemediaparticipantMap["startTime"].(string); ok {
		StartTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", startTimeString)
		o.StartTime = &StartTime
	}
	
	if startAlertingTimeString, ok := InternalmessagemediaparticipantMap["startAlertingTime"].(string); ok {
		StartAlertingTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", startAlertingTimeString)
		o.StartAlertingTime = &StartAlertingTime
	}
	
	if connectedTimeString, ok := InternalmessagemediaparticipantMap["connectedTime"].(string); ok {
		ConnectedTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", connectedTimeString)
		o.ConnectedTime = &ConnectedTime
	}
	
	if endTimeString, ok := InternalmessagemediaparticipantMap["endTime"].(string); ok {
		EndTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", endTimeString)
		o.EndTime = &EndTime
	}
	
	if startHoldTimeString, ok := InternalmessagemediaparticipantMap["startHoldTime"].(string); ok {
		StartHoldTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", startHoldTimeString)
		o.StartHoldTime = &StartHoldTime
	}
	
	if Purpose, ok := InternalmessagemediaparticipantMap["purpose"].(string); ok {
		o.Purpose = &Purpose
	}
    
	if State, ok := InternalmessagemediaparticipantMap["state"].(string); ok {
		o.State = &State
	}
    
	if Direction, ok := InternalmessagemediaparticipantMap["direction"].(string); ok {
		o.Direction = &Direction
	}
    
	if DisconnectType, ok := InternalmessagemediaparticipantMap["disconnectType"].(string); ok {
		o.DisconnectType = &DisconnectType
	}
    
	if Held, ok := InternalmessagemediaparticipantMap["held"].(bool); ok {
		o.Held = &Held
	}
    
	if WrapupRequired, ok := InternalmessagemediaparticipantMap["wrapupRequired"].(bool); ok {
		o.WrapupRequired = &WrapupRequired
	}
    
	if WrapupPrompt, ok := InternalmessagemediaparticipantMap["wrapupPrompt"].(string); ok {
		o.WrapupPrompt = &WrapupPrompt
	}
    
	if MediaRoles, ok := InternalmessagemediaparticipantMap["mediaRoles"].([]interface{}); ok {
		MediaRolesString, _ := json.Marshal(MediaRoles)
		json.Unmarshal(MediaRolesString, &o.MediaRoles)
	}
	
	if User, ok := InternalmessagemediaparticipantMap["user"].(map[string]interface{}); ok {
		UserString, _ := json.Marshal(User)
		json.Unmarshal(UserString, &o.User)
	}
	
	if Queue, ok := InternalmessagemediaparticipantMap["queue"].(map[string]interface{}); ok {
		QueueString, _ := json.Marshal(Queue)
		json.Unmarshal(QueueString, &o.Queue)
	}
	
	if Team, ok := InternalmessagemediaparticipantMap["team"].(map[string]interface{}); ok {
		TeamString, _ := json.Marshal(Team)
		json.Unmarshal(TeamString, &o.Team)
	}
	
	if Attributes, ok := InternalmessagemediaparticipantMap["attributes"].(map[string]interface{}); ok {
		AttributesString, _ := json.Marshal(Attributes)
		json.Unmarshal(AttributesString, &o.Attributes)
	}
	
	if ErrorInfo, ok := InternalmessagemediaparticipantMap["errorInfo"].(map[string]interface{}); ok {
		ErrorInfoString, _ := json.Marshal(ErrorInfo)
		json.Unmarshal(ErrorInfoString, &o.ErrorInfo)
	}
	
	if Script, ok := InternalmessagemediaparticipantMap["script"].(map[string]interface{}); ok {
		ScriptString, _ := json.Marshal(Script)
		json.Unmarshal(ScriptString, &o.Script)
	}
	
	if WrapupTimeoutMs, ok := InternalmessagemediaparticipantMap["wrapupTimeoutMs"].(float64); ok {
		WrapupTimeoutMsInt := int(WrapupTimeoutMs)
		o.WrapupTimeoutMs = &WrapupTimeoutMsInt
	}
	
	if WrapupSkipped, ok := InternalmessagemediaparticipantMap["wrapupSkipped"].(bool); ok {
		o.WrapupSkipped = &WrapupSkipped
	}
    
	if AlertingTimeoutMs, ok := InternalmessagemediaparticipantMap["alertingTimeoutMs"].(float64); ok {
		AlertingTimeoutMsInt := int(AlertingTimeoutMs)
		o.AlertingTimeoutMs = &AlertingTimeoutMsInt
	}
	
	if Provider, ok := InternalmessagemediaparticipantMap["provider"].(string); ok {
		o.Provider = &Provider
	}
    
	if ExternalContact, ok := InternalmessagemediaparticipantMap["externalContact"].(map[string]interface{}); ok {
		ExternalContactString, _ := json.Marshal(ExternalContact)
		json.Unmarshal(ExternalContactString, &o.ExternalContact)
	}
	
	if ExternalContactInitialDivisionId, ok := InternalmessagemediaparticipantMap["externalContactInitialDivisionId"].(string); ok {
		o.ExternalContactInitialDivisionId = &ExternalContactInitialDivisionId
	}
    
	if ExternalOrganization, ok := InternalmessagemediaparticipantMap["externalOrganization"].(map[string]interface{}); ok {
	...
	if Wrapup, ok := InternalmessagemediaparticipantMap["wrapup"].(map[string]interface{}); ok {
		WrapupString, _ := json.Marshal(Wrapup)
		json.Unmarshal(WrapupString, &o.Wrapup)
	}
	
	if Peer, ok := InternalmessagemediaparticipantMap["peer"].(string); ok {
		o.Peer = &Peer
	}
    
	if FlaggedReason, ok := InternalmessagemediaparticipantMap["flaggedReason"].(string); ok {
		o.FlaggedReason = &FlaggedReason
	}
    
	if JourneyContext, ok := InternalmessagemediaparticipantMap["journeyContext"].(map[string]interface{}); ok {
		JourneyContextString, _ := json.Marshal(JourneyContext)
		json.Unmarshal(JourneyContextString, &o.JourneyContext)
	}
	
	if ConversationRoutingData, ok := InternalmessagemediaparticipantMap["conversationRoutingData"].(map[string]interface{}); ok {
	...
	if startAcwTimeString, ok := InternalmessagemediaparticipantMap["startAcwTime"].(string); ok {
		StartAcwTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", startAcwTimeString)
		o.StartAcwTime = &StartAcwTime
	}
	
	if endAcwTimeString, ok := InternalmessagemediaparticipantMap["endAcwTime"].(string); ok {
		EndAcwTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", endAcwTimeString)
		o.EndAcwTime = &EndAcwTime
	}
	
	if parkTimeString, ok := InternalmessagemediaparticipantMap["parkTime"].(string); ok {
		ParkTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", parkTimeString)
		o.ParkTime = &ParkTime
	}
	
	if resumeTimeString, ok := InternalmessagemediaparticipantMap["resumeTime"].(string); ok {
		ResumeTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", resumeTimeString)
		o.ResumeTime = &ResumeTime
	}
	
	if InternalMessageId, ok := InternalmessagemediaparticipantMap["internalMessageId"].(string); ok {
		o.InternalMessageId = &InternalMessageId
	}
    
	if TargetUser, ok := InternalmessagemediaparticipantMap["targetUser"].(map[string]interface{}); ok {
		TargetUserString, _ := json.Marshal(TargetUser)
		json.Unmarshal(TargetUserString, &o.TargetUser)
	}
	
	if SourceUser, ok := InternalmessagemediaparticipantMap["sourceUser"].(map[string]interface{}); ok {
		SourceUserString, _ := json.Marshal(SourceUser)
		json.Unmarshal(SourceUserString, &o.SourceUser)
	}
	
	if ToAddress, ok := InternalmessagemediaparticipantMap["toAddress"].(map[string]interface{}); ok {
		ToAddressString, _ := json.Marshal(ToAddress)
		json.Unmarshal(ToAddressString, &o.ToAddress)
	}
	
	if FromAddress, ok := InternalmessagemediaparticipantMap["fromAddress"].(map[string]interface{}); ok {
		FromAddressString, _ := json.Marshal(FromAddress)
		json.Unmarshal(FromAddressString, &o.FromAddress)
	}
	
	if Messages, ok := InternalmessagemediaparticipantMap["messages"].([]interface{}); ok {
