...
func (o *Valuewrapperinstant) SetField(field string, fieldValue interface{}) {
...
func (o Valuewrapperinstant) MarshalJSON() ([]byte, error) {
...
func (o *Valuewrapperinstant) UnmarshalJSON(b []byte) error {
	var ValuewrapperinstantMap map[string]interface{}
	err := json.Unmarshal(b, &ValuewrapperinstantMap)
	if err != nil {
		return err
	}
	
	if valueString, ok := ValuewrapperinstantMap["value"].(string); ok {
