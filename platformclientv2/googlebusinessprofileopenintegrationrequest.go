...
func (o *Googlebusinessprofileopenintegrationrequest) SetField(field string, fieldValue interface{}) {
...
func (o Googlebusinessprofileopenintegrationrequest) MarshalJSON() ([]byte, error) {
...
func (o *Googlebusinessprofileopenintegrationrequest) UnmarshalJSON(b []byte) error {
	var GooglebusinessprofileopenintegrationrequestMap map[string]interface{}
	err := json.Unmarshal(b, &GooglebusinessprofileopenintegrationrequestMap)
	if err != nil {
		return err
	}
	
	if Id, ok := GooglebusinessprofileopenintegrationrequestMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Name, ok := GooglebusinessprofileopenintegrationrequestMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if SupportedContent, ok := GooglebusinessprofileopenintegrationrequestMap["supportedContent"].(map[string]interface{}); ok {
		SupportedContentString, _ := json.Marshal(SupportedContent)
		json.Unmarshal(SupportedContentString, &o.SupportedContent)
	}
	
	if MessagingSetting, ok := GooglebusinessprofileopenintegrationrequestMap["messagingSetting"].(map[string]interface{}); ok {
		MessagingSettingString, _ := json.Marshal(MessagingSetting)
		json.Unmarshal(MessagingSettingString, &o.MessagingSetting)
	}
	
	if Token, ok := GooglebusinessprofileopenintegrationrequestMap["token"].(map[string]interface{}); ok {
		TokenString, _ := json.Marshal(Token)
		json.Unmarshal(TokenString, &o.Token)
	}
	
	if Account, ok := GooglebusinessprofileopenintegrationrequestMap["account"].(map[string]interface{}); ok {
		AccountString, _ := json.Marshal(Account)
		json.Unmarshal(AccountString, &o.Account)
	}
	
	if SelfUri, ok := GooglebusinessprofileopenintegrationrequestMap["selfUri"].(string); ok {
		o.SelfUri = &SelfUri
	}
