...
type Coachingscheduleslotsjobslot struct { 
	...
	Schedule *Coachingscheduleslotsjobschedule `json:"schedule,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Coachingscheduleslotsjobslot) SetField(field string, fieldValue interface{}) {
...
func (o Coachingscheduleslotsjobslot) MarshalJSON() ([]byte, error) {
...
func (o *Coachingscheduleslotsjobslot) UnmarshalJSON(b []byte) error {
	var CoachingscheduleslotsjobslotMap map[string]interface{}
	err := json.Unmarshal(b, &CoachingscheduleslotsjobslotMap)
	if err != nil {
		return err
	}
	
	if dateStartString, ok := CoachingscheduleslotsjobslotMap["dateStart"].(string); ok {
		DateStart, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateStartString)
		o.DateStart = &DateStart
	}
	
	if Schedule, ok := CoachingscheduleslotsjobslotMap["schedule"].(map[string]interface{}); ok {
