...
func (o *Bualternativeshiftjobresponse) SetField(field string, fieldValue interface{}) {
...
func (o Bualternativeshiftjobresponse) MarshalJSON() ([]byte, error) {
...
func (o *Bualternativeshiftjobresponse) UnmarshalJSON(b []byte) error {
	var BualternativeshiftjobresponseMap map[string]interface{}
	err := json.Unmarshal(b, &BualternativeshiftjobresponseMap)
	if err != nil {
		return err
	}
	
	if Id, ok := BualternativeshiftjobresponseMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Status, ok := BualternativeshiftjobresponseMap["status"].(string); ok {
		o.Status = &Status
	}
    
	if VarType, ok := BualternativeshiftjobresponseMap["type"].(string); ok {
		o.VarType = &VarType
	}
    
	if DownloadUrl, ok := BualternativeshiftjobresponseMap["downloadUrl"].(string); ok {
		o.DownloadUrl = &DownloadUrl
	}
    
	if VarError, ok := BualternativeshiftjobresponseMap["error"].(map[string]interface{}); ok {
		VarErrorString, _ := json.Marshal(VarError)
		json.Unmarshal(VarErrorString, &o.VarError)
	}
	
	if ViewOffersResults, ok := BualternativeshiftjobresponseMap["viewOffersResults"].(map[string]interface{}); ok {
		ViewOffersResultsString, _ := json.Marshal(ViewOffersResults)
		json.Unmarshal(ViewOffersResultsString, &o.ViewOffersResults)
	}
	
	if ViewTradesResults, ok := BualternativeshiftjobresponseMap["viewTradesResults"].(map[string]interface{}); ok {
		ViewTradesResultsString, _ := json.Marshal(ViewTradesResults)
		json.Unmarshal(ViewTradesResultsString, &o.ViewTradesResults)
	}
	
	if BulkUpdateTradesResults, ok := BualternativeshiftjobresponseMap["bulkUpdateTradesResults"].(map[string]interface{}); ok {
	...
	if SelfUri, ok := BualternativeshiftjobresponseMap["selfUri"].(string); ok {
		o.SelfUri = &SelfUri
	}
