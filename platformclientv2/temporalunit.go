...
func (o *Temporalunit) SetField(field string, fieldValue interface{}) {
...
func (o Temporalunit) MarshalJSON() ([]byte, error) {
	...
	return json.Marshal(&struct { 
		...
		DurationEstimated: o.DurationEstimated,
		
		Duration: o.Duration,
		
		TimeBased: o.TimeBased,
		
		DateBased: o.DateBased,
		Alias:    (Alias)(o),
	})
}

func (o *Temporalunit) UnmarshalJSON(b []byte) error {
	var TemporalunitMap map[string]interface{}
	err := json.Unmarshal(b, &TemporalunitMap)
	if err != nil {
		return err
	}
	
	if DurationEstimated, ok := TemporalunitMap["durationEstimated"].(bool); ok {
	...
	if DateBased, ok := TemporalunitMap["dateBased"].(bool); ok {
		o.DateBased = &DateBased
	}
