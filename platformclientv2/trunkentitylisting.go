...
func (o *Trunkentitylisting) SetField(field string, fieldValue interface{}) {
...
func (o *Trunkentitylisting) UnmarshalJSON(b []byte) error {
	...
	if TotalNumberOfEntities, ok := TrunkentitylistingMap["totalNumberOfEntities"].(float64); ok {
