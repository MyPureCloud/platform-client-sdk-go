...
func (o *Queryagentunavailabletimesrequest) SetField(field string, fieldValue interface{}) {
...
func (o Queryagentunavailabletimesrequest) MarshalJSON() ([]byte, error) {
...
func (o *Queryagentunavailabletimesrequest) UnmarshalJSON(b []byte) error {
	var QueryagentunavailabletimesrequestMap map[string]interface{}
	err := json.Unmarshal(b, &QueryagentunavailabletimesrequestMap)
	if err != nil {
		return err
	}
	
	if startDateString, ok := QueryagentunavailabletimesrequestMap["startDate"].(string); ok {
		StartDate, _ := time.Parse("2006-01-02T15:04:05.999999Z", startDateString)
		o.StartDate = &StartDate
	}
	
	if endDateString, ok := QueryagentunavailabletimesrequestMap["endDate"].(string); ok {
