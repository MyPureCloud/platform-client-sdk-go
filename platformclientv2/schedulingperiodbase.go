...
func (o *Schedulingperiodbase) SetField(field string, fieldValue interface{}) {
...
func (o Schedulingperiodbase) MarshalJSON() ([]byte, error) {
	...
	if len(o.SetFieldNames) > 0 {
		...
		dateFields := []string{ "LatestEndDate", }
...
func (o *Schedulingperiodbase) UnmarshalJSON(b []byte) error {
	var SchedulingperiodbaseMap map[string]interface{}
	err := json.Unmarshal(b, &SchedulingperiodbaseMap)
	if err != nil {
		return err
	}
	
	if latestEndDateString, ok := SchedulingperiodbaseMap["latestEndDate"].(string); ok {
