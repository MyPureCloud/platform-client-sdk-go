...
func (o *Outlierinfo) SetField(field string, fieldValue interface{}) {
...
func (o Outlierinfo) MarshalJSON() ([]byte, error) {
...
func (o *Outlierinfo) UnmarshalJSON(b []byte) error {
	var OutlierinfoMap map[string]interface{}
	err := json.Unmarshal(b, &OutlierinfoMap)
	if err != nil {
		return err
	}
	
	if Outlier, ok := OutlierinfoMap["outlier"].(bool); ok {
		o.Outlier = &Outlier
	}
    
	if Score, ok := OutlierinfoMap["score"].(float64); ok {
