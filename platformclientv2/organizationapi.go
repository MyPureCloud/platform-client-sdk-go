...
func (a OrganizationApi) GetOrganizationsEmbeddedintegration() (*Embeddedintegration, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/organizations/embeddedintegration"
	...
	var successPayload *Embeddedintegration
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
func (a OrganizationApi) GetOrganizationsIpaddressauthentication() (*Ipaddressauthentication, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/organizations/ipaddressauthentication"
	defaultReturn := new(Ipaddressauthentication)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Ipaddressauthentication
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
func (a OrganizationApi) GetOrganizationsLimitsChangerequest(requestId string) (*Limitchangerequestdetails, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/organizations/limits/changerequests/{requestId}"
	path = strings.Replace(path, "{requestId}", url.PathEscape(fmt.Sprintf("%v", requestId)), -1)
	defaultReturn := new(Limitchangerequestdetails)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Limitchangerequestdetails
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
func (a OrganizationApi) GetOrganizationsLimitsChangerequests(after int, before int, status string, pageSize int, expand []string) (*Limitchangerequestsentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/organizations/limits/changerequests"
	defaultReturn := new(Limitchangerequestsentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Limitchangerequestsentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
// GetOrganizationsLimitsDocsFreetrial invokes GET /api/v2/organizations/limits/docs/freetrial
//
// Get free trial limit documentation
func (a OrganizationApi) GetOrganizationsLimitsDocsFreetrial() (*Freetriallimitdocs, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/organizations/limits/docs/freetrial"
	defaultReturn := new(Freetriallimitdocs)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Freetriallimitdocs
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
func (a OrganizationApi) GetOrganizationsLimitsNamespace(namespaceName string) (*Limitsentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/organizations/limits/namespaces/{namespaceName}"
	path = strings.Replace(path, "{namespaceName}", url.PathEscape(fmt.Sprintf("%v", namespaceName)), -1)
...
// GetOrganizationsLimitsNamespaceCounts invokes GET /api/v2/organizations/limits/namespaces/{namespaceName}/counts
//
...
func (a OrganizationApi) GetOrganizationsLimitsNamespaceCounts(namespaceName string, cursor string, entityId string, userId string) (*Limitcountlisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/organizations/limits/namespaces/{namespaceName}/counts"
	path = strings.Replace(path, "{namespaceName}", url.PathEscape(fmt.Sprintf("%v", namespaceName)), -1)
	defaultReturn := new(Limitcountlisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &namespaceName == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'namespaceName' when calling OrganizationApi->GetOrganizationsLimitsNamespaceCounts")
	}
	...
	var successPayload *Limitcountlisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
// GetOrganizationsLimitsNamespaceLimitCounts invokes GET /api/v2/organizations/limits/namespaces/{namespaceName}/limits/{limitName}/counts
//
...
func (a OrganizationApi) GetOrganizationsLimitsNamespaceLimitCounts(namespaceName string, limitName string, entityId string, userId string, cursor string) (*Limitcountlisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/organizations/limits/namespaces/{namespaceName}/limits/{limitName}/counts"
	path = strings.Replace(path, "{namespaceName}", url.PathEscape(fmt.Sprintf("%v", namespaceName)), -1)
	path = strings.Replace(path, "{limitName}", url.PathEscape(fmt.Sprintf("%v", limitName)), -1)
	defaultReturn := new(Limitcountlisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &namespaceName == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'namespaceName' when calling OrganizationApi->GetOrganizationsLimitsNamespaceLimitCounts")
	}
	// verify the required parameter 'limitName' is set
	if &limitName == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'limitName' when calling OrganizationApi->GetOrganizationsLimitsNamespaceLimitCounts")
	}
...
func (a OrganizationApi) GetOrganizationsMe() (*Organization, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/organizations/me"
...
func (a OrganizationApi) GetOrganizationsWhitelist() (*Orgwhitelistsettings, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/organizations/whitelist"
	defaultReturn := new(Orgwhitelistsettings)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Orgwhitelistsettings
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
func (a OrganizationApi) PatchOrganizationsFeature(featureName string, enabled Featurestate) (*Organizationfeatures, *APIResponse, error) {
	var httpMethod = "PATCH"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/organizations/features/{featureName}"
	path = strings.Replace(path, "{featureName}", url.PathEscape(fmt.Sprintf("%v", featureName)), -1)
	defaultReturn := new(Organizationfeatures)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Organizationfeatures
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
