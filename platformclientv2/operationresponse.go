...
func (o *Operationresponse) SetField(field string, fieldValue interface{}) {
...
func (o *Operationresponse) UnmarshalJSON(b []byte) error {
	var OperationresponseMap map[string]interface{}
	err := json.Unmarshal(b, &OperationresponseMap)
	if err != nil {
		return err
	}
	
	if Id, ok := OperationresponseMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Status, ok := OperationresponseMap["status"].(string); ok {
		o.Status = &Status
	}
    
	if VarType, ok := OperationresponseMap["type"].(string); ok {
		o.VarType = &VarType
	}
    
	if CreatedBy, ok := OperationresponseMap["createdBy"].(map[string]interface{}); ok {
		CreatedByString, _ := json.Marshal(CreatedBy)
		json.Unmarshal(CreatedByString, &o.CreatedBy)
	}
	
	if dateCreatedString, ok := OperationresponseMap["dateCreated"].(string); ok {
