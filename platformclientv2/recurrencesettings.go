...
func (o *Recurrencesettings) SetField(field string, fieldValue interface{}) {
...
func (o Recurrencesettings) MarshalJSON() ([]byte, error) {
...
func (o *Recurrencesettings) UnmarshalJSON(b []byte) error {
	var RecurrencesettingsMap map[string]interface{}
	err := json.Unmarshal(b, &RecurrencesettingsMap)
	if err != nil {
		return err
	}
