...
func (o *Smsidentityresolutionconfig) SetField(field string, fieldValue interface{}) {
...
func (o Smsidentityresolutionconfig) MarshalJSON() ([]byte, error) {
...
func (o *Smsidentityresolutionconfig) UnmarshalJSON(b []byte) error {
	var SmsidentityresolutionconfigMap map[string]interface{}
	err := json.Unmarshal(b, &SmsidentityresolutionconfigMap)
	if err != nil {
		return err
	}
	...
	if ResolveIdentities, ok := SmsidentityresolutionconfigMap["resolveIdentities"].(bool); ok {
		o.ResolveIdentities = &ResolveIdentities
	}
    
	if SelfUri, ok := SmsidentityresolutionconfigMap["selfUri"].(string); ok {
		o.SelfUri = &SelfUri
	}
