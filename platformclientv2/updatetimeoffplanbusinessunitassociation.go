...
type Updatetimeoffplanbusinessunitassociation struct { 
	...
	ManagementUnitIds *Setwrapperstring `json:"managementUnitIds,omitempty"`
...
func (o *Updatetimeoffplanbusinessunitassociation) SetField(field string, fieldValue interface{}) {
...
func (o Updatetimeoffplanbusinessunitassociation) MarshalJSON() ([]byte, error) {
...
func (o *Updatetimeoffplanbusinessunitassociation) UnmarshalJSON(b []byte) error {
	var UpdatetimeoffplanbusinessunitassociationMap map[string]interface{}
	err := json.Unmarshal(b, &UpdatetimeoffplanbusinessunitassociationMap)
	if err != nil {
		return err
	}
	
	if ManagementUnitIds, ok := UpdatetimeoffplanbusinessunitassociationMap["managementUnitIds"].(map[string]interface{}); ok {
		ManagementUnitIdsString, _ := json.Marshal(ManagementUnitIds)
		json.Unmarshal(ManagementUnitIdsString, &o.ManagementUnitIds)
	}
	
	if StaffingGroupIds, ok := UpdatetimeoffplanbusinessunitassociationMap["staffingGroupIds"].(map[string]interface{}); ok {
