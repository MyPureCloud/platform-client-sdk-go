...
func (o *Estimateavailablefulldaytimeoffrequest) SetField(field string, fieldValue interface{}) {
...
func (o Estimateavailablefulldaytimeoffrequest) MarshalJSON() ([]byte, error) {
...
func (o *Estimateavailablefulldaytimeoffrequest) UnmarshalJSON(b []byte) error {
	var EstimateavailablefulldaytimeoffrequestMap map[string]interface{}
	err := json.Unmarshal(b, &EstimateavailablefulldaytimeoffrequestMap)
	if err != nil {
		return err
	}
	
	if dateString, ok := EstimateavailablefulldaytimeoffrequestMap["date"].(string); ok {
		Date, _ := time.Parse("2006-01-02", dateString)
		o.Date = &Date
	}
	
	if RequestedDurationMinutes, ok := EstimateavailablefulldaytimeoffrequestMap["requestedDurationMinutes"].(float64); ok {
