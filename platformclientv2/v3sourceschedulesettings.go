...
func (o *V3sourceschedulesettings) SetField(field string, fieldValue interface{}) {
...
func (o V3sourceschedulesettings) MarshalJSON() ([]byte, error) {
...
func (o *V3sourceschedulesettings) UnmarshalJSON(b []byte) error {
	var V3sourceschedulesettingsMap map[string]interface{}
	err := json.Unmarshal(b, &V3sourceschedulesettingsMap)
	if err != nil {
		return err
	}
	
	if dateStartString, ok := V3sourceschedulesettingsMap["dateStart"].(string); ok {
		DateStart, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateStartString)
		o.DateStart = &DateStart
	}
	
	if Period, ok := V3sourceschedulesettingsMap["period"].(float64); ok {
