...
type Acceleratorinput struct { 
	...
	Parameters *[]Acceleratorparameter `json:"parameters,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Acceleratorinput) SetField(field string, fieldValue interface{}) {
...
func (o Acceleratorinput) MarshalJSON() ([]byte, error) {
...
func (o *Acceleratorinput) UnmarshalJSON(b []byte) error {
	var AcceleratorinputMap map[string]interface{}
	err := json.Unmarshal(b, &AcceleratorinputMap)
	if err != nil {
		return err
	}
	
	if DryRun, ok := AcceleratorinputMap["dryRun"].(bool); ok {
		o.DryRun = &DryRun
	}
    
	if AcceleratorId, ok := AcceleratorinputMap["acceleratorId"].(string); ok {
		o.AcceleratorId = &AcceleratorId
	}
    
	if Parameters, ok := AcceleratorinputMap["parameters"].([]interface{}); ok {
