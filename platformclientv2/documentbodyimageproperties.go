...
func (o *Documentbodyimageproperties) SetField(field string, fieldValue interface{}) {
...
func (o Documentbodyimageproperties) MarshalJSON() ([]byte, error) {
...
func (o *Documentbodyimageproperties) UnmarshalJSON(b []byte) error {
	var DocumentbodyimagepropertiesMap map[string]interface{}
	err := json.Unmarshal(b, &DocumentbodyimagepropertiesMap)
	if err != nil {
		return err
	}
	
	if BackgroundColor, ok := DocumentbodyimagepropertiesMap["backgroundColor"].(string); ok {
		o.BackgroundColor = &BackgroundColor
	}
    
	if Align, ok := DocumentbodyimagepropertiesMap["align"].(string); ok {
		o.Align = &Align
	}
    
	if Indentation, ok := DocumentbodyimagepropertiesMap["indentation"].(float64); ok {
