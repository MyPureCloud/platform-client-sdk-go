...
type Sessionmetadata struct { 
	...
	DownloadResult *Sessionmetadataresult `json:"downloadResult,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Sessionmetadata) SetField(field string, fieldValue interface{}) {
...
func (o *Sessionmetadata) UnmarshalJSON(b []byte) error {
	var SessionmetadataMap map[string]interface{}
	err := json.Unmarshal(b, &SessionmetadataMap)
	if err != nil {
		return err
	}
	
	if DownloadUrl, ok := SessionmetadataMap["downloadUrl"].(string); ok {
		o.DownloadUrl = &DownloadUrl
	}
    
	if DownloadResult, ok := SessionmetadataMap["downloadResult"].(map[string]interface{}); ok {
