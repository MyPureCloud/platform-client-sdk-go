...
func (o *Customer) SetField(field string, fieldValue interface{}) {
...
func (o *Customer) UnmarshalJSON(b []byte) error {
	var CustomerMap map[string]interface{}
	err := json.Unmarshal(b, &CustomerMap)
	if err != nil {
		return err
	}
	...
	if Number, ok := CustomerMap["number"].(string); ok {
		o.Number = &Number
	}
