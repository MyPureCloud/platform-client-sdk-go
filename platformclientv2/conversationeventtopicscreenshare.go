...
func (o *Conversationeventtopicscreenshare) SetField(field string, fieldValue interface{}) {
...
func (o *Conversationeventtopicscreenshare) UnmarshalJSON(b []byte) error {
	...
	if PeerCount, ok := ConversationeventtopicscreenshareMap["peerCount"].(float64); ok {
	...
	if QueueMediaSettings, ok := ConversationeventtopicscreenshareMap["queueMediaSettings"].(map[string]interface{}); ok {
