...
type Conversationcallbackeventtopicerrorbody struct { 
	...
	// Limit
	Limit *Conversationcallbackeventtopiclimit `json:"limit,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Conversationcallbackeventtopicerrorbody) SetField(field string, fieldValue interface{}) {
...
func (o *Conversationcallbackeventtopicerrorbody) UnmarshalJSON(b []byte) error {
	...
	if Limit, ok := ConversationcallbackeventtopicerrorbodyMap["limit"].(map[string]interface{}); ok {
