...
type Conversationscreenshareeventtopicqueuemediasettings struct { 
...
func (o *Conversationscreenshareeventtopicqueuemediasettings) SetField(field string, fieldValue interface{}) {
...
func (o Conversationscreenshareeventtopicqueuemediasettings) MarshalJSON() ([]byte, error) {
	...
	type Alias Conversationscreenshareeventtopicqueuemediasettings
...
func (o *Conversationscreenshareeventtopicqueuemediasettings) UnmarshalJSON(b []byte) error {
	var ConversationscreenshareeventtopicqueuemediasettingsMap map[string]interface{}
	err := json.Unmarshal(b, &ConversationscreenshareeventtopicqueuemediasettingsMap)
	if err != nil {
		return err
	}
	
	if AlertingTimeoutSeconds, ok := ConversationscreenshareeventtopicqueuemediasettingsMap["alertingTimeoutSeconds"].(float64); ok {
		AlertingTimeoutSecondsInt := int(AlertingTimeoutSeconds)
		o.AlertingTimeoutSeconds = &AlertingTimeoutSecondsInt
	}
	
	if AutoAnswerAlertToneSeconds, ok := ConversationscreenshareeventtopicqueuemediasettingsMap["autoAnswerAlertToneSeconds"].(float64); ok {
	...
	if ManualAnswerAlertToneSeconds, ok := ConversationscreenshareeventtopicqueuemediasettingsMap["manualAnswerAlertToneSeconds"].(float64); ok {
	...
	if EnableAutoAnswer, ok := ConversationscreenshareeventtopicqueuemediasettingsMap["enableAutoAnswer"].(bool); ok {
...
func (o *Conversationscreenshareeventtopicqueuemediasettings) String() string {
	j, _ := json.Marshal(o)
