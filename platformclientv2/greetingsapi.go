...
// GetGreetingDownloads invokes GET /api/v2/greetings/{greetingId}/downloads
//
// Download a organization greeting recording
func (a GreetingsApi) GetGreetingDownloads(greetingId string, formatId string) (*Greetingmediainfo, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/greetings/{greetingId}/downloads"
	path = strings.Replace(path, "{greetingId}", url.PathEscape(fmt.Sprintf("%v", greetingId)), -1)
	...
	if &greetingId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'greetingId' when calling GreetingsApi->GetGreetingDownloads")
	}
...
// GetGreetingGroupsDownloads invokes GET /api/v2/greetings/{greetingId}/groups/downloads
//
// Download a group greeting recording
func (a GreetingsApi) GetGreetingGroupsDownloads(greetingId string, formatId string) (*Greetingmediainfo, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/greetings/{greetingId}/groups/downloads"
	path = strings.Replace(path, "{greetingId}", url.PathEscape(fmt.Sprintf("%v", greetingId)), -1)
	defaultReturn := new(Greetingmediainfo)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	...
	if &greetingId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'greetingId' when calling GreetingsApi->GetGreetingGroupsDownloads")
	}
...
// GetGreetingUsersDownloads invokes GET /api/v2/greetings/{greetingId}/users/downloads
//
// Download a user greeting recording
func (a GreetingsApi) GetGreetingUsersDownloads(greetingId string, formatId string) (*Greetingmediainfo, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/greetings/{greetingId}/users/downloads"
	path = strings.Replace(path, "{greetingId}", url.PathEscape(fmt.Sprintf("%v", greetingId)), -1)
	defaultReturn := new(Greetingmediainfo)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	...
	if &greetingId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'greetingId' when calling GreetingsApi->GetGreetingUsersDownloads")
	}
