...
func (o *Timeoffsettingsresponse) SetField(field string, fieldValue interface{}) {
...
func (o Timeoffsettingsresponse) MarshalJSON() ([]byte, error) {
...
func (o *Timeoffsettingsresponse) UnmarshalJSON(b []byte) error {
	var TimeoffsettingsresponseMap map[string]interface{}
	err := json.Unmarshal(b, &TimeoffsettingsresponseMap)
	if err != nil {
		return err
	}
	
	if SubmissionRangeEnforced, ok := TimeoffsettingsresponseMap["submissionRangeEnforced"].(bool); ok {
