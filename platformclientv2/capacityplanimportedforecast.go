...
func (o *Capacityplanimportedforecast) SetField(field string, fieldValue interface{}) {
...
func (o Capacityplanimportedforecast) MarshalJSON() ([]byte, error) {
...
func (o *Capacityplanimportedforecast) UnmarshalJSON(b []byte) error {
	var CapacityplanimportedforecastMap map[string]interface{}
	err := json.Unmarshal(b, &CapacityplanimportedforecastMap)
	if err != nil {
		return err
	}
	
	if weekDateString, ok := CapacityplanimportedforecastMap["weekDate"].(string); ok {
		WeekDate, _ := time.Parse("2006-01-02", weekDateString)
		o.WeekDate = &WeekDate
	}
	
	if WeekCount, ok := CapacityplanimportedforecastMap["weekCount"].(float64); ok {
