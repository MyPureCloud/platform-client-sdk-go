...
type Conversationcalleventtopicrecordersstate struct { 
...
func (o *Conversationcalleventtopicrecordersstate) SetField(field string, fieldValue interface{}) {
...
func (o Conversationcalleventtopicrecordersstate) MarshalJSON() ([]byte, error) {
	...
	type Alias Conversationcalleventtopicrecordersstate
...
func (o *Conversationcalleventtopicrecordersstate) UnmarshalJSON(b []byte) error {
	var ConversationcalleventtopicrecordersstateMap map[string]interface{}
	err := json.Unmarshal(b, &ConversationcalleventtopicrecordersstateMap)
	if err != nil {
		return err
	}
	
	if AdhocState, ok := ConversationcalleventtopicrecordersstateMap["adhocState"].(string); ok {
		o.AdhocState = &AdhocState
	}
    
	if CustomerExperienceState, ok := ConversationcalleventtopicrecordersstateMap["customerExperienceState"].(string); ok {
		o.CustomerExperienceState = &CustomerExperienceState
	}
    
	if AgentExperienceState, ok := ConversationcalleventtopicrecordersstateMap["agentExperienceState"].(string); ok {
		o.AgentExperienceState = &AgentExperienceState
	}
    
	if SnippetState, ok := ConversationcalleventtopicrecordersstateMap["snippetState"].(string); ok {
...
func (o *Conversationcalleventtopicrecordersstate) String() string {
	j, _ := json.Marshal(o)
