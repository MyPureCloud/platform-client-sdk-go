...
type Conversationchateventtopicconversationroutingdata struct { 
	...
	SkillExpressionId *Conversationchateventtopicurireference `json:"skillExpressionId,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Conversationchateventtopicconversationroutingdata) SetField(field string, fieldValue interface{}) {
...
func (o *Conversationchateventtopicconversationroutingdata) UnmarshalJSON(b []byte) error {
	...
	if SkillExpressionId, ok := ConversationchateventtopicconversationroutingdataMap["skillExpressionId"].(map[string]interface{}); ok {
