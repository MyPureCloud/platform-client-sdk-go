...
func (o *Dialersequencescheduleconfigchangescheduleinterval) SetField(field string, fieldValue interface{}) {
...
func (o *Dialersequencescheduleconfigchangescheduleinterval) UnmarshalJSON(b []byte) error {
	...
	if GetAdditionalProperties, ok := DialersequencescheduleconfigchangescheduleintervalMap["getAdditionalProperties"].(map[string]interface{}); ok {
