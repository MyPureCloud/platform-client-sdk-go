...
type Bulkfetchnotesresponse struct { 
	...
	Results *[]Bulkresponseresultnoteentitybulkentityerrorentity `json:"results,omitempty"`
...
func (o *Bulkfetchnotesresponse) SetField(field string, fieldValue interface{}) {
