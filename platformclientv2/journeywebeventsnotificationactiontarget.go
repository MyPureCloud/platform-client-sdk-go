...
func (o *Journeywebeventsnotificationactiontarget) SetField(field string, fieldValue interface{}) {
...
func (o Journeywebeventsnotificationactiontarget) MarshalJSON() ([]byte, error) {
	...
	type Alias Journeywebeventsnotificationactiontarget
...
func (o *Journeywebeventsnotificationactiontarget) UnmarshalJSON(b []byte) error {
	var JourneywebeventsnotificationactiontargetMap map[string]interface{}
	err := json.Unmarshal(b, &JourneywebeventsnotificationactiontargetMap)
	if err != nil {
		return err
	}
...
func (o *Journeywebeventsnotificationactiontarget) String() string {
	j, _ := json.Marshal(o)
