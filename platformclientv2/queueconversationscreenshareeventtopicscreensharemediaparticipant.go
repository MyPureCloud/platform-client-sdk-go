...
type Queueconversationscreenshareeventtopicscreensharemediaparticipant struct { 
	...
	// QueueMediaSettings
	QueueMediaSettings *Queueconversationscreenshareeventtopicqueuemediasettings `json:"queueMediaSettings,omitempty"`
...
func (o *Queueconversationscreenshareeventtopicscreensharemediaparticipant) UnmarshalJSON(b []byte) error {
	...
	if ExternalContactInitialDivisionId, ok := QueueconversationscreenshareeventtopicscreensharemediaparticipantMap["externalContactInitialDivisionId"].(string); ok {
	...
	if QueueMediaSettings, ok := QueueconversationscreenshareeventtopicscreensharemediaparticipantMap["queueMediaSettings"].(map[string]interface{}); ok {
