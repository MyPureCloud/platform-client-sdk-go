...
type Queryopportunityenrollmentresult struct { 
	...
	Metadata *Queryopportunityenrollmentmetadata `json:"metadata,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Queryopportunityenrollmentresult) SetField(field string, fieldValue interface{}) {
...
func (o Queryopportunityenrollmentresult) MarshalJSON() ([]byte, error) {
...
func (o *Queryopportunityenrollmentresult) UnmarshalJSON(b []byte) error {
	var QueryopportunityenrollmentresultMap map[string]interface{}
	err := json.Unmarshal(b, &QueryopportunityenrollmentresultMap)
	if err != nil {
		return err
	}
	
	if Id, ok := QueryopportunityenrollmentresultMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if OpportunityId, ok := QueryopportunityenrollmentresultMap["opportunityId"].(string); ok {
		o.OpportunityId = &OpportunityId
	}
    
	if Agent, ok := QueryopportunityenrollmentresultMap["agent"].(map[string]interface{}); ok {
		AgentString, _ := json.Marshal(Agent)
		json.Unmarshal(AgentString, &o.Agent)
	}
	
	if Status, ok := QueryopportunityenrollmentresultMap["status"].(string); ok {
		o.Status = &Status
	}
    
	if Schedule, ok := QueryopportunityenrollmentresultMap["schedule"].(map[string]interface{}); ok {
		ScheduleString, _ := json.Marshal(Schedule)
		json.Unmarshal(ScheduleString, &o.Schedule)
	}
	
	if SystemMessageCode, ok := QueryopportunityenrollmentresultMap["systemMessageCode"].(string); ok {
		o.SystemMessageCode = &SystemMessageCode
	}
    
	if ReviewNote, ok := QueryopportunityenrollmentresultMap["reviewNote"].(string); ok {
		o.ReviewNote = &ReviewNote
	}
    
	if DenialCode, ok := QueryopportunityenrollmentresultMap["denialCode"].(string); ok {
		o.DenialCode = &DenialCode
	}
    
	if Metadata, ok := QueryopportunityenrollmentresultMap["metadata"].(map[string]interface{}); ok {
