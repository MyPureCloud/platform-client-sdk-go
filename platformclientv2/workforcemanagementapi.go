...
// DeleteWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistory invokes DELETE /api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffinggroupallocationshistory
//
// Delete staffing group allocations history created for a capacity plan before the given date
func (a WorkforceManagementApi) DeleteWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistory(businessUnitId string, capacityPlanId string, beforeDateId time.Time) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffinggroupallocationshistory"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	path = strings.Replace(path, "{capacityPlanId}", url.PathEscape(fmt.Sprintf("%v", capacityPlanId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &businessUnitId == nil {
		// false
		return nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->DeleteWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistory")
	}
	// verify the required parameter 'capacityPlanId' is set
	if &capacityPlanId == nil {
		// false
		return nil, errors.New("Missing required parameter 'capacityPlanId' when calling WorkforceManagementApi->DeleteWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistory")
	}
	...
	queryParams["beforeDateId"] = a.Configuration.APIClient.ParameterToString(beforeDateId, "")
...
// GetWorkforcemanagementAgentsMeAdherenceHistoricalJob invokes GET /api/v2/workforcemanagement/agents/me/adherence/historical/jobs/{jobId}
//
// Request to fetch the status of the agent adherence job. Only the user who started the operation can query the status
//
// Job details are only retained if the initial request returned a 202 ACCEPTED response
func (a WorkforceManagementApi) GetWorkforcemanagementAgentsMeAdherenceHistoricalJob(jobId string) (*Wfmagenthistoricaladherenceresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/agents/me/adherence/historical/jobs/{jobId}"
	path = strings.Replace(path, "{jobId}", url.PathEscape(fmt.Sprintf("%v", jobId)), -1)
	defaultReturn := new(Wfmagenthistoricaladherenceresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &jobId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'jobId' when calling WorkforceManagementApi->GetWorkforcemanagementAgentsMeAdherenceHistoricalJob")
	}
	...
	var successPayload *Wfmagenthistoricaladherenceresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Wfmagenthistoricaladherenceresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a WorkforceManagementApi) GetWorkforcemanagementBusinessunit(businessUnitId string, expand []string, includeSchedulingDefaultMessageSeverities bool) (*Businessunitresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	...
	queryParams["includeSchedulingDefaultMessageSeverities"] = a.Configuration.APIClient.ParameterToString(includeSchedulingDefaultMessageSeverities, "")
...
// GetWorkforcemanagementBusinessunitCapacityplan invokes GET /api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}
//
// Get a capacity plan
func (a WorkforceManagementApi) GetWorkforcemanagementBusinessunitCapacityplan(businessUnitId string, capacityPlanId string) (*Capacityplanresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	path = strings.Replace(path, "{capacityPlanId}", url.PathEscape(fmt.Sprintf("%v", capacityPlanId)), -1)
	defaultReturn := new(Capacityplanresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &businessUnitId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->GetWorkforcemanagementBusinessunitCapacityplan")
	}
	// verify the required parameter 'capacityPlanId' is set
	if &capacityPlanId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'capacityPlanId' when calling WorkforceManagementApi->GetWorkforcemanagementBusinessunitCapacityplan")
	}
	...
	var successPayload *Capacityplanresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Capacityplanresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a WorkforceManagementApi) GetWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocations(businessUnitId string, capacityPlanId string) (*Capacityplanstaffinggroupallocationsresponse, *APIResponse, error) {
	...
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	path = strings.Replace(path, "{capacityPlanId}", url.PathEscape(fmt.Sprintf("%v", capacityPlanId)), -1)
	defaultReturn := new(Capacityplanstaffinggroupallocationsresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &businessUnitId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->GetWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocations")
	}
	// verify the required parameter 'capacityPlanId' is set
	if &capacityPlanId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'capacityPlanId' when calling WorkforceManagementApi->GetWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocations")
	}
	...
	var successPayload *Capacityplanstaffinggroupallocationsresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Capacityplanstaffinggroupallocationsresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetWorkforcemanagementBusinessunitCapacityplanStaffingrequirements invokes GET /api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffingrequirements
//
// Get a capacity plan's staffing requirements
func (a WorkforceManagementApi) GetWorkforcemanagementBusinessunitCapacityplanStaffingrequirements(businessUnitId string, capacityPlanId string) (*Capacityplanstaffingrequirementresult, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffingrequirements"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	path = strings.Replace(path, "{capacityPlanId}", url.PathEscape(fmt.Sprintf("%v", capacityPlanId)), -1)
	defaultReturn := new(Capacityplanstaffingrequirementresult)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &businessUnitId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->GetWorkforcemanagementBusinessunitCapacityplanStaffingrequirements")
	}
	// verify the required parameter 'capacityPlanId' is set
	if &capacityPlanId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'capacityPlanId' when calling WorkforceManagementApi->GetWorkforcemanagementBusinessunitCapacityplanStaffingrequirements")
	}
	...
	var successPayload *Capacityplanstaffingrequirementresult
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Capacityplanstaffingrequirementresult" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a WorkforceManagementApi) GetWorkforcemanagementBusinessunitCapacityplanningLongtermrequirementsAutomaticbestmethodWeekForecast(businessUnitId string, weekDateId time.Time, forecastId string) (*Longtermrequirementsresponse, *APIResponse, error) {
	...
	path = strings.Replace(path, "{weekDateId}", url.PathEscape(fmt.Sprintf("%v", weekDateId)), -1)
	path = strings.Replace(path, "{forecastId}", url.PathEscape(fmt.Sprintf("%v", forecastId)), -1)
	defaultReturn := new(Longtermrequirementsresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &businessUnitId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->GetWorkforcemanagementBusinessunitCapacityplanningLongtermrequirementsAutomaticbestmethodWeekForecast")
	}
	// verify the required parameter 'weekDateId' is set
	if &weekDateId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'weekDateId' when calling WorkforceManagementApi->GetWorkforcemanagementBusinessunitCapacityplanningLongtermrequirementsAutomaticbestmethodWeekForecast")
	}
	// verify the required parameter 'forecastId' is set
	if &forecastId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'forecastId' when calling WorkforceManagementApi->GetWorkforcemanagementBusinessunitCapacityplanningLongtermrequirementsAutomaticbestmethodWeekForecast")
	}
	...
	var successPayload *Longtermrequirementsresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Longtermrequirementsresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetWorkforcemanagementBusinessunitCapacityplans invokes GET /api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans
//
// Get list of capacity plans for a business unit
func (a WorkforceManagementApi) GetWorkforcemanagementBusinessunitCapacityplans(businessUnitId string) (*Capacityplanslistresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	defaultReturn := new(Capacityplanslistresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &businessUnitId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->GetWorkforcemanagementBusinessunitCapacityplans")
	}
	...
	var successPayload *Capacityplanslistresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Capacityplanslistresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSession invokes GET /api/v2/workforcemanagement/businessunits/{businessUnitId}/mainforecast/continuousforecast/session
//
// Get the latest session for the business unit ID
//
// Preview: GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSession is a preview method and is subject to both breaking and non-breaking changes at any time without notice
func (a WorkforceManagementApi) GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSession(businessUnitId string) (*Continuousforecastgetsessionresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}/mainforecast/continuousforecast/session"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	defaultReturn := new(Continuousforecastgetsessionresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &businessUnitId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSession")
	}
	...
	var successPayload *Continuousforecastgetsessionresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
// GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionId invokes GET /api/v2/workforcemanagement/businessunits/{businessUnitId}/mainforecast/continuousforecast/session/{sessionId}
//
// Get the session details for the session ID
//
// Preview: GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionId is a preview method and is subject to both breaking and non-breaking changes at any time without notice
func (a WorkforceManagementApi) GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionId(businessUnitId string, sessionId string) (*Continuousforecastsessionresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}/mainforecast/continuousforecast/session/{sessionId}"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	path = strings.Replace(path, "{sessionId}", url.PathEscape(fmt.Sprintf("%v", sessionId)), -1)
	defaultReturn := new(Continuousforecastsessionresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &businessUnitId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionId")
	}
	// verify the required parameter 'sessionId' is set
	if &sessionId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'sessionId' when calling WorkforceManagementApi->GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionId")
	}
	...
	var successPayload *Continuousforecastsessionresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Continuousforecastsessionresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdSnapshotSnapshotId invokes GET /api/v2/workforcemanagement/businessunits/{businessUnitId}/mainforecast/continuousforecast/session/{sessionId}/snapshot/{snapshotId}
//
// Get the snapshot details for the snapshot ID
//
// Preview: GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdSnapshotSnapshotId is a preview method and is subject to both breaking and non-breaking changes at any time without notice
func (a WorkforceManagementApi) GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdSnapshotSnapshotId(businessUnitId string, sessionId string, snapshotId string) (*Continuousforecastsnapshotresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}/mainforecast/continuousforecast/session/{sessionId}/snapshot/{snapshotId}"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	path = strings.Replace(path, "{sessionId}", url.PathEscape(fmt.Sprintf("%v", sessionId)), -1)
	path = strings.Replace(path, "{snapshotId}", url.PathEscape(fmt.Sprintf("%v", snapshotId)), -1)
	defaultReturn := new(Continuousforecastsnapshotresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &businessUnitId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdSnapshotSnapshotId")
	}
	// verify the required parameter 'sessionId' is set
	if &sessionId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'sessionId' when calling WorkforceManagementApi->GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdSnapshotSnapshotId")
	}
	// verify the required parameter 'snapshotId' is set
	if &snapshotId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'snapshotId' when calling WorkforceManagementApi->GetWorkforcemanagementBusinessunitMainforecastContinuousforecastSessionSessionIdSnapshotSnapshotId")
	}
	...
	var successPayload *Continuousforecastsnapshotresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Continuousforecastsnapshotresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetWorkforcemanagementHistoricaldataBulkRemoveJob invokes GET /api/v2/workforcemanagement/historicaldata/bulk/remove/jobs/{jobId}
//
// Retrieves delete job status for historical data imports associated with the job id
func (a WorkforceManagementApi) GetWorkforcemanagementHistoricaldataBulkRemoveJob(jobId string) (*Historicalimportdeletefilesjobresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/historicaldata/bulk/remove/jobs/{jobId}"
	path = strings.Replace(path, "{jobId}", url.PathEscape(fmt.Sprintf("%v", jobId)), -1)
	defaultReturn := new(Historicalimportdeletefilesjobresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &jobId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'jobId' when calling WorkforceManagementApi->GetWorkforcemanagementHistoricaldataBulkRemoveJob")
	}
	...
	var successPayload *Historicalimportdeletefilesjobresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Historicalimportdeletefilesjobresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetWorkforcemanagementHistoricaldataBulkRemoveJobs invokes GET /api/v2/workforcemanagement/historicaldata/bulk/remove/jobs
//
// Retrieves all delete job status for historical data
func (a WorkforceManagementApi) GetWorkforcemanagementHistoricaldataBulkRemoveJobs() (*Historicalimportoveralldeletestatusresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/historicaldata/bulk/remove/jobs"
	defaultReturn := new(Historicalimportoveralldeletestatusresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Historicalimportoveralldeletestatusresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Historicalimportoveralldeletestatusresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetWorkforcemanagementHistoricaldataImportstatusJobId invokes GET /api/v2/workforcemanagement/historicaldata/importstatus/{jobId}
//
// Retrieves status of the historical data imports associated with job id
func (a WorkforceManagementApi) GetWorkforcemanagementHistoricaldataImportstatusJobId(jobId string) (*Historicalimportstatusjobresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/historicaldata/importstatus/{jobId}"
	path = strings.Replace(path, "{jobId}", url.PathEscape(fmt.Sprintf("%v", jobId)), -1)
	defaultReturn := new(Historicalimportstatusjobresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &jobId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'jobId' when calling WorkforceManagementApi->GetWorkforcemanagementHistoricaldataImportstatusJobId")
	}
	...
	var successPayload *Historicalimportstatusjobresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Historicalimportstatusjobresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetWorkforcemanagementTeamAdherence invokes GET /api/v2/workforcemanagement/teams/{teamId}/adherence
//
// Get a list of user schedule adherence records for the requested team
func (a WorkforceManagementApi) GetWorkforcemanagementTeamAdherence(teamId string) (*Userscheduleadherencelisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/teams/{teamId}/adherence"
	...
	if &teamId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'teamId' when calling WorkforceManagementApi->GetWorkforcemanagementTeamAdherence")
	}
...
// GetWorkforcemanagementUnavailabletimesSettings invokes GET /api/v2/workforcemanagement/unavailabletimes/settings
//
// Get availability management unit's settings for agent
func (a WorkforceManagementApi) GetWorkforcemanagementUnavailabletimesSettings() (*Managementunitavailabilitysettingsresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/unavailabletimes/settings"
	defaultReturn := new(Managementunitavailabilitysettingsresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Managementunitavailabilitysettingsresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Managementunitavailabilitysettingsresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetWorkforcemanagementUnavailabletimesValidationJob invokes GET /api/v2/workforcemanagement/unavailabletimes/validation/jobs/{jobId}
//
// Query agent unavailable times validation job
func (a WorkforceManagementApi) GetWorkforcemanagementUnavailabletimesValidationJob(jobId string) (*Queryagentunavailabletimesvalidationjobresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/unavailabletimes/validation/jobs/{jobId}"
	path = strings.Replace(path, "{jobId}", url.PathEscape(fmt.Sprintf("%v", jobId)), -1)
	defaultReturn := new(Queryagentunavailabletimesvalidationjobresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &jobId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'jobId' when calling WorkforceManagementApi->GetWorkforcemanagementUnavailabletimesValidationJob")
	}
	...
	var successPayload *Queryagentunavailabletimesvalidationjobresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Queryagentunavailabletimesvalidationjobresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a WorkforceManagementApi) PatchWorkforcemanagementBusinessunit(businessUnitId string, body Updatebusinessunitrequest, includeSchedulingDefaultMessageSeverities bool) (*Businessunitresponse, *APIResponse, error) {
	var httpMethod = "PATCH"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
...
// PatchWorkforcemanagementBusinessunitCapacityplan invokes PATCH /api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}
//
// Update a capacity plan configuration
func (a WorkforceManagementApi) PatchWorkforcemanagementBusinessunitCapacityplan(businessUnitId string, capacityPlanId string, body Updatecapacityplanrequest) (*Capacityplanresponse, *APIResponse, error) {
	var httpMethod = "PATCH"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	...
	if &businessUnitId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->PatchWorkforcemanagementBusinessunitCapacityplan")
	}
	// verify the required parameter 'capacityPlanId' is set
	if &capacityPlanId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'capacityPlanId' when calling WorkforceManagementApi->PatchWorkforcemanagementBusinessunitCapacityplan")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling WorkforceManagementApi->PatchWorkforcemanagementBusinessunitCapacityplan")
	}
...
// PatchWorkforcemanagementManagementunitUnavailabletimesSettings invokes PATCH /api/v2/workforcemanagement/managementunits/{managementUnitId}/unavailabletimes/settings
//
// Update management unit availability settings
func (a WorkforceManagementApi) PatchWorkforcemanagementManagementunitUnavailabletimesSettings(managementUnitId string, body Updatemanagementunitssettingsrequest) (*Managementunitavailabilitysettingsresponse, *APIResponse, error) {
	var httpMethod = "PATCH"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/managementunits/{managementUnitId}/unavailabletimes/settings"
	path = strings.Replace(path, "{managementUnitId}", url.PathEscape(fmt.Sprintf("%v", managementUnitId)), -1)
	defaultReturn := new(Managementunitavailabilitysettingsresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	...
	if &managementUnitId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'managementUnitId' when calling WorkforceManagementApi->PatchWorkforcemanagementManagementunitUnavailabletimesSettings")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling WorkforceManagementApi->PatchWorkforcemanagementManagementunitUnavailabletimesSettings")
	}
...
// PatchWorkforcemanagementUnavailabletimes invokes PATCH /api/v2/workforcemanagement/unavailabletimes
//
// Update agent unavailable times
func (a WorkforceManagementApi) PatchWorkforcemanagementUnavailabletimes(body Updateunavailabletimesrequest) (*Unavailabletimelisting, *APIResponse, error) {
	var httpMethod = "PATCH"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/unavailabletimes"
	defaultReturn := new(Unavailabletimelisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling WorkforceManagementApi->PatchWorkforcemanagementUnavailabletimes")
	}
	...
	var successPayload *Unavailabletimelisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Unavailabletimelisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostWorkforcemanagementAgentUnavailabletimesQuery invokes POST /api/v2/workforcemanagement/agents/{agentId}/unavailabletimes/query
//
// Get agent unavailable times
func (a WorkforceManagementApi) PostWorkforcemanagementAgentUnavailabletimesQuery(agentId string, body Queryagentunavailabletimesrequest) (*Unavailabletimelisting, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/agents/{agentId}/unavailabletimes/query"
	path = strings.Replace(path, "{agentId}", url.PathEscape(fmt.Sprintf("%v", agentId)), -1)
	defaultReturn := new(Unavailabletimelisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	...
	if &agentId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'agentId' when calling WorkforceManagementApi->PostWorkforcemanagementAgentUnavailabletimesQuery")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling WorkforceManagementApi->PostWorkforcemanagementAgentUnavailabletimesQuery")
	}
...
// PostWorkforcemanagementAgentsMeAdherenceHistoricalJobs invokes POST /api/v2/workforcemanagement/agents/me/adherence/historical/jobs
//
...
func (a WorkforceManagementApi) PostWorkforcemanagementAgentsMeAdherenceHistoricalJobs(expand []string, body Wfmhistoricaladherencequeryforagent) (*Wfmagenthistoricaladherenceresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/agents/me/adherence/historical/jobs"
	defaultReturn := new(Wfmagenthistoricaladherenceresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
// PostWorkforcemanagementAgentschedulesManagementunitsMine invokes POST /api/v2/workforcemanagement/agentschedules/managementunits/mine
//
// Fetch agent schedules for the logged in user's management unit
func (a WorkforceManagementApi) PostWorkforcemanagementAgentschedulesManagementunitsMine(body Agentmuschedulequery, forceAsync bool, forceDownloadService bool) (*Agentmuqueryresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/agentschedules/managementunits/mine"
	defaultReturn := new(Agentmuqueryresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling WorkforceManagementApi->PostWorkforcemanagementAgentschedulesManagementunitsMine")
	}
	...
	var successPayload *Agentmuqueryresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Agentmuqueryresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostWorkforcemanagementBusinessunitCapacityplanCopy invokes POST /api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/copy
//
// Copy a capacity plan
func (a WorkforceManagementApi) PostWorkforcemanagementBusinessunitCapacityplanCopy(businessUnitId string, capacityPlanId string, body Copycapacityplanrequest) (*Capacityplanresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/copy"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	path = strings.Replace(path, "{capacityPlanId}", url.PathEscape(fmt.Sprintf("%v", capacityPlanId)), -1)
	defaultReturn := new(Capacityplanresponse)
	if true == false {
	...
	if &businessUnitId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitCapacityplanCopy")
	}
	// verify the required parameter 'capacityPlanId' is set
	if &capacityPlanId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'capacityPlanId' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitCapacityplanCopy")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitCapacityplanCopy")
	}
...
// PostWorkforcemanagementBusinessunitCapacityplanRequirementGenerate invokes POST /api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/requirement/generate
//
// Regenerate requirements for capacity plan
func (a WorkforceManagementApi) PostWorkforcemanagementBusinessunitCapacityplanRequirementGenerate(businessUnitId string, capacityPlanId string) (*Capacityplanstaffingrequirementresult, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/requirement/generate"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	path = strings.Replace(path, "{capacityPlanId}", url.PathEscape(fmt.Sprintf("%v", capacityPlanId)), -1)
	defaultReturn := new(Capacityplanstaffingrequirementresult)
	if true == false {
	...
	if &businessUnitId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitCapacityplanRequirementGenerate")
	}
	// verify the required parameter 'capacityPlanId' is set
	if &capacityPlanId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'capacityPlanId' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitCapacityplanRequirementGenerate")
	}
...
// PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocations invokes POST /api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffinggroupallocations
//
// Create staffing group allocations for a capacity plan
func (a WorkforceManagementApi) PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocations(businessUnitId string, capacityPlanId string, body Createcapacityplanstaffinggroupmetricchangerequest) (*Capacityplanstaffinggroupmetricchangeresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffinggroupallocations"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	path = strings.Replace(path, "{capacityPlanId}", url.PathEscape(fmt.Sprintf("%v", capacityPlanId)), -1)
	defaultReturn := new(Capacityplanstaffinggroupmetricchangeresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &businessUnitId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocations")
	}
	// verify the required parameter 'capacityPlanId' is set
	if &capacityPlanId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'capacityPlanId' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocations")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocations")
	}
	...
	var successPayload *Capacityplanstaffinggroupmetricchangeresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Capacityplanstaffinggroupmetricchangeresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryQuery invokes POST /api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffinggroupallocationshistory/query
//
// Query staffing groups allocations history for a capacity plan
func (a WorkforceManagementApi) PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryQuery(businessUnitId string, capacityPlanId string, body Querycapacityplanstaffinggroupmetricchangehistory) (*Capacityplanstaffinggroupmetricchangehistorylistresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffinggroupallocationshistory/query"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	path = strings.Replace(path, "{capacityPlanId}", url.PathEscape(fmt.Sprintf("%v", capacityPlanId)), -1)
	defaultReturn := new(Capacityplanstaffinggroupmetricchangehistorylistresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &businessUnitId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryQuery")
	}
	// verify the required parameter 'capacityPlanId' is set
	if &capacityPlanId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'capacityPlanId' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryQuery")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryQuery")
	}
	...
	var successPayload *Capacityplanstaffinggroupmetricchangehistorylistresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Capacityplanstaffinggroupmetricchangehistorylistresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostWorkforcemanagementBusinessunitCapacityplanningLongtermrequirementsAutomaticbestmethodWeekForecastForceregenerate invokes POST /api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplanning/longtermrequirements/automaticbestmethod/weeks/{weekDateId}/forecasts/{forecastId}/forceregenerate
//
// Force regenerate the latest long term staffing requirements for a business unit
func (a WorkforceManagementApi) PostWorkforcemanagementBusinessunitCapacityplanningLongtermrequirementsAutomaticbestmethodWeekForecastForceregenerate(businessUnitId string, weekDateId time.Time, forecastId string) (*Longtermrequirementsresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplanning/longtermrequirements/automaticbestmethod/weeks/{weekDateId}/forecasts/{forecastId}/forceregenerate"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	path = strings.Replace(path, "{weekDateId}", url.PathEscape(fmt.Sprintf("%v", weekDateId)), -1)
	path = strings.Replace(path, "{forecastId}", url.PathEscape(fmt.Sprintf("%v", forecastId)), -1)
	defaultReturn := new(Longtermrequirementsresponse)
	...
	if &businessUnitId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitCapacityplanningLongtermrequirementsAutomaticbestmethodWeekForecastForceregenerate")
	}
	// verify the required parameter 'weekDateId' is set
	if &weekDateId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'weekDateId' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitCapacityplanningLongtermrequirementsAutomaticbestmethodWeekForecastForceregenerate")
	}
	// verify the required parameter 'forecastId' is set
	if &forecastId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'forecastId' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitCapacityplanningLongtermrequirementsAutomaticbestmethodWeekForecastForceregenerate")
	}
...
// PostWorkforcemanagementBusinessunitCapacityplans invokes POST /api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans
//
// Create a new capacity plan
func (a WorkforceManagementApi) PostWorkforcemanagementBusinessunitCapacityplans(businessUnitId string, body Capacityplanrequest) (*Capacityplanresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	...
	if &businessUnitId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitCapacityplans")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitCapacityplans")
	}
...
// PostWorkforcemanagementBusinessunitCapacityplansBulkRemove invokes POST /api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/bulk/remove
//
// Delete capacity plans in a business unit
func (a WorkforceManagementApi) PostWorkforcemanagementBusinessunitCapacityplansBulkRemove(businessUnitId string, body Capacityplandeleterequest) (*APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/bulk/remove"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &businessUnitId == nil {
		// false
		return nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitCapacityplansBulkRemove")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return nil, errors.New("Missing required parameter 'body' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitCapacityplansBulkRemove")
	}
...
// PostWorkforcemanagementBusinessunitStaffinggroupsPlanninggroupsQuery invokes POST /api/v2/workforcemanagement/businessunits/{businessUnitId}/staffinggroups/planninggroups/query
//
// Gets a list of planning group to staffing groups list association
func (a WorkforceManagementApi) PostWorkforcemanagementBusinessunitStaffinggroupsPlanninggroupsQuery(businessUnitId string, body Queryplanninggrouptostaffinggroupsrequest) (*Planninggrouptostaffinggroupslisting, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}/staffinggroups/planninggroups/query"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	defaultReturn := new(Planninggrouptostaffinggroupslisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &businessUnitId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitStaffinggroupsPlanninggroupsQuery")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitStaffinggroupsPlanninggroupsQuery")
	}
	...
	var successPayload *Planninggrouptostaffinggroupslisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Planninggrouptostaffinggroupslisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostWorkforcemanagementBusinessunitUnavailabletimesSchedulesQuery invokes POST /api/v2/workforcemanagement/businessunits/{businessUnitId}/unavailabletimes/schedules/query
//
// Get agent schedule generation unavailable times
func (a WorkforceManagementApi) PostWorkforcemanagementBusinessunitUnavailabletimesSchedulesQuery(businessUnitId string, body Queryagentscheduleunavailabletimesrequest) (*Queryagentscheduleunavailabletimesresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}/unavailabletimes/schedules/query"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	defaultReturn := new(Queryagentscheduleunavailabletimesresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &businessUnitId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitUnavailabletimesSchedulesQuery")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitUnavailabletimesSchedulesQuery")
	}
	...
	var successPayload *Queryagentscheduleunavailabletimesresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Queryagentscheduleunavailabletimesresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostWorkforcemanagementBusinessunitUnavailabletimesSettingsQuery invokes POST /api/v2/workforcemanagement/businessunits/{businessUnitId}/unavailabletimes/settings/query
//
// Query availability management units settings
func (a WorkforceManagementApi) PostWorkforcemanagementBusinessunitUnavailabletimesSettingsQuery(businessUnitId string, body Queryavailabilitymanagementunitssettingsrequest) (*Queryavailabilitymanagementunitssettingsresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits/{businessUnitId}/unavailabletimes/settings/query"
	path = strings.Replace(path, "{businessUnitId}", url.PathEscape(fmt.Sprintf("%v", businessUnitId)), -1)
	defaultReturn := new(Queryavailabilitymanagementunitssettingsresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &businessUnitId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'businessUnitId' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitUnavailabletimesSettingsQuery")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling WorkforceManagementApi->PostWorkforcemanagementBusinessunitUnavailabletimesSettingsQuery")
	}
	...
	var successPayload *Queryavailabilitymanagementunitssettingsresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Queryavailabilitymanagementunitssettingsresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a WorkforceManagementApi) PostWorkforcemanagementBusinessunits(body Createbusinessunitrequest, includeSchedulingDefaultMessageSeverities bool) (*Businessunitresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/businessunits"
	defaultReturn := new(Businessunitresponse)
...
// PostWorkforcemanagementHistoricaldataBulkRemoveJobs invokes POST /api/v2/workforcemanagement/historicaldata/bulk/remove/jobs
//
// Delete the list of the historical data import entries
func (a WorkforceManagementApi) PostWorkforcemanagementHistoricaldataBulkRemoveJobs(body Historicalimportdeletefilesjobrequest) (*Historicalimportdeletefilesjobresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/historicaldata/bulk/remove/jobs"
	defaultReturn := new(Historicalimportdeletefilesjobresponse)
...
func (a WorkforceManagementApi) PostWorkforcemanagementHistoricaldataValidate(body Validationservicerequest) (*Validationserviceasyncresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/historicaldata/validate"
	defaultReturn := new(Validationserviceasyncresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Validationserviceasyncresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Validationserviceasyncresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostWorkforcemanagementUnavailabletimesQuery invokes POST /api/v2/workforcemanagement/unavailabletimes/query
//
// Get agent unavailable times
func (a WorkforceManagementApi) PostWorkforcemanagementUnavailabletimesQuery(body Queryagentunavailabletimesrequest) (*Unavailabletimelisting, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/unavailabletimes/query"
	defaultReturn := new(Unavailabletimelisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling WorkforceManagementApi->PostWorkforcemanagementUnavailabletimesQuery")
	}
...
// PostWorkforcemanagementUnavailabletimesValidationJobs invokes POST /api/v2/workforcemanagement/unavailabletimes/validation/jobs
//
...
func (a WorkforceManagementApi) PostWorkforcemanagementUnavailabletimesValidationJobs(body Validateagentunavailabletimesrequest) (*Validateagentunavailabletimesresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/workforcemanagement/unavailabletimes/validation/jobs"
	defaultReturn := new(Validateagentunavailabletimesresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling WorkforceManagementApi->PostWorkforcemanagementUnavailabletimesValidationJobs")
	}
	...
	var successPayload *Validateagentunavailabletimesresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Validateagentunavailabletimesresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
