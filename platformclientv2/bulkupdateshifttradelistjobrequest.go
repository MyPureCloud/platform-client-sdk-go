...
func (o *Bulkupdateshifttradelistjobrequest) SetField(field string, fieldValue interface{}) {
...
func (o Bulkupdateshifttradelistjobrequest) MarshalJSON() ([]byte, error) {
...
func (o *Bulkupdateshifttradelistjobrequest) UnmarshalJSON(b []byte) error {
	var BulkupdateshifttradelistjobrequestMap map[string]interface{}
	err := json.Unmarshal(b, &BulkupdateshifttradelistjobrequestMap)
	if err != nil {
		return err
	}
	
	if ManagementUnitIds, ok := BulkupdateshifttradelistjobrequestMap["managementUnitIds"].([]interface{}); ok {
		ManagementUnitIdsString, _ := json.Marshal(ManagementUnitIds)
		json.Unmarshal(ManagementUnitIdsString, &o.ManagementUnitIds)
	}
	
	if WeekDates, ok := BulkupdateshifttradelistjobrequestMap["weekDates"].([]interface{}); ok {
		WeekDatesString, _ := json.Marshal(WeekDates)
		json.Unmarshal(WeekDatesString, &o.WeekDates)
	}
	
	if Entities, ok := BulkupdateshifttradelistjobrequestMap["entities"].([]interface{}); ok {
