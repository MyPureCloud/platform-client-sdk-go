...
func (o *Rollbackdecisiontableversionrequest) SetField(field string, fieldValue interface{}) {
...
func (o Rollbackdecisiontableversionrequest) MarshalJSON() ([]byte, error) {
...
func (o *Rollbackdecisiontableversionrequest) UnmarshalJSON(b []byte) error {
	var RollbackdecisiontableversionrequestMap map[string]interface{}
	err := json.Unmarshal(b, &RollbackdecisiontableversionrequestMap)
	if err != nil {
		return err
	}
	
	if RollbackReason, ok := RollbackdecisiontableversionrequestMap["rollbackReason"].(string); ok {
