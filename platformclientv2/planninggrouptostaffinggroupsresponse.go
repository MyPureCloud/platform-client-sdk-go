...
func (o *Planninggrouptostaffinggroupsresponse) SetField(field string, fieldValue interface{}) {
...
func (o Planninggrouptostaffinggroupsresponse) MarshalJSON() ([]byte, error) {
...
func (o *Planninggrouptostaffinggroupsresponse) UnmarshalJSON(b []byte) error {
	var PlanninggrouptostaffinggroupsresponseMap map[string]interface{}
	err := json.Unmarshal(b, &PlanninggrouptostaffinggroupsresponseMap)
	if err != nil {
		return err
	}
	
	if PlanningGroup, ok := PlanninggrouptostaffinggroupsresponseMap["planningGroup"].(map[string]interface{}); ok {
		PlanningGroupString, _ := json.Marshal(PlanningGroup)
		json.Unmarshal(PlanningGroupString, &o.PlanningGroup)
	}
	
	if StaffingGroups, ok := PlanninggrouptostaffinggroupsresponseMap["staffingGroups"].([]interface{}); ok {
