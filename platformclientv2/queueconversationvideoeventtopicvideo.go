...
func (o *Queueconversationvideoeventtopicvideo) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationvideoeventtopicvideo) UnmarshalJSON(b []byte) error {
	...
	if PeerCount, ok := QueueconversationvideoeventtopicvideoMap["peerCount"].(float64); ok {
