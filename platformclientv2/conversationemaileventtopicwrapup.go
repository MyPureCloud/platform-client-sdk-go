...
func (o *Conversationemaileventtopicwrapup) SetField(field string, fieldValue interface{}) {
...
func (o *Conversationemaileventtopicwrapup) UnmarshalJSON(b []byte) error {
	...
	if AdditionalProperties, ok := ConversationemaileventtopicwrapupMap["additionalProperties"].(map[string]interface{}); ok {
