...
func (o Campaignruleweekdayofmonthparameters) MarshalJSON() ([]byte, error) {
...
func (o *Campaignruleweekdayofmonthparameters) UnmarshalJSON(b []byte) error {
	var CampaignruleweekdayofmonthparametersMap map[string]interface{}
