...
type V2mobiusrulestopiccondition struct { 
	...
	// Clauses
	Clauses *[]V2mobiusrulestopiccondition `json:"clauses,omitempty"`
...
func (o *V2mobiusrulestopiccondition) SetField(field string, fieldValue interface{}) {
...
func (o *V2mobiusrulestopiccondition) UnmarshalJSON(b []byte) error {
	...
	if Id, ok := V2mobiusrulestopicconditionMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Clauses, ok := V2mobiusrulestopicconditionMap["clauses"].([]interface{}); ok {
