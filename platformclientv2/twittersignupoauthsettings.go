...
func (o *Twittersignupoauthsettings) SetField(field string, fieldValue interface{}) {
...
func (o Twittersignupoauthsettings) MarshalJSON() ([]byte, error) {
...
func (o *Twittersignupoauthsettings) UnmarshalJSON(b []byte) error {
	var TwittersignupoauthsettingsMap map[string]interface{}
	err := json.Unmarshal(b, &TwittersignupoauthsettingsMap)
	if err != nil {
		return err
	}
	
	if ClientId, ok := TwittersignupoauthsettingsMap["clientId"].(string); ok {
		o.ClientId = &ClientId
	}
    
	if Scopes, ok := TwittersignupoauthsettingsMap["scopes"].([]interface{}); ok {
		ScopesString, _ := json.Marshal(Scopes)
		json.Unmarshal(ScopesString, &o.Scopes)
	}
	
	if AppId, ok := TwittersignupoauthsettingsMap["appId"].(string); ok {
		o.AppId = &AppId
	}
