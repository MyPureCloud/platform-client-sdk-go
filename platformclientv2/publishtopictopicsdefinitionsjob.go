...
type Publishtopictopicsdefinitionsjob struct { 
	...
	TestTopicPhraseResults *[]Publishtopictesttopicphraseresults `json:"testTopicPhraseResults,omitempty"`
...
func (o *Publishtopictopicsdefinitionsjob) SetField(field string, fieldValue interface{}) {
...
func (o *Publishtopictopicsdefinitionsjob) UnmarshalJSON(b []byte) error {
	...
	if TestTopicPhraseResults, ok := PublishtopictopicsdefinitionsjobMap["testTopicPhraseResults"].([]interface{}); ok {
	...
	if GenAIPhrasesResults, ok := PublishtopictopicsdefinitionsjobMap["genAIPhrasesResults"].([]interface{}); ok {
