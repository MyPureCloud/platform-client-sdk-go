...
func (o *Contentdatepickeravailabletime) SetField(field string, fieldValue interface{}) {
...
func (o Contentdatepickeravailabletime) MarshalJSON() ([]byte, error) {
...
func (o *Contentdatepickeravailabletime) UnmarshalJSON(b []byte) error {
	var ContentdatepickeravailabletimeMap map[string]interface{}
	err := json.Unmarshal(b, &ContentdatepickeravailabletimeMap)
	if err != nil {
		return err
	}
	
	if Duration, ok := ContentdatepickeravailabletimeMap["duration"].(float64); ok {
		DurationInt := int(Duration)
		o.Duration = &DurationInt
	}
	
	if dateTimeString, ok := ContentdatepickeravailabletimeMap["dateTime"].(string); ok {
