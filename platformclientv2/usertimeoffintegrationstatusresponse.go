...
func (o *Usertimeoffintegrationstatusresponse) SetField(field string, fieldValue interface{}) {
...
func (o Usertimeoffintegrationstatusresponse) MarshalJSON() ([]byte, error) {
...
func (o *Usertimeoffintegrationstatusresponse) UnmarshalJSON(b []byte) error {
	var UsertimeoffintegrationstatusresponseMap map[string]interface{}
	err := json.Unmarshal(b, &UsertimeoffintegrationstatusresponseMap)
	if err != nil {
		return err
	}
	
	if TimeOffRequest, ok := UsertimeoffintegrationstatusresponseMap["timeOffRequest"].(map[string]interface{}); ok {
		TimeOffRequestString, _ := json.Marshal(TimeOffRequest)
		json.Unmarshal(TimeOffRequestString, &o.TimeOffRequest)
	}
	
	if IntegrationStatus, ok := UsertimeoffintegrationstatusresponseMap["integrationStatus"].(string); ok {
		o.IntegrationStatus = &IntegrationStatus
	}
    
	if User, ok := UsertimeoffintegrationstatusresponseMap["user"].(map[string]interface{}); ok {
