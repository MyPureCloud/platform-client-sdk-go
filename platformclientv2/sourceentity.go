...
func (o *Sourceentity) SetField(field string, fieldValue interface{}) {
...
func (o Sourceentity) MarshalJSON() ([]byte, error) {
...
func (o *Sourceentity) UnmarshalJSON(b []byte) error {
	var SourceentityMap map[string]interface{}
	err := json.Unmarshal(b, &SourceentityMap)
	if err != nil {
		return err
	}
	
	if Id, ok := SourceentityMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if VarType, ok := SourceentityMap["type"].(string); ok {
		o.VarType = &VarType
	}
