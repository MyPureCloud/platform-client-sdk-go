...
func (o *Learningmodulepreviewupdateresponsecurrentstep) SetField(field string, fieldValue interface{}) {
...
func (o Learningmodulepreviewupdateresponsecurrentstep) MarshalJSON() ([]byte, error) {
...
func (o *Learningmodulepreviewupdateresponsecurrentstep) UnmarshalJSON(b []byte) error {
	var LearningmodulepreviewupdateresponsecurrentstepMap map[string]interface{}
	err := json.Unmarshal(b, &LearningmodulepreviewupdateresponsecurrentstepMap)
	if err != nil {
		return err
	}
	
	if ShareableContentObject, ok := LearningmodulepreviewupdateresponsecurrentstepMap["shareableContentObject"].(map[string]interface{}); ok {
