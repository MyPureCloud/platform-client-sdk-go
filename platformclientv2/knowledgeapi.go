...
// PatchKnowledgeKnowledgebaseContext invokes PATCH /api/v2/knowledge/knowledgebases/{knowledgeBaseId}/contexts/{contextId}
//
// Update specific context data of the knowledge base.
//
// 
func (a KnowledgeApi) PatchKnowledgeKnowledgebaseContext(knowledgeBaseId string, contextId string, body Knowledgecontextrequest) (*Knowledgecontextresponse, *APIResponse, error) {
	var httpMethod = "PATCH"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/contexts/{contextId}"
	path = strings.Replace(path, "{knowledgeBaseId}", fmt.Sprintf("%v", knowledgeBaseId), -1)
	path = strings.Replace(path, "{contextId}", fmt.Sprintf("%v", contextId), -1)
	defaultReturn := new(Knowledgecontextresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &knowledgeBaseId == nil {
		// 
		return defaultReturn, nil, errors.New("Missing required parameter 'knowledgeBaseId' when calling KnowledgeApi->PatchKnowledgeKnowledgebaseContext")
	}
	// verify the required parameter 'contextId' is set
	if &contextId == nil {
		// 
		return defaultReturn, nil, errors.New("Missing required parameter 'contextId' when calling KnowledgeApi->PatchKnowledgeKnowledgebaseContext")
	}
	...
	var successPayload *Knowledgecontextresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes)
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Knowledgecontextresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PatchKnowledgeKnowledgebaseContextValue invokes PATCH /api/v2/knowledge/knowledgebases/{knowledgeBaseId}/contexts/{contextId}/values/{contextValueId}
//
// Update context value.
//
// 
func (a KnowledgeApi) PatchKnowledgeKnowledgebaseContextValue(knowledgeBaseId string, contextId string, contextValueId string, body Knowledgecontextvaluerequest) (*Knowledgecontextvalueresponse, *APIResponse, error) {
	var httpMethod = "PATCH"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/contexts/{contextId}/values/{contextValueId}"
	path = strings.Replace(path, "{knowledgeBaseId}", fmt.Sprintf("%v", knowledgeBaseId), -1)
	path = strings.Replace(path, "{contextId}", fmt.Sprintf("%v", contextId), -1)
	path = strings.Replace(path, "{contextValueId}", fmt.Sprintf("%v", contextValueId), -1)
	defaultReturn := new(Knowledgecontextvalueresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &knowledgeBaseId == nil {
		// 
		return defaultReturn, nil, errors.New("Missing required parameter 'knowledgeBaseId' when calling KnowledgeApi->PatchKnowledgeKnowledgebaseContextValue")
	}
	// verify the required parameter 'contextId' is set
	if &contextId == nil {
		// 
		return defaultReturn, nil, errors.New("Missing required parameter 'contextId' when calling KnowledgeApi->PatchKnowledgeKnowledgebaseContextValue")
	}
	// verify the required parameter 'contextValueId' is set
	if &contextValueId == nil {
		// 
		return defaultReturn, nil, errors.New("Missing required parameter 'contextValueId' when calling KnowledgeApi->PatchKnowledgeKnowledgebaseContextValue")
	}
	...
	var successPayload *Knowledgecontextvalueresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes)
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Knowledgecontextvalueresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
