...
type Conversationvideoeventtopicqueuemediasettings struct { 
...
func (o *Conversationvideoeventtopicqueuemediasettings) SetField(field string, fieldValue interface{}) {
...
func (o Conversationvideoeventtopicqueuemediasettings) MarshalJSON() ([]byte, error) {
	...
	type Alias Conversationvideoeventtopicqueuemediasettings
...
func (o *Conversationvideoeventtopicqueuemediasettings) UnmarshalJSON(b []byte) error {
	var ConversationvideoeventtopicqueuemediasettingsMap map[string]interface{}
	err := json.Unmarshal(b, &ConversationvideoeventtopicqueuemediasettingsMap)
	if err != nil {
		return err
	}
	
	if AlertingTimeoutSeconds, ok := ConversationvideoeventtopicqueuemediasettingsMap["alertingTimeoutSeconds"].(float64); ok {
		AlertingTimeoutSecondsInt := int(AlertingTimeoutSeconds)
		o.AlertingTimeoutSeconds = &AlertingTimeoutSecondsInt
	}
	
	if AutoAnswerAlertToneSeconds, ok := ConversationvideoeventtopicqueuemediasettingsMap["autoAnswerAlertToneSeconds"].(float64); ok {
	...
	if ManualAnswerAlertToneSeconds, ok := ConversationvideoeventtopicqueuemediasettingsMap["manualAnswerAlertToneSeconds"].(float64); ok {
	...
	if EnableAutoAnswer, ok := ConversationvideoeventtopicqueuemediasettingsMap["enableAutoAnswer"].(bool); ok {
...
func (o *Conversationvideoeventtopicqueuemediasettings) String() string {
	j, _ := json.Marshal(o)
