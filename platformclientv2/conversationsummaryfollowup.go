...
func (o *Conversationsummaryfollowup) SetField(field string, fieldValue interface{}) {
...
func (o Conversationsummaryfollowup) MarshalJSON() ([]byte, error) {
...
func (o *Conversationsummaryfollowup) UnmarshalJSON(b []byte) error {
	var ConversationsummaryfollowupMap map[string]interface{}
	err := json.Unmarshal(b, &ConversationsummaryfollowupMap)
	if err != nil {
		return err
	}
	...
	if Description, ok := ConversationsummaryfollowupMap["description"].(string); ok {
