...
func (o *Flowexecutionaggregationquery) SetField(field string, fieldValue interface{}) {
...
func (o Flowexecutionaggregationquery) MarshalJSON() ([]byte, error) {
...
func (o *Flowexecutionaggregationquery) UnmarshalJSON(b []byte) error {
	var FlowexecutionaggregationqueryMap map[string]interface{}
	err := json.Unmarshal(b, &FlowexecutionaggregationqueryMap)
	if err != nil {
		return err
	}
	
	if Interval, ok := FlowexecutionaggregationqueryMap["interval"].(string); ok {
		o.Interval = &Interval
	}
    
	if Granularity, ok := FlowexecutionaggregationqueryMap["granularity"].(string); ok {
		o.Granularity = &Granularity
	}
    
	if TimeZone, ok := FlowexecutionaggregationqueryMap["timeZone"].(string); ok {
		o.TimeZone = &TimeZone
	}
    
	if GroupBy, ok := FlowexecutionaggregationqueryMap["groupBy"].([]interface{}); ok {
		GroupByString, _ := json.Marshal(GroupBy)
		json.Unmarshal(GroupByString, &o.GroupBy)
	}
	
	if Filter, ok := FlowexecutionaggregationqueryMap["filter"].(map[string]interface{}); ok {
		FilterString, _ := json.Marshal(Filter)
		json.Unmarshal(FilterString, &o.Filter)
	}
	
	if Metrics, ok := FlowexecutionaggregationqueryMap["metrics"].([]interface{}); ok {
		MetricsString, _ := json.Marshal(Metrics)
		json.Unmarshal(MetricsString, &o.Metrics)
	}
	
	if FlattenMultivaluedDimensions, ok := FlowexecutionaggregationqueryMap["flattenMultivaluedDimensions"].(bool); ok {
		o.FlattenMultivaluedDimensions = &FlattenMultivaluedDimensions
	}
    
	if Views, ok := FlowexecutionaggregationqueryMap["views"].([]interface{}); ok {
		ViewsString, _ := json.Marshal(Views)
		json.Unmarshal(ViewsString, &o.Views)
	}
	
	if AlternateTimeDimension, ok := FlowexecutionaggregationqueryMap["alternateTimeDimension"].(string); ok {
