...
type Queueconversationchateventtopicqueuemediasettings struct { 
...
func (o *Queueconversationchateventtopicqueuemediasettings) SetField(field string, fieldValue interface{}) {
...
func (o Queueconversationchateventtopicqueuemediasettings) MarshalJSON() ([]byte, error) {
	...
	type Alias Queueconversationchateventtopicqueuemediasettings
...
func (o *Queueconversationchateventtopicqueuemediasettings) UnmarshalJSON(b []byte) error {
	var QueueconversationchateventtopicqueuemediasettingsMap map[string]interface{}
	err := json.Unmarshal(b, &QueueconversationchateventtopicqueuemediasettingsMap)
	if err != nil {
		return err
	}
	
	if AlertingTimeoutSeconds, ok := QueueconversationchateventtopicqueuemediasettingsMap["alertingTimeoutSeconds"].(float64); ok {
		AlertingTimeoutSecondsInt := int(AlertingTimeoutSeconds)
		o.AlertingTimeoutSeconds = &AlertingTimeoutSecondsInt
	}
	
	if AutoAnswerAlertToneSeconds, ok := QueueconversationchateventtopicqueuemediasettingsMap["autoAnswerAlertToneSeconds"].(float64); ok {
	...
	if ManualAnswerAlertToneSeconds, ok := QueueconversationchateventtopicqueuemediasettingsMap["manualAnswerAlertToneSeconds"].(float64); ok {
	...
	if EnableAutoAnswer, ok := QueueconversationchateventtopicqueuemediasettingsMap["enableAutoAnswer"].(bool); ok {
...
func (o *Queueconversationchateventtopicqueuemediasettings) String() string {
	j, _ := json.Marshal(o)
