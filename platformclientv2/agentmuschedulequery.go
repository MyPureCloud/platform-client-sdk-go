...
func (o *Agentmuschedulequery) SetField(field string, fieldValue interface{}) {
...
func (o Agentmuschedulequery) MarshalJSON() ([]byte, error) {
...
func (o *Agentmuschedulequery) UnmarshalJSON(b []byte) error {
	var AgentmuschedulequeryMap map[string]interface{}
	err := json.Unmarshal(b, &AgentmuschedulequeryMap)
	if err != nil {
		return err
	}
	
	if startDateString, ok := AgentmuschedulequeryMap["startDate"].(string); ok {
		StartDate, _ := time.Parse("2006-01-02T15:04:05.999999Z", startDateString)
		o.StartDate = &StartDate
	}
	
	if endDateString, ok := AgentmuschedulequeryMap["endDate"].(string); ok {
