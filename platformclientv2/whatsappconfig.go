...
type Whatsappconfig struct { 
	...
	WhatsAppIntegration *Addressableentityref `json:"whatsAppIntegration,omitempty"`
...
func (o *Whatsappconfig) SetField(field string, fieldValue interface{}) {
...
func (o Whatsappconfig) MarshalJSON() ([]byte, error) {
	...
	return json.Marshal(&struct { 
		...
		WhatsAppIntegration: o.WhatsAppIntegration,
...
func (o *Whatsappconfig) UnmarshalJSON(b []byte) error {
	var WhatsappconfigMap map[string]interface{}
	err := json.Unmarshal(b, &WhatsappconfigMap)
	if err != nil {
		return err
	}
	
	if WhatsAppColumns, ok := WhatsappconfigMap["whatsAppColumns"].([]interface{}); ok {
		WhatsAppColumnsString, _ := json.Marshal(WhatsAppColumns)
		json.Unmarshal(WhatsAppColumnsString, &o.WhatsAppColumns)
	}
	
	if WhatsAppIntegration, ok := WhatsappconfigMap["whatsAppIntegration"].(map[string]interface{}); ok {
		WhatsAppIntegrationString, _ := json.Marshal(WhatsAppIntegration)
		json.Unmarshal(WhatsAppIntegrationString, &o.WhatsAppIntegration)
	}
	
	if ContentTemplate, ok := WhatsappconfigMap["contentTemplate"].(map[string]interface{}); ok {
