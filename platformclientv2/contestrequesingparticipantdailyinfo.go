...
func (o *Contestrequesingparticipantdailyinfo) SetField(field string, fieldValue interface{}) {
...
func (o Contestrequesingparticipantdailyinfo) MarshalJSON() ([]byte, error) {
...
func (o *Contestrequesingparticipantdailyinfo) UnmarshalJSON(b []byte) error {
	var ContestrequesingparticipantdailyinfoMap map[string]interface{}
	err := json.Unmarshal(b, &ContestrequesingparticipantdailyinfoMap)
	if err != nil {
		return err
	}
	
	if dateWorkdayString, ok := ContestrequesingparticipantdailyinfoMap["dateWorkday"].(string); ok {
		DateWorkday, _ := time.Parse("2006-01-02", dateWorkdayString)
		o.DateWorkday = &DateWorkday
	}
	
	if ContestScore, ok := ContestrequesingparticipantdailyinfoMap["contestScore"].(map[string]interface{}); ok {
