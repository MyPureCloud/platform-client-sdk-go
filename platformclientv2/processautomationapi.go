...
// DeleteProcessautomationScheduledtrigger invokes DELETE /api/v2/processautomation/scheduledtriggers/{scheduledTriggerId}
//
// Delete a Scheduled Trigger
func (a ProcessAutomationApi) DeleteProcessautomationScheduledtrigger(scheduledTriggerId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/processautomation/scheduledtriggers/{scheduledTriggerId}"
	path = strings.Replace(path, "{scheduledTriggerId}", url.PathEscape(fmt.Sprintf("%v", scheduledTriggerId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}

	// verify the required parameter 'scheduledTriggerId' is set
	if &scheduledTriggerId == nil {
		// false
		return nil, errors.New("Missing required parameter 'scheduledTriggerId' when calling ProcessAutomationApi->DeleteProcessautomationScheduledtrigger")
	}
...
// GetProcessautomationScheduledtrigger invokes GET /api/v2/processautomation/scheduledtriggers/{scheduledTriggerId}
//
// Retrieve a single Scheduled Trigger matching id
func (a ProcessAutomationApi) GetProcessautomationScheduledtrigger(scheduledTriggerId string) (*Scheduledtrigger, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/processautomation/scheduledtriggers/{scheduledTriggerId}"
	path = strings.Replace(path, "{scheduledTriggerId}", url.PathEscape(fmt.Sprintf("%v", scheduledTriggerId)), -1)
	defaultReturn := new(Scheduledtrigger)
	if true == false {
	...
	if &scheduledTriggerId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'scheduledTriggerId' when calling ProcessAutomationApi->GetProcessautomationScheduledtrigger")
	}
	...
	var successPayload *Scheduledtrigger
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
// GetProcessautomationScheduledtriggers invokes GET /api/v2/processautomation/scheduledtriggers
//
// Retrieves all scheduled triggers, optionally filtered by query parameters.
func (a ProcessAutomationApi) GetProcessautomationScheduledtriggers(before string, after string, pageSize string, enabled bool) (*Scheduledtriggerentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/processautomation/scheduledtriggers"
	defaultReturn := new(Scheduledtriggerentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Scheduledtriggerentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Scheduledtriggerentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostProcessautomationScheduledtriggers invokes POST /api/v2/processautomation/scheduledtriggers
//
// Create a scheduled Trigger
func (a ProcessAutomationApi) PostProcessautomationScheduledtriggers(body Createscheduledtriggerrequest) (*Scheduledtrigger, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/processautomation/scheduledtriggers"
	defaultReturn := new(Scheduledtrigger)
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ProcessAutomationApi->PostProcessautomationScheduledtriggers")
	}
...
// PutProcessautomationScheduledtrigger invokes PUT /api/v2/processautomation/scheduledtriggers/{scheduledTriggerId}
//
// Update a Scheduled Trigger
func (a ProcessAutomationApi) PutProcessautomationScheduledtrigger(scheduledTriggerId string, body Updatescheduledtriggerrequest) (*Scheduledtrigger, *APIResponse, error) {
	var httpMethod = "PUT"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/processautomation/scheduledtriggers/{scheduledTriggerId}"
	path = strings.Replace(path, "{scheduledTriggerId}", url.PathEscape(fmt.Sprintf("%v", scheduledTriggerId)), -1)
	...
	if &scheduledTriggerId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'scheduledTriggerId' when calling ProcessAutomationApi->PutProcessautomationScheduledtrigger")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ProcessAutomationApi->PutProcessautomationScheduledtrigger")
	}
