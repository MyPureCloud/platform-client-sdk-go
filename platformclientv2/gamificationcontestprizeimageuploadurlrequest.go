...
func (o *Gamificationcontestprizeimageuploadurlrequest) SetField(field string, fieldValue interface{}) {
...
func (o Gamificationcontestprizeimageuploadurlrequest) MarshalJSON() ([]byte, error) {
...
func (o *Gamificationcontestprizeimageuploadurlrequest) UnmarshalJSON(b []byte) error {
	var GamificationcontestprizeimageuploadurlrequestMap map[string]interface{}
	err := json.Unmarshal(b, &GamificationcontestprizeimageuploadurlrequestMap)
	if err != nil {
		return err
	}
	
	if FileName, ok := GamificationcontestprizeimageuploadurlrequestMap["fileName"].(string); ok {
		o.FileName = &FileName
	}
    
	if ContentMd5, ok := GamificationcontestprizeimageuploadurlrequestMap["contentMd5"].(string); ok {
		o.ContentMd5 = &ContentMd5
	}
    
	if SignedUrlTimeoutSeconds, ok := GamificationcontestprizeimageuploadurlrequestMap["signedUrlTimeoutSeconds"].(float64); ok {
		SignedUrlTimeoutSecondsInt := int(SignedUrlTimeoutSeconds)
		o.SignedUrlTimeoutSeconds = &SignedUrlTimeoutSecondsInt
	}
	
	if ContentType, ok := GamificationcontestprizeimageuploadurlrequestMap["contentType"].(string); ok {
		o.ContentType = &ContentType
	}
    
	if ContentLength, ok := GamificationcontestprizeimageuploadurlrequestMap["contentLength"].(float64); ok {
		ContentLengthInt := int(ContentLength)
		o.ContentLength = &ContentLengthInt
	}
	
	if ServerSideEncryption, ok := GamificationcontestprizeimageuploadurlrequestMap["serverSideEncryption"].(string); ok {
