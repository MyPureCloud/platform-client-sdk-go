...
func NewConversationsApi() *ConversationsApi {
	...
	config.Debug(fmt.Sprintf("Creating ConversationsApi with base path: %s", strings.ToLower(config.BasePath)))
...
func NewConversationsApiWithConfig(config *Configuration) *ConversationsApi {
	config.Debugf("Creating ConversationsApi with base path: %s\n", strings.ToLower(config.BasePath))
	return &ConversationsApi{
		Configuration: config,
	}
}
