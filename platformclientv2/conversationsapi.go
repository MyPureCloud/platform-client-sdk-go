...
// DeleteConversation invokes DELETE /api/v2/conversations/{conversationId}
//
// Update a conversation by disconnecting all of the participants
func (a ConversationsApi) DeleteConversation(conversationId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	...
	if &conversationId == nil {
		// false
		return nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->DeleteConversation")
	}
...
// GetConversationCommunicationAgentchecklist invokes GET /api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/{agentChecklistId}
//
// Get checklist info for a single checklist.
func (a ConversationsApi) GetConversationCommunicationAgentchecklist(conversationId string, communicationId string, agentChecklistId string) (*Agentchecklistresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/{agentChecklistId}"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{communicationId}", url.PathEscape(fmt.Sprintf("%v", communicationId)), -1)
	path = strings.Replace(path, "{agentChecklistId}", url.PathEscape(fmt.Sprintf("%v", agentChecklistId)), -1)
	defaultReturn := new(Agentchecklistresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->GetConversationCommunicationAgentchecklist")
	}
	// verify the required parameter 'communicationId' is set
	if &communicationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'communicationId' when calling ConversationsApi->GetConversationCommunicationAgentchecklist")
	}
	// verify the required parameter 'agentChecklistId' is set
	if &agentChecklistId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'agentChecklistId' when calling ConversationsApi->GetConversationCommunicationAgentchecklist")
	}
	...
	var successPayload *Agentchecklistresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Agentchecklistresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetConversationCommunicationAgentchecklistJob invokes GET /api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/{agentChecklistId}/jobs/{jobId}
//
// Get inference job status
func (a ConversationsApi) GetConversationCommunicationAgentchecklistJob(conversationId string, communicationId string, agentChecklistId string, jobId string) (*Checklistinferencejobresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/{agentChecklistId}/jobs/{jobId}"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{communicationId}", url.PathEscape(fmt.Sprintf("%v", communicationId)), -1)
	path = strings.Replace(path, "{agentChecklistId}", url.PathEscape(fmt.Sprintf("%v", agentChecklistId)), -1)
	path = strings.Replace(path, "{jobId}", url.PathEscape(fmt.Sprintf("%v", jobId)), -1)
	defaultReturn := new(Checklistinferencejobresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->GetConversationCommunicationAgentchecklistJob")
	}
	// verify the required parameter 'communicationId' is set
	if &communicationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'communicationId' when calling ConversationsApi->GetConversationCommunicationAgentchecklistJob")
	}
	// verify the required parameter 'agentChecklistId' is set
	if &agentChecklistId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'agentChecklistId' when calling ConversationsApi->GetConversationCommunicationAgentchecklistJob")
	}
	// verify the required parameter 'jobId' is set
	if &jobId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'jobId' when calling ConversationsApi->GetConversationCommunicationAgentchecklistJob")
	}
	...
	var successPayload *Checklistinferencejobresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Checklistinferencejobresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetConversationCommunicationAgentchecklists invokes GET /api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists
//
// Get information of all checklists associated with a conversation.
func (a ConversationsApi) GetConversationCommunicationAgentchecklists(conversationId string, communicationId string) (*Agentchecklistresponselist, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{communicationId}", url.PathEscape(fmt.Sprintf("%v", communicationId)), -1)
	defaultReturn := new(Agentchecklistresponselist)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->GetConversationCommunicationAgentchecklists")
	}
	// verify the required parameter 'communicationId' is set
	if &communicationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'communicationId' when calling ConversationsApi->GetConversationCommunicationAgentchecklists")
	}
	...
	var successPayload *Agentchecklistresponselist
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Agentchecklistresponselist" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a ConversationsApi) GetConversationCommunicationInternalmessage(conversationId string, communicationId string, messageId string) (*Internalmessagedata, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/{conversationId}/communications/{communicationId}/internalmessages/{messageId}"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{communicationId}", url.PathEscape(fmt.Sprintf("%v", communicationId)), -1)
	path = strings.Replace(path, "{messageId}", url.PathEscape(fmt.Sprintf("%v", messageId)), -1)
	defaultReturn := new(Internalmessagedata)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->GetConversationCommunicationInternalmessage")
	}
	// verify the required parameter 'communicationId' is set
	if &communicationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'communicationId' when calling ConversationsApi->GetConversationCommunicationInternalmessage")
	}
	// verify the required parameter 'messageId' is set
	if &messageId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'messageId' when calling ConversationsApi->GetConversationCommunicationInternalmessage")
	}
	...
	var successPayload *Internalmessagedata
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
func (a ConversationsApi) GetConversationCommunicationInternalmessages(conversationId string, communicationId string, pageSize int, pageNumber int) (*Internalmessagedataentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/{conversationId}/communications/{communicationId}/internalmessages"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{communicationId}", url.PathEscape(fmt.Sprintf("%v", communicationId)), -1)
	defaultReturn := new(Internalmessagedataentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->GetConversationCommunicationInternalmessages")
	}
	// verify the required parameter 'communicationId' is set
	if &communicationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'communicationId' when calling ConversationsApi->GetConversationCommunicationInternalmessages")
	}
	...
	var successPayload *Internalmessagedataentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Internalmessagedataentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetConversationSuggestion invokes GET /api/v2/conversations/{conversationId}/suggestions/{suggestionId}
//
// Get Suggestion.
func (a ConversationsApi) GetConversationSuggestion(conversationId string, suggestionId string) (*Suggestion, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/{conversationId}/suggestions/{suggestionId}"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{suggestionId}", url.PathEscape(fmt.Sprintf("%v", suggestionId)), -1)
	defaultReturn := new(Suggestion)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->GetConversationSuggestion")
	}
	// verify the required parameter 'suggestionId' is set
	if &suggestionId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'suggestionId' when calling ConversationsApi->GetConversationSuggestion")
	}
...
// GetConversationSuggestions invokes GET /api/v2/conversations/{conversationId}/suggestions
//
// Get all suggestions for a conversation.
func (a ConversationsApi) GetConversationSuggestions(conversationId string, before string, after string, pageSize string, varType string, state string) (*Suggestionlisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/{conversationId}/suggestions"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	defaultReturn := new(Suggestionlisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->GetConversationSuggestions")
	}
	...
	var successPayload *Suggestionlisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
func (a ConversationsApi) GetConversationSummaries(conversationId string) (*Conversationsummariesgetresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/{conversationId}/summaries"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	defaultReturn := new(Conversationsummariesgetresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->GetConversationSummaries")
	}
	...
	var successPayload *Conversationsummariesgetresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Conversationsummariesgetresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a ConversationsApi) GetConversationsInternalmessage(conversationId string) (*Internalmessageconversation, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/internalmessages/{conversationId}"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	defaultReturn := new(Internalmessageconversation)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->GetConversationsInternalmessage")
	}
	...
	var successPayload *Internalmessageconversation
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Internalmessageconversation" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a ConversationsApi) GetConversationsInternalmessages() (*Internalmessageconversationentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/internalmessages"
	defaultReturn := new(Internalmessageconversationentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Internalmessageconversationentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Internalmessageconversationentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetConversationsMessageCommunicationMessagesMedia invokes GET /api/v2/conversations/messages/{conversationId}/communications/{communicationId}/messages/media
//
// Get message media list by status
func (a ConversationsApi) GetConversationsMessageCommunicationMessagesMedia(conversationId string, communicationId string, status string, pageNumber int, pageSize int) (*Messagemedialisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/messages/{conversationId}/communications/{communicationId}/messages/media"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{communicationId}", url.PathEscape(fmt.Sprintf("%v", communicationId)), -1)
	defaultReturn := new(Messagemedialisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->GetConversationsMessageCommunicationMessagesMedia")
	}
	// verify the required parameter 'communicationId' is set
	if &communicationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'communicationId' when calling ConversationsApi->GetConversationsMessageCommunicationMessagesMedia")
	}
	...
	var successPayload *Messagemedialisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
// GetConversationsMessagingFacebookPermissions invokes GET /api/v2/conversations/messaging/facebook/permissions
//
// Get a list of Facebook Permissions
func (a ConversationsApi) GetConversationsMessagingFacebookPermissions() (*Facebookpermissionentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/messaging/facebook/permissions"
	defaultReturn := new(Facebookpermissionentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Facebookpermissionentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Facebookpermissionentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a ConversationsApi) GetConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationId(integrationId string) (*Appleidentityresolutionconfig, *APIResponse, error) {
	...
	if &integrationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'integrationId' when calling ConversationsApi->GetConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationId")
	}
...
func (a ConversationsApi) GetConversationsMessagingIdentityresolutionIntegrationsFacebookIntegrationId(integrationId string) (*Facebookidentityresolutionconfig, *APIResponse, error) {
	...
	if &integrationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'integrationId' when calling ConversationsApi->GetConversationsMessagingIdentityresolutionIntegrationsFacebookIntegrationId")
	}
...
func (a ConversationsApi) GetConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationId(integrationId string) (*Instagramidentityresolutionconfig, *APIResponse, error) {
	...
	if &integrationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'integrationId' when calling ConversationsApi->GetConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationId")
	}
...
func (a ConversationsApi) GetConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationId(integrationId string) (*Openmessagingidentityresolutionconfig, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/messaging/identityresolution/integrations/open/{integrationId}"
	path = strings.Replace(path, "{integrationId}", url.PathEscape(fmt.Sprintf("%v", integrationId)), -1)
	defaultReturn := new(Openmessagingidentityresolutionconfig)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &integrationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'integrationId' when calling ConversationsApi->GetConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationId")
	}
	...
	var successPayload *Openmessagingidentityresolutionconfig
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Openmessagingidentityresolutionconfig" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a ConversationsApi) GetConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationId(integrationId string) (*Twitteridentityresolutionconfig, *APIResponse, error) {
	...
	if &integrationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'integrationId' when calling ConversationsApi->GetConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationId")
	}
...
func (a ConversationsApi) GetConversationsMessagingIdentityresolutionIntegrationsWhatsappIntegrationId(integrationId string) (*Whatsappidentityresolutionconfig, *APIResponse, error) {
	...
	if &integrationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'integrationId' when calling ConversationsApi->GetConversationsMessagingIdentityresolutionIntegrationsWhatsappIntegrationId")
	}
...
// GetConversationsMessagingIntegrationTwitterOauthSettings invokes GET /api/v2/conversations/messaging/integrations/{integrationId}/twitter/oauth/settings
//
// Get twitter oauth settings to patch an integration
func (a ConversationsApi) GetConversationsMessagingIntegrationTwitterOauthSettings(integrationId string) (*Twitteroauthsettings, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/messaging/integrations/{integrationId}/twitter/oauth/settings"
	path = strings.Replace(path, "{integrationId}", url.PathEscape(fmt.Sprintf("%v", integrationId)), -1)
	defaultReturn := new(Twitteroauthsettings)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &integrationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'integrationId' when calling ConversationsApi->GetConversationsMessagingIntegrationTwitterOauthSettings")
	}
	...
	var successPayload *Twitteroauthsettings
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Twitteroauthsettings" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetConversationsMessagingIntegrationsTwitterOauthSettings invokes GET /api/v2/conversations/messaging/integrations/twitter/oauth/settings
//
// Get twitter oauth settings
func (a ConversationsApi) GetConversationsMessagingIntegrationsTwitterOauthSettings() (*Twittersignupoauthsettings, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/messaging/integrations/twitter/oauth/settings"
	defaultReturn := new(Twittersignupoauthsettings)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Twittersignupoauthsettings
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Twittersignupoauthsettings" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PatchConversationRecordingstate invokes PATCH /api/v2/conversations/{conversationId}/recordingstate
//
// Update a conversation by setting its recording state
func (a ConversationsApi) PatchConversationRecordingstate(conversationId string, body Setrecordingstate) (*APIResponse, error) {
	var httpMethod = "PATCH"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/{conversationId}/recordingstate"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &conversationId == nil {
		// false
		return nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PatchConversationRecordingstate")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PatchConversationRecordingstate")
	}
...
func (a ConversationsApi) PatchConversationSummaryFeedback(conversationId string, summaryId string, body Feedbackupdaterequest) (*APIResponse, error) {
	...
	if &conversationId == nil {
		// false
		return nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PatchConversationSummaryFeedback")
	}
	// verify the required parameter 'summaryId' is set
	if &summaryId == nil {
		// false
		return nil, errors.New("Missing required parameter 'summaryId' when calling ConversationsApi->PatchConversationSummaryFeedback")
	}
...
func (a ConversationsApi) PatchConversationUtilizationlabel(conversationId string, body Conversationutilizationlabelupdate) (*string, *APIResponse, error) {
	var httpMethod = "PATCH"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/{conversationId}/utilizationlabel"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	defaultReturn := new(string)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PatchConversationUtilizationlabel")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PatchConversationUtilizationlabel")
	}
...
// PatchConversationsCallConference invokes PATCH /api/v2/conversations/calls/{conversationId}/conference
//
// Update a conversation by merging in other conversations to create a conference
func (a ConversationsApi) PatchConversationsCallConference(conversationId string, body Updateconferencerequest) (*APIResponse, error) {
	var httpMethod = "PATCH"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/calls/{conversationId}/conference"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &conversationId == nil {
		// false
		return nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PatchConversationsCallConference")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PatchConversationsCallConference")
	}
...
func (a ConversationsApi) PatchConversationsEmailParticipantParkingstate(conversationId string, participantId string, body Parkingstaterequest) (*APIResponse, error) {
	var httpMethod = "PATCH"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/emails/{conversationId}/participants/{participantId}/parkingstate"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{participantId}", url.PathEscape(fmt.Sprintf("%v", participantId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	...
	if &conversationId == nil {
		// false
		return nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PatchConversationsEmailParticipantParkingstate")
	}
	// verify the required parameter 'participantId' is set
	if &participantId == nil {
		// false
		return nil, errors.New("Missing required parameter 'participantId' when calling ConversationsApi->PatchConversationsEmailParticipantParkingstate")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PatchConversationsEmailParticipantParkingstate")
	}
...
func (a ConversationsApi) PatchConversationsMessagingIntegrationsTwitterIntegrationId(integrationId string, body Twitterintegrationupdaterequest) (*Twitterintegration, *APIResponse, error) {
	var httpMethod = "PATCH"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/messaging/integrations/twitter/{integrationId}"
	path = strings.Replace(path, "{integrationId}", url.PathEscape(fmt.Sprintf("%v", integrationId)), -1)
...
// PostConversationCommunicationAgentchecklist invokes POST /api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/{agentChecklistId}
//
// Agent Checklist activation API
func (a ConversationsApi) PostConversationCommunicationAgentchecklist(conversationId string, communicationId string, agentChecklistId string, body Checklistactivationpayload) (*Agentchecklistresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/{agentChecklistId}"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PostConversationCommunicationAgentchecklist")
	}
	// verify the required parameter 'communicationId' is set
	if &communicationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'communicationId' when calling ConversationsApi->PostConversationCommunicationAgentchecklist")
	}
	// verify the required parameter 'agentChecklistId' is set
	if &agentChecklistId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'agentChecklistId' when calling ConversationsApi->PostConversationCommunicationAgentchecklist")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PostConversationCommunicationAgentchecklist")
	}
...
// PostConversationCommunicationAgentchecklistAgentaction invokes POST /api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/{agentChecklistId}/agentaction
//
// API invoked to capture an agent action.
func (a ConversationsApi) PostConversationCommunicationAgentchecklistAgentaction(conversationId string, communicationId string, agentChecklistId string, body Agentactionpayload) (*Agentchecklistresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/{agentChecklistId}/agentaction"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{communicationId}", url.PathEscape(fmt.Sprintf("%v", communicationId)), -1)
	path = strings.Replace(path, "{agentChecklistId}", url.PathEscape(fmt.Sprintf("%v", agentChecklistId)), -1)
	defaultReturn := new(Agentchecklistresponse)
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PostConversationCommunicationAgentchecklistAgentaction")
	}
	// verify the required parameter 'communicationId' is set
	if &communicationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'communicationId' when calling ConversationsApi->PostConversationCommunicationAgentchecklistAgentaction")
	}
	// verify the required parameter 'agentChecklistId' is set
	if &agentChecklistId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'agentChecklistId' when calling ConversationsApi->PostConversationCommunicationAgentchecklistAgentaction")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PostConversationCommunicationAgentchecklistAgentaction")
	}
...
// PostConversationCommunicationAgentchecklistJobs invokes POST /api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/{agentChecklistId}/jobs
//
// Create inference job
func (a ConversationsApi) PostConversationCommunicationAgentchecklistJobs(conversationId string, communicationId string, agentChecklistId string, body Checklistinferencejobpayload) (*Checklistinferencejobcreationresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/{agentChecklistId}/jobs"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{communicationId}", url.PathEscape(fmt.Sprintf("%v", communicationId)), -1)
	path = strings.Replace(path, "{agentChecklistId}", url.PathEscape(fmt.Sprintf("%v", agentChecklistId)), -1)
	defaultReturn := new(Checklistinferencejobcreationresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PostConversationCommunicationAgentchecklistJobs")
	}
	// verify the required parameter 'communicationId' is set
	if &communicationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'communicationId' when calling ConversationsApi->PostConversationCommunicationAgentchecklistJobs")
	}
	// verify the required parameter 'agentChecklistId' is set
	if &agentChecklistId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'agentChecklistId' when calling ConversationsApi->PostConversationCommunicationAgentchecklistJobs")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PostConversationCommunicationAgentchecklistJobs")
	}
	...
	var successPayload *Checklistinferencejobcreationresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Checklistinferencejobcreationresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostConversationCommunicationAgentchecklistsFinalize invokes POST /api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/finalize
//
// API invoked to finalize agent checklist evaluation.
func (a ConversationsApi) PostConversationCommunicationAgentchecklistsFinalize(conversationId string, communicationId string, body Checklistfinalizepayload) (*Agentchecklistresponselist, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/{conversationId}/communications/{communicationId}/agentchecklists/finalize"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{communicationId}", url.PathEscape(fmt.Sprintf("%v", communicationId)), -1)
	defaultReturn := new(Agentchecklistresponselist)
	if true == false {
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PostConversationCommunicationAgentchecklistsFinalize")
	}
	// verify the required parameter 'communicationId' is set
	if &communicationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'communicationId' when calling ConversationsApi->PostConversationCommunicationAgentchecklistsFinalize")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PostConversationCommunicationAgentchecklistsFinalize")
	}
...
// PostConversationCommunicationInternalmessages invokes POST /api/v2/conversations/{conversationId}/communications/{communicationId}/internalmessages
//
...
func (a ConversationsApi) PostConversationCommunicationInternalmessages(conversationId string, communicationId string, body Internalmessagerequest) (*Internalmessagedata, *APIResponse, error) {
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PostConversationCommunicationInternalmessages")
	}
	// verify the required parameter 'communicationId' is set
	if &communicationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'communicationId' when calling ConversationsApi->PostConversationCommunicationInternalmessages")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PostConversationCommunicationInternalmessages")
	}
...
// PostConversationParticipantInternalmessagesUsersCommunications invokes POST /api/v2/conversations/{conversationId}/participants/{participantId}/internalmessages/users/communications
//
...
func (a ConversationsApi) PostConversationParticipantInternalmessagesUsersCommunications(conversationId string, participantId string, body Messagingconferwithuserrequest) (*Messagingconferresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/{conversationId}/participants/{participantId}/internalmessages/users/communications"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{participantId}", url.PathEscape(fmt.Sprintf("%v", participantId)), -1)
	defaultReturn := new(Messagingconferresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PostConversationParticipantInternalmessagesUsersCommunications")
	}
	// verify the required parameter 'participantId' is set
	if &participantId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'participantId' when calling ConversationsApi->PostConversationParticipantInternalmessagesUsersCommunications")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PostConversationParticipantInternalmessagesUsersCommunications")
	}
	...
	var successPayload *Messagingconferresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Messagingconferresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostConversationParticipantReplaceContactExternal invokes POST /api/v2/conversations/{conversationId}/participants/{participantId}/replace/contact/external
//
// Replace this participant with the an external contact
func (a ConversationsApi) PostConversationParticipantReplaceContactExternal(conversationId string, participantId string, body Transfertoexternalcontactrequest) (*APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/{conversationId}/participants/{participantId}/replace/contact/external"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{participantId}", url.PathEscape(fmt.Sprintf("%v", participantId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	...
	if &conversationId == nil {
		// false
		return nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PostConversationParticipantReplaceContactExternal")
	}
	// verify the required parameter 'participantId' is set
	if &participantId == nil {
		// false
		return nil, errors.New("Missing required parameter 'participantId' when calling ConversationsApi->PostConversationParticipantReplaceContactExternal")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PostConversationParticipantReplaceContactExternal")
	}
...
//
// Deprecated: PostConversationParticipantReplaceExternal is deprecated
...
// PostConversationParticipantTransfer invokes POST /api/v2/conversations/{conversationId}/participants/{participantId}/transfer
//
// Replace this participant by another one using the address of the destination.
func (a ConversationsApi) PostConversationParticipantTransfer(conversationId string, participantId string, body Transfertoaddressrequest) (*APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/{conversationId}/participants/{participantId}/transfer"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{participantId}", url.PathEscape(fmt.Sprintf("%v", participantId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	...
	if &conversationId == nil {
		// false
		return nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PostConversationParticipantTransfer")
	}
	// verify the required parameter 'participantId' is set
	if &participantId == nil {
		// false
		return nil, errors.New("Missing required parameter 'participantId' when calling ConversationsApi->PostConversationParticipantTransfer")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PostConversationParticipantTransfer")
	}
...
// PostConversationSuggestionEngagement invokes POST /api/v2/conversations/{conversationId}/suggestions/{suggestionId}/engagement
//
// Save an engagement on the suggestion.
func (a ConversationsApi) PostConversationSuggestionEngagement(conversationId string, suggestionId string, body Suggestionengagement) (*Suggestionengagement, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/{conversationId}/suggestions/{suggestionId}/engagement"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{suggestionId}", url.PathEscape(fmt.Sprintf("%v", suggestionId)), -1)
	defaultReturn := new(Suggestionengagement)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PostConversationSuggestionEngagement")
	}
	// verify the required parameter 'suggestionId' is set
	if &suggestionId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'suggestionId' when calling ConversationsApi->PostConversationSuggestionEngagement")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PostConversationSuggestionEngagement")
	}
	...
	var successPayload *Suggestionengagement
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Suggestionengagement" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a ConversationsApi) PostConversationSuggestionsFeedback(conversationId string, body Feedback) (*APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/{conversationId}/suggestions/feedback"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &conversationId == nil {
		// false
		return nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PostConversationSuggestionsFeedback")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PostConversationSuggestionsFeedback")
	}
...
// PostConversationsCallParticipantConsultContactExternal invokes POST /api/v2/conversations/calls/{conversationId}/participants/{participantId}/consult/contact/external
//
// Initiate a consult transfer to an external contact
func (a ConversationsApi) PostConversationsCallParticipantConsultContactExternal(conversationId string, participantId string, body Consulttransfertoexternalcontact) (*Consulttransferresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/calls/{conversationId}/participants/{participantId}/consult/contact/external"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{participantId}", url.PathEscape(fmt.Sprintf("%v", participantId)), -1)
	defaultReturn := new(Consulttransferresponse)
	if true == false {
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PostConversationsCallParticipantConsultContactExternal")
	}
	// verify the required parameter 'participantId' is set
	if &participantId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'participantId' when calling ConversationsApi->PostConversationsCallParticipantConsultContactExternal")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PostConversationsCallParticipantConsultContactExternal")
	}
...
//
// Deprecated: PostConversationsCallParticipantConsultExternal is deprecated
...
// PostConversationsCallParticipantVoiceConsult invokes POST /api/v2/conversations/calls/{conversationId}/participants/{participantId}/voice/consult
//
// Initiate voice consult transfer
func (a ConversationsApi) PostConversationsCallParticipantVoiceConsult(conversationId string, participantId string, body Consulttransfertoaddress) (*Consulttransferresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/calls/{conversationId}/participants/{participantId}/voice/consult"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{participantId}", url.PathEscape(fmt.Sprintf("%v", participantId)), -1)
	defaultReturn := new(Consulttransferresponse)
	if true == false {
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PostConversationsCallParticipantVoiceConsult")
	}
	// verify the required parameter 'participantId' is set
	if &participantId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'participantId' when calling ConversationsApi->PostConversationsCallParticipantVoiceConsult")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PostConversationsCallParticipantVoiceConsult")
	}
...
func (a ConversationsApi) PostConversationsCallParticipantsUserUserId(conversationId string, userId string, body Conversation) (*Conversation, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/calls/{conversationId}/participants/user/{userId}"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{userId}", url.PathEscape(fmt.Sprintf("%v", userId)), -1)
	defaultReturn := new(Conversation)
	if true == false {
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PostConversationsCallParticipantsUserUserId")
	}
	// verify the required parameter 'userId' is set
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling ConversationsApi->PostConversationsCallParticipantsUserUserId")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PostConversationsCallParticipantsUserUserId")
	}
...
// PostConversationsCallsUserUserId invokes POST /api/v2/conversations/calls/user/{userId}
//
// Create a call conversation on behalf of a user
func (a ConversationsApi) PostConversationsCallsUserUserId(userId string, body Createcallrequest) (*Createcallresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/calls/user/{userId}"
	path = strings.Replace(path, "{userId}", url.PathEscape(fmt.Sprintf("%v", userId)), -1)
	defaultReturn := new(Createcallresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	...
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling ConversationsApi->PostConversationsCallsUserUserId")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PostConversationsCallsUserUserId")
	}
...
// See https://developer.genesys.cloud/api/rest/v2/conversations/messaging-media-upload for example usage.
//
// Deprecated: PostConversationsMessageCommunicationMessagesMedia is deprecated
...
// PostConversationsMessageCommunicationMessagesMediaUploads invokes POST /api/v2/conversations/messages/{conversationId}/communications/{communicationId}/messages/media/uploads
//
// Create a URL to upload a message media file
//
// See https://developer.genesys.cloud/api/rest/v2/conversations/messaging-media-upload for example usage.
func (a ConversationsApi) PostConversationsMessageCommunicationMessagesMediaUploads(conversationId string, communicationId string, body Uploadmediarequest) (*Messagemediauploaddata, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/messages/{conversationId}/communications/{communicationId}/messages/media/uploads"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{communicationId}", url.PathEscape(fmt.Sprintf("%v", communicationId)), -1)
	defaultReturn := new(Messagemediauploaddata)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PostConversationsMessageCommunicationMessagesMediaUploads")
	}
	// verify the required parameter 'communicationId' is set
	if &communicationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'communicationId' when calling ConversationsApi->PostConversationsMessageCommunicationMessagesMediaUploads")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PostConversationsMessageCommunicationMessagesMediaUploads")
	}
	...
	var successPayload *Messagemediauploaddata
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Messagemediauploaddata" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostConversationsMessageCommunicationSocialmediaMessages invokes POST /api/v2/conversations/messages/{conversationId}/communications/{communicationId}/socialmedia/messages
//
// Send a social media message
//
// Send a social media message on existing conversation/communication.
func (a ConversationsApi) PostConversationsMessageCommunicationSocialmediaMessages(conversationId string, communicationId string, body Additionalsocialmediamessage) (*Socialmediamessagedata, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/messages/{conversationId}/communications/{communicationId}/socialmedia/messages"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{communicationId}", url.PathEscape(fmt.Sprintf("%v", communicationId)), -1)
	defaultReturn := new(Socialmediamessagedata)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PostConversationsMessageCommunicationSocialmediaMessages")
	}
	// verify the required parameter 'communicationId' is set
	if &communicationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'communicationId' when calling ConversationsApi->PostConversationsMessageCommunicationSocialmediaMessages")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PostConversationsMessageCommunicationSocialmediaMessages")
	}
	...
	var successPayload *Socialmediamessagedata
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Socialmediamessagedata" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostConversationsMessageInboundOpenStructuredResponse invokes POST /api/v2/conversations/messages/{integrationId}/inbound/open/structured/response
//
...
func (a ConversationsApi) PostConversationsMessageInboundOpenStructuredResponse(integrationId string, body Openinboundstructuredresponsemessage) (*Openstructuredresponsenormalizedmessage, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/messages/{integrationId}/inbound/open/structured/response"
	path = strings.Replace(path, "{integrationId}", url.PathEscape(fmt.Sprintf("%v", integrationId)), -1)
	defaultReturn := new(Openstructuredresponsenormalizedmessage)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &integrationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'integrationId' when calling ConversationsApi->PostConversationsMessageInboundOpenStructuredResponse")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PostConversationsMessageInboundOpenStructuredResponse")
	}
	...
	var successPayload *Openstructuredresponsenormalizedmessage
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Openstructuredresponsenormalizedmessage" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a ConversationsApi) PostConversationsMessages(body Createoutboundmessagingconversationrequest) (*Createoutboundmessagingconversationresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/messages"
	defaultReturn := new(Createoutboundmessagingconversationresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Createoutboundmessagingconversationresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Createoutboundmessagingconversationresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostConversationsVideoAgentconferenceCommunication invokes POST /api/v2/conversations/videos/{conversationId}/agentconference/communications/{communicationId}
//
// Create an Agent-Type video conference and assign an agent to it
//
// Preview: PostConversationsVideoAgentconferenceCommunication is a preview method and is subject to both breaking and non-breaking changes at any time without notice
func (a ConversationsApi) PostConversationsVideoAgentconferenceCommunication(conversationId string, communicationId string) (*Videoconferencedetails, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/conversations/videos/{conversationId}/agentconference/communications/{communicationId}"
	path = strings.Replace(path, "{conversationId}", url.PathEscape(fmt.Sprintf("%v", conversationId)), -1)
	path = strings.Replace(path, "{communicationId}", url.PathEscape(fmt.Sprintf("%v", communicationId)), -1)
	defaultReturn := new(Videoconferencedetails)
	if true == false {
	...
	if &conversationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'conversationId' when calling ConversationsApi->PostConversationsVideoAgentconferenceCommunication")
	}
	// verify the required parameter 'communicationId' is set
	if &communicationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'communicationId' when calling ConversationsApi->PostConversationsVideoAgentconferenceCommunication")
	}
...
func (a ConversationsApi) PutConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationId(integrationId string, body Appleidentityresolutionconfig) (*Appleidentityresolutionconfig, *APIResponse, error) {
	...
	if &integrationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'integrationId' when calling ConversationsApi->PutConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationId")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PutConversationsMessagingIdentityresolutionIntegrationsAppleIntegrationId")
	}
...
func (a ConversationsApi) PutConversationsMessagingIdentityresolutionIntegrationsFacebookIntegrationId(integrationId string, body Facebookidentityresolutionconfig) (*Facebookidentityresolutionconfig, *APIResponse, error) {
	...
	if &integrationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'integrationId' when calling ConversationsApi->PutConversationsMessagingIdentityresolutionIntegrationsFacebookIntegrationId")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PutConversationsMessagingIdentityresolutionIntegrationsFacebookIntegrationId")
	}
...
func (a ConversationsApi) PutConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationId(integrationId string, body Instagramidentityresolutionconfig) (*Instagramidentityresolutionconfig, *APIResponse, error) {
	...
	if &integrationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'integrationId' when calling ConversationsApi->PutConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationId")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PutConversationsMessagingIdentityresolutionIntegrationsInstagramIntegrationId")
	}
...
func (a ConversationsApi) PutConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationId(integrationId string, body Openmessagingidentityresolutionconfig) (*Openmessagingidentityresolutionconfig, *APIResponse, error) {
	...
	if &integrationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'integrationId' when calling ConversationsApi->PutConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationId")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PutConversationsMessagingIdentityresolutionIntegrationsOpenIntegrationId")
	}
...
func (a ConversationsApi) PutConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationId(integrationId string, body Twitteridentityresolutionconfig) (*Twitteridentityresolutionconfig, *APIResponse, error) {
	...
	if &integrationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'integrationId' when calling ConversationsApi->PutConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationId")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PutConversationsMessagingIdentityresolutionIntegrationsTwitterIntegrationId")
	}
...
func (a ConversationsApi) PutConversationsMessagingIdentityresolutionIntegrationsWhatsappIntegrationId(integrationId string, body Whatsappidentityresolutionconfig) (*Whatsappidentityresolutionconfig, *APIResponse, error) {
	...
	if &integrationId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'integrationId' when calling ConversationsApi->PutConversationsMessagingIdentityresolutionIntegrationsWhatsappIntegrationId")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ConversationsApi->PutConversationsMessagingIdentityresolutionIntegrationsWhatsappIntegrationId")
	}
