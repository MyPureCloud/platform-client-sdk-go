...
func (o *Managementunituserlisting) SetField(field string, fieldValue interface{}) {
...
func (o Managementunituserlisting) MarshalJSON() ([]byte, error) {
...
func (o *Managementunituserlisting) UnmarshalJSON(b []byte) error {
	var ManagementunituserlistingMap map[string]interface{}
	err := json.Unmarshal(b, &ManagementunituserlistingMap)
	if err != nil {
		return err
	}
	
	if ManagementUnit, ok := ManagementunituserlistingMap["managementUnit"].(map[string]interface{}); ok {
		ManagementUnitString, _ := json.Marshal(ManagementUnit)
		json.Unmarshal(ManagementUnitString, &o.ManagementUnit)
	}
	
	if Users, ok := ManagementunituserlistingMap["users"].([]interface{}); ok {
