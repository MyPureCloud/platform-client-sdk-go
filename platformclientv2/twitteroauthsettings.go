...
func (o *Twitteroauthsettings) SetField(field string, fieldValue interface{}) {
...
func (o Twitteroauthsettings) MarshalJSON() ([]byte, error) {
...
func (o *Twitteroauthsettings) UnmarshalJSON(b []byte) error {
	var TwitteroauthsettingsMap map[string]interface{}
	err := json.Unmarshal(b, &TwitteroauthsettingsMap)
	if err != nil {
		return err
	}
	
	if ClientId, ok := TwitteroauthsettingsMap["clientId"].(string); ok {
		o.ClientId = &ClientId
	}
    
	if Scopes, ok := TwitteroauthsettingsMap["scopes"].([]interface{}); ok {
