...
func (o Diagnosticssettings) MarshalJSON() ([]byte, error) {
...
func (o *Diagnosticssettings) UnmarshalJSON(b []byte) error {
	var DiagnosticssettingsMap map[string]interface{}
	err := json.Unmarshal(b, &DiagnosticssettingsMap)
	if err != nil {
		return err
	}
