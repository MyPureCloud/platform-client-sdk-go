...
type Importtemplateimportstatusimportstatus struct { 
...
func (o *Importtemplateimportstatusimportstatus) SetField(field string, fieldValue interface{}) {
...
func (o Importtemplateimportstatusimportstatus) MarshalJSON() ([]byte, error) {
	...
	type Alias Importtemplateimportstatusimportstatus
...
func (o *Importtemplateimportstatusimportstatus) UnmarshalJSON(b []byte) error {
	var ImporttemplateimportstatusimportstatusMap map[string]interface{}
	err := json.Unmarshal(b, &ImporttemplateimportstatusimportstatusMap)
	if err != nil {
		return err
	}
	
	if ImportState, ok := ImporttemplateimportstatusimportstatusMap["importState"].(string); ok {
		o.ImportState = &ImportState
	}
    
	if TotalRecords, ok := ImporttemplateimportstatusimportstatusMap["totalRecords"].(float64); ok {
		TotalRecordsInt := int(TotalRecords)
		o.TotalRecords = &TotalRecordsInt
	}
	
	if CompletedRecords, ok := ImporttemplateimportstatusimportstatusMap["completedRecords"].(float64); ok {
		CompletedRecordsInt := int(CompletedRecords)
		o.CompletedRecords = &CompletedRecordsInt
	}
	
	if PercentageComplete, ok := ImporttemplateimportstatusimportstatusMap["percentageComplete"].(float64); ok {
		PercentageCompleteInt := int(PercentageComplete)
		o.PercentageComplete = &PercentageCompleteInt
	}
	
	if FailureReason, ok := ImporttemplateimportstatusimportstatusMap["failureReason"].(string); ok {
		o.FailureReason = &FailureReason
	}
    
	if TargetContactListIds, ok := ImporttemplateimportstatusimportstatusMap["targetContactListIds"].([]interface{}); ok {
	...
	if ListNamePrefix, ok := ImporttemplateimportstatusimportstatusMap["listNamePrefix"].(string); ok {
		o.ListNamePrefix = &ListNamePrefix
	}
    
	if AdditionalProperties, ok := ImporttemplateimportstatusimportstatusMap["additionalProperties"].(map[string]interface{}); ok {
		AdditionalPropertiesString, _ := json.Marshal(AdditionalProperties)
		json.Unmarshal(AdditionalPropertiesString, &o.AdditionalProperties)
	}
	
	if GetAdditionalProperties, ok := ImporttemplateimportstatusimportstatusMap["getAdditionalProperties"].(map[string]interface{}); ok {
...
func (o *Importtemplateimportstatusimportstatus) String() string {
	j, _ := json.Marshal(o)
