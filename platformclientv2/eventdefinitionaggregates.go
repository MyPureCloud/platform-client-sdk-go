...
func (o *Eventdefinitionaggregates) SetField(field string, fieldValue interface{}) {
...
func (o Eventdefinitionaggregates) MarshalJSON() ([]byte, error) {
...
func (o *Eventdefinitionaggregates) UnmarshalJSON(b []byte) error {
	var EventdefinitionaggregatesMap map[string]interface{}
	err := json.Unmarshal(b, &EventdefinitionaggregatesMap)
	if err != nil {
		return err
	}
	
	if EventDefinition, ok := EventdefinitionaggregatesMap["eventDefinition"].(map[string]interface{}); ok {
		EventDefinitionString, _ := json.Marshal(EventDefinition)
		json.Unmarshal(EventDefinitionString, &o.EventDefinition)
	}
	
	if EventCount, ok := EventdefinitionaggregatesMap["eventCount"].(float64); ok {
