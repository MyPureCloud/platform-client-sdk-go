...
func (o *Outlierresultbody) SetField(field string, fieldValue interface{}) {
...
func (o Outlierresultbody) MarshalJSON() ([]byte, error) {
...
func (o *Outlierresultbody) UnmarshalJSON(b []byte) error {
	var OutlierresultbodyMap map[string]interface{}
	err := json.Unmarshal(b, &OutlierresultbodyMap)
	if err != nil {
		return err
	}
	
	if PlanningGroupId, ok := OutlierresultbodyMap["planningGroupId"].(string); ok {
		o.PlanningGroupId = &PlanningGroupId
	}
    
	if Outliers, ok := OutlierresultbodyMap["outliers"].([]interface{}); ok {
