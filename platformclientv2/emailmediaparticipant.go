...
func (o *Emailmediaparticipant) UnmarshalJSON(b []byte) error {
	...
	if startAlertingTimeString, ok := EmailmediaparticipantMap["startAlertingTime"].(string); ok {
	...
	if ExternalContactInitialDivisionId, ok := EmailmediaparticipantMap["externalContactInitialDivisionId"].(string); ok {
