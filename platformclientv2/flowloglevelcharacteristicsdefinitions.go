...
func (o *Flowloglevelcharacteristicsdefinitions) SetField(field string, fieldValue interface{}) {
...
func (o Flowloglevelcharacteristicsdefinitions) MarshalJSON() ([]byte, error) {
...
func (o *Flowloglevelcharacteristicsdefinitions) UnmarshalJSON(b []byte) error {
	var FlowloglevelcharacteristicsdefinitionsMap map[string]interface{}
