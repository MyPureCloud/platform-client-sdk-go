...
func (o *Userasyncaggregatequeryresponse) SetField(field string, fieldValue interface{}) {
...
func (o Userasyncaggregatequeryresponse) MarshalJSON() ([]byte, error) {
...
func (o *Userasyncaggregatequeryresponse) UnmarshalJSON(b []byte) error {
	var UserasyncaggregatequeryresponseMap map[string]interface{}
	err := json.Unmarshal(b, &UserasyncaggregatequeryresponseMap)
	if err != nil {
		return err
	}
	
	if SystemToOrganizationMappings, ok := UserasyncaggregatequeryresponseMap["systemToOrganizationMappings"].(map[string]interface{}); ok {
	...
	if Results, ok := UserasyncaggregatequeryresponseMap["results"].([]interface{}); ok {
		ResultsString, _ := json.Marshal(Results)
		json.Unmarshal(ResultsString, &o.Results)
	}
	
	if Cursor, ok := UserasyncaggregatequeryresponseMap["cursor"].(string); ok {
		o.Cursor = &Cursor
	}
