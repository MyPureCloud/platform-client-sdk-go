...
func (o *Journeyviewchartmetricresultvalue) SetField(field string, fieldValue interface{}) {
...
func (o Journeyviewchartmetricresultvalue) MarshalJSON() ([]byte, error) {
...
func (o *Journeyviewchartmetricresultvalue) UnmarshalJSON(b []byte) error {
	var JourneyviewchartmetricresultvalueMap map[string]interface{}
	err := json.Unmarshal(b, &JourneyviewchartmetricresultvalueMap)
	if err != nil {
		return err
	}
