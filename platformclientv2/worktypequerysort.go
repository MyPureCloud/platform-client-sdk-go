...
func (o *Worktypequerysort) SetField(field string, fieldValue interface{}) {
...
func (o Worktypequerysort) MarshalJSON() ([]byte, error) {
...
func (o *Worktypequerysort) UnmarshalJSON(b []byte) error {
	var WorktypequerysortMap map[string]interface{}
	err := json.Unmarshal(b, &WorktypequerysortMap)
	if err != nil {
		return err
	}
	
	if Name, ok := WorktypequerysortMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if Ascending, ok := WorktypequerysortMap["ascending"].(bool); ok {
