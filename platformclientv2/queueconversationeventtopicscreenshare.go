...
func (o *Queueconversationeventtopicscreenshare) UnmarshalJSON(b []byte) error {
	...
	if PeerCount, ok := QueueconversationeventtopicscreenshareMap["peerCount"].(float64); ok {
	...
	if QueueMediaSettings, ok := QueueconversationeventtopicscreenshareMap["queueMediaSettings"].(map[string]interface{}); ok {
