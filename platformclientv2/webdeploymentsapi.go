...
//
// Invalidate JWT
func (a WebDeploymentsApi) DeleteWebdeploymentsTokenRevoke(xJourneySessionId string, xJourneySessionType string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/webdeployments/token/revoke"
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
func (a WebDeploymentsApi) GetWebdeploymentsDeploymentConfigurations(deploymentId string, varType string, expand []string) (*Webdeploymentactiveconfigurationondeployment, *APIResponse, error) {
	...
	if &deploymentId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'deploymentId' when calling WebDeploymentsApi->GetWebdeploymentsDeploymentConfigurations")
	}
	...
	if err != nil {
		...
		if "Webdeploymentactiveconfigurationondeployment" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a WebDeploymentsApi) GetWebdeploymentsDeploymentIdentityresolution(deploymentId string) (*Identityresolutionconfig, *APIResponse, error) {
	...
	if &deploymentId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'deploymentId' when calling WebDeploymentsApi->GetWebdeploymentsDeploymentIdentityresolution")
	}
...
func (a WebDeploymentsApi) PostWebdeploymentsTokenOauthcodegrantjwtexchange(body Webdeploymentsoauthexchangerequest) (*Webdeploymentsauthorizationresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/webdeployments/token/oauthcodegrantjwtexchange"
	defaultReturn := new(Webdeploymentsauthorizationresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling WebDeploymentsApi->PostWebdeploymentsTokenOauthcodegrantjwtexchange")
	}
	...
	if err != nil {
		...
		if "Webdeploymentsauthorizationresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostWebdeploymentsTokenRefresh invokes POST /api/v2/webdeployments/token/refresh
//
// Refresh a JWT.
func (a WebDeploymentsApi) PostWebdeploymentsTokenRefresh(body Webdeploymentsrefreshjwtrequest) (*Signeddata, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/webdeployments/token/refresh"
...
func (a WebDeploymentsApi) PutWebdeploymentsDeploymentIdentityresolution(deploymentId string, body Identityresolutionconfig) (*Identityresolutionconfig, *APIResponse, error) {
	...
	if &deploymentId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'deploymentId' when calling WebDeploymentsApi->PutWebdeploymentsDeploymentIdentityresolution")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling WebDeploymentsApi->PutWebdeploymentsDeploymentIdentityresolution")
	}
