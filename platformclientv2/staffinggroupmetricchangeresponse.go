...
func (o *Staffinggroupmetricchangeresponse) SetField(field string, fieldValue interface{}) {
...
func (o Staffinggroupmetricchangeresponse) MarshalJSON() ([]byte, error) {
...
func (o *Staffinggroupmetricchangeresponse) UnmarshalJSON(b []byte) error {
	var StaffinggroupmetricchangeresponseMap map[string]interface{}
	err := json.Unmarshal(b, &StaffinggroupmetricchangeresponseMap)
	if err != nil {
		return err
	}
	
	if NumberOfWeeks, ok := StaffinggroupmetricchangeresponseMap["numberOfWeeks"].(float64); ok {
		NumberOfWeeksInt := int(NumberOfWeeks)
		o.NumberOfWeeks = &NumberOfWeeksInt
	}
	
	if WeekStartNumber, ok := StaffinggroupmetricchangeresponseMap["weekStartNumber"].(float64); ok {
		WeekStartNumberInt := int(WeekStartNumber)
		o.WeekStartNumber = &WeekStartNumberInt
	}
	
	if Value, ok := StaffinggroupmetricchangeresponseMap["value"].(float64); ok {
		o.Value = &Value
	}
    
	if Metric, ok := StaffinggroupmetricchangeresponseMap["metric"].(string); ok {
		o.Metric = &Metric
	}
    
	if Notes, ok := StaffinggroupmetricchangeresponseMap["notes"].(string); ok {
		o.Notes = &Notes
	}
    
	if TransfersFullTimeEquivalent, ok := StaffinggroupmetricchangeresponseMap["transfersFullTimeEquivalent"].(map[string]interface{}); ok {
	...
	if StaffingGroups, ok := StaffinggroupmetricchangeresponseMap["staffingGroups"].([]interface{}); ok {
		StaffingGroupsString, _ := json.Marshal(StaffingGroups)
		json.Unmarshal(StaffingGroupsString, &o.StaffingGroups)
	}
	
	if CreatedBy, ok := StaffinggroupmetricchangeresponseMap["createdBy"].(map[string]interface{}); ok {
		CreatedByString, _ := json.Marshal(CreatedBy)
		json.Unmarshal(CreatedByString, &o.CreatedBy)
	}
	
	if createdDateString, ok := StaffinggroupmetricchangeresponseMap["createdDate"].(string); ok {
