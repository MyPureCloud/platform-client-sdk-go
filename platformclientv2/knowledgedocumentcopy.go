...
func (o *Knowledgedocumentcopy) SetField(field string, fieldValue interface{}) {
...
func (o Knowledgedocumentcopy) MarshalJSON() ([]byte, error) {
...
func (o *Knowledgedocumentcopy) UnmarshalJSON(b []byte) error {
	var KnowledgedocumentcopyMap map[string]interface{}
	err := json.Unmarshal(b, &KnowledgedocumentcopyMap)
	if err != nil {
		return err
	}
	
	if DocumentVariationId, ok := KnowledgedocumentcopyMap["documentVariationId"].(string); ok {
		o.DocumentVariationId = &DocumentVariationId
	}
    
	if DocumentVersionId, ok := KnowledgedocumentcopyMap["documentVersionId"].(string); ok {
		o.DocumentVersionId = &DocumentVersionId
	}
    
	if SearchId, ok := KnowledgedocumentcopyMap["searchId"].(string); ok {
		o.SearchId = &SearchId
	}
    
	if QueryType, ok := KnowledgedocumentcopyMap["queryType"].(string); ok {
		o.QueryType = &QueryType
	}
    
	if SurfacingMethod, ok := KnowledgedocumentcopyMap["surfacingMethod"].(string); ok {
		o.SurfacingMethod = &SurfacingMethod
	}
    
	if SessionId, ok := KnowledgedocumentcopyMap["sessionId"].(string); ok {
		o.SessionId = &SessionId
	}
    
	if ConversationContext, ok := KnowledgedocumentcopyMap["conversationContext"].(map[string]interface{}); ok {
	...
	if Application, ok := KnowledgedocumentcopyMap["application"].(map[string]interface{}); ok {
