...
type Queueconversationscreenshareeventtopicerrorbody struct { 
	...
	// Limit
	Limit *Queueconversationscreenshareeventtopiclimit `json:"limit,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Queueconversationscreenshareeventtopicerrorbody) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationscreenshareeventtopicerrorbody) UnmarshalJSON(b []byte) error {
	...
	if Limit, ok := QueueconversationscreenshareeventtopicerrorbodyMap["limit"].(map[string]interface{}); ok {
