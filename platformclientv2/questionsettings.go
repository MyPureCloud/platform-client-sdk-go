...
func (o *Questionsettings) SetField(field string, fieldValue interface{}) {
...
func (o Questionsettings) MarshalJSON() ([]byte, error) {
...
func (o *Questionsettings) UnmarshalJSON(b []byte) error {
	var QuestionsettingsMap map[string]interface{}
	err := json.Unmarshal(b, &QuestionsettingsMap)
	if err != nil {
		return err
	}
	
	if QuestionIndex, ok := QuestionsettingsMap["questionIndex"].(float64); ok {
		QuestionIndexInt := int(QuestionIndex)
