...
type Conversationmessageeventtopicqueuemediasettings struct { 
...
func (o *Conversationmessageeventtopicqueuemediasettings) SetField(field string, fieldValue interface{}) {
...
func (o Conversationmessageeventtopicqueuemediasettings) MarshalJSON() ([]byte, error) {
	...
	type Alias Conversationmessageeventtopicqueuemediasettings
...
func (o *Conversationmessageeventtopicqueuemediasettings) UnmarshalJSON(b []byte) error {
	var ConversationmessageeventtopicqueuemediasettingsMap map[string]interface{}
	err := json.Unmarshal(b, &ConversationmessageeventtopicqueuemediasettingsMap)
	if err != nil {
		return err
	}
	
	if AlertingTimeoutSeconds, ok := ConversationmessageeventtopicqueuemediasettingsMap["alertingTimeoutSeconds"].(float64); ok {
		AlertingTimeoutSecondsInt := int(AlertingTimeoutSeconds)
		o.AlertingTimeoutSeconds = &AlertingTimeoutSecondsInt
	}
	
	if AutoAnswerAlertToneSeconds, ok := ConversationmessageeventtopicqueuemediasettingsMap["autoAnswerAlertToneSeconds"].(float64); ok {
	...
	if ManualAnswerAlertToneSeconds, ok := ConversationmessageeventtopicqueuemediasettingsMap["manualAnswerAlertToneSeconds"].(float64); ok {
	...
	if EnableAutoAnswer, ok := ConversationmessageeventtopicqueuemediasettingsMap["enableAutoAnswer"].(bool); ok {
...
func (o *Conversationmessageeventtopicqueuemediasettings) String() string {
	j, _ := json.Marshal(o)
