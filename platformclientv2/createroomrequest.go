...
func (o *Createroomrequest) SetField(field string, fieldValue interface{}) {
...
func (o *Createroomrequest) UnmarshalJSON(b []byte) error {
	var CreateroomrequestMap map[string]interface{}
	err := json.Unmarshal(b, &CreateroomrequestMap)
	if err != nil {
		return err
	}
	...
	if UserIds, ok := CreateroomrequestMap["userIds"].([]interface{}); ok {
