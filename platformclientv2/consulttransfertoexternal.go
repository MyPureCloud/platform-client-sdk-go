...
func (o *Consulttransfertoexternal) SetField(field string, fieldValue interface{}) {
...
func (o Consulttransfertoexternal) MarshalJSON() ([]byte, error) {
...
func (o *Consulttransfertoexternal) UnmarshalJSON(b []byte) error {
	var ConsulttransfertoexternalMap map[string]interface{}
	err := json.Unmarshal(b, &ConsulttransfertoexternalMap)
	if err != nil {
		return err
	}
	
	if SpeakTo, ok := ConsulttransfertoexternalMap["speakTo"].(string); ok {
		o.SpeakTo = &SpeakTo
	}
    
	if ConsultingUserId, ok := ConsulttransfertoexternalMap["consultingUserId"].(string); ok {
		o.ConsultingUserId = &ConsultingUserId
	}
    
	if Address, ok := ConsulttransfertoexternalMap["address"].(string); ok {
		o.Address = &Address
	}
