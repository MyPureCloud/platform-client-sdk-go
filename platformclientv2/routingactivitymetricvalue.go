...
func (o *Routingactivitymetricvalue) SetField(field string, fieldValue interface{}) {
...
func (o Routingactivitymetricvalue) MarshalJSON() ([]byte, error) {
...
func (o *Routingactivitymetricvalue) UnmarshalJSON(b []byte) error {
	var RoutingactivitymetricvalueMap map[string]interface{}
	err := json.Unmarshal(b, &RoutingactivitymetricvalueMap)
	if err != nil {
		return err
	}
	
	if Metric, ok := RoutingactivitymetricvalueMap["metric"].(string); ok {
		o.Metric = &Metric
	}
