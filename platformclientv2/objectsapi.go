...
func (a ObjectsApi) GetAuthorizationDivisionsDeleted(pageNumber int, pageSize int) (*Authzdivisionentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
...
func (a ObjectsApi) GetAuthorizationDivisionsQuery(before string, after string, pageSize string, id []string, name string) (*Authzdivisioncursorlisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
