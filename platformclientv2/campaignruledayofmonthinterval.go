...
func (o Campaignruledayofmonthinterval) MarshalJSON() ([]byte, error) {
...
func (o *Campaignruledayofmonthinterval) UnmarshalJSON(b []byte) error {
	var CampaignruledayofmonthintervalMap map[string]interface{}
	err := json.Unmarshal(b, &CampaignruledayofmonthintervalMap)
	if err != nil {
		return err
	}
