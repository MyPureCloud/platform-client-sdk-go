...
type Buimporttimeofflimitvaluesschema struct { 
	...
	LimitValues *[]Buimporttimeofflimitvalue `json:"limitValues,omitempty"`
...
func (o *Buimporttimeofflimitvaluesschema) SetField(field string, fieldValue interface{}) {
...
func (o Buimporttimeofflimitvaluesschema) MarshalJSON() ([]byte, error) {
...
func (o *Buimporttimeofflimitvaluesschema) UnmarshalJSON(b []byte) error {
	var BuimporttimeofflimitvaluesschemaMap map[string]interface{}
	err := json.Unmarshal(b, &BuimporttimeofflimitvaluesschemaMap)
	if err != nil {
		return err
	}
	
	if LimitValues, ok := BuimporttimeofflimitvaluesschemaMap["limitValues"].([]interface{}); ok {
		LimitValuesString, _ := json.Marshal(LimitValues)
		json.Unmarshal(LimitValuesString, &o.LimitValues)
	}
	
	if Metadata, ok := BuimporttimeofflimitvaluesschemaMap["metadata"].(map[string]interface{}); ok {
