...
type Conversationemaileventtopicqueuemediasettings struct { 
...
func (o *Conversationemaileventtopicqueuemediasettings) SetField(field string, fieldValue interface{}) {
...
func (o Conversationemaileventtopicqueuemediasettings) MarshalJSON() ([]byte, error) {
	...
	type Alias Conversationemaileventtopicqueuemediasettings
...
func (o *Conversationemaileventtopicqueuemediasettings) UnmarshalJSON(b []byte) error {
	var ConversationemaileventtopicqueuemediasettingsMap map[string]interface{}
	err := json.Unmarshal(b, &ConversationemaileventtopicqueuemediasettingsMap)
	if err != nil {
		return err
	}
	
	if AlertingTimeoutSeconds, ok := ConversationemaileventtopicqueuemediasettingsMap["alertingTimeoutSeconds"].(float64); ok {
		AlertingTimeoutSecondsInt := int(AlertingTimeoutSeconds)
		o.AlertingTimeoutSeconds = &AlertingTimeoutSecondsInt
	}
	
	if AutoAnswerAlertToneSeconds, ok := ConversationemaileventtopicqueuemediasettingsMap["autoAnswerAlertToneSeconds"].(float64); ok {
	...
	if ManualAnswerAlertToneSeconds, ok := ConversationemaileventtopicqueuemediasettingsMap["manualAnswerAlertToneSeconds"].(float64); ok {
	...
	if EnableAutoAnswer, ok := ConversationemaileventtopicqueuemediasettingsMap["enableAutoAnswer"].(bool); ok {
...
func (o *Conversationemaileventtopicqueuemediasettings) String() string {
	j, _ := json.Marshal(o)
