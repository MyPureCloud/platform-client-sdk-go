...
func (o *Extensionpoolentitylisting) SetField(field string, fieldValue interface{}) {
...
func (o *Extensionpoolentitylisting) UnmarshalJSON(b []byte) error {
	...
	if TotalNumberOfEntities, ok := ExtensionpoolentitylistingMap["totalNumberOfEntities"].(float64); ok {
