...
func (o *Conversationpublicmetadata) SetField(field string, fieldValue interface{}) {
...
func (o Conversationpublicmetadata) MarshalJSON() ([]byte, error) {
...
func (o *Conversationpublicmetadata) UnmarshalJSON(b []byte) error {
	var ConversationpublicmetadataMap map[string]interface{}
	err := json.Unmarshal(b, &ConversationpublicmetadataMap)
	if err != nil {
		return err
	}
	
	if RootId, ok := ConversationpublicmetadataMap["rootId"].(string); ok {
		o.RootId = &RootId
	}
