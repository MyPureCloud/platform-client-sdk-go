...
func (o *Timeoffplanbusinessunitassociation) SetField(field string, fieldValue interface{}) {
...
func (o Timeoffplanbusinessunitassociation) MarshalJSON() ([]byte, error) {
...
func (o *Timeoffplanbusinessunitassociation) UnmarshalJSON(b []byte) error {
	var TimeoffplanbusinessunitassociationMap map[string]interface{}
	err := json.Unmarshal(b, &TimeoffplanbusinessunitassociationMap)
	if err != nil {
		return err
	}
	
	if ManagementUnits, ok := TimeoffplanbusinessunitassociationMap["managementUnits"].([]interface{}); ok {
		ManagementUnitsString, _ := json.Marshal(ManagementUnits)
		json.Unmarshal(ManagementUnitsString, &o.ManagementUnits)
	}
	
	if StaffingGroups, ok := TimeoffplanbusinessunitassociationMap["staffingGroups"].([]interface{}); ok {
