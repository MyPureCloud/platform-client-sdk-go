...
func (o *Quarterhourly) SetField(field string, fieldValue interface{}) {
...
func (o Quarterhourly) MarshalJSON() ([]byte, error) {
...
func (o *Quarterhourly) UnmarshalJSON(b []byte) error {
	var QuarterhourlyMap map[string]interface{}
	err := json.Unmarshal(b, &QuarterhourlyMap)
	if err != nil {
		return err
	}
	
	if DownloadUrls, ok := QuarterhourlyMap["downloadUrls"].([]interface{}); ok {
		DownloadUrlsString, _ := json.Marshal(DownloadUrls)
		json.Unmarshal(DownloadUrlsString, &o.DownloadUrls)
	}
	
	if DownloadResult, ok := QuarterhourlyMap["downloadResult"].([]interface{}); ok {
