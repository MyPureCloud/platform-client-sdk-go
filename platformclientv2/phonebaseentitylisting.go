...
func (o *Phonebaseentitylisting) SetField(field string, fieldValue interface{}) {
...
func (o *Phonebaseentitylisting) UnmarshalJSON(b []byte) error {
	var PhonebaseentitylistingMap map[string]interface{}
	err := json.Unmarshal(b, &PhonebaseentitylistingMap)
	if err != nil {
		return err
	}
	
	if Entities, ok := PhonebaseentitylistingMap["entities"].([]interface{}); ok {
		EntitiesString, _ := json.Marshal(Entities)
		json.Unmarshal(EntitiesString, &o.Entities)
	}
	
	if PageSize, ok := PhonebaseentitylistingMap["pageSize"].(float64); ok {
		PageSizeInt := int(PageSize)
		o.PageSize = &PageSizeInt
	}
	
	if PageNumber, ok := PhonebaseentitylistingMap["pageNumber"].(float64); ok {
