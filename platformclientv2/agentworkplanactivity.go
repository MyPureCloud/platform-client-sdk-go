...
func (o *Agentworkplanactivity) SetField(field string, fieldValue interface{}) {
...
func (o Agentworkplanactivity) MarshalJSON() ([]byte, error) {
...
func (o *Agentworkplanactivity) UnmarshalJSON(b []byte) error {
	var AgentworkplanactivityMap map[string]interface{}
	err := json.Unmarshal(b, &AgentworkplanactivityMap)
	if err != nil {
		return err
	}
	
	if LengthMinutes, ok := AgentworkplanactivityMap["lengthMinutes"].(float64); ok {
		LengthMinutesInt := int(LengthMinutes)
		o.LengthMinutes = &LengthMinutesInt
	}
	
	if CountsAsPaidTime, ok := AgentworkplanactivityMap["countsAsPaidTime"].(bool); ok {
