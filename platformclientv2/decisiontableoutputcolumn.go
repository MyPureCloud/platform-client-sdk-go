...
func (o *Decisiontableoutputcolumn) SetField(field string, fieldValue interface{}) {
...
func (o Decisiontableoutputcolumn) MarshalJSON() ([]byte, error) {
...
func (o *Decisiontableoutputcolumn) UnmarshalJSON(b []byte) error {
	var DecisiontableoutputcolumnMap map[string]interface{}
	err := json.Unmarshal(b, &DecisiontableoutputcolumnMap)
	if err != nil {
		return err
	}
	
	if Id, ok := DecisiontableoutputcolumnMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if DefaultsTo, ok := DecisiontableoutputcolumnMap["defaultsTo"].(map[string]interface{}); ok {
		DefaultsToString, _ := json.Marshal(DefaultsTo)
		json.Unmarshal(DefaultsToString, &o.DefaultsTo)
	}
	
	if Value, ok := DecisiontableoutputcolumnMap["value"].(map[string]interface{}); ok {
