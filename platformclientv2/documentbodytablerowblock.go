...
func (o *Documentbodytablerowblock) SetField(field string, fieldValue interface{}) {
...
func (o Documentbodytablerowblock) MarshalJSON() ([]byte, error) {
...
func (o *Documentbodytablerowblock) UnmarshalJSON(b []byte) error {
	var DocumentbodytablerowblockMap map[string]interface{}
	err := json.Unmarshal(b, &DocumentbodytablerowblockMap)
	if err != nil {
		return err
	}
