...
func (o *Paymentresponse) SetField(field string, fieldValue interface{}) {
...
func (o *Paymentresponse) UnmarshalJSON(b []byte) error {
	var PaymentresponseMap map[string]interface{}
	err := json.Unmarshal(b, &PaymentresponseMap)
	if err != nil {
		return err
	}
	
	if OriginatingMessageId, ok := PaymentresponseMap["originatingMessageId"].(string); ok {
		o.OriginatingMessageId = &OriginatingMessageId
	}
    
	if PaymentStatus, ok := PaymentresponseMap["paymentStatus"].(string); ok {
		o.PaymentStatus = &PaymentStatus
	}
    
	if FailureReason, ok := PaymentresponseMap["failureReason"].(string); ok {
