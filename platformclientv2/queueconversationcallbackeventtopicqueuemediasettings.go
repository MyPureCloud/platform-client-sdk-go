...
type Queueconversationcallbackeventtopicqueuemediasettings struct { 
...
func (o *Queueconversationcallbackeventtopicqueuemediasettings) SetField(field string, fieldValue interface{}) {
...
func (o Queueconversationcallbackeventtopicqueuemediasettings) MarshalJSON() ([]byte, error) {
	...
	type Alias Queueconversationcallbackeventtopicqueuemediasettings
...
func (o *Queueconversationcallbackeventtopicqueuemediasettings) UnmarshalJSON(b []byte) error {
	var QueueconversationcallbackeventtopicqueuemediasettingsMap map[string]interface{}
	err := json.Unmarshal(b, &QueueconversationcallbackeventtopicqueuemediasettingsMap)
	if err != nil {
		return err
	}
	
	if AlertingTimeoutSeconds, ok := QueueconversationcallbackeventtopicqueuemediasettingsMap["alertingTimeoutSeconds"].(float64); ok {
		AlertingTimeoutSecondsInt := int(AlertingTimeoutSeconds)
		o.AlertingTimeoutSeconds = &AlertingTimeoutSecondsInt
	}
	
	if AutoAnswerAlertToneSeconds, ok := QueueconversationcallbackeventtopicqueuemediasettingsMap["autoAnswerAlertToneSeconds"].(float64); ok {
	...
	if ManualAnswerAlertToneSeconds, ok := QueueconversationcallbackeventtopicqueuemediasettingsMap["manualAnswerAlertToneSeconds"].(float64); ok {
	...
	if EnableAutoAnswer, ok := QueueconversationcallbackeventtopicqueuemediasettingsMap["enableAutoAnswer"].(bool); ok {
...
func (o *Queueconversationcallbackeventtopicqueuemediasettings) String() string {
	j, _ := json.Marshal(o)
