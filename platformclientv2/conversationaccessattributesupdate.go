...
func (o *Conversationaccessattributesupdate) SetField(field string, fieldValue interface{}) {
...
func (o Conversationaccessattributesupdate) MarshalJSON() ([]byte, error) {
...
func (o *Conversationaccessattributesupdate) UnmarshalJSON(b []byte) error {
	var ConversationaccessattributesupdateMap map[string]interface{}
	err := json.Unmarshal(b, &ConversationaccessattributesupdateMap)
	if err != nil {
		return err
	}
	
	if AccessAttributes, ok := ConversationaccessattributesupdateMap["accessAttributes"].([]interface{}); ok {
