...
func (o *Pingidentity) SetField(field string, fieldValue interface{}) {
...
func (o *Pingidentity) UnmarshalJSON(b []byte) error {
	...
	if LogoImageData, ok := PingidentityMap["logoImageData"].(string); ok {
		o.LogoImageData = &LogoImageData
	}
    
	if NameIdentifierFormat, ok := PingidentityMap["nameIdentifierFormat"].(string); ok {
		o.NameIdentifierFormat = &NameIdentifierFormat
	}
    
	if SsoBinding, ok := PingidentityMap["ssoBinding"].(string); ok {
		o.SsoBinding = &SsoBinding
	}
    
	if SignAuthnRequests, ok := PingidentityMap["signAuthnRequests"].(bool); ok {
		o.SignAuthnRequests = &SignAuthnRequests
	}
    
	if ProviderName, ok := PingidentityMap["providerName"].(string); ok {
	...
	if ForceAuthn, ok := PingidentityMap["forceAuthn"].(bool); ok {
