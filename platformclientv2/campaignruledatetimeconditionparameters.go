...
func (o Campaignruledatetimeconditionparameters) MarshalJSON() ([]byte, error) {
...
func (o *Campaignruledatetimeconditionparameters) UnmarshalJSON(b []byte) error {
	var CampaignruledatetimeconditionparametersMap map[string]interface{}
