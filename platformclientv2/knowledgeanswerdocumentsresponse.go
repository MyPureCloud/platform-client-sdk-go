...
type Knowledgeanswerdocumentsresponse struct { 
	...
	Results *[]Knowledgeanswerdocumentresponse `json:"results,omitempty"`
...
func (o *Knowledgeanswerdocumentsresponse) SetField(field string, fieldValue interface{}) {
...
func (o Knowledgeanswerdocumentsresponse) MarshalJSON() ([]byte, error) {
...
func (o *Knowledgeanswerdocumentsresponse) UnmarshalJSON(b []byte) error {
	var KnowledgeanswerdocumentsresponseMap map[string]interface{}
	err := json.Unmarshal(b, &KnowledgeanswerdocumentsresponseMap)
	if err != nil {
		return err
	}
	
	if Results, ok := KnowledgeanswerdocumentsresponseMap["results"].([]interface{}); ok {
		ResultsString, _ := json.Marshal(Results)
		json.Unmarshal(ResultsString, &o.Results)
	}
	
	if AnswerGeneration, ok := KnowledgeanswerdocumentsresponseMap["answerGeneration"].(map[string]interface{}); ok {
