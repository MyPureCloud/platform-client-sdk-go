...
type Conversationknowledgearticlesuggestionstopicsuggestioncontext struct { 
	...
	QueryReformulationContext *Conversationknowledgearticlesuggestionstopicqueryreformulationcontext `json:"queryReformulationContext,omitempty"`
...
func (o *Conversationknowledgearticlesuggestionstopicsuggestioncontext) UnmarshalJSON(b []byte) error {
	...
	if Language, ok := ConversationknowledgearticlesuggestionstopicsuggestioncontextMap["language"].(string); ok {
		o.Language = &Language
	}
    
	if QueryReformulationContext, ok := ConversationknowledgearticlesuggestionstopicsuggestioncontextMap["queryReformulationContext"].(map[string]interface{}); ok {
	...
	if ParticipantType, ok := ConversationknowledgearticlesuggestionstopicsuggestioncontextMap["participantType"].(string); ok {
