...
func (o *Assistantcopilotvariation) SetField(field string, fieldValue interface{}) {
...
func (o Assistantcopilotvariation) MarshalJSON() ([]byte, error) {
...
func (o *Assistantcopilotvariation) UnmarshalJSON(b []byte) error {
	var AssistantcopilotvariationMap map[string]interface{}
	err := json.Unmarshal(b, &AssistantcopilotvariationMap)
	if err != nil {
		return err
	}
	
	if Id, ok := AssistantcopilotvariationMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Name, ok := AssistantcopilotvariationMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if dateCreatedString, ok := AssistantcopilotvariationMap["dateCreated"].(string); ok {
		DateCreated, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateCreatedString)
		o.DateCreated = &DateCreated
	}
	
	if dateModifiedString, ok := AssistantcopilotvariationMap["dateModified"].(string); ok {
		DateModified, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateModifiedString)
		o.DateModified = &DateModified
	}
	
	if CreatedBy, ok := AssistantcopilotvariationMap["createdBy"].(map[string]interface{}); ok {
		CreatedByString, _ := json.Marshal(CreatedBy)
		json.Unmarshal(CreatedByString, &o.CreatedBy)
	}
	
	if ModifiedBy, ok := AssistantcopilotvariationMap["modifiedBy"].(map[string]interface{}); ok {
		ModifiedByString, _ := json.Marshal(ModifiedBy)
		json.Unmarshal(ModifiedByString, &o.ModifiedBy)
	}
	
	if GoogleDialogflowConfig, ok := AssistantcopilotvariationMap["googleDialogflowConfig"].(map[string]interface{}); ok {
	...
	if TranscriptionConfig, ok := AssistantcopilotvariationMap["transcriptionConfig"].(map[string]interface{}); ok {
	...
	if KnowledgeSuggestionConfig, ok := AssistantcopilotvariationMap["knowledgeSuggestionConfig"].(map[string]interface{}); ok {
	...
	if State, ok := AssistantcopilotvariationMap["state"].(string); ok {
		o.State = &State
	}
    
	if Copilot, ok := AssistantcopilotvariationMap["copilot"].(map[string]interface{}); ok {
		CopilotString, _ := json.Marshal(Copilot)
		json.Unmarshal(CopilotString, &o.Copilot)
	}
	
	if SelfUri, ok := AssistantcopilotvariationMap["selfUri"].(string); ok {
		o.SelfUri = &SelfUri
	}
    
	if VariationParent, ok := AssistantcopilotvariationMap["variationParent"].(map[string]interface{}); ok {
