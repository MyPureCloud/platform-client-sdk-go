...
type Ivrdivisionviewentitylisting struct { 
	...
	// Entities
	Entities *[]Ivrdivisionview `json:"entities,omitempty"`
...
func (o *Ivrdivisionviewentitylisting) SetField(field string, fieldValue interface{}) {
...
func (o Ivrdivisionviewentitylisting) MarshalJSON() ([]byte, error) {
...
func (o *Ivrdivisionviewentitylisting) UnmarshalJSON(b []byte) error {
	var IvrdivisionviewentitylistingMap map[string]interface{}
	err := json.Unmarshal(b, &IvrdivisionviewentitylistingMap)
	if err != nil {
		return err
	}
	
	if Entities, ok := IvrdivisionviewentitylistingMap["entities"].([]interface{}); ok {
		EntitiesString, _ := json.Marshal(Entities)
		json.Unmarshal(EntitiesString, &o.Entities)
	}
	
	if PageSize, ok := IvrdivisionviewentitylistingMap["pageSize"].(float64); ok {
		PageSizeInt := int(PageSize)
		o.PageSize = &PageSizeInt
	}
	
	if PageNumber, ok := IvrdivisionviewentitylistingMap["pageNumber"].(float64); ok {
		PageNumberInt := int(PageNumber)
		o.PageNumber = &PageNumberInt
	}
	
	if Total, ok := IvrdivisionviewentitylistingMap["total"].(float64); ok {
		TotalInt := int(Total)
		o.Total = &TotalInt
	}
	
	if TotalNumberOfEntities, ok := IvrdivisionviewentitylistingMap["totalNumberOfEntities"].(float64); ok {
