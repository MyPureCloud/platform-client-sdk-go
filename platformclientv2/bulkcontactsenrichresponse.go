...
type Bulkcontactsenrichresponse struct { 
	...
	Results *[]Bulkresponseresultexternalcontactcontactenrichrequestbulkentityerrorcontactenrichrequest `json:"results,omitempty"`
...
func (o *Bulkcontactsenrichresponse) SetField(field string, fieldValue interface{}) {
...
func (o Bulkcontactsenrichresponse) MarshalJSON() ([]byte, error) {
...
func (o *Bulkcontactsenrichresponse) UnmarshalJSON(b []byte) error {
	var BulkcontactsenrichresponseMap map[string]interface{}
	err := json.Unmarshal(b, &BulkcontactsenrichresponseMap)
	if err != nil {
		return err
	}
	
	if Results, ok := BulkcontactsenrichresponseMap["results"].([]interface{}); ok {
		ResultsString, _ := json.Marshal(Results)
		json.Unmarshal(ResultsString, &o.Results)
	}
	
	if ErrorCount, ok := BulkcontactsenrichresponseMap["errorCount"].(float64); ok {
		ErrorCountInt := int(ErrorCount)
		o.ErrorCount = &ErrorCountInt
	}
	
	if ErrorIndexes, ok := BulkcontactsenrichresponseMap["errorIndexes"].([]interface{}); ok {
