...
func (o *Ratingfilter) SetField(field string, fieldValue interface{}) {
...
func (o Ratingfilter) MarshalJSON() ([]byte, error) {
...
func (o *Ratingfilter) UnmarshalJSON(b []byte) error {
	var RatingfilterMap map[string]interface{}
	err := json.Unmarshal(b, &RatingfilterMap)
	if err != nil {
		return err
	}
	
	if Operator, ok := RatingfilterMap["operator"].(string); ok {
		o.Operator = &Operator
	}
