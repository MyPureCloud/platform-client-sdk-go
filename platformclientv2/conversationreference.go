...
func (o *Conversationreference) SetField(field string, fieldValue interface{}) {
...
func (o *Conversationreference) UnmarshalJSON(b []byte) error {
	var ConversationreferenceMap map[string]interface{}
	err := json.Unmarshal(b, &ConversationreferenceMap)
	if err != nil {
		return err
	}
