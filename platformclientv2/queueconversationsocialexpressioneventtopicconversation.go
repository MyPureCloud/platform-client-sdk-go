...
type Queueconversationsocialexpressioneventtopicconversation struct { 
	...
	// RecentTransfers
	RecentTransfers *[]Queueconversationsocialexpressioneventtopictransferresponse `json:"recentTransfers,omitempty"`
...
func (o *Queueconversationsocialexpressioneventtopicconversation) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationsocialexpressioneventtopicconversation) UnmarshalJSON(b []byte) error {
	...
	if RecentTransfers, ok := QueueconversationsocialexpressioneventtopicconversationMap["recentTransfers"].([]interface{}); ok {
	...
	if UtilizationLabelId, ok := QueueconversationsocialexpressioneventtopicconversationMap["utilizationLabelId"].(string); ok {
