...
//
// 
func (a AuthorizationApi) DeleteUserRoles(userId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	...
	if &userId == nil {
		// 
		return nil, errors.New("Missing required parameter 'userId' when calling AuthorizationApi->DeleteUserRoles")
	}
...
func (a AuthorizationApi) GetAuthorizationDivisionspermittedSubjectId(subjectId string, permission string, name string) ([]Authzdivision, *APIResponse, error) {
	...
	if &subjectId == nil {
		// 
		return defaultReturn, nil, errors.New("Missing required parameter 'subjectId' when calling AuthorizationApi->GetAuthorizationDivisionspermittedSubjectId")
	}
	// verify the required parameter 'permission' is set
	if &permission == nil {
		// 
		return defaultReturn, nil, errors.New("Missing required parameter 'permission' when calling AuthorizationApi->GetAuthorizationDivisionspermittedSubjectId")
	}
