...
func (o *Emailusertransferevent) SetField(field string, fieldValue interface{}) {
...
func (o Emailusertransferevent) MarshalJSON() ([]byte, error) {
...
func (o *Emailusertransferevent) UnmarshalJSON(b []byte) error {
	var EmailusertransfereventMap map[string]interface{}
	err := json.Unmarshal(b, &EmailusertransfereventMap)
	if err != nil {
		return err
	}
	
	if EventId, ok := EmailusertransfereventMap["eventId"].(string); ok {
		o.EventId = &EventId
	}
    
	if eventDateTimeString, ok := EmailusertransfereventMap["eventDateTime"].(string); ok {
		EventDateTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", eventDateTimeString)
		o.EventDateTime = &EventDateTime
	}
	
	if ConversationId, ok := EmailusertransfereventMap["conversationId"].(string); ok {
		o.ConversationId = &ConversationId
	}
    
	if TransferType, ok := EmailusertransfereventMap["transferType"].(string); ok {
		o.TransferType = &TransferType
	}
    
	if CommandId, ok := EmailusertransfereventMap["commandId"].(string); ok {
		o.CommandId = &CommandId
	}
    
	if InitiatingCommunicationId, ok := EmailusertransfereventMap["initiatingCommunicationId"].(string); ok {
		o.InitiatingCommunicationId = &InitiatingCommunicationId
	}
    
	if TargetCommunicationId, ok := EmailusertransfereventMap["targetCommunicationId"].(string); ok {
		o.TargetCommunicationId = &TargetCommunicationId
	}
    
	if ObjectCommunicationId, ok := EmailusertransfereventMap["objectCommunicationId"].(string); ok {
		o.ObjectCommunicationId = &ObjectCommunicationId
	}
    
	if DestinationUserId, ok := EmailusertransfereventMap["destinationUserId"].(string); ok {
