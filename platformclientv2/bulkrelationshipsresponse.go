...
type Bulkrelationshipsresponse struct { 
	...
	Results *[]Bulkresponseresultrelationshiprelationshipbulkentityerrorrelationship `json:"results,omitempty"`
...
func (o *Bulkrelationshipsresponse) SetField(field string, fieldValue interface{}) {
