...
func (o *Staffingrequirementsplanninggroupdata) SetField(field string, fieldValue interface{}) {
...
func (o Staffingrequirementsplanninggroupdata) MarshalJSON() ([]byte, error) {
...
func (o *Staffingrequirementsplanninggroupdata) UnmarshalJSON(b []byte) error {
	var StaffingrequirementsplanninggroupdataMap map[string]interface{}
	err := json.Unmarshal(b, &StaffingrequirementsplanninggroupdataMap)
	if err != nil {
		return err
	}
	
	if PlanningGroupId, ok := StaffingrequirementsplanninggroupdataMap["planningGroupId"].(string); ok {
