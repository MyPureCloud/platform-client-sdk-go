...
func (o *Conversationchateventtopicchatconversation) SetField(field string, fieldValue interface{}) {
...
func (o *Conversationchateventtopicchatconversation) UnmarshalJSON(b []byte) error {
	...
	if UtilizationLabelId, ok := ConversationchateventtopicchatconversationMap["utilizationLabelId"].(string); ok {
		o.UtilizationLabelId = &UtilizationLabelId
	}
    
	if AccessAttributes, ok := ConversationchateventtopicchatconversationMap["accessAttributes"].([]interface{}); ok {
		AccessAttributesString, _ := json.Marshal(AccessAttributes)
		json.Unmarshal(AccessAttributesString, &o.AccessAttributes)
	}
	
	if inactivityTimeoutString, ok := ConversationchateventtopicchatconversationMap["inactivityTimeout"].(string); ok {
