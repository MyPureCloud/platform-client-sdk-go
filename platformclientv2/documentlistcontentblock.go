...
func (o *Documentlistcontentblock) SetField(field string, fieldValue interface{}) {
...
func (o Documentlistcontentblock) MarshalJSON() ([]byte, error) {
...
func (o *Documentlistcontentblock) UnmarshalJSON(b []byte) error {
	var DocumentlistcontentblockMap map[string]interface{}
	err := json.Unmarshal(b, &DocumentlistcontentblockMap)
	if err != nil {
		return err
	}
	
	if VarType, ok := DocumentlistcontentblockMap["type"].(string); ok {
		o.VarType = &VarType
	}
    
	if Text, ok := DocumentlistcontentblockMap["text"].(map[string]interface{}); ok {
		TextString, _ := json.Marshal(Text)
		json.Unmarshal(TextString, &o.Text)
	}
	
	if Image, ok := DocumentlistcontentblockMap["image"].(map[string]interface{}); ok {
