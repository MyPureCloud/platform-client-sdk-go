...
func (o *Labelutilizationresponse) SetField(field string, fieldValue interface{}) {
...
func (o Labelutilizationresponse) MarshalJSON() ([]byte, error) {
...
func (o *Labelutilizationresponse) UnmarshalJSON(b []byte) error {
	var LabelutilizationresponseMap map[string]interface{}
	err := json.Unmarshal(b, &LabelutilizationresponseMap)
	if err != nil {
		return err
	}
	
	if MaximumCapacity, ok := LabelutilizationresponseMap["maximumCapacity"].(float64); ok {
		MaximumCapacityInt := int(MaximumCapacity)
		o.MaximumCapacity = &MaximumCapacityInt
	}
	
	if InterruptingLabelIds, ok := LabelutilizationresponseMap["interruptingLabelIds"].([]interface{}); ok {
	...
	if LabelName, ok := LabelutilizationresponseMap["labelName"].(string); ok {
