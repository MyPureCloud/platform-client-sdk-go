...
func (o *Queueconversationsocialexpressioneventtopicchat) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationsocialexpressioneventtopicchat) UnmarshalJSON(b []byte) error {
	...
	if QueueMediaSettings, ok := QueueconversationsocialexpressioneventtopicchatMap["queueMediaSettings"].(map[string]interface{}); ok {
