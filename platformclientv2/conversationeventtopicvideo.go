...
func (o *Conversationeventtopicvideo) SetField(field string, fieldValue interface{}) {
...
func (o *Conversationeventtopicvideo) UnmarshalJSON(b []byte) error {
	...
	if InitialState, ok := ConversationeventtopicvideoMap["initialState"].(string); ok {
	...
	if PeerCount, ok := ConversationeventtopicvideoMap["peerCount"].(map[string]interface{}); ok {
	...
	if QueueMediaSettings, ok := ConversationeventtopicvideoMap["queueMediaSettings"].(map[string]interface{}); ok {
