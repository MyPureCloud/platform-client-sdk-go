...
func (o *Engineintegration) SetField(field string, fieldValue interface{}) {
...
func (o Engineintegration) MarshalJSON() ([]byte, error) {
...
func (o *Engineintegration) UnmarshalJSON(b []byte) error {
	var EngineintegrationMap map[string]interface{}
	err := json.Unmarshal(b, &EngineintegrationMap)
	if err != nil {
		return err
	}
