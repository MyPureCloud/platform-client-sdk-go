...
func (o *Knowledgeintegrationfilter) SetField(field string, fieldValue interface{}) {
...
func (o Knowledgeintegrationfilter) MarshalJSON() ([]byte, error) {
...
func (o *Knowledgeintegrationfilter) UnmarshalJSON(b []byte) error {
	var KnowledgeintegrationfilterMap map[string]interface{}
	err := json.Unmarshal(b, &KnowledgeintegrationfilterMap)
	if err != nil {
		return err
	}
	
	if Name, ok := KnowledgeintegrationfilterMap["name"].(string); ok {
		o.Name = &Name
	}
