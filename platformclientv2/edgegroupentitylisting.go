...
func (o *Edgegroupentitylisting) SetField(field string, fieldValue interface{}) {
...
func (o *Edgegroupentitylisting) UnmarshalJSON(b []byte) error {
	...
	if TotalNumberOfEntities, ok := EdgegroupentitylistingMap["totalNumberOfEntities"].(float64); ok {
