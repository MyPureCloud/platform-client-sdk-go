...
func (o *Dialerrulesetconfigchangeruleset) SetField(field string, fieldValue interface{}) {
...
func (o *Dialerrulesetconfigchangeruleset) UnmarshalJSON(b []byte) error {
	...
	if GetAdditionalProperties, ok := DialerrulesetconfigchangerulesetMap["getAdditionalProperties"].(map[string]interface{}); ok {
