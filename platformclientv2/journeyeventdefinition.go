...
type Journeyeventdefinition struct { 
	...
	// JsonSchema - The JSON schema of this event definition
...
func (o *Journeyeventdefinition) SetField(field string, fieldValue interface{}) {
...
func (o Journeyeventdefinition) MarshalJSON() ([]byte, error) {
...
func (o *Journeyeventdefinition) UnmarshalJSON(b []byte) error {
	var JourneyeventdefinitionMap map[string]interface{}
	err := json.Unmarshal(b, &JourneyeventdefinitionMap)
	if err != nil {
		return err
	}
	
	if Id, ok := JourneyeventdefinitionMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Name, ok := JourneyeventdefinitionMap["name"].(string); ok {
		o.Name = &Name
	}
	...
	if JsonSchema, ok := JourneyeventdefinitionMap["jsonSchema"].(map[string]interface{}); ok {
		JsonSchemaString, _ := json.Marshal(JsonSchema)
		json.Unmarshal(JsonSchemaString, &o.JsonSchema)
	}
	
	if SelfUri, ok := JourneyeventdefinitionMap["selfUri"].(string); ok {
		o.SelfUri = &SelfUri
	}
