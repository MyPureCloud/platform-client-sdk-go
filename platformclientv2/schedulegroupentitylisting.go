...
func (o *Schedulegroupentitylisting) SetField(field string, fieldValue interface{}) {
...
func (o *Schedulegroupentitylisting) UnmarshalJSON(b []byte) error {
	...
	if TotalNumberOfEntities, ok := SchedulegroupentitylistingMap["totalNumberOfEntities"].(float64); ok {
