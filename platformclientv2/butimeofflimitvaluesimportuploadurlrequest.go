...
func (o *Butimeofflimitvaluesimportuploadurlrequest) SetField(field string, fieldValue interface{}) {
...
func (o Butimeofflimitvaluesimportuploadurlrequest) MarshalJSON() ([]byte, error) {
...
func (o *Butimeofflimitvaluesimportuploadurlrequest) UnmarshalJSON(b []byte) error {
	var ButimeofflimitvaluesimportuploadurlrequestMap map[string]interface{}
	err := json.Unmarshal(b, &ButimeofflimitvaluesimportuploadurlrequestMap)
	if err != nil {
		return err
	}
	
	if ContentLengthBytes, ok := ButimeofflimitvaluesimportuploadurlrequestMap["contentLengthBytes"].(float64); ok {
