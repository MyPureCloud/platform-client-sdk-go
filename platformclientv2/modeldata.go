...
type Modeldata struct { 
	...
	DownloadResult *[]Planninggroupmodel `json:"downloadResult,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Modeldata) SetField(field string, fieldValue interface{}) {
...
func (o Modeldata) MarshalJSON() ([]byte, error) {
...
func (o *Modeldata) UnmarshalJSON(b []byte) error {
	var ModeldataMap map[string]interface{}
	err := json.Unmarshal(b, &ModeldataMap)
	if err != nil {
		return err
	}
	
	if DownloadUrls, ok := ModeldataMap["downloadUrls"].([]interface{}); ok {
		DownloadUrlsString, _ := json.Marshal(DownloadUrls)
		json.Unmarshal(DownloadUrlsString, &o.DownloadUrls)
	}
	
	if DownloadResult, ok := ModeldataMap["downloadResult"].([]interface{}); ok {
