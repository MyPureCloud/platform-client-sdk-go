...
func (o *Buconverttimeofflimitgranularityjobrequest) SetField(field string, fieldValue interface{}) {
...
func (o Buconverttimeofflimitgranularityjobrequest) MarshalJSON() ([]byte, error) {
...
func (o *Buconverttimeofflimitgranularityjobrequest) UnmarshalJSON(b []byte) error {
	var BuconverttimeofflimitgranularityjobrequestMap map[string]interface{}
	err := json.Unmarshal(b, &BuconverttimeofflimitgranularityjobrequestMap)
	if err != nil {
		return err
	}
	
	if Granularity, ok := BuconverttimeofflimitgranularityjobrequestMap["granularity"].(string); ok {
		o.Granularity = &Granularity
	}
    
	if FullDayTimeOffStartTime, ok := BuconverttimeofflimitgranularityjobrequestMap["fullDayTimeOffStartTime"].(string); ok {
