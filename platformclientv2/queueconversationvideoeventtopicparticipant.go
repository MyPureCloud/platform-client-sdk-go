...
type Queueconversationvideoeventtopicparticipant struct { 
	...
	// ScreenMonitorings
	ScreenMonitorings *[]Queueconversationvideoeventtopicscreenmonitoring `json:"screenMonitorings,omitempty"`
...
func (o *Queueconversationvideoeventtopicparticipant) UnmarshalJSON(b []byte) error {
	...
	if ExternalContactInitialDivisionId, ok := QueueconversationvideoeventtopicparticipantMap["externalContactInitialDivisionId"].(string); ok {
	...
	if ScreenMonitorings, ok := QueueconversationvideoeventtopicparticipantMap["screenMonitorings"].([]interface{}); ok {
