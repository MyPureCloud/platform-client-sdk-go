...
func (o *Whatsappintegrationrequest) SetField(field string, fieldValue interface{}) {
...
func (o *Whatsappintegrationrequest) UnmarshalJSON(b []byte) error {
	...
	if MessagingSetting, ok := WhatsappintegrationrequestMap["messagingSetting"].(map[string]interface{}); ok {
