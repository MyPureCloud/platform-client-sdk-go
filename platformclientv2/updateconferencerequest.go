...
func (o *Updateconferencerequest) SetField(field string, fieldValue interface{}) {
...
func (o *Updateconferencerequest) UnmarshalJSON(b []byte) error {
	var UpdateconferencerequestMap map[string]interface{}
	err := json.Unmarshal(b, &UpdateconferencerequestMap)
	if err != nil {
		return err
	}
	
	if ConversationIds, ok := UpdateconferencerequestMap["conversationIds"].([]interface{}); ok {
