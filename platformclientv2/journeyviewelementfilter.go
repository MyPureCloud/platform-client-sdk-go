...
func (o *Journeyviewelementfilter) SetField(field string, fieldValue interface{}) {
...
func (o Journeyviewelementfilter) MarshalJSON() ([]byte, error) {
...
func (o *Journeyviewelementfilter) UnmarshalJSON(b []byte) error {
	var JourneyviewelementfilterMap map[string]interface{}
	err := json.Unmarshal(b, &JourneyviewelementfilterMap)
	if err != nil {
		return err
	}
	
	if VarType, ok := JourneyviewelementfilterMap["type"].(string); ok {
		o.VarType = &VarType
	}
