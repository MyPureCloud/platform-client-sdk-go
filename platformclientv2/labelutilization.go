...
func (o *Labelutilization) SetField(field string, fieldValue interface{}) {
...
func (o Labelutilization) MarshalJSON() ([]byte, error) {
...
func (o *Labelutilization) UnmarshalJSON(b []byte) error {
	var LabelutilizationMap map[string]interface{}
	err := json.Unmarshal(b, &LabelutilizationMap)
	if err != nil {
		return err
	}
	
	if MaximumCapacity, ok := LabelutilizationMap["maximumCapacity"].(float64); ok {
