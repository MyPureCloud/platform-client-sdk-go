...
func (o *Socialmediadetailmessagecontainer) SetField(field string, fieldValue interface{}) {
...
func (o Socialmediadetailmessagecontainer) MarshalJSON() ([]byte, error) {
...
func (o *Socialmediadetailmessagecontainer) UnmarshalJSON(b []byte) error {
	var SocialmediadetailmessagecontainerMap map[string]interface{}
	err := json.Unmarshal(b, &SocialmediadetailmessagecontainerMap)
	if err != nil {
		return err
	}
	
	if Id, ok := SocialmediadetailmessagecontainerMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if NormalizedMessage, ok := SocialmediadetailmessagecontainerMap["normalizedMessage"].(map[string]interface{}); ok {
