...
// GetResponsemanagementLibrariesDivisionview invokes GET /api/v2/responsemanagement/libraries/divisionviews/{libraryId}
//
// Get details about an existing response library.
func (a ResponseManagementApi) GetResponsemanagementLibrariesDivisionview(libraryId string) (*Librarydivisionview, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/responsemanagement/libraries/divisionviews/{libraryId}"
	path = strings.Replace(path, "{libraryId}", url.PathEscape(fmt.Sprintf("%v", libraryId)), -1)
	defaultReturn := new(Librarydivisionview)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &libraryId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'libraryId' when calling ResponseManagementApi->GetResponsemanagementLibrariesDivisionview")
	}
	...
	var successPayload *Librarydivisionview
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
// GetResponsemanagementLibrariesDivisionviews invokes GET /api/v2/responsemanagement/libraries/divisionviews
//
// Gets a list of existing response libraries.
func (a ResponseManagementApi) GetResponsemanagementLibrariesDivisionviews(pageNumber int, pageSize int, messagingTemplateFilter string, libraryPrefix string) (*Librarydivisionviewentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/responsemanagement/libraries/divisionviews"
	defaultReturn := new(Librarydivisionviewentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Librarydivisionviewentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Librarydivisionviewentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetResponsemanagementResponsesDivisionview invokes GET /api/v2/responsemanagement/responses/divisionviews/{responseId}
//
// Get details about an existing response.
func (a ResponseManagementApi) GetResponsemanagementResponsesDivisionview(responseId string) (*Responsedivisionview, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/responsemanagement/responses/divisionviews/{responseId}"
	path = strings.Replace(path, "{responseId}", url.PathEscape(fmt.Sprintf("%v", responseId)), -1)
	defaultReturn := new(Responsedivisionview)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &responseId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'responseId' when calling ResponseManagementApi->GetResponsemanagementResponsesDivisionview")
	}
	...
	var successPayload *Responsedivisionview
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Responsedivisionview" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostResponsemanagementLibrariesBulk invokes POST /api/v2/responsemanagement/libraries/bulk
//
// Get response libraries.
func (a ResponseManagementApi) PostResponsemanagementLibrariesBulk(body Librarybatchrequest) (*Libraryentitylisting, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/responsemanagement/libraries/bulk"
	defaultReturn := new(Libraryentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ResponseManagementApi->PostResponsemanagementLibrariesBulk")
	}
...
func (a ResponseManagementApi) PostResponsemanagementLibrariesQuery(body Querycriteriaquery, pageNumber int, pageSize int) (*Libraryentitylisting, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/responsemanagement/libraries/query"
	defaultReturn := new(Libraryentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ResponseManagementApi->PostResponsemanagementLibrariesQuery")
	}
...
// PostResponsemanagementResponseassetsBulk invokes POST /api/v2/responsemanagement/responseassets/bulk
//
// Get response assets.
func (a ResponseManagementApi) PostResponsemanagementResponseassetsBulk(body Responseassetbulkrequest) (*Responseassetentitylisting, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/responsemanagement/responseassets/bulk"
	defaultReturn := new(Responseassetentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ResponseManagementApi->PostResponsemanagementResponseassetsBulk")
	}
	...
	var successPayload *Responseassetentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Responseassetentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostResponsemanagementResponsesDivisionviewsQuery invokes POST /api/v2/responsemanagement/responses/divisionviews/query
//
// Query responses
func (a ResponseManagementApi) PostResponsemanagementResponsesDivisionviewsQuery(body Responsequeryrequest) (*Responsedivisionviewqueryresults, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/responsemanagement/responses/divisionviews/query"
	defaultReturn := new(Responsedivisionviewqueryresults)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ResponseManagementApi->PostResponsemanagementResponsesDivisionviewsQuery")
	}
	...
	var successPayload *Responsedivisionviewqueryresults
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Responsedivisionviewqueryresults" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
