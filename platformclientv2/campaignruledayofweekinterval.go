...
func (o Campaignruledayofweekinterval) MarshalJSON() ([]byte, error) {
...
func (o *Campaignruledayofweekinterval) UnmarshalJSON(b []byte) error {
	var CampaignruledayofweekintervalMap map[string]interface{}
