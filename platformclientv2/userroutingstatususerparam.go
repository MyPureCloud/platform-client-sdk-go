...
func (o *Userroutingstatususerparam) SetField(field string, fieldValue interface{}) {
...
func (o *Userroutingstatususerparam) UnmarshalJSON(b []byte) error {
	...
	if GetAdditionalProperties, ok := UserroutingstatususerparamMap["getAdditionalProperties"].(map[string]interface{}); ok {
