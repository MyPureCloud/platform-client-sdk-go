...
func (o *Transfertoexternalrequest) SetField(field string, fieldValue interface{}) {
...
func (o Transfertoexternalrequest) MarshalJSON() ([]byte, error) {
...
func (o *Transfertoexternalrequest) UnmarshalJSON(b []byte) error {
	var TransfertoexternalrequestMap map[string]interface{}
	err := json.Unmarshal(b, &TransfertoexternalrequestMap)
	if err != nil {
		return err
	}
