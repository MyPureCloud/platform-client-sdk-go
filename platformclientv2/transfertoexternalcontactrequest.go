...
func (o *Transfertoexternalcontactrequest) SetField(field string, fieldValue interface{}) {
...
func (o Transfertoexternalcontactrequest) MarshalJSON() ([]byte, error) {
...
func (o *Transfertoexternalcontactrequest) UnmarshalJSON(b []byte) error {
	var TransfertoexternalcontactrequestMap map[string]interface{}
	err := json.Unmarshal(b, &TransfertoexternalcontactrequestMap)
	if err != nil {
		return err
	}
	
	if TransferType, ok := TransfertoexternalcontactrequestMap["transferType"].(string); ok {
		o.TransferType = &TransferType
	}
    
	if KeepInternalMessageAlive, ok := TransfertoexternalcontactrequestMap["keepInternalMessageAlive"].(bool); ok {
		o.KeepInternalMessageAlive = &KeepInternalMessageAlive
	}
    
	if ContactId, ok := TransfertoexternalcontactrequestMap["contactId"].(string); ok {
		o.ContactId = &ContactId
	}
    
	if PhoneType, ok := TransfertoexternalcontactrequestMap["phoneType"].(string); ok {
