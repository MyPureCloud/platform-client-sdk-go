...
func (o Campaignruletimeofdayparameters) MarshalJSON() ([]byte, error) {
...
func (o *Campaignruletimeofdayparameters) UnmarshalJSON(b []byte) error {
	var CampaignruletimeofdayparametersMap map[string]interface{}
	err := json.Unmarshal(b, &CampaignruletimeofdayparametersMap)
	if err != nil {
		return err
	}
