...
type Capacityplanforecastinputsresponse struct { 
	...
	DownloadTemplate *Capacityplanforecastinputstemplate `json:"downloadTemplate,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Capacityplanforecastinputsresponse) SetField(field string, fieldValue interface{}) {
...
func (o Capacityplanforecastinputsresponse) MarshalJSON() ([]byte, error) {
...
func (o *Capacityplanforecastinputsresponse) UnmarshalJSON(b []byte) error {
	var CapacityplanforecastinputsresponseMap map[string]interface{}
	err := json.Unmarshal(b, &CapacityplanforecastinputsresponseMap)
	if err != nil {
		return err
	}
	
	if BusinessUnit, ok := CapacityplanforecastinputsresponseMap["businessUnit"].(map[string]interface{}); ok {
		BusinessUnitString, _ := json.Marshal(BusinessUnit)
		json.Unmarshal(BusinessUnitString, &o.BusinessUnit)
	}
	
	if CapacityPlan, ok := CapacityplanforecastinputsresponseMap["capacityPlan"].(map[string]interface{}); ok {
		CapacityPlanString, _ := json.Marshal(CapacityPlan)
		json.Unmarshal(CapacityPlanString, &o.CapacityPlan)
	}
	
	if DownloadUrl, ok := CapacityplanforecastinputsresponseMap["downloadUrl"].(string); ok {
		o.DownloadUrl = &DownloadUrl
	}
    
	if DownloadTemplate, ok := CapacityplanforecastinputsresponseMap["downloadTemplate"].(map[string]interface{}); ok {
