...
func (o *Openinboundstructuredresponsemessage) SetField(field string, fieldValue interface{}) {
...
func (o Openinboundstructuredresponsemessage) MarshalJSON() ([]byte, error) {
...
func (o *Openinboundstructuredresponsemessage) UnmarshalJSON(b []byte) error {
	var OpeninboundstructuredresponsemessageMap map[string]interface{}
	err := json.Unmarshal(b, &OpeninboundstructuredresponsemessageMap)
	if err != nil {
		return err
	}
	
	if Channel, ok := OpeninboundstructuredresponsemessageMap["channel"].(map[string]interface{}); ok {
		ChannelString, _ := json.Marshal(Channel)
		json.Unmarshal(ChannelString, &o.Channel)
	}
	
	if ButtonResponse, ok := OpeninboundstructuredresponsemessageMap["buttonResponse"].(map[string]interface{}); ok {
		ButtonResponseString, _ := json.Marshal(ButtonResponse)
		json.Unmarshal(ButtonResponseString, &o.ButtonResponse)
	}
	
	if OriginatingMessageId, ok := OpeninboundstructuredresponsemessageMap["originatingMessageId"].(string); ok {
