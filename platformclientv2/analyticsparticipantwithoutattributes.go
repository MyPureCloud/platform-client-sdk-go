...
func (o *Analyticsparticipantwithoutattributes) SetField(field string, fieldValue interface{}) {
...
func (o *Analyticsparticipantwithoutattributes) UnmarshalJSON(b []byte) error {
	...
	if ScreenRecording, ok := AnalyticsparticipantwithoutattributesMap["screenRecording"].(bool); ok {
