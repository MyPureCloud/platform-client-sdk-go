...
func (o *Campaigndiagnosticwindow) SetField(field string, fieldValue interface{}) {
...
func (o Campaigndiagnosticwindow) MarshalJSON() ([]byte, error) {
...
func (o *Campaigndiagnosticwindow) UnmarshalJSON(b []byte) error {
	var CampaigndiagnosticwindowMap map[string]interface{}
	err := json.Unmarshal(b, &CampaigndiagnosticwindowMap)
	if err != nil {
		return err
	}
	
	if State, ok := CampaigndiagnosticwindowMap["state"].(string); ok {
		o.State = &State
	}
    
	if dateStartString, ok := CampaigndiagnosticwindowMap["dateStart"].(string); ok {
		DateStart, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateStartString)
		o.DateStart = &DateStart
	}
	
	if dateEndString, ok := CampaigndiagnosticwindowMap["dateEnd"].(string); ok {
