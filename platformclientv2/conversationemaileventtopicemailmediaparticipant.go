...
type Conversationemaileventtopicemailmediaparticipant struct { 
	...
	// QueueMediaSettings
	QueueMediaSettings *Conversationemaileventtopicqueuemediasettings `json:"queueMediaSettings,omitempty"`
...
func (o *Conversationemaileventtopicemailmediaparticipant) UnmarshalJSON(b []byte) error {
	...
	if resumeTimeString, ok := ConversationemaileventtopicemailmediaparticipantMap["resumeTime"].(string); ok {
		ResumeTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", resumeTimeString)
		o.ResumeTime = &ResumeTime
	}
	
	if parkTimeString, ok := ConversationemaileventtopicemailmediaparticipantMap["parkTime"].(string); ok {
	...
	if QueueMediaSettings, ok := ConversationemaileventtopicemailmediaparticipantMap["queueMediaSettings"].(map[string]interface{}); ok {
