...
func (o *Updatedecisiontablecolumnsrequest) SetField(field string, fieldValue interface{}) {
...
func (o Updatedecisiontablecolumnsrequest) MarshalJSON() ([]byte, error) {
...
func (o *Updatedecisiontablecolumnsrequest) UnmarshalJSON(b []byte) error {
	var UpdatedecisiontablecolumnsrequestMap map[string]interface{}
	err := json.Unmarshal(b, &UpdatedecisiontablecolumnsrequestMap)
	if err != nil {
		return err
	}
	
	if Inputs, ok := UpdatedecisiontablecolumnsrequestMap["inputs"].([]interface{}); ok {
		InputsString, _ := json.Marshal(Inputs)
		json.Unmarshal(InputsString, &o.Inputs)
	}
	
	if Outputs, ok := UpdatedecisiontablecolumnsrequestMap["outputs"].([]interface{}); ok {
