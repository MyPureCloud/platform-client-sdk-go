...
func (o Campaignrulespecificdateinterval) MarshalJSON() ([]byte, error) {
...
func (o *Campaignrulespecificdateinterval) UnmarshalJSON(b []byte) error {
	var CampaignrulespecificdateintervalMap map[string]interface{}
	err := json.Unmarshal(b, &CampaignrulespecificdateintervalMap)
	if err != nil {
		return err
	}
