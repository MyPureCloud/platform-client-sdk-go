...
func (o *Conversationaccessattributesresponse) SetField(field string, fieldValue interface{}) {
...
func (o Conversationaccessattributesresponse) MarshalJSON() ([]byte, error) {
...
func (o *Conversationaccessattributesresponse) UnmarshalJSON(b []byte) error {
	var ConversationaccessattributesresponseMap map[string]interface{}
	err := json.Unmarshal(b, &ConversationaccessattributesresponseMap)
	if err != nil {
		return err
	}
	
	if AccessAttributes, ok := ConversationaccessattributesresponseMap["accessAttributes"].([]interface{}); ok {
