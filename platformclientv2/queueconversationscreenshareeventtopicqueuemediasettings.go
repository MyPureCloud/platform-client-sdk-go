...
type Queueconversationscreenshareeventtopicqueuemediasettings struct { 
...
func (o *Queueconversationscreenshareeventtopicqueuemediasettings) SetField(field string, fieldValue interface{}) {
...
func (o Queueconversationscreenshareeventtopicqueuemediasettings) MarshalJSON() ([]byte, error) {
	...
	type Alias Queueconversationscreenshareeventtopicqueuemediasettings
...
func (o *Queueconversationscreenshareeventtopicqueuemediasettings) UnmarshalJSON(b []byte) error {
	var QueueconversationscreenshareeventtopicqueuemediasettingsMap map[string]interface{}
	err := json.Unmarshal(b, &QueueconversationscreenshareeventtopicqueuemediasettingsMap)
	if err != nil {
		return err
	}
	
	if AlertingTimeoutSeconds, ok := QueueconversationscreenshareeventtopicqueuemediasettingsMap["alertingTimeoutSeconds"].(float64); ok {
		AlertingTimeoutSecondsInt := int(AlertingTimeoutSeconds)
		o.AlertingTimeoutSeconds = &AlertingTimeoutSecondsInt
	}
	
	if AutoAnswerAlertToneSeconds, ok := QueueconversationscreenshareeventtopicqueuemediasettingsMap["autoAnswerAlertToneSeconds"].(float64); ok {
	...
	if ManualAnswerAlertToneSeconds, ok := QueueconversationscreenshareeventtopicqueuemediasettingsMap["manualAnswerAlertToneSeconds"].(float64); ok {
	...
	if EnableAutoAnswer, ok := QueueconversationscreenshareeventtopicqueuemediasettingsMap["enableAutoAnswer"].(bool); ok {
...
func (o *Queueconversationscreenshareeventtopicqueuemediasettings) String() string {
	j, _ := json.Marshal(o)
