...
type Journeyschemaupdaterequest struct { 
	...
	JsonSchema *Journeyjsonschemarequest `json:"jsonSchema,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Journeyschemaupdaterequest) SetField(field string, fieldValue interface{}) {
...
func (o Journeyschemaupdaterequest) MarshalJSON() ([]byte, error) {
...
func (o *Journeyschemaupdaterequest) UnmarshalJSON(b []byte) error {
	var JourneyschemaupdaterequestMap map[string]interface{}
	err := json.Unmarshal(b, &JourneyschemaupdaterequestMap)
	if err != nil {
		return err
	}
	
	if Version, ok := JourneyschemaupdaterequestMap["version"].(float64); ok {
		VersionInt := int(Version)
		o.Version = &VersionInt
	}
	
	if Enabled, ok := JourneyschemaupdaterequestMap["enabled"].(bool); ok {
		o.Enabled = &Enabled
	}
    
	if JsonSchema, ok := JourneyschemaupdaterequestMap["jsonSchema"].(map[string]interface{}); ok {
