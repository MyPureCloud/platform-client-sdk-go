...
func (o *Analyticsconversationwithoutattributes) UnmarshalJSON(b []byte) error {
	...
	if AccessAttributes, ok := AnalyticsconversationwithoutattributesMap["accessAttributes"].([]interface{}); ok {
		AccessAttributesString, _ := json.Marshal(AccessAttributes)
		json.Unmarshal(AccessAttributesString, &o.AccessAttributes)
	}
	
	if AssociatedConversationId, ok := AnalyticsconversationwithoutattributesMap["associatedConversationId"].(string); ok {
	...
	if ConsultationConversationIds, ok := AnalyticsconversationwithoutattributesMap["consultationConversationIds"].([]interface{}); ok {
	...
	if inactivityTimeoutString, ok := AnalyticsconversationwithoutattributesMap["inactivityTimeout"].(string); ok {
