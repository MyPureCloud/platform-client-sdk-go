...
func (o *Dialercampaignprogresseventcampaignprogress) SetField(field string, fieldValue interface{}) {
...
func (o *Dialercampaignprogresseventcampaignprogress) UnmarshalJSON(b []byte) error {
	...
	if NumberOfContactsSkipped, ok := DialercampaignprogresseventcampaignprogressMap["numberOfContactsSkipped"].(map[string]interface{}); ok {
