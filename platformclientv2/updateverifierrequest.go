...
func (o *Updateverifierrequest) SetField(field string, fieldValue interface{}) {
...
func (o Updateverifierrequest) MarshalJSON() ([]byte, error) {
...
func (o *Updateverifierrequest) UnmarshalJSON(b []byte) error {
	var UpdateverifierrequestMap map[string]interface{}
	err := json.Unmarshal(b, &UpdateverifierrequestMap)
	if err != nil {
		return err
	}
	
	if Name, ok := UpdateverifierrequestMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if Enabled, ok := UpdateverifierrequestMap["enabled"].(bool); ok {
		o.Enabled = &Enabled
	}
