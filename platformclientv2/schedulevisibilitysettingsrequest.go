...
func (o *Schedulevisibilitysettingsrequest) SetField(field string, fieldValue interface{}) {
...
func (o Schedulevisibilitysettingsrequest) MarshalJSON() ([]byte, error) {
...
func (o *Schedulevisibilitysettingsrequest) UnmarshalJSON(b []byte) error {
	var SchedulevisibilitysettingsrequestMap map[string]interface{}
	err := json.Unmarshal(b, &SchedulevisibilitysettingsrequestMap)
	if err != nil {
		return err
	}
	
	if Enabled, ok := SchedulevisibilitysettingsrequestMap["enabled"].(bool); ok {
		o.Enabled = &Enabled
	}
    
	if FutureWeeks, ok := SchedulevisibilitysettingsrequestMap["futureWeeks"].(float64); ok {
