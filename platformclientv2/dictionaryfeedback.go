...
func (o *Dictionaryfeedback) SetField(field string, fieldValue interface{}) {
...
func (o Dictionaryfeedback) MarshalJSON() ([]byte, error) {
...
func (o *Dictionaryfeedback) UnmarshalJSON(b []byte) error {
	var DictionaryfeedbackMap map[string]interface{}
	err := json.Unmarshal(b, &DictionaryfeedbackMap)
	if err != nil {
		return err
	}
	
	if Id, ok := DictionaryfeedbackMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Term, ok := DictionaryfeedbackMap["term"].(string); ok {
		o.Term = &Term
	}
    
	if Dialect, ok := DictionaryfeedbackMap["dialect"].(string); ok {
		o.Dialect = &Dialect
	}
    
	if BoostValue, ok := DictionaryfeedbackMap["boostValue"].(float64); ok {
		BoostValueFloat32 := float32(BoostValue)
		o.BoostValue = &BoostValueFloat32
	}
	
	if Source, ok := DictionaryfeedbackMap["source"].(string); ok {
		o.Source = &Source
	}
    
	if dateCreatedString, ok := DictionaryfeedbackMap["dateCreated"].(string); ok {
		DateCreated, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateCreatedString)
		o.DateCreated = &DateCreated
	}
	
	if CreatedBy, ok := DictionaryfeedbackMap["createdBy"].(map[string]interface{}); ok {
		CreatedByString, _ := json.Marshal(CreatedBy)
		json.Unmarshal(CreatedByString, &o.CreatedBy)
	}
	
	if dateModifiedString, ok := DictionaryfeedbackMap["dateModified"].(string); ok {
		DateModified, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateModifiedString)
		o.DateModified = &DateModified
	}
	
	if ModifiedBy, ok := DictionaryfeedbackMap["modifiedBy"].(map[string]interface{}); ok {
	...
	if SoundsLike, ok := DictionaryfeedbackMap["soundsLike"].([]interface{}); ok {
		SoundsLikeString, _ := json.Marshal(SoundsLike)
		json.Unmarshal(SoundsLikeString, &o.SoundsLike)
	}
	
	if SelfUri, ok := DictionaryfeedbackMap["selfUri"].(string); ok {
		o.SelfUri = &SelfUri
	}
