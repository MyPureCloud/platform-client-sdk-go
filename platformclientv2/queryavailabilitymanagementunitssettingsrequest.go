...
func (o *Queryavailabilitymanagementunitssettingsrequest) SetField(field string, fieldValue interface{}) {
...
func (o Queryavailabilitymanagementunitssettingsrequest) MarshalJSON() ([]byte, error) {
...
func (o *Queryavailabilitymanagementunitssettingsrequest) UnmarshalJSON(b []byte) error {
	var QueryavailabilitymanagementunitssettingsrequestMap map[string]interface{}
	err := json.Unmarshal(b, &QueryavailabilitymanagementunitssettingsrequestMap)
	if err != nil {
		return err
	}
	
	if ManagementUnitIds, ok := QueryavailabilitymanagementunitssettingsrequestMap["managementUnitIds"].([]interface{}); ok {
