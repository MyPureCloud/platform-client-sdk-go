...
func (o *Dialerresponsesetconfigchangereaction) SetField(field string, fieldValue interface{}) {
...
func (o *Dialerresponsesetconfigchangereaction) UnmarshalJSON(b []byte) error {
	...
	if GetAdditionalProperties, ok := DialerresponsesetconfigchangereactionMap["getAdditionalProperties"].(map[string]interface{}); ok {
