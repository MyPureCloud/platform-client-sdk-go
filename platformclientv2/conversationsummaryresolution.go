...
func (o *Conversationsummaryresolution) SetField(field string, fieldValue interface{}) {
...
func (o Conversationsummaryresolution) MarshalJSON() ([]byte, error) {
...
func (o *Conversationsummaryresolution) UnmarshalJSON(b []byte) error {
	var ConversationsummaryresolutionMap map[string]interface{}
	err := json.Unmarshal(b, &ConversationsummaryresolutionMap)
	if err != nil {
		return err
	}
	...
	if Description, ok := ConversationsummaryresolutionMap["description"].(string); ok {
