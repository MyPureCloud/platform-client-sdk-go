...
func (o *Listpicker) SetField(field string, fieldValue interface{}) {
...
func (o Listpicker) MarshalJSON() ([]byte, error) {
...
func (o *Listpicker) UnmarshalJSON(b []byte) error {
	var ListpickerMap map[string]interface{}
	err := json.Unmarshal(b, &ListpickerMap)
	if err != nil {
		return err
	}
