...
func (o *Opendataingestionrulerequest) SetField(field string, fieldValue interface{}) {
...
func (o Opendataingestionrulerequest) MarshalJSON() ([]byte, error) {
...
func (o *Opendataingestionrulerequest) UnmarshalJSON(b []byte) error {
	var OpendataingestionrulerequestMap map[string]interface{}
	err := json.Unmarshal(b, &OpendataingestionrulerequestMap)
	if err != nil {
		return err
	}
	
	if Name, ok := OpendataingestionrulerequestMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if Description, ok := OpendataingestionrulerequestMap["description"].(string); ok {
		o.Description = &Description
	}
    
	if ExternalSource, ok := OpendataingestionrulerequestMap["externalSource"].(map[string]interface{}); ok {
