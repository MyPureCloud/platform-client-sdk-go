...
func (o *V2mobiusalertstopicentityproperties) UnmarshalJSON(b []byte) error {
	...
	if User, ok := V2mobiusalertstopicentitypropertiesMap["user"].(map[string]interface{}); ok {
		UserString, _ := json.Marshal(User)
		json.Unmarshal(UserString, &o.User)
	}
	
	if Group, ok := V2mobiusalertstopicentitypropertiesMap["group"].(map[string]interface{}); ok {
		GroupString, _ := json.Marshal(Group)
		json.Unmarshal(GroupString, &o.Group)
	}
	
	if Queue, ok := V2mobiusalertstopicentitypropertiesMap["queue"].(map[string]interface{}); ok {
		QueueString, _ := json.Marshal(Queue)
		json.Unmarshal(QueueString, &o.Queue)
	}
	
	if Team, ok := V2mobiusalertstopicentitypropertiesMap["team"].(map[string]interface{}); ok {
