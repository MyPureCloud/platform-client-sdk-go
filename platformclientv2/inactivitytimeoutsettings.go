...
func (o Inactivitytimeoutsettings) MarshalJSON() ([]byte, error) {
...
func (o *Inactivitytimeoutsettings) UnmarshalJSON(b []byte) error {
	var InactivitytimeoutsettingsMap map[string]interface{}
