...
func (o Cobrowsemediaparticipant) MarshalJSON() ([]byte, error) {
	...
	if len(o.SetFieldNames) > 0 {
		...
		dateTimeFields := []string{ "StartTime","StartAlertingTime","ConnectedTime","EndTime","StartHoldTime","StartAcwTime","EndAcwTime","ParkTime","ResumeTime","ProviderEventTime", }
...
func (o *Cobrowsemediaparticipant) UnmarshalJSON(b []byte) error {
	...
	if startAlertingTimeString, ok := CobrowsemediaparticipantMap["startAlertingTime"].(string); ok {
