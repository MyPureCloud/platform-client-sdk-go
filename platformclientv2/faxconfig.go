...
func (o *Faxconfig) SetField(field string, fieldValue interface{}) {
...
func (o Faxconfig) MarshalJSON() ([]byte, error) {
...
func (o *Faxconfig) UnmarshalJSON(b []byte) error {
	var FaxconfigMap map[string]interface{}
	err := json.Unmarshal(b, &FaxconfigMap)
	if err != nil {
		return err
	}
	
	if SendEmailNotifications, ok := FaxconfigMap["sendEmailNotifications"].(bool); ok {
		o.SendEmailNotifications = &SendEmailNotifications
	}
    
	if DisableEmailPii, ok := FaxconfigMap["disableEmailPii"].(bool); ok {
