...
func (o *Suggestionpatchrequest) SetField(field string, fieldValue interface{}) {
...
func (o Suggestionpatchrequest) MarshalJSON() ([]byte, error) {
...
func (o *Suggestionpatchrequest) UnmarshalJSON(b []byte) error {
	var SuggestionpatchrequestMap map[string]interface{}
	err := json.Unmarshal(b, &SuggestionpatchrequestMap)
	if err != nil {
		return err
	}
	
	if ThirdPartySuggestion, ok := SuggestionpatchrequestMap["thirdPartySuggestion"].(map[string]interface{}); ok {
