...
type Queueconversationchateventtopicerrorbody struct { 
	...
	// Limit
	Limit *Queueconversationchateventtopiclimit `json:"limit,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Queueconversationchateventtopicerrorbody) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationchateventtopicerrorbody) UnmarshalJSON(b []byte) error {
	...
	if Limit, ok := QueueconversationchateventtopicerrorbodyMap["limit"].(map[string]interface{}); ok {
