...
func (o *Createtimeoffplanmanagementunitassociation) SetField(field string, fieldValue interface{}) {
...
func (o Createtimeoffplanmanagementunitassociation) MarshalJSON() ([]byte, error) {
...
func (o *Createtimeoffplanmanagementunitassociation) UnmarshalJSON(b []byte) error {
	var CreatetimeoffplanmanagementunitassociationMap map[string]interface{}
	err := json.Unmarshal(b, &CreatetimeoffplanmanagementunitassociationMap)
	if err != nil {
		return err
	}
	
	if ManagementUnitId, ok := CreatetimeoffplanmanagementunitassociationMap["managementUnitId"].(string); ok {
		o.ManagementUnitId = &ManagementUnitId
	}
    
	if StaffingGroupIds, ok := CreatetimeoffplanmanagementunitassociationMap["staffingGroupIds"].([]interface{}); ok {
