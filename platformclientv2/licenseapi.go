...
func (a LicenseApi) GetLicenseDefinition(licenseId string) (*Licensedefinition, *APIResponse, error) {
	...
	if &licenseId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'licenseId' when calling LicenseApi->GetLicenseDefinition")
	}
...
func (a LicenseApi) GetLicenseDefinitions() ([]Licensedefinition, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/license/definitions"
	defaultReturn := make([]Licensedefinition, 0)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
func (a LicenseApi) GetLicenseToggle(featureName string) (*Licenseorgtoggle, *APIResponse, error) {
	...
	if &featureName == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'featureName' when calling LicenseApi->GetLicenseToggle")
	}
...
func (a LicenseApi) GetLicenseUser(userId string) (*Licenseuser, *APIResponse, error) {
	...
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling LicenseApi->GetLicenseUser")
	}
...
func (a LicenseApi) GetLicenseUsers(pageSize int, pageNumber int) (*Userlicensesentitylisting, *APIResponse, error) {
	...
	defaultReturn := new(Userlicensesentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
func (a LicenseApi) PostLicenseInfer(body []string) ([]string, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/license/infer"
...
// PostLicenseInferPermissions invokes POST /api/v2/license/infer/permissions
//
// Get a list of licenses inferred based on a list of permissions
//
// Preview: PostLicenseInferPermissions is a preview method and is subject to both breaking and non-breaking changes at any time without notice
func (a LicenseApi) PostLicenseInferPermissions(body []string) ([]string, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/license/infer/permissions"
	defaultReturn := make([]string, 0)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
func (a LicenseApi) PostLicenseOrganization(body Licensebatchassignmentrequest) ([]Licenseupdatestatus, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/license/organization"
	defaultReturn := make([]Licenseupdatestatus, 0)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
func (a LicenseApi) PostLicenseToggle(featureName string) (*Licenseorgtoggle, *APIResponse, error) {
	...
	if &featureName == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'featureName' when calling LicenseApi->PostLicenseToggle")
	}
