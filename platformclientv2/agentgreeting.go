...
func (o *Agentgreeting) SetField(field string, fieldValue interface{}) {
...
func (o Agentgreeting) MarshalJSON() ([]byte, error) {
...
func (o *Agentgreeting) UnmarshalJSON(b []byte) error {
	var AgentgreetingMap map[string]interface{}
	err := json.Unmarshal(b, &AgentgreetingMap)
	if err != nil {
		return err
	}
	...
	if OutboundPrompt, ok := AgentgreetingMap["outboundPrompt"].(map[string]interface{}); ok {
		OutboundPromptString, _ := json.Marshal(OutboundPrompt)
		json.Unmarshal(OutboundPromptString, &o.OutboundPrompt)
	}
	
	if InboundPromptDefaultLanguage, ok := AgentgreetingMap["inboundPromptDefaultLanguage"].(string); ok {
		o.InboundPromptDefaultLanguage = &InboundPromptDefaultLanguage
	}
    
	if OutboundPromptDefaultLanguage, ok := AgentgreetingMap["outboundPromptDefaultLanguage"].(string); ok {
		o.OutboundPromptDefaultLanguage = &OutboundPromptDefaultLanguage
	}
    
	if SelfUri, ok := AgentgreetingMap["selfUri"].(string); ok {
		o.SelfUri = &SelfUri
	}
