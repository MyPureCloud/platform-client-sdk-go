...
func (o *Timeoffrequestresponse) UnmarshalJSON(b []byte) error {
	...
	if FullDayEarliestStartOffsetMinutes, ok := TimeoffrequestresponseMap["fullDayEarliestStartOffsetMinutes"].([]interface{}); ok {
	...
	if FullDayLatestEndOffsetMinutes, ok := TimeoffrequestresponseMap["fullDayLatestEndOffsetMinutes"].([]interface{}); ok {
