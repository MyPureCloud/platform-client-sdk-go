...
type Queueconversationeventtopiccall struct { 
	...
	// RecordersState
	RecordersState *Queueconversationeventtopicrecordersstate `json:"recordersState,omitempty"`
...
func (o *Queueconversationeventtopiccall) UnmarshalJSON(b []byte) error {
	...
	if RecordersState, ok := QueueconversationeventtopiccallMap["recordersState"].(map[string]interface{}); ok {
	...
	if SecurePause, ok := QueueconversationeventtopiccallMap["securePause"].(bool); ok {
	...
	if PublicIpAddress, ok := QueueconversationeventtopiccallMap["publicIpAddress"].(string); ok {
