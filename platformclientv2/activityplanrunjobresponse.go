...
func (o *Activityplanrunjobresponse) SetField(field string, fieldValue interface{}) {
...
func (o Activityplanrunjobresponse) MarshalJSON() ([]byte, error) {
...
func (o *Activityplanrunjobresponse) UnmarshalJSON(b []byte) error {
	var ActivityplanrunjobresponseMap map[string]interface{}
	err := json.Unmarshal(b, &ActivityplanrunjobresponseMap)
	if err != nil {
		return err
	}
	
	if Id, ok := ActivityplanrunjobresponseMap["id"].(string); ok {
		o.Id = &Id
	}
	...
	if Exceptions, ok := ActivityplanrunjobresponseMap["exceptions"].([]interface{}); ok {
