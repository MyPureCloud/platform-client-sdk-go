...
// Queueconversationeventtopicqueuemediasettings - Represents the queue setting for this media.
type Queueconversationeventtopicqueuemediasettings struct { 
...
func (o *Queueconversationeventtopicqueuemediasettings) SetField(field string, fieldValue interface{}) {
...
func (o Queueconversationeventtopicqueuemediasettings) MarshalJSON() ([]byte, error) {
	...
	type Alias Queueconversationeventtopicqueuemediasettings
...
func (o *Queueconversationeventtopicqueuemediasettings) UnmarshalJSON(b []byte) error {
	var QueueconversationeventtopicqueuemediasettingsMap map[string]interface{}
	err := json.Unmarshal(b, &QueueconversationeventtopicqueuemediasettingsMap)
	if err != nil {
		return err
	}
	
	if AlertingTimeoutSeconds, ok := QueueconversationeventtopicqueuemediasettingsMap["alertingTimeoutSeconds"].(float64); ok {
		AlertingTimeoutSecondsInt := int(AlertingTimeoutSeconds)
		o.AlertingTimeoutSeconds = &AlertingTimeoutSecondsInt
	}
	
	if AutoAnswerAlertToneSeconds, ok := QueueconversationeventtopicqueuemediasettingsMap["autoAnswerAlertToneSeconds"].(float64); ok {
	...
	if ManualAnswerAlertToneSeconds, ok := QueueconversationeventtopicqueuemediasettingsMap["manualAnswerAlertToneSeconds"].(float64); ok {
	...
	if EnableAutoAnswer, ok := QueueconversationeventtopicqueuemediasettingsMap["enableAutoAnswer"].(bool); ok {
...
func (o *Queueconversationeventtopicqueuemediasettings) String() string {
	j, _ := json.Marshal(o)
