...
func (a TaskManagementApi) GetTaskmanagementWorkitemsSchemasCoretype(coreTypeName string) (*Coretype, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/taskmanagement/workitems/schemas/coretypes/{coreTypeName}"
	...
	if &coreTypeName == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'coreTypeName' when calling TaskManagementApi->GetTaskmanagementWorkitemsSchemasCoretype")
	}
...
// GetTaskmanagementWorkitemsSchemasLimits invokes GET /api/v2/taskmanagement/workitems/schemas/limits
//
// Get quantitative limits on schemas
func (a TaskManagementApi) GetTaskmanagementWorkitemsSchemasLimits() (*Schemaquantitylimits, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/taskmanagement/workitems/schemas/limits"
