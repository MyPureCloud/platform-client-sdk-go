...
type Webmessagingevent struct { 
	...
	// Video - Video event.
	Video *Webmessagingeventvideo `json:"video,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Webmessagingevent) SetField(field string, fieldValue interface{}) {
...
func (o *Webmessagingevent) UnmarshalJSON(b []byte) error {
	...
	if Video, ok := WebmessagingeventMap["video"].(map[string]interface{}); ok {
