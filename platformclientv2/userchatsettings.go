...
func (o *Userchatsettings) SetField(field string, fieldValue interface{}) {
...
func (o Userchatsettings) MarshalJSON() ([]byte, error) {
...
func (o *Userchatsettings) UnmarshalJSON(b []byte) error {
	var UserchatsettingsMap map[string]interface{}
	err := json.Unmarshal(b, &UserchatsettingsMap)
	if err != nil {
		return err
	}
	
	if Muted, ok := UserchatsettingsMap["muted"].(bool); ok {
		o.Muted = &Muted
	}
    
	if MentionsOnly, ok := UserchatsettingsMap["mentionsOnly"].(bool); ok {
		o.MentionsOnly = &MentionsOnly
	}
    
	if NotifyOnReactions, ok := UserchatsettingsMap["notifyOnReactions"].(bool); ok {
