...
func (a UploadsApi) GetKnowledgeKnowledgebaseUploadsUrlsJob(knowledgeBaseId string, jobId string) (*Getuploadsourceurljobstatusresponse, *APIResponse, error) {
	...
	if &knowledgeBaseId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'knowledgeBaseId' when calling UploadsApi->GetKnowledgeKnowledgebaseUploadsUrlsJob")
	}
	// verify the required parameter 'jobId' is set
	if &jobId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'jobId' when calling UploadsApi->GetKnowledgeKnowledgebaseUploadsUrlsJob")
	}
...
func (a UploadsApi) PostGamificationContestsUploadsPrizeimages(body Gamificationcontestprizeimageuploadurlrequest) (*Uploadurlresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling UploadsApi->PostGamificationContestsUploadsPrizeimages")
	}
...
func (a UploadsApi) PostGuidesUploads(body Uploadurlrequest) (*Uploadurlresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling UploadsApi->PostGuidesUploads")
	}
...
func (a UploadsApi) PostIntegrationsActionDraftFunctionUpload(actionId string, body Functionuploadrequest) (*Functionuploadresponse, *APIResponse, error) {
	...
	if &actionId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'actionId' when calling UploadsApi->PostIntegrationsActionDraftFunctionUpload")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling UploadsApi->PostIntegrationsActionDraftFunctionUpload")
	}
...
func (a UploadsApi) PostKnowledgeKnowledgebaseUploadsUrlsJobs(knowledgeBaseId string, body Createuploadsourceurljobrequest) (*Createuploadsourceurljobresponse, *APIResponse, error) {
	...
	if &knowledgeBaseId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'knowledgeBaseId' when calling UploadsApi->PostKnowledgeKnowledgebaseUploadsUrlsJobs")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling UploadsApi->PostKnowledgeKnowledgebaseUploadsUrlsJobs")
	}
...
func (a UploadsApi) PostUploadsLearningCoverart(body Learningcoverartuploadurlrequest) (*Uploadurlresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/uploads/learning/coverart"
	defaultReturn := new(Uploadurlresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling UploadsApi->PostUploadsLearningCoverart")
	}
...
func (a UploadsApi) PostUploadsRecordings(body Uploadurlrequest) (*Uploadurlresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/uploads/recordings"
	defaultReturn := new(Uploadurlresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
func (a UploadsApi) PostUploadsWorkforcemanagementHistoricaldataCsv(body Uploadurlrequest) (*Uploadurlresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/uploads/workforcemanagement/historicaldata/csv"
	defaultReturn := new(Uploadurlresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
