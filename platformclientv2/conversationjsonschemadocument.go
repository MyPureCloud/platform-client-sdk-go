...
func (o *Conversationjsonschemadocument) SetField(field string, fieldValue interface{}) {
...
func (o Conversationjsonschemadocument) MarshalJSON() ([]byte, error) {
...
func (o *Conversationjsonschemadocument) UnmarshalJSON(b []byte) error {
	var ConversationjsonschemadocumentMap map[string]interface{}
	err := json.Unmarshal(b, &ConversationjsonschemadocumentMap)
	if err != nil {
		return err
	}
	
	if Schema, ok := ConversationjsonschemadocumentMap["$schema"].(string); ok {
		o.Schema = &Schema
	}
    
	if Title, ok := ConversationjsonschemadocumentMap["title"].(string); ok {
		o.Title = &Title
	}
    
	if Description, ok := ConversationjsonschemadocumentMap["description"].(string); ok {
		o.Description = &Description
	}
    
	if Required, ok := ConversationjsonschemadocumentMap["required"].([]interface{}); ok {
		RequiredString, _ := json.Marshal(Required)
		json.Unmarshal(RequiredString, &o.Required)
	}
	
	if Properties, ok := ConversationjsonschemadocumentMap["properties"].(map[string]interface{}); ok {
