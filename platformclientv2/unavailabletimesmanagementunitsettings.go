...
func (o *Unavailabletimesmanagementunitsettings) SetField(field string, fieldValue interface{}) {
...
func (o Unavailabletimesmanagementunitsettings) MarshalJSON() ([]byte, error) {
...
func (o *Unavailabletimesmanagementunitsettings) UnmarshalJSON(b []byte) error {
	var UnavailabletimesmanagementunitsettingsMap map[string]interface{}
	err := json.Unmarshal(b, &UnavailabletimesmanagementunitsettingsMap)
	if err != nil {
		return err
	}
	
	if ManagementUnit, ok := UnavailabletimesmanagementunitsettingsMap["managementUnit"].(map[string]interface{}); ok {
		ManagementUnitString, _ := json.Marshal(ManagementUnit)
		json.Unmarshal(ManagementUnitString, &o.ManagementUnit)
	}
	
	if Enabled, ok := UnavailabletimesmanagementunitsettingsMap["enabled"].(bool); ok {
		o.Enabled = &Enabled
	}
