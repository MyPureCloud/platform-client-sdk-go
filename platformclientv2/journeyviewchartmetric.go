...
func (o *Journeyviewchartmetric) SetField(field string, fieldValue interface{}) {
...
func (o Journeyviewchartmetric) MarshalJSON() ([]byte, error) {
...
func (o *Journeyviewchartmetric) UnmarshalJSON(b []byte) error {
	var JourneyviewchartmetricMap map[string]interface{}
	err := json.Unmarshal(b, &JourneyviewchartmetricMap)
	if err != nil {
		return err
	}
	
	if Id, ok := JourneyviewchartmetricMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if ElementId, ok := JourneyviewchartmetricMap["elementId"].(string); ok {
