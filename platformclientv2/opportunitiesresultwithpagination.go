...
type Opportunitiesresultwithpagination struct { 
	...
	Opportunities *[]Opportunityresult `json:"opportunities,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Opportunitiesresultwithpagination) SetField(field string, fieldValue interface{}) {
...
func (o Opportunitiesresultwithpagination) MarshalJSON() ([]byte, error) {
...
func (o *Opportunitiesresultwithpagination) UnmarshalJSON(b []byte) error {
	var OpportunitiesresultwithpaginationMap map[string]interface{}
	err := json.Unmarshal(b, &OpportunitiesresultwithpaginationMap)
	if err != nil {
		return err
	}
	
	if nextStartDateString, ok := OpportunitiesresultwithpaginationMap["nextStartDate"].(string); ok {
		NextStartDate, _ := time.Parse("2006-01-02T15:04:05.999999Z", nextStartDateString)
		o.NextStartDate = &NextStartDate
	}
	
	if Opportunities, ok := OpportunitiesresultwithpaginationMap["opportunities"].([]interface{}); ok {
