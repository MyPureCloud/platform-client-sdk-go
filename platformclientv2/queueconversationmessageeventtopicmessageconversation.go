...
func (o *Queueconversationmessageeventtopicmessageconversation) SetField(field string, fieldValue interface{}) {
...
func (o Queueconversationmessageeventtopicmessageconversation) MarshalJSON() ([]byte, error) {
...
func (o *Queueconversationmessageeventtopicmessageconversation) UnmarshalJSON(b []byte) error {
	var QueueconversationmessageeventtopicmessageconversationMap map[string]interface{}
	err := json.Unmarshal(b, &QueueconversationmessageeventtopicmessageconversationMap)
	if err != nil {
		return err
	}
	
	if Id, ok := QueueconversationmessageeventtopicmessageconversationMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Name, ok := QueueconversationmessageeventtopicmessageconversationMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if Participants, ok := QueueconversationmessageeventtopicmessageconversationMap["participants"].([]interface{}); ok {
		ParticipantsString, _ := json.Marshal(Participants)
		json.Unmarshal(ParticipantsString, &o.Participants)
	}
	
	if OtherMediaUris, ok := QueueconversationmessageeventtopicmessageconversationMap["otherMediaUris"].([]interface{}); ok {
		OtherMediaUrisString, _ := json.Marshal(OtherMediaUris)
		json.Unmarshal(OtherMediaUrisString, &o.OtherMediaUris)
	}
	
	if Address, ok := QueueconversationmessageeventtopicmessageconversationMap["address"].(string); ok {
		o.Address = &Address
	}
    
	if UtilizationLabelId, ok := QueueconversationmessageeventtopicmessageconversationMap["utilizationLabelId"].(string); ok {
		o.UtilizationLabelId = &UtilizationLabelId
	}
    
	if AccessAttributes, ok := QueueconversationmessageeventtopicmessageconversationMap["accessAttributes"].([]interface{}); ok {
