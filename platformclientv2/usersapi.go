...
func (a UsersApi) DeleteAnalyticsUsersAggregatesJob(jobId string) (*APIResponse, error) {
	...
	if &jobId == nil {
		// false
		return nil, errors.New("Missing required parameter 'jobId' when calling UsersApi->DeleteAnalyticsUsersAggregatesJob")
	}
...
func (a UsersApi) DeleteRoutingDirectroutingbackupSettingsMe() (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
...
//
// Delete the user's Direct Routing Backup settings and revert to the Direct Routing Queue default.
func (a UsersApi) DeleteRoutingUserDirectroutingbackupSettings(userId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	...
	if &userId == nil {
		// false
		return nil, errors.New("Missing required parameter 'userId' when calling UsersApi->DeleteRoutingUserDirectroutingbackupSettings")
	}
...
func (a UsersApi) DeleteUserCustomattribute(userId string, schemaId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/{userId}/customattributes/{schemaId}"
	path = strings.Replace(path, "{userId}", url.PathEscape(fmt.Sprintf("%v", userId)), -1)
	...
	if &userId == nil {
		// false
		return nil, errors.New("Missing required parameter 'userId' when calling UsersApi->DeleteUserCustomattribute")
	}
	// verify the required parameter 'schemaId' is set
	if &schemaId == nil {
		// false
		return nil, errors.New("Missing required parameter 'schemaId' when calling UsersApi->DeleteUserCustomattribute")
	}
...
// DeleteUserExternalidAuthorityNameExternalKey invokes DELETE /api/v2/users/{userId}/externalid/{authorityName}/{externalKey}
//
// Delete the external identifier for user.
func (a UsersApi) DeleteUserExternalidAuthorityNameExternalKey(userId string, authorityName string, externalKey string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/{userId}/externalid/{authorityName}/{externalKey}"
	path = strings.Replace(path, "{userId}", url.PathEscape(fmt.Sprintf("%v", userId)), -1)
	path = strings.Replace(path, "{authorityName}", url.PathEscape(fmt.Sprintf("%v", authorityName)), -1)
	path = strings.Replace(path, "{externalKey}", url.PathEscape(fmt.Sprintf("%v", externalKey)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &userId == nil {
		// false
		return nil, errors.New("Missing required parameter 'userId' when calling UsersApi->DeleteUserExternalidAuthorityNameExternalKey")
	}
	// verify the required parameter 'authorityName' is set
	if &authorityName == nil {
		// false
		return nil, errors.New("Missing required parameter 'authorityName' when calling UsersApi->DeleteUserExternalidAuthorityNameExternalKey")
	}
	// verify the required parameter 'externalKey' is set
	if &externalKey == nil {
		// false
		return nil, errors.New("Missing required parameter 'externalKey' when calling UsersApi->DeleteUserExternalidAuthorityNameExternalKey")
	}
...
func (a UsersApi) DeleteUsersCustomattributesSchema(schemaId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/customattributes/schemas/{schemaId}"
	path = strings.Replace(path, "{schemaId}", url.PathEscape(fmt.Sprintf("%v", schemaId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &schemaId == nil {
		// false
		return nil, errors.New("Missing required parameter 'schemaId' when calling UsersApi->DeleteUsersCustomattributesSchema")
	}
...
// DeleteUsersMeVerifier invokes DELETE /api/v2/users/me/verifiers/{verifierId}
//
// Delete a verifier
func (a UsersApi) DeleteUsersMeVerifier(verifierId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/me/verifiers/{verifierId}"
	path = strings.Replace(path, "{verifierId}", url.PathEscape(fmt.Sprintf("%v", verifierId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &verifierId == nil {
		// false
		return nil, errors.New("Missing required parameter 'verifierId' when calling UsersApi->DeleteUsersMeVerifier")
	}
...
func (a UsersApi) GetRoutingDirectroutingbackupSettingsMe() (*Agentdirectroutingbackupsettings, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/directroutingbackup/settings/me"
...
//
// Get the user's Direct Routing Backup settings.
func (a UsersApi) GetRoutingUserDirectroutingbackupSettings(userId string) (*Agentdirectroutingbackupsettings, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/users/{userId}/directroutingbackup/settings"
	path = strings.Replace(path, "{userId}", url.PathEscape(fmt.Sprintf("%v", userId)), -1)
	...
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling UsersApi->GetRoutingUserDirectroutingbackupSettings")
	}
...
func (a UsersApi) GetUserCustomattribute(userId string, schemaId string) (*Usercustomattributes, *APIResponse, error) {
	...
	path = strings.Replace(path, "{userId}", url.PathEscape(fmt.Sprintf("%v", userId)), -1)
	path = strings.Replace(path, "{schemaId}", url.PathEscape(fmt.Sprintf("%v", schemaId)), -1)
	defaultReturn := new(Usercustomattributes)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling UsersApi->GetUserCustomattribute")
	}
	// verify the required parameter 'schemaId' is set
	if &schemaId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'schemaId' when calling UsersApi->GetUserCustomattribute")
	}
	...
	var successPayload *Usercustomattributes
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Usercustomattributes" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a UsersApi) GetUserCustomattributesBulk(userId string, schemaIds []string) ([]interface{}, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/{userId}/customattributes/bulk"
	path = strings.Replace(path, "{userId}", url.PathEscape(fmt.Sprintf("%v", userId)), -1)
	...
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling UsersApi->GetUserCustomattributesBulk")
	}
	// verify the required parameter 'schemaIds' is set
	if &schemaIds == nil {
		// true
		return defaultReturn, nil, errors.New("Missing required parameter 'schemaIds' when calling UsersApi->GetUserCustomattributesBulk")
	}
	...
	queryParams["schemaIds"] = a.Configuration.APIClient.ParameterToString(schemaIds, "multi")
...
// GetUserExternalid invokes GET /api/v2/users/{userId}/externalid
//
// Get the external identifiers for a user.
func (a UsersApi) GetUserExternalid(userId string) ([]Userexternalidentifier, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	...
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling UsersApi->GetUserExternalid")
	}
...
// GetUserExternalidAuthorityName invokes GET /api/v2/users/{userId}/externalid/{authorityName}
//
// Get the external identifier of user for an authority.
//
// Authority name and external key are case sensitive.
func (a UsersApi) GetUserExternalidAuthorityName(userId string, authorityName string) (*Userexternalidentifier, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/{userId}/externalid/{authorityName}"
	path = strings.Replace(path, "{userId}", url.PathEscape(fmt.Sprintf("%v", userId)), -1)
	path = strings.Replace(path, "{authorityName}", url.PathEscape(fmt.Sprintf("%v", authorityName)), -1)
	defaultReturn := new(Userexternalidentifier)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling UsersApi->GetUserExternalidAuthorityName")
	}
	// verify the required parameter 'authorityName' is set
	if &authorityName == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'authorityName' when calling UsersApi->GetUserExternalidAuthorityName")
	}
...
func (a UsersApi) GetUsersChatsMe(excludeClosed bool, includePresence bool, includeRoomOwners bool, after string) (*Chatitemcursorlisting, *APIResponse, error) {
	...
	defaultReturn := new(Chatitemcursorlisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Chatitemcursorlisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Chatitemcursorlisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a UsersApi) GetUsersCustomattributesSchema(schemaId string) (*Dataschema, *APIResponse, error) {
	...
	if &schemaId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'schemaId' when calling UsersApi->GetUsersCustomattributesSchema")
	}
...
func (a UsersApi) GetUsersCustomattributesSchemaVersion(schemaId string, versionId string) (*Dataschema, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/customattributes/schemas/{schemaId}/versions/{versionId}"
	path = strings.Replace(path, "{schemaId}", url.PathEscape(fmt.Sprintf("%v", schemaId)), -1)
	...
	if &schemaId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'schemaId' when calling UsersApi->GetUsersCustomattributesSchemaVersion")
	}
	// verify the required parameter 'versionId' is set
	if &versionId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'versionId' when calling UsersApi->GetUsersCustomattributesSchemaVersion")
	}
...
func (a UsersApi) GetUsersCustomattributesSchemaVersions(schemaId string) (*Dataschemalisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/customattributes/schemas/{schemaId}/versions"
	path = strings.Replace(path, "{schemaId}", url.PathEscape(fmt.Sprintf("%v", schemaId)), -1)
	...
	if &schemaId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'schemaId' when calling UsersApi->GetUsersCustomattributesSchemaVersions")
	}
...
func (a UsersApi) GetUsersCustomattributesSchemas() (*Dataschemalisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/customattributes/schemas"
	defaultReturn := new(Dataschemalisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
func (a UsersApi) GetUsersCustomattributesSchemasCoretype(coreTypeName string) (*Coretype, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/customattributes/schemas/coretypes/{coreTypeName}"
	...
	if &coreTypeName == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'coreTypeName' when calling UsersApi->GetUsersCustomattributesSchemasCoretype")
	}
...
func (a UsersApi) GetUsersCustomattributesSchemasCoretypes() (*Coretypelisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/customattributes/schemas/coretypes"
...
func (a UsersApi) GetUsersCustomattributesSchemasLimits() (*Schemaquantitylimits, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/customattributes/schemas/limits"
...
// GetUsersExternalidAuthorityNameExternalKey invokes GET /api/v2/users/externalid/{authorityName}/{externalKey}
//
// Get the user associated with external identifier.
//
// Authority name and external key are case sensitive.
func (a UsersApi) GetUsersExternalidAuthorityNameExternalKey(authorityName string, externalKey string, expand []string) (*User, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/externalid/{authorityName}/{externalKey}"
	path = strings.Replace(path, "{authorityName}", url.PathEscape(fmt.Sprintf("%v", authorityName)), -1)
	path = strings.Replace(path, "{externalKey}", url.PathEscape(fmt.Sprintf("%v", externalKey)), -1)
	defaultReturn := new(User)
	if true == false {
	...
	if &authorityName == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'authorityName' when calling UsersApi->GetUsersExternalidAuthorityNameExternalKey")
	}
	// verify the required parameter 'externalKey' is set
	if &externalKey == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'externalKey' when calling UsersApi->GetUsersExternalidAuthorityNameExternalKey")
	}
...
// GetUsersMeVerifiers invokes GET /api/v2/users/me/verifiers
//
// Get a list of my verifiers
func (a UsersApi) GetUsersMeVerifiers() (*Verifierentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/me/verifiers"
	defaultReturn := new(Verifierentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
func (a UsersApi) GetUsersQuery(cursor string, pageSize int, sortOrder string, expand []string, integrationPresenceSource string, userCustomAttributeSchemaIds []string, state string) (*Usercursorentitylisting, *APIResponse, error) {
	...
	defaultReturn := new(Usercursorentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Usercursorentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Usercursorentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a UsersApi) PatchUserCustomattributes(userId string, userCustomAttributes Usercustomattributesupdaterequest) (*Usercustomattributes, *APIResponse, error) {
	var httpMethod = "PATCH"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/{userId}/customattributes"
	path = strings.Replace(path, "{userId}", url.PathEscape(fmt.Sprintf("%v", userId)), -1)
	defaultReturn := new(Usercustomattributes)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	...
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling UsersApi->PatchUserCustomattributes")
	}
	// verify the required parameter 'userCustomAttributes' is set
	if &userCustomAttributes == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userCustomAttributes' when calling UsersApi->PatchUserCustomattributes")
	}
...
func (a UsersApi) PatchUserCustomattributesBulk(userId string, userCustomAttributesList []Usercustomattributesupdaterequest) (*Usercustomattributes, *APIResponse, error) {
	...
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling UsersApi->PatchUserCustomattributesBulk")
	}
	// verify the required parameter 'userCustomAttributesList' is set
	if &userCustomAttributesList == nil {
		// true
		return defaultReturn, nil, errors.New("Missing required parameter 'userCustomAttributesList' when calling UsersApi->PatchUserCustomattributesBulk")
	}
	...
	// body params
	postBody = &userCustomAttributesList
...
func (a UsersApi) PostUsersCustomattributesSchemas(body Dataschema) (*Dataschema, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling UsersApi->PostUsersCustomattributesSchemas")
	}
...
// PostUsersMeVerifiersTotp invokes POST /api/v2/users/me/verifiers/totp
//
// Add a new TOTP verifier
func (a UsersApi) PostUsersMeVerifiersTotp(body Createverifierrequest) (*Createverifierresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/me/verifiers/totp"
	defaultReturn := new(Createverifierresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling UsersApi->PostUsersMeVerifiersTotp")
	}
	...
	var successPayload *Createverifierresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Createverifierresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostUsersMeVerifiersTotpVerifierId invokes POST /api/v2/users/me/verifiers/totp/{verifierId}
//
// Validate a TOTP verifier
func (a UsersApi) PostUsersMeVerifiersTotpVerifierId(verifierId string, body Validateverifierrequest) (*APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/me/verifiers/totp/{verifierId}"
	path = strings.Replace(path, "{verifierId}", url.PathEscape(fmt.Sprintf("%v", verifierId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &verifierId == nil {
		// false
		return nil, errors.New("Missing required parameter 'verifierId' when calling UsersApi->PostUsersMeVerifiersTotpVerifierId")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return nil, errors.New("Missing required parameter 'body' when calling UsersApi->PostUsersMeVerifiersTotpVerifierId")
	}
...
// PostUsersMeVerifiersWebauthnRegister invokes POST /api/v2/users/me/verifiers/webauthn/register
//
...
func (a UsersApi) PostUsersMeVerifiersWebauthnRegister(body Finishwebauthnregistrationrequest) (*Verifier, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/me/verifiers/webauthn/register"
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling UsersApi->PostUsersMeVerifiersWebauthnRegister")
	}
...
// PostUsersMeVerifiersWebauthnRegisterOptions invokes POST /api/v2/users/me/verifiers/webauthn/register/options
//
...
func (a UsersApi) PostUsersMeVerifiersWebauthnRegisterOptions() (*Beginwebauthnregistrationresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/me/verifiers/webauthn/register/options"
	defaultReturn := new(Beginwebauthnregistrationresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Beginwebauthnregistrationresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Beginwebauthnregistrationresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a UsersApi) PutRoutingDirectroutingbackupSettingsMe(body Agentdirectroutingbackupsettings) (*Agentdirectroutingbackupsettings, *APIResponse, error) {
	var httpMethod = "PUT"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/directroutingbackup/settings/me"
	defaultReturn := new(Agentdirectroutingbackupsettings)
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling UsersApi->PutRoutingDirectroutingbackupSettingsMe")
	}
...
//
// Update the user's Direct Routing Backup settings.
func (a UsersApi) PutRoutingUserDirectroutingbackupSettings(userId string, body Agentdirectroutingbackupsettings) (*Agentdirectroutingbackupsettings, *APIResponse, error) {
	var httpMethod = "PUT"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/routing/users/{userId}/directroutingbackup/settings"
	path = strings.Replace(path, "{userId}", url.PathEscape(fmt.Sprintf("%v", userId)), -1)
	...
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling UsersApi->PutRoutingUserDirectroutingbackupSettings")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling UsersApi->PutRoutingUserDirectroutingbackupSettings")
	}
...
func (a UsersApi) PutUserCustomattributes(userId string, userCustomAttributes Usercustomattributesupdaterequest) (*Usercustomattributes, *APIResponse, error) {
	...
	if &userId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userId' when calling UsersApi->PutUserCustomattributes")
	}
	// verify the required parameter 'userCustomAttributes' is set
	if &userCustomAttributes == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'userCustomAttributes' when calling UsersApi->PutUserCustomattributes")
	}
...
func (a UsersApi) PutUsersCustomattributesSchema(schemaId string, body Dataschema) (*Dataschema, *APIResponse, error) {
	...
	if &schemaId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'schemaId' when calling UsersApi->PutUsersCustomattributesSchema")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling UsersApi->PutUsersCustomattributesSchema")
	}
...
// PutUsersMeVerifier invokes PUT /api/v2/users/me/verifiers/{verifierId}
//
// Update a verifier
func (a UsersApi) PutUsersMeVerifier(verifierId string, body Updateverifierrequest) (*Verifier, *APIResponse, error) {
	var httpMethod = "PUT"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/users/me/verifiers/{verifierId}"
	path = strings.Replace(path, "{verifierId}", url.PathEscape(fmt.Sprintf("%v", verifierId)), -1)
	...
	if &verifierId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'verifierId' when calling UsersApi->PutUsersMeVerifier")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling UsersApi->PutUsersMeVerifier")
	}
