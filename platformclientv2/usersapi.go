...
// DeleteUserRoles invokes DELETE /api/v2/users/{userId}/roles
//
// Removes all the roles from the user.
//
// 
func (a UsersApi) DeleteUserRoles(userId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	...
	if &userId == nil {
		// 
		return nil, errors.New("Missing required parameter 'userId' when calling UsersApi->DeleteUserRoles")
	}
...
//
// 
func (a UsersApi) GetAnalyticsUsersDetailsJobResults(jobId string, cursor string) (*Analyticsuserdetailsasyncqueryresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
...
//
// 
func (a UsersApi) GetAuthorizationDivisionspermittedSubjectId(subjectId string, permission string, name string) ([]Authzdivision, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/authorization/divisionspermitted/{subjectId}"
	path = strings.Replace(path, "{subjectId}", fmt.Sprintf("%v", subjectId), -1)
	defaultReturn := make([]Authzdivision, 0)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	...
	if &subjectId == nil {
		// 
		return defaultReturn, nil, errors.New("Missing required parameter 'subjectId' when calling UsersApi->GetAuthorizationDivisionspermittedSubjectId")
	}
	// verify the required parameter 'permission' is set
	if &permission == nil {
		// 
		return defaultReturn, nil, errors.New("Missing required parameter 'permission' when calling UsersApi->GetAuthorizationDivisionspermittedSubjectId")
	}
