...
func (o *Shifttradematchresponseitem) SetField(field string, fieldValue interface{}) {
...
func (o Shifttradematchresponseitem) MarshalJSON() ([]byte, error) {
...
func (o *Shifttradematchresponseitem) UnmarshalJSON(b []byte) error {
	var ShifttradematchresponseitemMap map[string]interface{}
	err := json.Unmarshal(b, &ShifttradematchresponseitemMap)
	if err != nil {
		return err
	}
	
	if ShiftIds, ok := ShifttradematchresponseitemMap["shiftIds"].([]interface{}); ok {
		ShiftIdsString, _ := json.Marshal(ShiftIds)
		json.Unmarshal(ShiftIdsString, &o.ShiftIds)
	}
	
	if Preview, ok := ShifttradematchresponseitemMap["preview"].(map[string]interface{}); ok {
