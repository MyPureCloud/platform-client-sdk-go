...
func (o *Dialerrulesetconfigchangecontactcolumntodataactionfieldmapping) SetField(field string, fieldValue interface{}) {
...
func (o *Dialerrulesetconfigchangecontactcolumntodataactionfieldmapping) UnmarshalJSON(b []byte) error {
	...
	if GetAdditionalProperties, ok := DialerrulesetconfigchangecontactcolumntodataactionfieldmappingMap["getAdditionalProperties"].(map[string]interface{}); ok {
