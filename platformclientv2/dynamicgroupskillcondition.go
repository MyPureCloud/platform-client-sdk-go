...
type Dynamicgroupskillcondition struct { 
	...
	RoutingSkillConditions *[]Dynamicgrouproutingskillcondition `json:"routingSkillConditions,omitempty"`

	// LanguageSkillConditions - Routing skill conditions that will be used for building the query
	LanguageSkillConditions *[]Dynamicgrouplanguageskillcondition `json:"languageSkillConditions,omitempty"`
...
func (o *Dynamicgroupskillcondition) SetField(field string, fieldValue interface{}) {
...
func (o Dynamicgroupskillcondition) MarshalJSON() ([]byte, error) {
...
func (o *Dynamicgroupskillcondition) UnmarshalJSON(b []byte) error {
	var DynamicgroupskillconditionMap map[string]interface{}
	err := json.Unmarshal(b, &DynamicgroupskillconditionMap)
	if err != nil {
		return err
	}
	
	if RoutingSkillConditions, ok := DynamicgroupskillconditionMap["routingSkillConditions"].([]interface{}); ok {
	...
	if LanguageSkillConditions, ok := DynamicgroupskillconditionMap["languageSkillConditions"].([]interface{}); ok {
	...
	if Operation, ok := DynamicgroupskillconditionMap["operation"].(string); ok {
