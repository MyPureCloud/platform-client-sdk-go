...
type Queueconversationsocialexpressioneventtopiccall struct { 
	...
	// RecordersState
	RecordersState *Queueconversationsocialexpressioneventtopicrecordersstate `json:"recordersState,omitempty"`
...
func (o *Queueconversationsocialexpressioneventtopiccall) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationsocialexpressioneventtopiccall) UnmarshalJSON(b []byte) error {
	...
	if RecordersState, ok := QueueconversationsocialexpressioneventtopiccallMap["recordersState"].(map[string]interface{}); ok {
	...
	if SecurePause, ok := QueueconversationsocialexpressioneventtopiccallMap["securePause"].(bool); ok {
	...
	if Disposition, ok := QueueconversationsocialexpressioneventtopiccallMap["disposition"].(map[string]interface{}); ok {
