...
func (o *Monthlyplanningperiodsettings) SetField(field string, fieldValue interface{}) {
...
func (o Monthlyplanningperiodsettings) MarshalJSON() ([]byte, error) {
...
func (o *Monthlyplanningperiodsettings) UnmarshalJSON(b []byte) error {
	var MonthlyplanningperiodsettingsMap map[string]interface{}
	err := json.Unmarshal(b, &MonthlyplanningperiodsettingsMap)
	if err != nil {
		return err
	}
	
	if startDateString, ok := MonthlyplanningperiodsettingsMap["startDate"].(string); ok {
