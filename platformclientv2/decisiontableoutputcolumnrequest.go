...
func (o *Decisiontableoutputcolumnrequest) SetField(field string, fieldValue interface{}) {
...
func (o Decisiontableoutputcolumnrequest) MarshalJSON() ([]byte, error) {
...
func (o *Decisiontableoutputcolumnrequest) UnmarshalJSON(b []byte) error {
	var DecisiontableoutputcolumnrequestMap map[string]interface{}
	err := json.Unmarshal(b, &DecisiontableoutputcolumnrequestMap)
	if err != nil {
		return err
	}
	
	if DefaultsTo, ok := DecisiontableoutputcolumnrequestMap["defaultsTo"].(map[string]interface{}); ok {
		DefaultsToString, _ := json.Marshal(DefaultsTo)
		json.Unmarshal(DefaultsToString, &o.DefaultsTo)
	}
	
	if Value, ok := DecisiontableoutputcolumnrequestMap["value"].(map[string]interface{}); ok {
