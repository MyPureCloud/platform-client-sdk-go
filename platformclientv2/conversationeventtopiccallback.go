...
func (o *Conversationeventtopiccallback) SetField(field string, fieldValue interface{}) {
...
func (o *Conversationeventtopiccallback) UnmarshalJSON(b []byte) error {
	...
	if QueueMediaSettings, ok := ConversationeventtopiccallbackMap["queueMediaSettings"].(map[string]interface{}); ok {
