...
func (o *Dialerdnclistconfigchangeimportstatus) SetField(field string, fieldValue interface{}) {
...
func (o *Dialerdnclistconfigchangeimportstatus) UnmarshalJSON(b []byte) error {
	...
	if TargetContactListIds, ok := DialerdnclistconfigchangeimportstatusMap["targetContactListIds"].([]interface{}); ok {
	...
	if ListNamePrefix, ok := DialerdnclistconfigchangeimportstatusMap["listNamePrefix"].(string); ok {
	...
	if GetAdditionalProperties, ok := DialerdnclistconfigchangeimportstatusMap["getAdditionalProperties"].(map[string]interface{}); ok {
