...
func (o *Contactsexportrequest) SetField(field string, fieldValue interface{}) {
...
func (o Contactsexportrequest) MarshalJSON() ([]byte, error) {
...
func (o *Contactsexportrequest) UnmarshalJSON(b []byte) error {
	var ContactsexportrequestMap map[string]interface{}
	err := json.Unmarshal(b, &ContactsexportrequestMap)
	if err != nil {
		return err
	}
	
	if ContactListFilterId, ok := ContactsexportrequestMap["contactListFilterId"].(string); ok {
