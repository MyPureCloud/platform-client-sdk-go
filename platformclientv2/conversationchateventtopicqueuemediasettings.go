...
type Conversationchateventtopicqueuemediasettings struct { 
...
func (o *Conversationchateventtopicqueuemediasettings) SetField(field string, fieldValue interface{}) {
...
func (o Conversationchateventtopicqueuemediasettings) MarshalJSON() ([]byte, error) {
	...
	type Alias Conversationchateventtopicqueuemediasettings
...
func (o *Conversationchateventtopicqueuemediasettings) UnmarshalJSON(b []byte) error {
	var ConversationchateventtopicqueuemediasettingsMap map[string]interface{}
	err := json.Unmarshal(b, &ConversationchateventtopicqueuemediasettingsMap)
	if err != nil {
		return err
	}
	
	if AlertingTimeoutSeconds, ok := ConversationchateventtopicqueuemediasettingsMap["alertingTimeoutSeconds"].(float64); ok {
		AlertingTimeoutSecondsInt := int(AlertingTimeoutSeconds)
		o.AlertingTimeoutSeconds = &AlertingTimeoutSecondsInt
	}
	
	if AutoAnswerAlertToneSeconds, ok := ConversationchateventtopicqueuemediasettingsMap["autoAnswerAlertToneSeconds"].(float64); ok {
	...
	if ManualAnswerAlertToneSeconds, ok := ConversationchateventtopicqueuemediasettingsMap["manualAnswerAlertToneSeconds"].(float64); ok {
	...
	if EnableAutoAnswer, ok := ConversationchateventtopicqueuemediasettingsMap["enableAutoAnswer"].(bool); ok {
...
func (o *Conversationchateventtopicqueuemediasettings) String() string {
	j, _ := json.Marshal(o)
