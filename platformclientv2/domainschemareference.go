...
func (o *Domainschemareference) SetField(field string, fieldValue interface{}) {
...
func (o *Domainschemareference) UnmarshalJSON(b []byte) error {
	var DomainschemareferenceMap map[string]interface{}
	err := json.Unmarshal(b, &DomainschemareferenceMap)
	if err != nil {
		return err
	}
	...
	if dateCreatedString, ok := DomainschemareferenceMap["dateCreated"].(string); ok {
		DateCreated, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateCreatedString)
		o.DateCreated = &DateCreated
	}
	
	if dateModifiedString, ok := DomainschemareferenceMap["dateModified"].(string); ok {
