...
func (o *Bulkupdateactivitycoderequestitem) SetField(field string, fieldValue interface{}) {
...
func (o Bulkupdateactivitycoderequestitem) MarshalJSON() ([]byte, error) {
...
func (o *Bulkupdateactivitycoderequestitem) UnmarshalJSON(b []byte) error {
	var BulkupdateactivitycoderequestitemMap map[string]interface{}
	err := json.Unmarshal(b, &BulkupdateactivitycoderequestitemMap)
	if err != nil {
		return err
	}
	
	if Name, ok := BulkupdateactivitycoderequestitemMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if Category, ok := BulkupdateactivitycoderequestitemMap["category"].(string); ok {
		o.Category = &Category
	}
    
	if LengthInMinutes, ok := BulkupdateactivitycoderequestitemMap["lengthInMinutes"].(float64); ok {
		LengthInMinutesInt := int(LengthInMinutes)
		o.LengthInMinutes = &LengthInMinutesInt
	}
	
	if CountsAsPaidTime, ok := BulkupdateactivitycoderequestitemMap["countsAsPaidTime"].(bool); ok {
		o.CountsAsPaidTime = &CountsAsPaidTime
	}
    
	if CountsAsWorkTime, ok := BulkupdateactivitycoderequestitemMap["countsAsWorkTime"].(bool); ok {
		o.CountsAsWorkTime = &CountsAsWorkTime
	}
    
	if AgentTimeOffSelectable, ok := BulkupdateactivitycoderequestitemMap["agentTimeOffSelectable"].(bool); ok {
		o.AgentTimeOffSelectable = &AgentTimeOffSelectable
	}
    
	if CountsTowardShrinkage, ok := BulkupdateactivitycoderequestitemMap["countsTowardShrinkage"].(bool); ok {
		o.CountsTowardShrinkage = &CountsTowardShrinkage
	}
    
	if PlannedShrinkage, ok := BulkupdateactivitycoderequestitemMap["plannedShrinkage"].(bool); ok {
		o.PlannedShrinkage = &PlannedShrinkage
	}
    
	if Interruptible, ok := BulkupdateactivitycoderequestitemMap["interruptible"].(bool); ok {
		o.Interruptible = &Interruptible
	}
    
	if PlanningGroupIds, ok := BulkupdateactivitycoderequestitemMap["planningGroupIds"].(map[string]interface{}); ok {
		PlanningGroupIdsString, _ := json.Marshal(PlanningGroupIds)
		json.Unmarshal(PlanningGroupIdsString, &o.PlanningGroupIds)
	}
	
	if Style, ok := BulkupdateactivitycoderequestitemMap["style"].(map[string]interface{}); ok {
		StyleString, _ := json.Marshal(Style)
		json.Unmarshal(StyleString, &o.Style)
	}
	
	if Metadata, ok := BulkupdateactivitycoderequestitemMap["metadata"].(map[string]interface{}); ok {
		MetadataString, _ := json.Marshal(Metadata)
		json.Unmarshal(MetadataString, &o.Metadata)
	}
	
	if Id, ok := BulkupdateactivitycoderequestitemMap["id"].(string); ok {
		o.Id = &Id
	}
