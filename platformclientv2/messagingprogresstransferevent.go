...
func (o *Messagingprogresstransferevent) SetField(field string, fieldValue interface{}) {
...
func (o Messagingprogresstransferevent) MarshalJSON() ([]byte, error) {
...
func (o *Messagingprogresstransferevent) UnmarshalJSON(b []byte) error {
	var MessagingprogresstransfereventMap map[string]interface{}
	err := json.Unmarshal(b, &MessagingprogresstransfereventMap)
	if err != nil {
		return err
	}
	
	if EventId, ok := MessagingprogresstransfereventMap["eventId"].(string); ok {
		o.EventId = &EventId
	}
    
	if eventDateTimeString, ok := MessagingprogresstransfereventMap["eventDateTime"].(string); ok {
		EventDateTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", eventDateTimeString)
		o.EventDateTime = &EventDateTime
	}
	
	if ConversationId, ok := MessagingprogresstransfereventMap["conversationId"].(string); ok {
		o.ConversationId = &ConversationId
	}
    
	if CommandId, ok := MessagingprogresstransfereventMap["commandId"].(string); ok {
		o.CommandId = &CommandId
	}
    
	if ObjectCommunicationId, ok := MessagingprogresstransfereventMap["objectCommunicationId"].(string); ok {
		o.ObjectCommunicationId = &ObjectCommunicationId
	}
    
	if DestinationCommunicationId, ok := MessagingprogresstransfereventMap["destinationCommunicationId"].(string); ok {
