...
func (o *Recordingnotificationresponse) SetField(field string, fieldValue interface{}) {
...
func (o Recordingnotificationresponse) MarshalJSON() ([]byte, error) {
...
func (o *Recordingnotificationresponse) UnmarshalJSON(b []byte) error {
	var RecordingnotificationresponseMap map[string]interface{}
	err := json.Unmarshal(b, &RecordingnotificationresponseMap)
	if err != nil {
		return err
	}
	
	if OriginatingMessageId, ok := RecordingnotificationresponseMap["originatingMessageId"].(string); ok {
		o.OriginatingMessageId = &OriginatingMessageId
	}
    
	if ReferenceId, ok := RecordingnotificationresponseMap["referenceId"].(string); ok {
		o.ReferenceId = &ReferenceId
	}
    
	if NotificationStatus, ok := RecordingnotificationresponseMap["notificationStatus"].(string); ok {
		o.NotificationStatus = &NotificationStatus
	}
    
	if NotificationText, ok := RecordingnotificationresponseMap["notificationText"].(string); ok {
