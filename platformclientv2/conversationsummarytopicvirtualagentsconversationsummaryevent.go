...
type Conversationsummarytopicvirtualagentsconversationsummaryevent struct { 
	...
	// Labels
	Labels *[]Conversationsummarytopicvirtualagentsconversationsummarylabel `json:"labels,omitempty"`
}
...
func (o *Conversationsummarytopicvirtualagentsconversationsummaryevent) UnmarshalJSON(b []byte) error {
	...
	if LatestCommunicationId, ok := ConversationsummarytopicvirtualagentsconversationsummaryeventMap["latestCommunicationId"].(string); ok {
	...
	if Labels, ok := ConversationsummarytopicvirtualagentsconversationsummaryeventMap["labels"].([]interface{}); ok {
