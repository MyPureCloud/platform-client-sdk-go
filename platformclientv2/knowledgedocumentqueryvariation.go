...
type Knowledgedocumentqueryvariation struct { 
	...
	Chunks *[]Documentvariationquerychunkblock `json:"chunks,omitempty"`
...
func (o *Knowledgedocumentqueryvariation) SetField(field string, fieldValue interface{}) {
...
func (o Knowledgedocumentqueryvariation) MarshalJSON() ([]byte, error) {
...
func (o *Knowledgedocumentqueryvariation) UnmarshalJSON(b []byte) error {
	var KnowledgedocumentqueryvariationMap map[string]interface{}
	err := json.Unmarshal(b, &KnowledgedocumentqueryvariationMap)
	if err != nil {
		return err
	}
	
	if Id, ok := KnowledgedocumentqueryvariationMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if dateCreatedString, ok := KnowledgedocumentqueryvariationMap["dateCreated"].(string); ok {
		DateCreated, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateCreatedString)
		o.DateCreated = &DateCreated
	}
	
	if dateModifiedString, ok := KnowledgedocumentqueryvariationMap["dateModified"].(string); ok {
		DateModified, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateModifiedString)
		o.DateModified = &DateModified
	}
	
	if DocumentVersion, ok := KnowledgedocumentqueryvariationMap["documentVersion"].(map[string]interface{}); ok {
		DocumentVersionString, _ := json.Marshal(DocumentVersion)
		json.Unmarshal(DocumentVersionString, &o.DocumentVersion)
	}
	
	if Contexts, ok := KnowledgedocumentqueryvariationMap["contexts"].([]interface{}); ok {
		ContextsString, _ := json.Marshal(Contexts)
		json.Unmarshal(ContextsString, &o.Contexts)
	}
	
	if Document, ok := KnowledgedocumentqueryvariationMap["document"].(map[string]interface{}); ok {
		DocumentString, _ := json.Marshal(Document)
		json.Unmarshal(DocumentString, &o.Document)
	}
	
	if Priority, ok := KnowledgedocumentqueryvariationMap["priority"].(float64); ok {
		PriorityInt := int(Priority)
		o.Priority = &PriorityInt
	}
	
	if Name, ok := KnowledgedocumentqueryvariationMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if Body, ok := KnowledgedocumentqueryvariationMap["body"].(map[string]interface{}); ok {
		BodyString, _ := json.Marshal(Body)
		json.Unmarshal(BodyString, &o.Body)
	}
	
	if Chunks, ok := KnowledgedocumentqueryvariationMap["chunks"].([]interface{}); ok {
		ChunksString, _ := json.Marshal(Chunks)
		json.Unmarshal(ChunksString, &o.Chunks)
	}
	
	if SelfUri, ok := KnowledgedocumentqueryvariationMap["selfUri"].(string); ok {
		o.SelfUri = &SelfUri
	}
