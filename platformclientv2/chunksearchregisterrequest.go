...
func (o *Chunksearchregisterrequest) SetField(field string, fieldValue interface{}) {
...
func (o Chunksearchregisterrequest) MarshalJSON() ([]byte, error) {
...
func (o *Chunksearchregisterrequest) UnmarshalJSON(b []byte) error {
	var ChunksearchregisterrequestMap map[string]interface{}
	err := json.Unmarshal(b, &ChunksearchregisterrequestMap)
	if err != nil {
		return err
	}
	
	if SessionId, ok := ChunksearchregisterrequestMap["sessionId"].(string); ok {
		o.SessionId = &SessionId
	}
    
	if Answered, ok := ChunksearchregisterrequestMap["answered"].(bool); ok {
		o.Answered = &Answered
	}
    
	if SelectedAnswers, ok := ChunksearchregisterrequestMap["selectedAnswers"].([]interface{}); ok {
