...
type Agentmuscheduleresult struct { 
	...
	AgentSchedules *[]Agentmuscheduleitem `json:"agentSchedules,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Agentmuscheduleresult) SetField(field string, fieldValue interface{}) {
...
func (o Agentmuscheduleresult) MarshalJSON() ([]byte, error) {
...
func (o *Agentmuscheduleresult) UnmarshalJSON(b []byte) error {
	var AgentmuscheduleresultMap map[string]interface{}
	err := json.Unmarshal(b, &AgentmuscheduleresultMap)
	if err != nil {
		return err
	}
	
	if referenceStartDateString, ok := AgentmuscheduleresultMap["referenceStartDate"].(string); ok {
	...
	if AgentSchedules, ok := AgentmuscheduleresultMap["agentSchedules"].([]interface{}); ok {
