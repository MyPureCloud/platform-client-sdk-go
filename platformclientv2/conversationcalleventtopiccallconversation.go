...
func (o *Conversationcalleventtopiccallconversation) UnmarshalJSON(b []byte) error {
	...
	if Divisions, ok := ConversationcalleventtopiccallconversationMap["divisions"].([]interface{}); ok {
	...
	if SecurePause, ok := ConversationcalleventtopiccallconversationMap["securePause"].(bool); ok {
