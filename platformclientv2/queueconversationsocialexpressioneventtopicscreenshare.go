...
func (o *Queueconversationsocialexpressioneventtopicscreenshare) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationsocialexpressioneventtopicscreenshare) UnmarshalJSON(b []byte) error {
	...
	if QueueMediaSettings, ok := QueueconversationsocialexpressioneventtopicscreenshareMap["queueMediaSettings"].(map[string]interface{}); ok {
