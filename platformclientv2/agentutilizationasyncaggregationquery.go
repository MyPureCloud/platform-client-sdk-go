...
type Agentutilizationasyncaggregationquery struct { 
	...
	Filter *Agentutilizationaggregatequeryfilter `json:"filter,omitempty"`
	...
	Views *[]Agentutilizationaggregationview `json:"views,omitempty"`
...
func (o *Agentutilizationasyncaggregationquery) SetField(field string, fieldValue interface{}) {
...
func (o Agentutilizationasyncaggregationquery) MarshalJSON() ([]byte, error) {
...
func (o *Agentutilizationasyncaggregationquery) UnmarshalJSON(b []byte) error {
	var AgentutilizationasyncaggregationqueryMap map[string]interface{}
	err := json.Unmarshal(b, &AgentutilizationasyncaggregationqueryMap)
	if err != nil {
		return err
	}
	
	if Interval, ok := AgentutilizationasyncaggregationqueryMap["interval"].(string); ok {
		o.Interval = &Interval
	}
    
	if Granularity, ok := AgentutilizationasyncaggregationqueryMap["granularity"].(string); ok {
		o.Granularity = &Granularity
	}
    
	if TimeZone, ok := AgentutilizationasyncaggregationqueryMap["timeZone"].(string); ok {
		o.TimeZone = &TimeZone
	}
    
	if GroupBy, ok := AgentutilizationasyncaggregationqueryMap["groupBy"].([]interface{}); ok {
		GroupByString, _ := json.Marshal(GroupBy)
		json.Unmarshal(GroupByString, &o.GroupBy)
	}
	
	if Filter, ok := AgentutilizationasyncaggregationqueryMap["filter"].(map[string]interface{}); ok {
		FilterString, _ := json.Marshal(Filter)
		json.Unmarshal(FilterString, &o.Filter)
	}
	
	if Metrics, ok := AgentutilizationasyncaggregationqueryMap["metrics"].([]interface{}); ok {
		MetricsString, _ := json.Marshal(Metrics)
		json.Unmarshal(MetricsString, &o.Metrics)
	}
	
	if FlattenMultivaluedDimensions, ok := AgentutilizationasyncaggregationqueryMap["flattenMultivaluedDimensions"].(bool); ok {
		o.FlattenMultivaluedDimensions = &FlattenMultivaluedDimensions
	}
    
	if Views, ok := AgentutilizationasyncaggregationqueryMap["views"].([]interface{}); ok {
		ViewsString, _ := json.Marshal(Views)
		json.Unmarshal(ViewsString, &o.Views)
	}
	
	if AlternateTimeDimension, ok := AgentutilizationasyncaggregationqueryMap["alternateTimeDimension"].(string); ok {
		o.AlternateTimeDimension = &AlternateTimeDimension
	}
    
	if PageSize, ok := AgentutilizationasyncaggregationqueryMap["pageSize"].(float64); ok {
