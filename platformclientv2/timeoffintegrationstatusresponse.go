...
func (o *Timeoffintegrationstatusresponse) SetField(field string, fieldValue interface{}) {
...
func (o Timeoffintegrationstatusresponse) MarshalJSON() ([]byte, error) {
...
func (o *Timeoffintegrationstatusresponse) UnmarshalJSON(b []byte) error {
	var TimeoffintegrationstatusresponseMap map[string]interface{}
	err := json.Unmarshal(b, &TimeoffintegrationstatusresponseMap)
	if err != nil {
		return err
	}
	
	if TimeOffRequest, ok := TimeoffintegrationstatusresponseMap["timeOffRequest"].(map[string]interface{}); ok {
		TimeOffRequestString, _ := json.Marshal(TimeOffRequest)
		json.Unmarshal(TimeOffRequestString, &o.TimeOffRequest)
	}
	
	if IntegrationStatus, ok := TimeoffintegrationstatusresponseMap["integrationStatus"].(string); ok {
