...
func (a FlowsApi) DeleteAnalyticsFlowsAggregatesJob(jobId string) (*APIResponse, error) {
	...
	if &jobId == nil {
		// false
		return nil, errors.New("Missing required parameter 'jobId' when calling FlowsApi->DeleteAnalyticsFlowsAggregatesJob")
	}
...
func (a FlowsApi) GetAnalyticsFlowsAggregatesJob(jobId string) (*Asyncquerystatus, *APIResponse, error) {
	...
	if &jobId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'jobId' when calling FlowsApi->GetAnalyticsFlowsAggregatesJob")
	}
...
func (a FlowsApi) GetAnalyticsFlowsAggregatesJobResults(jobId string, cursor string) (*Flowasyncaggregatequeryresponse, *APIResponse, error) {
	...
	if &jobId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'jobId' when calling FlowsApi->GetAnalyticsFlowsAggregatesJobResults")
	}
...
func (a FlowsApi) PostAnalyticsFlowsActivityQuery(body Flowactivityquery, pageSize int, pageNumber int) (*Flowactivityresponse, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling FlowsApi->PostAnalyticsFlowsActivityQuery")
	}
...
func (a FlowsApi) PostAnalyticsFlowsAggregatesJobs(body Flowasyncaggregationquery) (*Asyncqueryresponse, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling FlowsApi->PostAnalyticsFlowsAggregatesJobs")
	}
