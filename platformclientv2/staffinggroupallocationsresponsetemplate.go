...
func (o *Staffinggroupallocationsresponsetemplate) SetField(field string, fieldValue interface{}) {
...
func (o Staffinggroupallocationsresponsetemplate) MarshalJSON() ([]byte, error) {
...
func (o *Staffinggroupallocationsresponsetemplate) UnmarshalJSON(b []byte) error {
	var StaffinggroupallocationsresponsetemplateMap map[string]interface{}
	err := json.Unmarshal(b, &StaffinggroupallocationsresponsetemplateMap)
	if err != nil {
		return err
	}
