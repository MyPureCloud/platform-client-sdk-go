...
func (o *Casedatedueupdate) SetField(field string, fieldValue interface{}) {
...
func (o Casedatedueupdate) MarshalJSON() ([]byte, error) {
...
func (o *Casedatedueupdate) UnmarshalJSON(b []byte) error {
	var CasedatedueupdateMap map[string]interface{}
	err := json.Unmarshal(b, &CasedatedueupdateMap)
	if err != nil {
		return err
	}
	
	if dateDueString, ok := CasedatedueupdateMap["dateDue"].(string); ok {
