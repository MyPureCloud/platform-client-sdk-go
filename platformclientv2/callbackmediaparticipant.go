...
func (o *Callbackmediaparticipant) UnmarshalJSON(b []byte) error {
	...
	if ExternalContactInitialDivisionId, ok := CallbackmediaparticipantMap["externalContactInitialDivisionId"].(string); ok {
	...
	if resumeTimeString, ok := CallbackmediaparticipantMap["resumeTime"].(string); ok {
