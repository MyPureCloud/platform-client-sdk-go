...
func (o *Userchatsettingspost) SetField(field string, fieldValue interface{}) {
...
func (o Userchatsettingspost) MarshalJSON() ([]byte, error) {
...
func (o *Userchatsettingspost) UnmarshalJSON(b []byte) error {
	var UserchatsettingspostMap map[string]interface{}
	err := json.Unmarshal(b, &UserchatsettingspostMap)
	if err != nil {
		return err
	}
	
	if Muted, ok := UserchatsettingspostMap["muted"].(bool); ok {
		o.Muted = &Muted
	}
    
	if MentionsOnly, ok := UserchatsettingspostMap["mentionsOnly"].(bool); ok {
		o.MentionsOnly = &MentionsOnly
	}
    
	if NotifyOnReactions, ok := UserchatsettingspostMap["notifyOnReactions"].(bool); ok {
