...
func (o *Divisionentityref) SetField(field string, fieldValue interface{}) {
...
func (o Divisionentityref) MarshalJSON() ([]byte, error) {
...
func (o *Divisionentityref) UnmarshalJSON(b []byte) error {
	var DivisionentityrefMap map[string]interface{}
	err := json.Unmarshal(b, &DivisionentityrefMap)
	if err != nil {
		return err
	}
	
	if Id, ok := DivisionentityrefMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Name, ok := DivisionentityrefMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if SelfUri, ok := DivisionentityrefMap["selfUri"].(string); ok {
		o.SelfUri = &SelfUri
	}
    
	if dateDivisionUpdatedString, ok := DivisionentityrefMap["dateDivisionUpdated"].(string); ok {
