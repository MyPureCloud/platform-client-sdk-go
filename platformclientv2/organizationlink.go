...
func (o *Organizationlink) SetField(field string, fieldValue interface{}) {
...
func (o Organizationlink) MarshalJSON() ([]byte, error) {
...
func (o *Organizationlink) UnmarshalJSON(b []byte) error {
	var OrganizationlinkMap map[string]interface{}
	err := json.Unmarshal(b, &OrganizationlinkMap)
	if err != nil {
		return err
	}
	
	if SourceOrganizationId, ok := OrganizationlinkMap["sourceOrganizationId"].(string); ok {
		o.SourceOrganizationId = &SourceOrganizationId
	}
    
	if TargetOrganizationId, ok := OrganizationlinkMap["targetOrganizationId"].(string); ok {
		o.TargetOrganizationId = &TargetOrganizationId
	}
    
	if SourceRegion, ok := OrganizationlinkMap["sourceRegion"].(string); ok {
		o.SourceRegion = &SourceRegion
	}
    
	if TargetRegion, ok := OrganizationlinkMap["targetRegion"].(string); ok {
		o.TargetRegion = &TargetRegion
	}
    
	if Status, ok := OrganizationlinkMap["status"].(string); ok {
		o.Status = &Status
	}
