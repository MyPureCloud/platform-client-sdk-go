...
type V2mobiusalertstopicalertnotification struct { 
	...
	// Recipient
	Recipient *V2mobiusalertstopicalertnotificationrecipient `json:"recipient,omitempty"`
...
func (o *V2mobiusalertstopicalertnotification) SetField(field string, fieldValue interface{}) {
...
func (o *V2mobiusalertstopicalertnotification) UnmarshalJSON(b []byte) error {
	...
	if Recipient, ok := V2mobiusalertstopicalertnotificationMap["recipient"].(map[string]interface{}); ok {
	...
	if Locale, ok := V2mobiusalertstopicalertnotificationMap["locale"].(string); ok {
		o.Locale = &Locale
	}
