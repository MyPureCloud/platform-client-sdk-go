...
func (o *Evaluationsearchresponse) SetField(field string, fieldValue interface{}) {
...
func (o Evaluationsearchresponse) MarshalJSON() ([]byte, error) {
...
func (o *Evaluationsearchresponse) UnmarshalJSON(b []byte) error {
	var EvaluationsearchresponseMap map[string]interface{}
	err := json.Unmarshal(b, &EvaluationsearchresponseMap)
	if err != nil {
		return err
	}
	
	if PageSize, ok := EvaluationsearchresponseMap["pageSize"].(float64); ok {
		PageSizeInt := int(PageSize)
		o.PageSize = &PageSizeInt
	}
	
	if PageNumber, ok := EvaluationsearchresponseMap["pageNumber"].(float64); ok {
		PageNumberInt := int(PageNumber)
		o.PageNumber = &PageNumberInt
	}
	
	if Results, ok := EvaluationsearchresponseMap["results"].([]interface{}); ok {
		ResultsString, _ := json.Marshal(Results)
		json.Unmarshal(ResultsString, &o.Results)
	}
	
	if Aggregations, ok := EvaluationsearchresponseMap["aggregations"].(map[string]interface{}); ok {
