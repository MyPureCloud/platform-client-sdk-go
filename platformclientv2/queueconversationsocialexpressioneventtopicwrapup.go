...
func (o *Queueconversationsocialexpressioneventtopicwrapup) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationsocialexpressioneventtopicwrapup) UnmarshalJSON(b []byte) error {
	...
	if AdditionalProperties, ok := QueueconversationsocialexpressioneventtopicwrapupMap["additionalProperties"].(map[string]interface{}); ok {
