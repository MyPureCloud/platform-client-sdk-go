...
func (o Usernextactivityreminder) MarshalJSON() ([]byte, error) {
...
func (o *Usernextactivityreminder) UnmarshalJSON(b []byte) error {
	var UsernextactivityreminderMap map[string]interface{}
