...
func (o *Copilotcontextvalue) SetField(field string, fieldValue interface{}) {
...
func (o Copilotcontextvalue) MarshalJSON() ([]byte, error) {
...
func (o *Copilotcontextvalue) UnmarshalJSON(b []byte) error {
	var CopilotcontextvalueMap map[string]interface{}
	err := json.Unmarshal(b, &CopilotcontextvalueMap)
	if err != nil {
		return err
	}
	
	if Name, ok := CopilotcontextvalueMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if VarType, ok := CopilotcontextvalueMap["type"].(string); ok {
		o.VarType = &VarType
	}
