...
type Outbounddomainpatchrequest struct { 
	...
	CustomSMTPServer *Customsmtpserverrequest `json:"customSMTPServer,omitempty"`
...
func (o *Outbounddomainpatchrequest) SetField(field string, fieldValue interface{}) {
...
func (o Outbounddomainpatchrequest) MarshalJSON() ([]byte, error) {
...
func (o *Outbounddomainpatchrequest) UnmarshalJSON(b []byte) error {
	var OutbounddomainpatchrequestMap map[string]interface{}
	err := json.Unmarshal(b, &OutbounddomainpatchrequestMap)
	if err != nil {
		return err
	}
	
	if CustomSMTPServer, ok := OutbounddomainpatchrequestMap["customSMTPServer"].(map[string]interface{}); ok {
		CustomSMTPServerString, _ := json.Marshal(CustomSMTPServer)
		json.Unmarshal(CustomSMTPServerString, &o.CustomSMTPServer)
	}
	
	if SenderType, ok := OutbounddomainpatchrequestMap["senderType"].(string); ok {
		o.SenderType = &SenderType
	}
    
	if EmailSetting, ok := OutbounddomainpatchrequestMap["emailSetting"].(map[string]interface{}); ok {
