...
func (o *V3knowledgesearchclientapplication) SetField(field string, fieldValue interface{}) {
...
func (o V3knowledgesearchclientapplication) MarshalJSON() ([]byte, error) {
...
func (o *V3knowledgesearchclientapplication) UnmarshalJSON(b []byte) error {
	var V3knowledgesearchclientapplicationMap map[string]interface{}
	err := json.Unmarshal(b, &V3knowledgesearchclientapplicationMap)
	if err != nil {
		return err
	}
	
	if VarType, ok := V3knowledgesearchclientapplicationMap["type"].(string); ok {
		o.VarType = &VarType
	}
    
	if BotFlow, ok := V3knowledgesearchclientapplicationMap["botFlow"].(map[string]interface{}); ok {
		BotFlowString, _ := json.Marshal(BotFlow)
		json.Unmarshal(BotFlowString, &o.BotFlow)
	}
	
	if Assistant, ok := V3knowledgesearchclientapplicationMap["assistant"].(map[string]interface{}); ok {
