...
func (o *Agentutilizationaggregationquery) SetField(field string, fieldValue interface{}) {
...
func (o Agentutilizationaggregationquery) MarshalJSON() ([]byte, error) {
...
func (o *Agentutilizationaggregationquery) UnmarshalJSON(b []byte) error {
	var AgentutilizationaggregationqueryMap map[string]interface{}
	err := json.Unmarshal(b, &AgentutilizationaggregationqueryMap)
	if err != nil {
		return err
	}
	
	if Interval, ok := AgentutilizationaggregationqueryMap["interval"].(string); ok {
		o.Interval = &Interval
	}
    
	if Granularity, ok := AgentutilizationaggregationqueryMap["granularity"].(string); ok {
		o.Granularity = &Granularity
	}
    
	if TimeZone, ok := AgentutilizationaggregationqueryMap["timeZone"].(string); ok {
		o.TimeZone = &TimeZone
	}
    
	if GroupBy, ok := AgentutilizationaggregationqueryMap["groupBy"].([]interface{}); ok {
		GroupByString, _ := json.Marshal(GroupBy)
		json.Unmarshal(GroupByString, &o.GroupBy)
	}
	
	if Filter, ok := AgentutilizationaggregationqueryMap["filter"].(map[string]interface{}); ok {
		FilterString, _ := json.Marshal(Filter)
		json.Unmarshal(FilterString, &o.Filter)
	}
	
	if Metrics, ok := AgentutilizationaggregationqueryMap["metrics"].([]interface{}); ok {
		MetricsString, _ := json.Marshal(Metrics)
		json.Unmarshal(MetricsString, &o.Metrics)
	}
	
	if FlattenMultivaluedDimensions, ok := AgentutilizationaggregationqueryMap["flattenMultivaluedDimensions"].(bool); ok {
		o.FlattenMultivaluedDimensions = &FlattenMultivaluedDimensions
	}
    
	if Views, ok := AgentutilizationaggregationqueryMap["views"].([]interface{}); ok {
		ViewsString, _ := json.Marshal(Views)
		json.Unmarshal(ViewsString, &o.Views)
	}
	
	if AlternateTimeDimension, ok := AgentutilizationaggregationqueryMap["alternateTimeDimension"].(string); ok {
