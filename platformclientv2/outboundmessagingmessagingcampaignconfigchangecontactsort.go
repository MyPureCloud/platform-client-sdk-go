...
func (o *Outboundmessagingmessagingcampaignconfigchangecontactsort) SetField(field string, fieldValue interface{}) {
...
func (o *Outboundmessagingmessagingcampaignconfigchangecontactsort) UnmarshalJSON(b []byte) error {
	...
	if GetAdditionalProperties, ok := OutboundmessagingmessagingcampaignconfigchangecontactsortMap["getAdditionalProperties"].(map[string]interface{}); ok {
