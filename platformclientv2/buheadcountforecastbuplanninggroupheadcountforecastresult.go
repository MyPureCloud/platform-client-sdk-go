...
type Buheadcountforecastbuplanninggroupheadcountforecastresult struct { 
	...
	// Entities
	Entities *[]Buplanninggroupheadcountforecastresult `json:"entities,omitempty"`
...
func (o *Buheadcountforecastbuplanninggroupheadcountforecastresult) SetField(field string, fieldValue interface{}) {
...
func (o Buheadcountforecastbuplanninggroupheadcountforecastresult) MarshalJSON() ([]byte, error) {
...
func (o *Buheadcountforecastbuplanninggroupheadcountforecastresult) UnmarshalJSON(b []byte) error {
	var BuheadcountforecastbuplanninggroupheadcountforecastresultMap map[string]interface{}
	err := json.Unmarshal(b, &BuheadcountforecastbuplanninggroupheadcountforecastresultMap)
	if err != nil {
		return err
	}
	
	if Entities, ok := BuheadcountforecastbuplanninggroupheadcountforecastresultMap["entities"].([]interface{}); ok {
		EntitiesString, _ := json.Marshal(Entities)
		json.Unmarshal(EntitiesString, &o.Entities)
	}
	
	if referenceStartDateString, ok := BuheadcountforecastbuplanninggroupheadcountforecastresultMap["referenceStartDate"].(string); ok {
