...
func (o *Agentstatepresencecount) SetField(field string, fieldValue interface{}) {
...
func (o Agentstatepresencecount) MarshalJSON() ([]byte, error) {
...
func (o *Agentstatepresencecount) UnmarshalJSON(b []byte) error {
	var AgentstatepresencecountMap map[string]interface{}
	err := json.Unmarshal(b, &AgentstatepresencecountMap)
	if err != nil {
		return err
	}
	
	if SystemPresence, ok := AgentstatepresencecountMap["systemPresence"].(string); ok {
		o.SystemPresence = &SystemPresence
	}
    
	if OrganizationPresenceId, ok := AgentstatepresencecountMap["organizationPresenceId"].(string); ok {
		o.OrganizationPresenceId = &OrganizationPresenceId
	}
    
	if Count, ok := AgentstatepresencecountMap["count"].(float64); ok {
		CountInt := int(Count)
		o.Count = &CountInt
	}
