...
func (o *Trunkbaseentitylisting) SetField(field string, fieldValue interface{}) {
...
func (o *Trunkbaseentitylisting) UnmarshalJSON(b []byte) error {
	...
	if TotalNumberOfEntities, ok := TrunkbaseentitylistingMap["totalNumberOfEntities"].(float64); ok {
