...
func (o *Journeyviewresult) SetField(field string, fieldValue interface{}) {
...
func (o Journeyviewresult) MarshalJSON() ([]byte, error) {
...
func (o *Journeyviewresult) UnmarshalJSON(b []byte) error {
	var JourneyviewresultMap map[string]interface{}
	err := json.Unmarshal(b, &JourneyviewresultMap)
	if err != nil {
		return err
	}
