...
func (o *Summarysettingwithtranscript) SetField(field string, fieldValue interface{}) {
...
func (o Summarysettingwithtranscript) MarshalJSON() ([]byte, error) {
...
func (o *Summarysettingwithtranscript) UnmarshalJSON(b []byte) error {
	var SummarysettingwithtranscriptMap map[string]interface{}
	err := json.Unmarshal(b, &SummarysettingwithtranscriptMap)
	if err != nil {
		return err
	}
	
	if Transcript, ok := SummarysettingwithtranscriptMap["transcript"].(string); ok {
