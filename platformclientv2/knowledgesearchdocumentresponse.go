...
func (o *Knowledgesearchdocumentresponse) SetField(field string, fieldValue interface{}) {
...
func (o Knowledgesearchdocumentresponse) MarshalJSON() ([]byte, error) {
...
func (o *Knowledgesearchdocumentresponse) UnmarshalJSON(b []byte) error {
	var KnowledgesearchdocumentresponseMap map[string]interface{}
	err := json.Unmarshal(b, &KnowledgesearchdocumentresponseMap)
	if err != nil {
		return err
	}
	
	if Id, ok := KnowledgesearchdocumentresponseMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Title, ok := KnowledgesearchdocumentresponseMap["title"].(string); ok {
		o.Title = &Title
	}
    
	if Visible, ok := KnowledgesearchdocumentresponseMap["visible"].(bool); ok {
		o.Visible = &Visible
	}
    
	if Alternatives, ok := KnowledgesearchdocumentresponseMap["alternatives"].([]interface{}); ok {
		AlternativesString, _ := json.Marshal(Alternatives)
		json.Unmarshal(AlternativesString, &o.Alternatives)
	}
	
	if State, ok := KnowledgesearchdocumentresponseMap["state"].(string); ok {
		o.State = &State
	}
    
	if dateCreatedString, ok := KnowledgesearchdocumentresponseMap["dateCreated"].(string); ok {
		DateCreated, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateCreatedString)
		o.DateCreated = &DateCreated
	}
	
	if dateModifiedString, ok := KnowledgesearchdocumentresponseMap["dateModified"].(string); ok {
		DateModified, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateModifiedString)
		o.DateModified = &DateModified
	}
	
	if dateImportedString, ok := KnowledgesearchdocumentresponseMap["dateImported"].(string); ok {
		DateImported, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateImportedString)
		o.DateImported = &DateImported
	}
	
	if LastPublishedVersionNumber, ok := KnowledgesearchdocumentresponseMap["lastPublishedVersionNumber"].(float64); ok {
		LastPublishedVersionNumberInt := int(LastPublishedVersionNumber)
		o.LastPublishedVersionNumber = &LastPublishedVersionNumberInt
	}
	
	if datePublishedString, ok := KnowledgesearchdocumentresponseMap["datePublished"].(string); ok {
		DatePublished, _ := time.Parse("2006-01-02T15:04:05.999999Z", datePublishedString)
		o.DatePublished = &DatePublished
	}
	
	if CreatedBy, ok := KnowledgesearchdocumentresponseMap["createdBy"].(map[string]interface{}); ok {
		CreatedByString, _ := json.Marshal(CreatedBy)
		json.Unmarshal(CreatedByString, &o.CreatedBy)
	}
	
	if ModifiedBy, ok := KnowledgesearchdocumentresponseMap["modifiedBy"].(map[string]interface{}); ok {
		ModifiedByString, _ := json.Marshal(ModifiedBy)
		json.Unmarshal(ModifiedByString, &o.ModifiedBy)
	}
	
	if DocumentVersion, ok := KnowledgesearchdocumentresponseMap["documentVersion"].(map[string]interface{}); ok {
		DocumentVersionString, _ := json.Marshal(DocumentVersion)
		json.Unmarshal(DocumentVersionString, &o.DocumentVersion)
	}
	
	if Category, ok := KnowledgesearchdocumentresponseMap["category"].(map[string]interface{}); ok {
		CategoryString, _ := json.Marshal(Category)
		json.Unmarshal(CategoryString, &o.Category)
	}
	
	if Labels, ok := KnowledgesearchdocumentresponseMap["labels"].([]interface{}); ok {
		LabelsString, _ := json.Marshal(Labels)
		json.Unmarshal(LabelsString, &o.Labels)
	}
	
	if KnowledgeBase, ok := KnowledgesearchdocumentresponseMap["knowledgeBase"].(map[string]interface{}); ok {
		KnowledgeBaseString, _ := json.Marshal(KnowledgeBase)
		json.Unmarshal(KnowledgeBaseString, &o.KnowledgeBase)
	}
	
	if ExternalId, ok := KnowledgesearchdocumentresponseMap["externalId"].(string); ok {
		o.ExternalId = &ExternalId
	}
    
	if ExternalUrl, ok := KnowledgesearchdocumentresponseMap["externalUrl"].(string); ok {
		o.ExternalUrl = &ExternalUrl
	}
    
	if Source, ok := KnowledgesearchdocumentresponseMap["source"].(map[string]interface{}); ok {
		SourceString, _ := json.Marshal(Source)
		json.Unmarshal(SourceString, &o.Source)
	}
	
	if Readonly, ok := KnowledgesearchdocumentresponseMap["readonly"].(bool); ok {
		o.Readonly = &Readonly
	}
    
	if Variations, ok := KnowledgesearchdocumentresponseMap["variations"].([]interface{}); ok {
		VariationsString, _ := json.Marshal(Variations)
		json.Unmarshal(VariationsString, &o.Variations)
	}
	
	if Answer, ok := KnowledgesearchdocumentresponseMap["answer"].(string); ok {
		o.Answer = &Answer
	}
    
	if SelfUri, ok := KnowledgesearchdocumentresponseMap["selfUri"].(string); ok {
		o.SelfUri = &SelfUri
	}
