...
func (o *Datepickeravailabledatetime) SetField(field string, fieldValue interface{}) {
...
func (o Datepickeravailabledatetime) MarshalJSON() ([]byte, error) {
...
func (o *Datepickeravailabledatetime) UnmarshalJSON(b []byte) error {
	var DatepickeravailabledatetimeMap map[string]interface{}
	err := json.Unmarshal(b, &DatepickeravailabledatetimeMap)
	if err != nil {
		return err
	}
	
	if Duration, ok := DatepickeravailabledatetimeMap["duration"].(float64); ok {
		DurationInt := int(Duration)
		o.Duration = &DurationInt
	}
	
	if dateTimeString, ok := DatepickeravailabledatetimeMap["dateTime"].(string); ok {
