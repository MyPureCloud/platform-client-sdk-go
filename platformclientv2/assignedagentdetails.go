...
func (o *Assignedagentdetails) SetField(field string, fieldValue interface{}) {
...
func (o Assignedagentdetails) MarshalJSON() ([]byte, error) {
...
func (o *Assignedagentdetails) UnmarshalJSON(b []byte) error {
	var AssignedagentdetailsMap map[string]interface{}
	err := json.Unmarshal(b, &AssignedagentdetailsMap)
	if err != nil {
		return err
	}
	
	if Id, ok := AssignedagentdetailsMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if endDateString, ok := AssignedagentdetailsMap["endDate"].(string); ok {
