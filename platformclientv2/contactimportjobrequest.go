...
func (o *Contactimportjobrequest) SetField(field string, fieldValue interface{}) {
...
func (o Contactimportjobrequest) MarshalJSON() ([]byte, error) {
...
func (o *Contactimportjobrequest) UnmarshalJSON(b []byte) error {
	var ContactimportjobrequestMap map[string]interface{}
	err := json.Unmarshal(b, &ContactimportjobrequestMap)
	if err != nil {
		return err
	}
	
	if SettingsId, ok := ContactimportjobrequestMap["settingsId"].(string); ok {
