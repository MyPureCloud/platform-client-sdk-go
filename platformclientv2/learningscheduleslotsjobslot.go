...
type Learningscheduleslotsjobslot struct { 
	...
	Schedule *Learningscheduleslotsjobschedule `json:"schedule,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Learningscheduleslotsjobslot) SetField(field string, fieldValue interface{}) {
...
func (o Learningscheduleslotsjobslot) MarshalJSON() ([]byte, error) {
...
func (o *Learningscheduleslotsjobslot) UnmarshalJSON(b []byte) error {
	var LearningscheduleslotsjobslotMap map[string]interface{}
	err := json.Unmarshal(b, &LearningscheduleslotsjobslotMap)
	if err != nil {
		return err
	}
	
	if dateStartString, ok := LearningscheduleslotsjobslotMap["dateStart"].(string); ok {
		DateStart, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateStartString)
		o.DateStart = &DateStart
	}
	
	if Schedule, ok := LearningscheduleslotsjobslotMap["schedule"].(map[string]interface{}); ok {
