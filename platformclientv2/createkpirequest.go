...
func (o *Createkpirequest) SetField(field string, fieldValue interface{}) {
...
func (o Createkpirequest) MarshalJSON() ([]byte, error) {
...
func (o *Createkpirequest) UnmarshalJSON(b []byte) error {
	var CreatekpirequestMap map[string]interface{}
	err := json.Unmarshal(b, &CreatekpirequestMap)
	if err != nil {
		return err
	}
	
	if Name, ok := CreatekpirequestMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if Description, ok := CreatekpirequestMap["description"].(string); ok {
		o.Description = &Description
	}
    
	if KpiType, ok := CreatekpirequestMap["kpiType"].(string); ok {
		o.KpiType = &KpiType
	}
    
	if WrapUpCodeConfig, ok := CreatekpirequestMap["wrapUpCodeConfig"].(map[string]interface{}); ok {
		WrapUpCodeConfigString, _ := json.Marshal(WrapUpCodeConfig)
		json.Unmarshal(WrapUpCodeConfigString, &o.WrapUpCodeConfig)
	}
	
	if Source, ok := CreatekpirequestMap["source"].(string); ok {
		o.Source = &Source
	}
