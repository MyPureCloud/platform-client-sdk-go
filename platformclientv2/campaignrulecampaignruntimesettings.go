...
func (o Campaignrulecampaignruntimesettings) MarshalJSON() ([]byte, error) {
...
func (o *Campaignrulecampaignruntimesettings) UnmarshalJSON(b []byte) error {
	var CampaignrulecampaignruntimesettingsMap map[string]interface{}
	err := json.Unmarshal(b, &CampaignrulecampaignruntimesettingsMap)
	if err != nil {
		return err
	}
