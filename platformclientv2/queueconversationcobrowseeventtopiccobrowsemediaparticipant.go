...
type Queueconversationcobrowseeventtopiccobrowsemediaparticipant struct { 
	...
	// QueueMediaSettings
	QueueMediaSettings *Queueconversationcobrowseeventtopicqueuemediasettings `json:"queueMediaSettings,omitempty"`
...
func (o *Queueconversationcobrowseeventtopiccobrowsemediaparticipant) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationcobrowseeventtopiccobrowsemediaparticipant) UnmarshalJSON(b []byte) error {
	...
	if ExternalContactInitialDivisionId, ok := QueueconversationcobrowseeventtopiccobrowsemediaparticipantMap["externalContactInitialDivisionId"].(string); ok {
	...
	if resumeTimeString, ok := QueueconversationcobrowseeventtopiccobrowsemediaparticipantMap["resumeTime"].(string); ok {
		ResumeTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", resumeTimeString)
		o.ResumeTime = &ResumeTime
	}
	
	if parkTimeString, ok := QueueconversationcobrowseeventtopiccobrowsemediaparticipantMap["parkTime"].(string); ok {
	...
	if QueueMediaSettings, ok := QueueconversationcobrowseeventtopiccobrowsemediaparticipantMap["queueMediaSettings"].(map[string]interface{}); ok {
