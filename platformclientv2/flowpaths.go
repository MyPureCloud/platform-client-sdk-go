...
func (o *Flowpaths) SetField(field string, fieldValue interface{}) {
...
func (o Flowpaths) MarshalJSON() ([]byte, error) {
...
func (o *Flowpaths) UnmarshalJSON(b []byte) error {
	var FlowpathsMap map[string]interface{}
	err := json.Unmarshal(b, &FlowpathsMap)
	if err != nil {
		return err
	}
	
	if Category, ok := FlowpathsMap["category"].(string); ok {
		o.Category = &Category
	}
