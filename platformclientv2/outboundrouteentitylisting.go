...
func (o *Outboundrouteentitylisting) SetField(field string, fieldValue interface{}) {
...
func (o *Outboundrouteentitylisting) UnmarshalJSON(b []byte) error {
	...
	if TotalNumberOfEntities, ok := OutboundrouteentitylistingMap["totalNumberOfEntities"].(float64); ok {
