...
type Copilotrule struct { 
	...
	Conditions *[]Copilotcondition `json:"conditions,omitempty"`
...
func (o *Copilotrule) SetField(field string, fieldValue interface{}) {
...
func (o Copilotrule) MarshalJSON() ([]byte, error) {
...
func (o *Copilotrule) UnmarshalJSON(b []byte) error {
	var CopilotruleMap map[string]interface{}
	err := json.Unmarshal(b, &CopilotruleMap)
	if err != nil {
		return err
	}
	
	if Conditions, ok := CopilotruleMap["conditions"].([]interface{}); ok {
		ConditionsString, _ := json.Marshal(Conditions)
		json.Unmarshal(ConditionsString, &o.Conditions)
	}
	
	if Actions, ok := CopilotruleMap["actions"].([]interface{}); ok {
