...
type Buheadcountforecastbuplanninggroupheadcountforecastuploadschema struct { 
	...
	// Entities
	Entities *[]Buplanninggroupheadcountforecastuploadschema `json:"entities,omitempty"`
...
func (o *Buheadcountforecastbuplanninggroupheadcountforecastuploadschema) SetField(field string, fieldValue interface{}) {
...
func (o Buheadcountforecastbuplanninggroupheadcountforecastuploadschema) MarshalJSON() ([]byte, error) {
...
func (o *Buheadcountforecastbuplanninggroupheadcountforecastuploadschema) UnmarshalJSON(b []byte) error {
	var BuheadcountforecastbuplanninggroupheadcountforecastuploadschemaMap map[string]interface{}
	err := json.Unmarshal(b, &BuheadcountforecastbuplanninggroupheadcountforecastuploadschemaMap)
	if err != nil {
		return err
	}
	
	if Entities, ok := BuheadcountforecastbuplanninggroupheadcountforecastuploadschemaMap["entities"].([]interface{}); ok {
		EntitiesString, _ := json.Marshal(Entities)
		json.Unmarshal(EntitiesString, &o.Entities)
	}
	
	if referenceStartDateString, ok := BuheadcountforecastbuplanninggroupheadcountforecastuploadschemaMap["referenceStartDate"].(string); ok {
