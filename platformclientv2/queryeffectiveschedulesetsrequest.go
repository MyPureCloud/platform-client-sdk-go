...
func (o *Queryeffectiveschedulesetsrequest) SetField(field string, fieldValue interface{}) {
...
func (o Queryeffectiveschedulesetsrequest) MarshalJSON() ([]byte, error) {
...
func (o *Queryeffectiveschedulesetsrequest) UnmarshalJSON(b []byte) error {
	var QueryeffectiveschedulesetsrequestMap map[string]interface{}
	err := json.Unmarshal(b, &QueryeffectiveschedulesetsrequestMap)
	if err != nil {
		return err
	}
	
	if startDateString, ok := QueryeffectiveschedulesetsrequestMap["startDate"].(string); ok {
		StartDate, _ := time.Parse("2006-01-02", startDateString)
		o.StartDate = &StartDate
	}
	
	if WeekCount, ok := QueryeffectiveschedulesetsrequestMap["weekCount"].(float64); ok {
