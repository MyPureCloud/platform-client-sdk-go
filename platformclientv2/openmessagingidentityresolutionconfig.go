...
func (o *Openmessagingidentityresolutionconfig) SetField(field string, fieldValue interface{}) {
...
func (o Openmessagingidentityresolutionconfig) MarshalJSON() ([]byte, error) {
...
func (o *Openmessagingidentityresolutionconfig) UnmarshalJSON(b []byte) error {
	var OpenmessagingidentityresolutionconfigMap map[string]interface{}
	err := json.Unmarshal(b, &OpenmessagingidentityresolutionconfigMap)
	if err != nil {
		return err
	}
	...
	if ResolveIdentities, ok := OpenmessagingidentityresolutionconfigMap["resolveIdentities"].(bool); ok {
