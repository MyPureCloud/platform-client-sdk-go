...
type Bulkjobaddresponse struct { 
	...
	Results *[]Bulkjobaddresult `json:"results,omitempty"`
...
func (o *Bulkjobaddresponse) SetField(field string, fieldValue interface{}) {
...
func (o Bulkjobaddresponse) MarshalJSON() ([]byte, error) {
...
func (o *Bulkjobaddresponse) UnmarshalJSON(b []byte) error {
	var BulkjobaddresponseMap map[string]interface{}
	err := json.Unmarshal(b, &BulkjobaddresponseMap)
	if err != nil {
		return err
	}
	
	if Results, ok := BulkjobaddresponseMap["results"].([]interface{}); ok {
		ResultsString, _ := json.Marshal(Results)
		json.Unmarshal(ResultsString, &o.Results)
	}
	
	if ErrorCount, ok := BulkjobaddresponseMap["errorCount"].(float64); ok {
		ErrorCountInt := int(ErrorCount)
		o.ErrorCount = &ErrorCountInt
	}
	
	if ErrorIndexes, ok := BulkjobaddresponseMap["errorIndexes"].([]interface{}); ok {
