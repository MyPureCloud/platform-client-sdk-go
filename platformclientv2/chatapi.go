...
// DeleteChatsUsersMeSettings invokes DELETE /api/v2/chats/users/me/settings
//
// Delete a user's chat settings
func (a ChatApi) DeleteChatsUsersMeSettings() (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
...
func (a ChatApi) PatchChatsUsersMeSettings(body Usersettingsforchat) (*Usersettingsforchat, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ChatApi->PatchChatsUsersMeSettings")
	}
...
// PostChatsUsersMeSettings invokes POST /api/v2/chats/users/me/settings
//
// Create a user's chat settings
func (a ChatApi) PostChatsUsersMeSettings(body Userchatsettingspost) (*APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/chats/users/me/settings"
	if true == false {
	...
	if &body == nil {
		// false
		return nil, errors.New("Missing required parameter 'body' when calling ChatApi->PostChatsUsersMeSettings")
	}
