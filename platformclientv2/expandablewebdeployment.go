...
func (o *Expandablewebdeployment) SetField(field string, fieldValue interface{}) {
...
func (o *Expandablewebdeployment) UnmarshalJSON(b []byte) error {
	...
	if SupportedContent, ok := ExpandablewebdeploymentMap["supportedContent"].(map[string]interface{}); ok {
	...
	if PushIntegrations, ok := ExpandablewebdeploymentMap["pushIntegrations"].([]interface{}); ok {
