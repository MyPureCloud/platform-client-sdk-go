...
type Outboundmessagingemailcampaignprogresseventcampaignprogress struct { 
	// SetFieldNames defines the list of fields to use for controlled JSON serialization
	SetFieldNames map[string]bool `json:"-"`
	// Campaign
	Campaign *Outboundmessagingemailcampaignprogresseventurireference `json:"campaign,omitempty"`
...
func (o *Outboundmessagingemailcampaignprogresseventcampaignprogress) SetField(field string, fieldValue interface{}) {
...
func (o Outboundmessagingemailcampaignprogresseventcampaignprogress) MarshalJSON() ([]byte, error) {
	...
	type Alias Outboundmessagingemailcampaignprogresseventcampaignprogress
...
func (o *Outboundmessagingemailcampaignprogresseventcampaignprogress) UnmarshalJSON(b []byte) error {
	var OutboundmessagingemailcampaignprogresseventcampaignprogressMap map[string]interface{}
	err := json.Unmarshal(b, &OutboundmessagingemailcampaignprogresseventcampaignprogressMap)
	if err != nil {
		return err
	}
	
	if Campaign, ok := OutboundmessagingemailcampaignprogresseventcampaignprogressMap["campaign"].(map[string]interface{}); ok {
		CampaignString, _ := json.Marshal(Campaign)
		json.Unmarshal(CampaignString, &o.Campaign)
	}
	
	if NumberOfContactsCalled, ok := OutboundmessagingemailcampaignprogresseventcampaignprogressMap["numberOfContactsCalled"].(float64); ok {
		NumberOfContactsCalledFloat32 := float32(NumberOfContactsCalled)
		o.NumberOfContactsCalled = &NumberOfContactsCalledFloat32
	}
    
	if NumberOfContactsMessaged, ok := OutboundmessagingemailcampaignprogresseventcampaignprogressMap["numberOfContactsMessaged"].(float64); ok {
	...
	if TotalNumberOfContacts, ok := OutboundmessagingemailcampaignprogresseventcampaignprogressMap["totalNumberOfContacts"].(float64); ok {
		TotalNumberOfContactsFloat32 := float32(TotalNumberOfContacts)
		o.TotalNumberOfContacts = &TotalNumberOfContactsFloat32
	}
    
	if Percentage, ok := OutboundmessagingemailcampaignprogresseventcampaignprogressMap["percentage"].(float64); ok {
		PercentageInt := int(Percentage)
		o.Percentage = &PercentageInt
	}
	
	if NumberOfContactsSkipped, ok := OutboundmessagingemailcampaignprogresseventcampaignprogressMap["numberOfContactsSkipped"].(map[string]interface{}); ok {
	...
	if AdditionalProperties, ok := OutboundmessagingemailcampaignprogresseventcampaignprogressMap["additionalProperties"].(map[string]interface{}); ok {
		AdditionalPropertiesString, _ := json.Marshal(AdditionalProperties)
		json.Unmarshal(AdditionalPropertiesString, &o.AdditionalProperties)
	}
	
	if GetAdditionalProperties, ok := OutboundmessagingemailcampaignprogresseventcampaignprogressMap["getAdditionalProperties"].(map[string]interface{}); ok {
...
func (o *Outboundmessagingemailcampaignprogresseventcampaignprogress) String() string {
	j, _ := json.Marshal(o)
