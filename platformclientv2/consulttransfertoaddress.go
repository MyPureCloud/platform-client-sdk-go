...
func (o *Consulttransfertoaddress) SetField(field string, fieldValue interface{}) {
...
func (o Consulttransfertoaddress) MarshalJSON() ([]byte, error) {
...
func (o *Consulttransfertoaddress) UnmarshalJSON(b []byte) error {
	var ConsulttransfertoaddressMap map[string]interface{}
	err := json.Unmarshal(b, &ConsulttransfertoaddressMap)
	if err != nil {
		return err
	}
	
	if SpeakTo, ok := ConsulttransfertoaddressMap["speakTo"].(string); ok {
		o.SpeakTo = &SpeakTo
	}
    
	if ConsultingUserId, ok := ConsulttransfertoaddressMap["consultingUserId"].(string); ok {
		o.ConsultingUserId = &ConsultingUserId
	}
    
	if Address, ok := ConsulttransfertoaddressMap["address"].(string); ok {
		o.Address = &Address
	}
