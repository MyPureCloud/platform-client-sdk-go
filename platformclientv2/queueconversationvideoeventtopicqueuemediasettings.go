...
// Queueconversationvideoeventtopicqueuemediasettings - Represents the queue setting for this media.
type Queueconversationvideoeventtopicqueuemediasettings struct { 
...
func (o *Queueconversationvideoeventtopicqueuemediasettings) SetField(field string, fieldValue interface{}) {
...
func (o Queueconversationvideoeventtopicqueuemediasettings) MarshalJSON() ([]byte, error) {
	...
	type Alias Queueconversationvideoeventtopicqueuemediasettings
...
func (o *Queueconversationvideoeventtopicqueuemediasettings) UnmarshalJSON(b []byte) error {
	var QueueconversationvideoeventtopicqueuemediasettingsMap map[string]interface{}
	err := json.Unmarshal(b, &QueueconversationvideoeventtopicqueuemediasettingsMap)
	if err != nil {
		return err
	}
	
	if AlertingTimeoutSeconds, ok := QueueconversationvideoeventtopicqueuemediasettingsMap["alertingTimeoutSeconds"].(float64); ok {
		AlertingTimeoutSecondsInt := int(AlertingTimeoutSeconds)
		o.AlertingTimeoutSeconds = &AlertingTimeoutSecondsInt
	}
	
	if AutoAnswerAlertToneSeconds, ok := QueueconversationvideoeventtopicqueuemediasettingsMap["autoAnswerAlertToneSeconds"].(float64); ok {
	...
	if ManualAnswerAlertToneSeconds, ok := QueueconversationvideoeventtopicqueuemediasettingsMap["manualAnswerAlertToneSeconds"].(float64); ok {
	...
	if EnableAutoAnswer, ok := QueueconversationvideoeventtopicqueuemediasettingsMap["enableAutoAnswer"].(bool); ok {
...
func (o *Queueconversationvideoeventtopicqueuemediasettings) String() string {
	j, _ := json.Marshal(o)
