...
func (o *Queryweeksummarylistjobrequest) SetField(field string, fieldValue interface{}) {
...
func (o Queryweeksummarylistjobrequest) MarshalJSON() ([]byte, error) {
...
func (o *Queryweeksummarylistjobrequest) UnmarshalJSON(b []byte) error {
	var QueryweeksummarylistjobrequestMap map[string]interface{}
	err := json.Unmarshal(b, &QueryweeksummarylistjobrequestMap)
	if err != nil {
		return err
	}
	
	if ManagementUnitIds, ok := QueryweeksummarylistjobrequestMap["managementUnitIds"].([]interface{}); ok {
		ManagementUnitIdsString, _ := json.Marshal(ManagementUnitIds)
		json.Unmarshal(ManagementUnitIdsString, &o.ManagementUnitIds)
	}
	
	if WeekDates, ok := QueryweeksummarylistjobrequestMap["weekDates"].([]interface{}); ok {
