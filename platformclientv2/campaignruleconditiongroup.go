...
type Campaignruleconditiongroup struct { 
	...
	Conditions *[]Campaignrulecondition `json:"conditions,omitempty"`
}

// SetField uses reflection to set a field on the model if the model has a property SetFieldNames, and triggers custom JSON serialization logic to only serialize properties that have been set using this function.
func (o *Campaignruleconditiongroup) SetField(field string, fieldValue interface{}) {
...
func (o Campaignruleconditiongroup) MarshalJSON() ([]byte, error) {
...
func (o *Campaignruleconditiongroup) UnmarshalJSON(b []byte) error {
	var CampaignruleconditiongroupMap map[string]interface{}
	err := json.Unmarshal(b, &CampaignruleconditiongroupMap)
	if err != nil {
		return err
	}
	
	if MatchAnyConditions, ok := CampaignruleconditiongroupMap["matchAnyConditions"].(bool); ok {
		o.MatchAnyConditions = &MatchAnyConditions
	}
    
	if Conditions, ok := CampaignruleconditiongroupMap["conditions"].([]interface{}); ok {
