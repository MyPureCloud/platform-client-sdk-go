...
func (o *Outboundroutebaseentitylisting) SetField(field string, fieldValue interface{}) {
...
func (o *Outboundroutebaseentitylisting) UnmarshalJSON(b []byte) error {
	...
	if TotalNumberOfEntities, ok := OutboundroutebaseentitylistingMap["totalNumberOfEntities"].(float64); ok {
