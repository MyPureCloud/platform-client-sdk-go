...
func (a SpeechTextAnalyticsApi) GetSpeechandtextanalyticsProgramMappings(programId string) (*Topicsdefinitionsprogrammappings, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/speechandtextanalytics/programs/{programId}/mappings"
	path = strings.Replace(path, "{programId}", url.PathEscape(fmt.Sprintf("%v", programId)), -1)
	defaultReturn := new(Topicsdefinitionsprogrammappings)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Topicsdefinitionsprogrammappings
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Topicsdefinitionsprogrammappings" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a SpeechTextAnalyticsApi) GetSpeechandtextanalyticsProgramsMappings(nextPage string, pageSize int) (*Topicsdefinitionsprogramsmappingsentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/speechandtextanalytics/programs/mappings"
	defaultReturn := new(Topicsdefinitionsprogramsmappingsentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Topicsdefinitionsprogramsmappingsentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Topicsdefinitionsprogramsmappingsentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetSpeechandtextanalyticsProgramsTopiclinksJob invokes GET /api/v2/speechandtextanalytics/programs/topiclinks/jobs/{jobId}
//
// Get a Speech & Text Analytics program-topic links job by id
func (a SpeechTextAnalyticsApi) GetSpeechandtextanalyticsProgramsTopiclinksJob(jobId string) (*Programtopiclinksjob, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/speechandtextanalytics/programs/topiclinks/jobs/{jobId}"
	path = strings.Replace(path, "{jobId}", url.PathEscape(fmt.Sprintf("%v", jobId)), -1)
	defaultReturn := new(Programtopiclinksjob)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &jobId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'jobId' when calling SpeechTextAnalyticsApi->GetSpeechandtextanalyticsProgramsTopiclinksJob")
	}
	...
	var successPayload *Programtopiclinksjob
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Programtopiclinksjob" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a SpeechTextAnalyticsApi) GetSpeechandtextanalyticsTopics(nextPage string, pageSize int, pageNumber int, state string, name string, ids []string, dialects []string, sortBy string, sortOrder string) (*Topicsentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
...
func (a SpeechTextAnalyticsApi) PutSpeechandtextanalyticsProgramMappings(programId string, body Programmappingsrequest) (*Topicsdefinitionsprogrammappings, *APIResponse, error) {
	var httpMethod = "PUT"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/speechandtextanalytics/programs/{programId}/mappings"
	path = strings.Replace(path, "{programId}", url.PathEscape(fmt.Sprintf("%v", programId)), -1)
