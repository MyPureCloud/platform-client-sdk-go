...
func (o *Workplanbidmetadata) SetField(field string, fieldValue interface{}) {
...
func (o Workplanbidmetadata) MarshalJSON() ([]byte, error) {
...
func (o *Workplanbidmetadata) UnmarshalJSON(b []byte) error {
	var WorkplanbidmetadataMap map[string]interface{}
	err := json.Unmarshal(b, &WorkplanbidmetadataMap)
	if err != nil {
		return err
	}
	
	if CreatedBy, ok := WorkplanbidmetadataMap["createdBy"].(map[string]interface{}); ok {
		CreatedByString, _ := json.Marshal(CreatedBy)
		json.Unmarshal(CreatedByString, &o.CreatedBy)
	}
	
	if createdDateString, ok := WorkplanbidmetadataMap["createdDate"].(string); ok {
		CreatedDate, _ := time.Parse("2006-01-02T15:04:05.999999Z", createdDateString)
		o.CreatedDate = &CreatedDate
	}
	
	if ModifiedBy, ok := WorkplanbidmetadataMap["modifiedBy"].(map[string]interface{}); ok {
		ModifiedByString, _ := json.Marshal(ModifiedBy)
		json.Unmarshal(ModifiedByString, &o.ModifiedBy)
	}
	
	if modifiedDateString, ok := WorkplanbidmetadataMap["modifiedDate"].(string); ok {
