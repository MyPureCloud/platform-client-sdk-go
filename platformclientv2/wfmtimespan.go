...
func (o *Wfmtimespan) SetField(field string, fieldValue interface{}) {
...
func (o Wfmtimespan) MarshalJSON() ([]byte, error) {
...
func (o *Wfmtimespan) UnmarshalJSON(b []byte) error {
	var WfmtimespanMap map[string]interface{}
	err := json.Unmarshal(b, &WfmtimespanMap)
	if err != nil {
		return err
	}
	
	if startDateString, ok := WfmtimespanMap["startDate"].(string); ok {
		StartDate, _ := time.Parse("2006-01-02T15:04:05.999999Z", startDateString)
		o.StartDate = &StartDate
	}
	
	if LengthMinutes, ok := WfmtimespanMap["lengthMinutes"].(float64); ok {
