...
func (o *Queueconversationeventtopicmessage) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationeventtopicmessage) UnmarshalJSON(b []byte) error {
	...
	if Direction, ok := QueueconversationeventtopicmessageMap["direction"].(string); ok {
	...
	if QueueMediaSettings, ok := QueueconversationeventtopicmessageMap["queueMediaSettings"].(map[string]interface{}); ok {
		QueueMediaSettingsString, _ := json.Marshal(QueueMediaSettings)
		json.Unmarshal(QueueMediaSettingsString, &o.QueueMediaSettings)
	}
	
	if resumeTimeString, ok := QueueconversationeventtopicmessageMap["resumeTime"].(string); ok {
		ResumeTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", resumeTimeString)
		o.ResumeTime = &ResumeTime
	}
	
	if parkTimeString, ok := QueueconversationeventtopicmessageMap["parkTime"].(string); ok {
