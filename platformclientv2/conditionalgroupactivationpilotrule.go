...
func (o *Conditionalgroupactivationpilotrule) SetField(field string, fieldValue interface{}) {
...
func (o Conditionalgroupactivationpilotrule) MarshalJSON() ([]byte, error) {
...
func (o *Conditionalgroupactivationpilotrule) UnmarshalJSON(b []byte) error {
	var ConditionalgroupactivationpilotruleMap map[string]interface{}
	err := json.Unmarshal(b, &ConditionalgroupactivationpilotruleMap)
	if err != nil {
		return err
	}
	
	if Conditions, ok := ConditionalgroupactivationpilotruleMap["conditions"].([]interface{}); ok {
		ConditionsString, _ := json.Marshal(Conditions)
		json.Unmarshal(ConditionsString, &o.Conditions)
	}
	
	if ConditionExpression, ok := ConditionalgroupactivationpilotruleMap["conditionExpression"].(string); ok {
