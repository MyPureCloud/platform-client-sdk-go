...
func (o *Assignmenteffectivedaterange) SetField(field string, fieldValue interface{}) {
...
func (o Assignmenteffectivedaterange) MarshalJSON() ([]byte, error) {
...
func (o *Assignmenteffectivedaterange) UnmarshalJSON(b []byte) error {
	var AssignmenteffectivedaterangeMap map[string]interface{}
	err := json.Unmarshal(b, &AssignmenteffectivedaterangeMap)
	if err != nil {
		return err
	}
	
	if startDateString, ok := AssignmenteffectivedaterangeMap["startDate"].(string); ok {
		StartDate, _ := time.Parse("2006-01-02", startDateString)
		o.StartDate = &StartDate
	}
	
	if endDateString, ok := AssignmenteffectivedaterangeMap["endDate"].(string); ok {
