...
func (o *Insightssummaryuseritem) SetField(field string, fieldValue interface{}) {
...
func (o Insightssummaryuseritem) MarshalJSON() ([]byte, error) {
...
func (o *Insightssummaryuseritem) UnmarshalJSON(b []byte) error {
	var InsightssummaryuseritemMap map[string]interface{}
	err := json.Unmarshal(b, &InsightssummaryuseritemMap)
	if err != nil {
		return err
	}
	
	if User, ok := InsightssummaryuseritemMap["user"].(map[string]interface{}); ok {
		UserString, _ := json.Marshal(User)
		json.Unmarshal(UserString, &o.User)
	}
	
	if MetricData, ok := InsightssummaryuseritemMap["metricData"].([]interface{}); ok {
