...
type Contestsfinalizerequest struct { 
	...
	Winners *[]Contestwinnersrequest `json:"winners,omitempty"`
...
func (o *Contestsfinalizerequest) SetField(field string, fieldValue interface{}) {
...
func (o Contestsfinalizerequest) MarshalJSON() ([]byte, error) {
...
func (o *Contestsfinalizerequest) UnmarshalJSON(b []byte) error {
	var ContestsfinalizerequestMap map[string]interface{}
	err := json.Unmarshal(b, &ContestsfinalizerequestMap)
	if err != nil {
		return err
	}
	
	if Status, ok := ContestsfinalizerequestMap["status"].(string); ok {
		o.Status = &Status
	}
    
	if Winners, ok := ContestsfinalizerequestMap["winners"].([]interface{}); ok {
		WinnersString, _ := json.Marshal(Winners)
		json.Unmarshal(WinnersString, &o.Winners)
	}
	
	if DisqualifiedAgents, ok := ContestsfinalizerequestMap["disqualifiedAgents"].([]interface{}); ok {
