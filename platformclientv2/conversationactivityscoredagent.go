...
func (o *Conversationactivityscoredagent) SetField(field string, fieldValue interface{}) {
...
func (o Conversationactivityscoredagent) MarshalJSON() ([]byte, error) {
...
func (o *Conversationactivityscoredagent) UnmarshalJSON(b []byte) error {
	var ConversationactivityscoredagentMap map[string]interface{}
	err := json.Unmarshal(b, &ConversationactivityscoredagentMap)
	if err != nil {
		return err
	}
	
	if AgentScore, ok := ConversationactivityscoredagentMap["agentScore"].(float64); ok {
		AgentScoreInt := int(AgentScore)
		o.AgentScore = &AgentScoreInt
	}
	
	if ScoredAgentId, ok := ConversationactivityscoredagentMap["scoredAgentId"].(string); ok {
