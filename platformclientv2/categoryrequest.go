...
func (o *Categoryrequest) SetField(field string, fieldValue interface{}) {
...
func (o *Categoryrequest) UnmarshalJSON(b []byte) error {
	...
	if InteractionType, ok := CategoryrequestMap["interactionType"].(string); ok {
		o.InteractionType = &InteractionType
	}
    
	if Criteria, ok := CategoryrequestMap["criteria"].(map[string]interface{}); ok {
