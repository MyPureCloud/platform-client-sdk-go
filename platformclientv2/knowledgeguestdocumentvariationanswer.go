...
func (o *Knowledgeguestdocumentvariationanswer) SetField(field string, fieldValue interface{}) {
...
func (o Knowledgeguestdocumentvariationanswer) MarshalJSON() ([]byte, error) {
...
func (o *Knowledgeguestdocumentvariationanswer) UnmarshalJSON(b []byte) error {
	var KnowledgeguestdocumentvariationanswerMap map[string]interface{}
	err := json.Unmarshal(b, &KnowledgeguestdocumentvariationanswerMap)
	if err != nil {
		return err
	}
	
	if Id, ok := KnowledgeguestdocumentvariationanswerMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if dateCreatedString, ok := KnowledgeguestdocumentvariationanswerMap["dateCreated"].(string); ok {
		DateCreated, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateCreatedString)
		o.DateCreated = &DateCreated
	}
	
	if dateModifiedString, ok := KnowledgeguestdocumentvariationanswerMap["dateModified"].(string); ok {
		DateModified, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateModifiedString)
		o.DateModified = &DateModified
	}
	
	if DocumentVersion, ok := KnowledgeguestdocumentvariationanswerMap["documentVersion"].(map[string]interface{}); ok {
		DocumentVersionString, _ := json.Marshal(DocumentVersion)
		json.Unmarshal(DocumentVersionString, &o.DocumentVersion)
	}
	
	if Contexts, ok := KnowledgeguestdocumentvariationanswerMap["contexts"].([]interface{}); ok {
		ContextsString, _ := json.Marshal(Contexts)
		json.Unmarshal(ContextsString, &o.Contexts)
	}
	
	if Document, ok := KnowledgeguestdocumentvariationanswerMap["document"].(map[string]interface{}); ok {
		DocumentString, _ := json.Marshal(Document)
		json.Unmarshal(DocumentString, &o.Document)
	}
	
	if Body, ok := KnowledgeguestdocumentvariationanswerMap["body"].(map[string]interface{}); ok {
		BodyString, _ := json.Marshal(Body)
		json.Unmarshal(BodyString, &o.Body)
	}
	
	if SelfUri, ok := KnowledgeguestdocumentvariationanswerMap["selfUri"].(string); ok {
		o.SelfUri = &SelfUri
	}
