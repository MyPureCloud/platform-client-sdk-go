...
type Queueconversationeventtopicparticipant struct { 
	...
	// InternalMessages
	InternalMessages *[]Queueconversationeventtopicinternalmessage `json:"internalMessages,omitempty"`

	// ScreenMonitorings
	ScreenMonitorings *[]Queueconversationeventtopicscreenmonitoring `json:"screenMonitorings,omitempty"`
...
func (o *Queueconversationeventtopicparticipant) SetField(field string, fieldValue interface{}) {
...
func (o *Queueconversationeventtopicparticipant) UnmarshalJSON(b []byte) error {
	...
	if ExternalContactInitialDivisionId, ok := QueueconversationeventtopicparticipantMap["externalContactInitialDivisionId"].(string); ok {
	...
	if ScreenMonitoredParticipantId, ok := QueueconversationeventtopicparticipantMap["screenMonitoredParticipantId"].(string); ok {
	...
	if MediaRoles, ok := QueueconversationeventtopicparticipantMap["mediaRoles"].([]interface{}); ok {
	...
	if InternalMessages, ok := QueueconversationeventtopicparticipantMap["internalMessages"].([]interface{}); ok {
		InternalMessagesString, _ := json.Marshal(InternalMessages)
		json.Unmarshal(InternalMessagesString, &o.InternalMessages)
	}
	
	if ScreenMonitorings, ok := QueueconversationeventtopicparticipantMap["screenMonitorings"].([]interface{}); ok {
