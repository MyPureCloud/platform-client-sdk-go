...
func (o *Wfmservicegoalimpactsettings) SetField(field string, fieldValue interface{}) {
...
func (o Wfmservicegoalimpactsettings) MarshalJSON() ([]byte, error) {
...
func (o *Wfmservicegoalimpactsettings) UnmarshalJSON(b []byte) error {
	var WfmservicegoalimpactsettingsMap map[string]interface{}
	err := json.Unmarshal(b, &WfmservicegoalimpactsettingsMap)
	if err != nil {
		return err
	}
	
	if ServiceLevel, ok := WfmservicegoalimpactsettingsMap["serviceLevel"].(map[string]interface{}); ok {
		ServiceLevelString, _ := json.Marshal(ServiceLevel)
		json.Unmarshal(ServiceLevelString, &o.ServiceLevel)
	}
	
	if AverageSpeedOfAnswer, ok := WfmservicegoalimpactsettingsMap["averageSpeedOfAnswer"].(map[string]interface{}); ok {
	...
	if AbandonRate, ok := WfmservicegoalimpactsettingsMap["abandonRate"].(map[string]interface{}); ok {
