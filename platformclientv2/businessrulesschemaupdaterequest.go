...
func (o *Businessrulesschemaupdaterequest) SetField(field string, fieldValue interface{}) {
...
func (o Businessrulesschemaupdaterequest) MarshalJSON() ([]byte, error) {
...
func (o *Businessrulesschemaupdaterequest) UnmarshalJSON(b []byte) error {
	var BusinessrulesschemaupdaterequestMap map[string]interface{}
	err := json.Unmarshal(b, &BusinessrulesschemaupdaterequestMap)
	if err != nil {
		return err
	}
	
	if Version, ok := BusinessrulesschemaupdaterequestMap["version"].(float64); ok {
		VersionInt := int(Version)
		o.Version = &VersionInt
	}
	
	if Enabled, ok := BusinessrulesschemaupdaterequestMap["enabled"].(bool); ok {
		o.Enabled = &Enabled
	}
    
	if JsonSchema, ok := BusinessrulesschemaupdaterequestMap["jsonSchema"].(map[string]interface{}); ok {
