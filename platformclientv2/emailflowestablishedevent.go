...
func (o *Emailflowestablishedevent) SetField(field string, fieldValue interface{}) {
...
func (o Emailflowestablishedevent) MarshalJSON() ([]byte, error) {
...
func (o *Emailflowestablishedevent) UnmarshalJSON(b []byte) error {
	var EmailflowestablishedeventMap map[string]interface{}
	err := json.Unmarshal(b, &EmailflowestablishedeventMap)
	if err != nil {
		return err
	}
	
	if EventId, ok := EmailflowestablishedeventMap["eventId"].(string); ok {
		o.EventId = &EventId
	}
    
	if eventDateTimeString, ok := EmailflowestablishedeventMap["eventDateTime"].(string); ok {
		EventDateTime, _ := time.Parse("2006-01-02T15:04:05.999999Z", eventDateTimeString)
		o.EventDateTime = &EventDateTime
	}
	
	if ConversationId, ok := EmailflowestablishedeventMap["conversationId"].(string); ok {
		o.ConversationId = &ConversationId
	}
    
	if CommunicationId, ok := EmailflowestablishedeventMap["communicationId"].(string); ok {
		o.CommunicationId = &CommunicationId
	}
    
	if InitialConfiguration, ok := EmailflowestablishedeventMap["initialConfiguration"].(map[string]interface{}); ok {
	...
	if SourceConfiguration, ok := EmailflowestablishedeventMap["sourceConfiguration"].(map[string]interface{}); ok {
