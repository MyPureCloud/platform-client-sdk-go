...
func (o *Snapshotmetricdata) SetField(field string, fieldValue interface{}) {
...
func (o Snapshotmetricdata) MarshalJSON() ([]byte, error) {
...
func (o *Snapshotmetricdata) UnmarshalJSON(b []byte) error {
	var SnapshotmetricdataMap map[string]interface{}
	err := json.Unmarshal(b, &SnapshotmetricdataMap)
	if err != nil {
		return err
	}
	
	if Weekly, ok := SnapshotmetricdataMap["weekly"].(map[string]interface{}); ok {
		WeeklyString, _ := json.Marshal(Weekly)
		json.Unmarshal(WeeklyString, &o.Weekly)
	}
	
	if QuarterHour, ok := SnapshotmetricdataMap["quarterHour"].(map[string]interface{}); ok {
