...
// GetRecordingUploadsReport invokes GET /api/v2/recording/uploads/reports/{reportId}
//
// Get the status of a recording upload status report
func (a RecordingApi) GetRecordingUploadsReport(reportId string) (*Recordinguploadreport, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	...
	if &reportId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'reportId' when calling RecordingApi->GetRecordingUploadsReport")
	}
	...
	var successPayload *Recordinguploadreport
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes)
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Recordinguploadreport" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a RecordingApi) GetRecordingsRetentionQuery(retentionThresholdDays int, cursor string, pageSize int) (*Recordingretentioncursorentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/recordings/retention/query"
	defaultReturn := new(Recordingretentioncursorentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}

	// verify the required parameter 'retentionThresholdDays' is set
	if &retentionThresholdDays == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'retentionThresholdDays' when calling RecordingApi->GetRecordingsRetentionQuery")
	}
	...
	queryParams["retentionThresholdDays"] = a.Configuration.APIClient.ParameterToString(retentionThresholdDays, "")
	...
	var successPayload *Recordingretentioncursorentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes)
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Recordingretentioncursorentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a RecordingApi) GetRecordingsScreensessionsDetails() (*Screenrecordingactivesessions, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/recordings/screensessions/details"
	defaultReturn := new(Screenrecordingactivesessions)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Screenrecordingactivesessions
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes)
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Screenrecordingactivesessions" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostRecordingUploadsReports invokes POST /api/v2/recording/uploads/reports
//
// Creates a recording upload status report
func (a RecordingApi) PostRecordingUploadsReports(body Recordinguploadreportrequest) (*Recordinguploadreport, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/recording/uploads/reports"
	defaultReturn := new(Recordinguploadreport)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling RecordingApi->PostRecordingUploadsReports")
	}
