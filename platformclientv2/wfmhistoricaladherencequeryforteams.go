...
func (o *Wfmhistoricaladherencequeryforteams) SetField(field string, fieldValue interface{}) {
...
func (o Wfmhistoricaladherencequeryforteams) MarshalJSON() ([]byte, error) {
...
func (o *Wfmhistoricaladherencequeryforteams) UnmarshalJSON(b []byte) error {
	var WfmhistoricaladherencequeryforteamsMap map[string]interface{}
	err := json.Unmarshal(b, &WfmhistoricaladherencequeryforteamsMap)
	if err != nil {
		return err
	}
	
	if startDateString, ok := WfmhistoricaladherencequeryforteamsMap["startDate"].(string); ok {
		StartDate, _ := time.Parse("2006-01-02T15:04:05.999999Z", startDateString)
		o.StartDate = &StartDate
	}
	
	if endDateString, ok := WfmhistoricaladherencequeryforteamsMap["endDate"].(string); ok {
		EndDate, _ := time.Parse("2006-01-02T15:04:05.999999Z", endDateString)
		o.EndDate = &EndDate
	}
	
	if TimeZone, ok := WfmhistoricaladherencequeryforteamsMap["timeZone"].(string); ok {
		o.TimeZone = &TimeZone
	}
    
	if UserIds, ok := WfmhistoricaladherencequeryforteamsMap["userIds"].([]interface{}); ok {
		UserIdsString, _ := json.Marshal(UserIds)
		json.Unmarshal(UserIdsString, &o.UserIds)
	}
	
	if IncludeExceptions, ok := WfmhistoricaladherencequeryforteamsMap["includeExceptions"].(bool); ok {
