...
func (o *Schedulevisibilityrange) SetField(field string, fieldValue interface{}) {
...
func (o Schedulevisibilityrange) MarshalJSON() ([]byte, error) {
	...
	if len(o.SetFieldNames) > 0 {
		...
		dateTimeFields := []string{ "EndDate", }
		localDateTimeFields := []string{  }
		dateFields := []string{ "EndBusinessUnitDate", }
...
func (o *Schedulevisibilityrange) UnmarshalJSON(b []byte) error {
	var SchedulevisibilityrangeMap map[string]interface{}
	err := json.Unmarshal(b, &SchedulevisibilityrangeMap)
	if err != nil {
		return err
	}
	
	if endDateString, ok := SchedulevisibilityrangeMap["endDate"].(string); ok {
		EndDate, _ := time.Parse("2006-01-02T15:04:05.999999Z", endDateString)
		o.EndDate = &EndDate
	}
	
	if endBusinessUnitDateString, ok := SchedulevisibilityrangeMap["endBusinessUnitDate"].(string); ok {
