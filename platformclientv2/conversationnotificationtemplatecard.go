...
func (o *Conversationnotificationtemplatecard) SetField(field string, fieldValue interface{}) {
...
func (o Conversationnotificationtemplatecard) MarshalJSON() ([]byte, error) {
...
func (o *Conversationnotificationtemplatecard) UnmarshalJSON(b []byte) error {
	var ConversationnotificationtemplatecardMap map[string]interface{}
	err := json.Unmarshal(b, &ConversationnotificationtemplatecardMap)
	if err != nil {
		return err
	}
	
	if Header, ok := ConversationnotificationtemplatecardMap["header"].(map[string]interface{}); ok {
		HeaderString, _ := json.Marshal(Header)
		json.Unmarshal(HeaderString, &o.Header)
	}
	
	if Body, ok := ConversationnotificationtemplatecardMap["body"].(map[string]interface{}); ok {
		BodyString, _ := json.Marshal(Body)
		json.Unmarshal(BodyString, &o.Body)
	}
	
	if Buttons, ok := ConversationnotificationtemplatecardMap["buttons"].([]interface{}); ok {
