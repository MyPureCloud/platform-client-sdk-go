...
A Go package to interface with the Genesys Cloud Platform API. View the documentation on the [PureCloud Developer Center](https://developer.mypurecloud.com/api/rest/client-libraries/go/). Browse the source code on [Github](https://github.com/MyPureCloud/platform-client-sdk-go).

Latest version: 1.0.1 [![GitHub release](https://img.shields.io/github/release/mypurecloud/platform-client-sdk-go.svg)]()
...
```go
go get github.com/mypurecloud/platform-client-sdk-go
```
