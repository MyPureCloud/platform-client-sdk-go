...
Latest version: 49.0.0 [![GitHub release](https://img.shields.io/github/release/mypurecloud/platform-client-sdk-go.svg)](https://github.com/MyPureCloud/platform-client-sdk-go)
...
```go
go get github.com/mypurecloud/platform-client-sdk-go/v49/platformclientv2
```
...
```go
import (
	"github.com/mypurecloud/platform-client-sdk-go/v49/platformclientv2"
)
```
